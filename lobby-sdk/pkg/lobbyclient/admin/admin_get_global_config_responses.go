...
type AdminGetGlobalConfigResponse struct {
...
func (m *AdminGetGlobalConfigResponse) Unpack() (*lobbyclientmodels.ModelGlobalConfiguration, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
