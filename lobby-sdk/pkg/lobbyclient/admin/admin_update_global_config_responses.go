...
type AdminUpdateGlobalConfigResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelGlobalConfiguration

	Error401 *lobbyclientmodels.RestapiErrorResponseBody
	Error403 *lobbyclientmodels.RestapiErrorResponseBody
}

func (m *AdminUpdateGlobalConfigResponse) Unpack() (*lobbyclientmodels.ModelGlobalConfiguration, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
