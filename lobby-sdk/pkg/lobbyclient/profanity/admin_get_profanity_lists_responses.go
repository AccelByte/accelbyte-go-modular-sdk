...
type AdminGetProfanityListsResponse struct {
	lobbyclientmodels.ApiResponse
	Data []*lobbyclientmodels.ModelsAdminGetProfanityListsListResponse
...
func (m *AdminGetProfanityListsResponse) Unpack() ([]*lobbyclientmodels.ModelsAdminGetProfanityListsListResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
