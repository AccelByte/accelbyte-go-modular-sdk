...
type AdminGetPlayerSessionAttributeResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelsGetPlayerSessionAttributeResponse
...
func (m *AdminGetPlayerSessionAttributeResponse) Unpack() (*lobbyclientmodels.ModelsGetPlayerSessionAttributeResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
