...
type PublicGetPlayerBlockedPlayersV1Response struct {
...
func (m *PublicGetPlayerBlockedPlayersV1Response) Unpack() (*lobbyclientmodels.ModelsGetAllPlayerBlockedUsersResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
