...
type AdminGetBulkPlayerBlockedPlayersV1Response struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelsGetBulkAllPlayerBlockedUsersResponse
...
func (m *AdminGetBulkPlayerBlockedPlayersV1Response) Unpack() (*lobbyclientmodels.ModelsGetBulkAllPlayerBlockedUsersResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
