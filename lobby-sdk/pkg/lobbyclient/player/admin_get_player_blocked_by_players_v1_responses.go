...
type AdminGetPlayerBlockedByPlayersV1Response struct {
...
func (m *AdminGetPlayerBlockedByPlayersV1Response) Unpack() (*lobbyclientmodels.ModelsGetAllPlayerBlockedByUsersResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
