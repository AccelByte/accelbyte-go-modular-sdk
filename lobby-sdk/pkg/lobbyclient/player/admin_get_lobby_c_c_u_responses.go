...
type AdminGetLobbyCCUResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelsGetLobbyCcuResponse
...
func (m *AdminGetLobbyCCUResponse) Unpack() (*lobbyclientmodels.ModelsGetLobbyCcuResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
