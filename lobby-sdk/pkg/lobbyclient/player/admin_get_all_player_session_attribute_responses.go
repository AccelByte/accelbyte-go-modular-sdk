...
type AdminGetAllPlayerSessionAttributeResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelsGetAllPlayerSessionAttributeResponse
...
func (m *AdminGetAllPlayerSessionAttributeResponse) Unpack() (*lobbyclientmodels.ModelsGetAllPlayerSessionAttributeResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
