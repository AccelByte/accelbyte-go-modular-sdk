...
type AdminUpdateThirdPartyConfigResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelsUpdateConfigResponse
...
func (m *AdminUpdateThirdPartyConfigResponse) Unpack() (*lobbyclientmodels.ModelsUpdateConfigResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
