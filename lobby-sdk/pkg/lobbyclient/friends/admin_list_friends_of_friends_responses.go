...
type AdminListFriendsOfFriendsResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelFriendshipConnectionResponse
...
func (m *AdminListFriendsOfFriendsResponse) Unpack() (*lobbyclientmodels.ModelFriendshipConnectionResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
