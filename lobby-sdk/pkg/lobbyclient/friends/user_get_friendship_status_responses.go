...
type UserGetFriendshipStatusResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelUserGetFriendshipStatusResponse
...
func (m *UserGetFriendshipStatusResponse) Unpack() (*lobbyclientmodels.ModelUserGetFriendshipStatusResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
