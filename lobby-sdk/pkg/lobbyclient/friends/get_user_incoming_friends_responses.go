...
type GetUserIncomingFriendsResponse struct {
	lobbyclientmodels.ApiResponse
	Data []*lobbyclientmodels.ModelGetUserIncomingFriendsResponse
...
func (m *GetUserIncomingFriendsResponse) Unpack() ([]*lobbyclientmodels.ModelGetUserIncomingFriendsResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
