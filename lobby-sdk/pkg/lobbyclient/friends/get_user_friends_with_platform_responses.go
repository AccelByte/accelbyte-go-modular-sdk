...
type GetUserFriendsWithPlatformResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelListBulkUserPlatformsResponse
...
func (m *GetUserFriendsWithPlatformResponse) Unpack() (*lobbyclientmodels.ModelListBulkUserPlatformsResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
