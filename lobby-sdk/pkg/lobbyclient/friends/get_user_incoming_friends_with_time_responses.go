...
type GetUserIncomingFriendsWithTimeResponse struct {
	lobbyclientmodels.ApiResponse
	Data []*lobbyclientmodels.ModelLoadIncomingFriendsWithTimeResponse
...
func (m *GetUserIncomingFriendsWithTimeResponse) Unpack() ([]*lobbyclientmodels.ModelLoadIncomingFriendsWithTimeResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
