...
type SyncNativeFriendsResponse struct {
	lobbyclientmodels.ApiResponse
	Data []*lobbyclientmodels.ModelNativeFriendSyncResponse
...
func (m *SyncNativeFriendsResponse) Unpack() ([]*lobbyclientmodels.ModelNativeFriendSyncResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
