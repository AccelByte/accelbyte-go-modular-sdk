...
func (o *PublicGetMessagesOK) Error() string {
	return fmt.Sprintf("[GET /lobby/v1/messages][%d] publicGetMessagesOK  %+v", 200, o.ToJSONString())
}
...
func (o *PublicGetMessagesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /lobby/v1/messages][%d] publicGetMessagesInternalServerError  %+v", 500, o.ToJSONString())
}
