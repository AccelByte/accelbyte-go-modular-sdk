...
type AdminUpdatePartyAttributesV1Response struct {
...
func (m *AdminUpdatePartyAttributesV1Response) Unpack() (*lobbyclientmodels.ModelsPartyData, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
