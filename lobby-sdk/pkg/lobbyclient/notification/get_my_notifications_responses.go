...
type GetMyNotificationsResponse struct {
	...
	Data *lobbyclientmodels.ModelNotificationResponse
...
func (m *GetMyNotificationsResponse) Unpack() (*lobbyclientmodels.ModelNotificationResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
