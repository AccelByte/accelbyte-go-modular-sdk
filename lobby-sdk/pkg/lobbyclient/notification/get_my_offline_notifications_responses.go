...
type GetMyOfflineNotificationsResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelNotificationsResponse
...
func (m *GetMyOfflineNotificationsResponse) Unpack() (*lobbyclientmodels.ModelNotificationsResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
