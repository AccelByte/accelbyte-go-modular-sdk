...
type GetAllNotificationTemplatesV1AdminResponse struct {
	lobbyclientmodels.ApiResponse
	Data []*lobbyclientmodels.ModelNotificationTemplateResponse
...
func (m *GetAllNotificationTemplatesV1AdminResponse) Unpack() ([]*lobbyclientmodels.ModelNotificationTemplateResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
