...
type GetTopicByNamespaceResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelTopicByNamespacesResponse
...
func (m *GetTopicByNamespaceResponse) Unpack() (*lobbyclientmodels.ModelTopicByNamespacesResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
