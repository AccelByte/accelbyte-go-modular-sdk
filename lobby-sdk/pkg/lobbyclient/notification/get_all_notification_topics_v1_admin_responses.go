...
type GetAllNotificationTopicsV1AdminResponse struct {
	lobbyclientmodels.ApiResponse
	Data *lobbyclientmodels.ModelGetAllNotificationTopicsResponse
...
func (m *GetAllNotificationTopicsV1AdminResponse) Unpack() (*lobbyclientmodels.ModelGetAllNotificationTopicsResponse, *lobbyclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
