...
type SendSpecificUserFreeformNotificationV1AdminResponse struct {
...
func (m *SendSpecificUserFreeformNotificationV1AdminResponse) Unpack() *lobbyclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
