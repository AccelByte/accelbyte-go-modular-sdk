...
// Validate validates this Model get all notification topics response
func (m *ModelGetAllNotificationTopicsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelGetAllNotificationTopicsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelGetAllNotificationTopicsResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelGetAllNotificationTopicsResponse) UnmarshalBinary(b []byte) error {
	var res ModelGetAllNotificationTopicsResponse
