...
// Validate validates this Model get all notification template slug resp
func (m *ModelGetAllNotificationTemplateSlugResp) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelGetAllNotificationTemplateSlugResp) validateData(formats strfmt.Registry) error {
...
func (m *ModelGetAllNotificationTemplateSlugResp) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelGetAllNotificationTemplateSlugResp) UnmarshalBinary(b []byte) error {
	var res ModelGetAllNotificationTemplateSlugResp
