...
// Validate validates this Model load incoming friends with time response
func (m *ModelLoadIncomingFriendsWithTimeResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelLoadIncomingFriendsWithTimeResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelLoadIncomingFriendsWithTimeResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelLoadIncomingFriendsWithTimeResponse) UnmarshalBinary(b []byte) error {
	var res ModelLoadIncomingFriendsWithTimeResponse
