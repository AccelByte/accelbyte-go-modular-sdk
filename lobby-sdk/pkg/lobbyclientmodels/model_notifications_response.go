...
// Validate validates this Model notifications response
func (m *ModelNotificationsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelNotificationsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelNotificationsResponse) UnmarshalBinary(b []byte) error {
	var res ModelNotificationsResponse
