...
// Validate validates this Model friendship connection response
func (m *ModelFriendshipConnectionResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelFriendshipConnectionResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelFriendshipConnectionResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelFriendshipConnectionResponse) UnmarshalBinary(b []byte) error {
	var res ModelFriendshipConnectionResponse
