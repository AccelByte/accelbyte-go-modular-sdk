...
type QueryMatchLengthDurationp99Response struct {
...
func (m *QueryMatchLengthDurationp99Response) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchLengthDurationQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
