...
type QueryTotalMatchmakingMatchTicketResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayMatchMatchmakingTicketQueryResponse
	...
	Error404 *sessionhistoryclientmodels.ResponseError
	Error500 *sessionhistoryclientmodels.ResponseError
}

func (m *QueryTotalMatchmakingMatchTicketResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchMatchmakingTicketQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
