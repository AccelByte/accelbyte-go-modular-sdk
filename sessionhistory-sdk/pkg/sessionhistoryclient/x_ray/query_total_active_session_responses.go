...
type QueryTotalActiveSessionResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayTotalActiveSessionQueryResponse
...
func (m *QueryTotalActiveSessionResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayTotalActiveSessionQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
