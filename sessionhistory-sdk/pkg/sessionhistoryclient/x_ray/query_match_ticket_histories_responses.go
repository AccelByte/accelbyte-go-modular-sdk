...
type QueryMatchTicketHistoriesResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayMatchTicketHistoryQueryResponse
...
func (m *QueryMatchTicketHistoriesResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchTicketHistoryQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
