...
type QueryXrayTimelineByTicketIDResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayTicketQueryResponse
...
func (m *QueryXrayTimelineByTicketIDResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayTicketQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
