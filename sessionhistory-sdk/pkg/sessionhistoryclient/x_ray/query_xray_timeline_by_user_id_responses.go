...
type QueryXrayTimelineByUserIDResponse struct {
...
func (m *QueryXrayTimelineByUserIDResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayTicketQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
