...
type QueryDetailTickMatchPoolResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayMatchPoolPodTickQueryResponse
...
func (m *QueryDetailTickMatchPoolResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchPoolPodTickQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
