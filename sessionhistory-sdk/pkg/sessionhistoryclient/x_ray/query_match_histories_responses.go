...
type QueryMatchHistoriesResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayMatchHistorQueryResponse
...
func (m *QueryMatchHistoriesResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchHistorQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
