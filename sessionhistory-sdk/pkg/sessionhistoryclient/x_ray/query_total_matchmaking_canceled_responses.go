...
type QueryTotalMatchmakingCanceledResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayCanceledMatchmakingTicketQueryResponse
...
func (m *QueryTotalMatchmakingCanceledResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayCanceledMatchmakingTicketQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
