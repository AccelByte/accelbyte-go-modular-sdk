...
type CreateXrayTicketObservabilityResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayTicketObservabilityResponse
...
func (m *CreateXrayTicketObservabilityResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayTicketObservabilityResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
