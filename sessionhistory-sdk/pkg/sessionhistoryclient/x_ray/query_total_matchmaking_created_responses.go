...
type QueryTotalMatchmakingCreatedResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayCreatedMatchmakingTicketQueryResponse
...
func (m *QueryTotalMatchmakingCreatedResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayCreatedMatchmakingTicketQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
