...
type QueryTotalPlayerPersessionResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayTotalPlayerPersessionAVGQueryResponse
...
func (m *QueryTotalPlayerPersessionResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayTotalPlayerPersessionAVGQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
