...
type QueryMatchLengthDurationpAvgResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayMatchLengthDurationQueryResponse
...
func (m *QueryMatchLengthDurationpAvgResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchLengthDurationQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
