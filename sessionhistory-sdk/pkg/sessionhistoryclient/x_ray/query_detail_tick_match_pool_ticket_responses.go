...
type QueryDetailTickMatchPoolTicketResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayMatchPoolPodTickTicketResponse
...
func (m *QueryDetailTickMatchPoolTicketResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchPoolPodTickTicketResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
