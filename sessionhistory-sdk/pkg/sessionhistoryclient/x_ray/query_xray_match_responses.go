...
type QueryXrayMatchResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayMatchesQueryResponse
...
func (m *QueryXrayMatchResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchesQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
