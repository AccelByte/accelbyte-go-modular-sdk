...
type QueryXrayMatchPoolResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsXRayMatchPoolQueryResponse
...
func (m *QueryXrayMatchPoolResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsXRayMatchPoolQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
