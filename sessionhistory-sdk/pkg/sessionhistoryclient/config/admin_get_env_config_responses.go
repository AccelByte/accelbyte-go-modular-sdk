...
type AdminGetEnvConfigResponse struct {
...
func (m *AdminGetEnvConfigResponse) Unpack() (*sessionhistoryclientmodels.EnvconfigConfiguration, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
