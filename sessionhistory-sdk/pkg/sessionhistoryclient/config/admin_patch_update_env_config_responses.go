...
type AdminPatchUpdateEnvConfigResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.EnvconfigConfiguration

	Error401 *sessionhistoryclientmodels.ResponseError
	Error403 *sessionhistoryclientmodels.ResponseError
}

func (m *AdminPatchUpdateEnvConfigResponse) Unpack() (*sessionhistoryclientmodels.EnvconfigConfiguration, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
