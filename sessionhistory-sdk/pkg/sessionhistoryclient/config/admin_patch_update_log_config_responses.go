...
func (o *AdminPatchUpdateLogConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested PATCH /sessionhistory/v1/admin/config/log returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *AdminPatchUpdateLogConfigOK) Error() string {
	return fmt.Sprintf("[PATCH /sessionhistory/v1/admin/config/log][%d] adminPatchUpdateLogConfigOK  %+v", 200, o.ToJSONString())
}
...
func (o *AdminPatchUpdateLogConfigUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /sessionhistory/v1/admin/config/log][%d] adminPatchUpdateLogConfigUnauthorized  %+v", 401, o.ToJSONString())
}
...
func (o *AdminPatchUpdateLogConfigForbidden) Error() string {
	return fmt.Sprintf("[PATCH /sessionhistory/v1/admin/config/log][%d] adminPatchUpdateLogConfigForbidden  %+v", 403, o.ToJSONString())
}
