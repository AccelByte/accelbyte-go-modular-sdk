...
func (m *AdminGetLogConfigResponse) Unpack() (*sessionhistoryclientmodels.LogconfigConfiguration, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *AdminGetLogConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /sessionhistory/v1/admin/config/log returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *AdminGetLogConfigOK) Error() string {
	return fmt.Sprintf("[GET /sessionhistory/v1/admin/config/log][%d] adminGetLogConfigOK  %+v", 200, o.ToJSONString())
}
...
func (o *AdminGetLogConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(sessionhistoryclientmodels.LogconfigConfiguration)
...
func (o *AdminGetLogConfigUnauthorized) Error() string {
	return fmt.Sprintf("[GET /sessionhistory/v1/admin/config/log][%d] adminGetLogConfigUnauthorized  %+v", 401, o.ToJSONString())
}
...
func (o *AdminGetLogConfigForbidden) Error() string {
	return fmt.Sprintf("[GET /sessionhistory/v1/admin/config/log][%d] adminGetLogConfigForbidden  %+v", 403, o.ToJSONString())
}
