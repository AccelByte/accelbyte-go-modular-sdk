...
type AdminQueryPartyDetailResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsPartyDetailQueryResponse
...
func (m *AdminQueryPartyDetailResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsPartyDetailQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
