...
type AdminQueryTicketDetailResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsTicketDetailQueryResponse
...
func (m *AdminQueryTicketDetailResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsTicketDetailQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
