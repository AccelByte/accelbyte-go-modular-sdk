...
type GetGameSessionDetailResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsGameSessionDetail
...
func (m *GetGameSessionDetailResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsGameSessionDetail, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
