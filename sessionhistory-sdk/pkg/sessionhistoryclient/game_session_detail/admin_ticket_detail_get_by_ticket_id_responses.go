...
type AdminTicketDetailGetByTicketIDResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsTicketObservabilityDetail
...
func (m *AdminTicketDetailGetByTicketIDResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsTicketObservabilityDetail, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
