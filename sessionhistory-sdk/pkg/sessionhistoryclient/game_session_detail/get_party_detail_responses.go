...
type GetPartyDetailResponse struct {
	sessionhistoryclientmodels.ApiResponse
	Data *sessionhistoryclientmodels.ApimodelsPartyDetail
...
func (m *GetPartyDetailResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsPartyDetail, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
