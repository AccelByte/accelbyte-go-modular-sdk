...
type AdminQueryGameSessionDetailResponse struct {
...
func (m *AdminQueryGameSessionDetailResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsGameSessionDetailQueryResponse, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
