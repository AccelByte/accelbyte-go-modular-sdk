...
type AdminGetMatchmakingDetailByTicketIDResponse struct {
...
func (m *AdminGetMatchmakingDetailByTicketIDResponse) Unpack() (*sessionhistoryclientmodels.ApimodelsMatchmakingDetail, *sessionhistoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
