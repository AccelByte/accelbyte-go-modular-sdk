...
func (m *GetHealthcheckInfoV1Response) Unpack() *sessionhistoryclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
		...
		default:
			return &sessionhistoryclientmodels.ApiError{Code: "500", Message: "Unknown error"}
		}
	}
...
func (o *GetHealthcheckInfoV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /sessionhistory/healthz returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetHealthcheckInfoV1OK) Error() string {
	return fmt.Sprintf("[GET /sessionhistory/healthz][%d] getHealthcheckInfoV1OK ", 200)
}
