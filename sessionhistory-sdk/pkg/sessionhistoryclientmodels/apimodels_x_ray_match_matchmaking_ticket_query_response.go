...
func (m *ApimodelsXRayMatchMatchmakingTicketQueryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsXRayMatchMatchmakingTicketQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsXRayMatchMatchmakingTicketQueryResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsXRayMatchMatchmakingTicketQueryResponse
