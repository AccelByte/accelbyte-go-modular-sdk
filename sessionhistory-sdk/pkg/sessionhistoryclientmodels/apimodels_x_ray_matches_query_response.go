...
func (m *ApimodelsXRayMatchesQueryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsXRayMatchesQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsXRayMatchesQueryResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsXRayMatchesQueryResponse
