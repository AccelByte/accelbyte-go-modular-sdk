...
func (m *ApimodelsXRayCreatedMatchmakingTicketQueryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsXRayCreatedMatchmakingTicketQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsXRayCreatedMatchmakingTicketQueryResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsXRayCreatedMatchmakingTicketQueryResponse
