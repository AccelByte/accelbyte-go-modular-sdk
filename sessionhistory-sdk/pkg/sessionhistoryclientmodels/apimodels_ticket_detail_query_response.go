...
func (m *ApimodelsTicketDetailQueryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsTicketDetailQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsTicketDetailQueryResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ApimodelsTicketDetailQueryResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsTicketDetailQueryResponse
