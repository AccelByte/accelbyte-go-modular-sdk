...
func (m *ApimodelsXRayMatchPoolPodTickMatchResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsXRayMatchPoolPodTickMatchResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsXRayMatchPoolPodTickMatchResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsXRayMatchPoolPodTickMatchResponse
