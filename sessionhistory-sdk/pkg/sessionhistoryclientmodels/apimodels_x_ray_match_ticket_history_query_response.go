...
func (m *ApimodelsXRayMatchTicketHistoryQueryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsXRayMatchTicketHistoryQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsXRayMatchTicketHistoryQueryResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsXRayMatchTicketHistoryQueryResponse
