...
func (m *ApimodelsXRayTotalPlayerPersessionAVGQueryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsXRayTotalPlayerPersessionAVGQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsXRayTotalPlayerPersessionAVGQueryResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsXRayTotalPlayerPersessionAVGQueryResponse
