...
func (m *ApimodelsXRayMatchPoolQueryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsXRayMatchPoolQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsXRayMatchPoolQueryResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsXRayMatchPoolQueryResponse
