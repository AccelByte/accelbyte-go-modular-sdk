...
type JoinGroupV2Response struct {
	groupclientmodels.ApiResponse
	Data *groupclientmodels.ModelsJoinGroupResponseV1
...
func (m *JoinGroupV2Response) Unpack() (*groupclientmodels.ModelsJoinGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
