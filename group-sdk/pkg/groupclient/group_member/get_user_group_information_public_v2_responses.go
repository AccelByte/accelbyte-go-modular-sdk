...
type GetUserGroupInformationPublicV2Response struct {
...
func (m *GetUserGroupInformationPublicV2Response) Unpack() (*groupclientmodels.ModelsGetGroupMemberListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
