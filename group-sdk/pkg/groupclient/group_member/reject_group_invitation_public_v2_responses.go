...
type RejectGroupInvitationPublicV2Response struct {
...
func (m *RejectGroupInvitationPublicV2Response) Unpack() (*groupclientmodels.ModelsMemberRequestGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
