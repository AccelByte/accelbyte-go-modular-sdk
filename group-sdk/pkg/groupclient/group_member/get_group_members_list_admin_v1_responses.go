...
type GetGroupMembersListAdminV1Response struct {
...
func (m *GetGroupMembersListAdminV1Response) Unpack() (*groupclientmodels.ModelsGetGroupMemberListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
