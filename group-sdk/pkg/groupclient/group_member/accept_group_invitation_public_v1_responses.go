...
type AcceptGroupInvitationPublicV1Response struct {
...
func (m *AcceptGroupInvitationPublicV1Response) Unpack() (*groupclientmodels.ModelsMemberRequestGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
