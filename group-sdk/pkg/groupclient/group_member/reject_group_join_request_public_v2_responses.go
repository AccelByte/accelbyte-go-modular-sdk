...
type RejectGroupJoinRequestPublicV2Response struct {
...
func (m *RejectGroupJoinRequestPublicV2Response) Unpack() (*groupclientmodels.ModelsMemberRequestGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
