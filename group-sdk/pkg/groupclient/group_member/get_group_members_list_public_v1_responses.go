...
type GetGroupMembersListPublicV1Response struct {
...
func (m *GetGroupMembersListPublicV1Response) Unpack() (*groupclientmodels.ModelsGetGroupMemberListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
