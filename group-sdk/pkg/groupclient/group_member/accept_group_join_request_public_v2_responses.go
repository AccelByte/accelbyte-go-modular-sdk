...
type AcceptGroupJoinRequestPublicV2Response struct {
...
func (m *AcceptGroupJoinRequestPublicV2Response) Unpack() (*groupclientmodels.ModelsMemberRequestGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
