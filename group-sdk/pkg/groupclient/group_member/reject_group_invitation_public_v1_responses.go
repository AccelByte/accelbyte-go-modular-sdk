...
type RejectGroupInvitationPublicV1Response struct {
...
func (m *RejectGroupInvitationPublicV1Response) Unpack() (*groupclientmodels.ModelsMemberRequestGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
