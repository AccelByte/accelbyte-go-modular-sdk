...
type GetUserGroupInformationPublicV1Response struct {
...
func (m *GetUserGroupInformationPublicV1Response) Unpack() (*groupclientmodels.ModelsGetUserGroupInformationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
