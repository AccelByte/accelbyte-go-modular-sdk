...
type RejectGroupJoinRequestPublicV1Response struct {
...
func (m *RejectGroupJoinRequestPublicV1Response) Unpack() (*groupclientmodels.ModelsMemberRequestGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
