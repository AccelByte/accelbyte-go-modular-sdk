...
type InviteGroupPublicV1Response struct {
...
func (m *InviteGroupPublicV1Response) Unpack() (*groupclientmodels.ModelsUserInvitationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
