...
type GetUserJoinedGroupInformationPublicV2Response struct {
	groupclientmodels.ApiResponse
	Data *groupclientmodels.ModelsGetGroupMemberListResponseV1
...
func (m *GetUserJoinedGroupInformationPublicV2Response) Unpack() (*groupclientmodels.ModelsGetGroupMemberListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
