...
type CancelGroupJoinRequestV1Response struct {
...
func (m *CancelGroupJoinRequestV1Response) Unpack() (*groupclientmodels.ModelsMemberRequestGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
