...
type GetUserGroupStatusInformationV2Response struct {
...
func (m *GetUserGroupStatusInformationV2Response) Unpack() (*groupclientmodels.ModelsGetUserGroupInformationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
