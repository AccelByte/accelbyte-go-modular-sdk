...
type LeaveGroupPublicV2Response struct {
	groupclientmodels.ApiResponse
	Data *groupclientmodels.ModelsLeaveGroupResponseV1
...
func (m *LeaveGroupPublicV2Response) Unpack() (*groupclientmodels.ModelsLeaveGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
