...
type LeaveGroupPublicV1Response struct {
...
func (m *LeaveGroupPublicV1Response) Unpack() (*groupclientmodels.ModelsLeaveGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
