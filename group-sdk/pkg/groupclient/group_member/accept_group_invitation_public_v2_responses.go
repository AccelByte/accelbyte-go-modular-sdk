...
type AcceptGroupInvitationPublicV2Response struct {
...
func (m *AcceptGroupInvitationPublicV2Response) Unpack() (*groupclientmodels.ModelsMemberRequestGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
