...
type InviteGroupPublicV2Response struct {
	groupclientmodels.ApiResponse
	Data *groupclientmodels.ModelsUserInvitationResponseV1
...
func (m *InviteGroupPublicV2Response) Unpack() (*groupclientmodels.ModelsUserInvitationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
