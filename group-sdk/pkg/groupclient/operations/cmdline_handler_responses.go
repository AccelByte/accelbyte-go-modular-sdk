...
func (o *CmdlineHandlerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /group/debug/pprof/cmdline returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *CmdlineHandlerOK) Error() string {
	return fmt.Sprintf("[GET /group/debug/pprof/cmdline][%d] cmdlineHandlerOK ", 200)
}
