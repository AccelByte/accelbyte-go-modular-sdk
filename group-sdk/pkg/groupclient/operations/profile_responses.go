...
func (o *ProfileReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /group/debug/pprof/profile returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ProfileOK) Error() string {
	return fmt.Sprintf("[GET /group/debug/pprof/profile][%d] profileOK ", 200)
}
