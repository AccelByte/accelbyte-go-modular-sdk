...
func (o *SymbolHandlerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /group/debug/pprof/symbol returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *SymbolHandlerOK) Error() string {
	return fmt.Sprintf("[GET /group/debug/pprof/symbol][%d] symbolHandlerOK ", 200)
}
