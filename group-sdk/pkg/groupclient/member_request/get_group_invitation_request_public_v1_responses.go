...
type GetGroupInvitationRequestPublicV1Response struct {
...
func (m *GetGroupInvitationRequestPublicV1Response) Unpack() (*groupclientmodels.ModelsGetMemberRequestsListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
