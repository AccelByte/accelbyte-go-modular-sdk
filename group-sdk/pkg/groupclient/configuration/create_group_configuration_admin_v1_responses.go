...
type CreateGroupConfigurationAdminV1Response struct {
...
func (m *CreateGroupConfigurationAdminV1Response) Unpack() (*groupclientmodels.ModelsCreateGroupConfigurationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
