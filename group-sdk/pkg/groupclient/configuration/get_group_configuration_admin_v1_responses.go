...
type GetGroupConfigurationAdminV1Response struct {
	groupclientmodels.ApiResponse
	Data *groupclientmodels.ModelsGetGroupConfigurationResponseV1
...
func (m *GetGroupConfigurationAdminV1Response) Unpack() (*groupclientmodels.ModelsGetGroupConfigurationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
