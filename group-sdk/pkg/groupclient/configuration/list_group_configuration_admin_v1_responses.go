...
type ListGroupConfigurationAdminV1Response struct {
	groupclientmodels.ApiResponse
	Data *groupclientmodels.ModelsListConfigurationResponseV1
...
func (m *ListGroupConfigurationAdminV1Response) Unpack() (*groupclientmodels.ModelsListConfigurationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
