...
type UpdatePatchSingleGroupPublicV2Response struct {
...
func (m *UpdatePatchSingleGroupPublicV2Response) Unpack() (*groupclientmodels.ModelsGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
