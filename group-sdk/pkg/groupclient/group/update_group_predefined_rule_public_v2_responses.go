...
type UpdateGroupPredefinedRulePublicV2Response struct {
...
func (m *UpdateGroupPredefinedRulePublicV2Response) Unpack() (*groupclientmodels.ModelsGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
