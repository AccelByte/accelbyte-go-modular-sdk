...
type UpdateGroupCustomRulePublicV1Response struct {
...
func (m *UpdateGroupCustomRulePublicV1Response) Unpack() (*groupclientmodels.ModelsGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
