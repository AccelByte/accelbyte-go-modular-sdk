...
type UpdatePutSingleGroupPublicV2Response struct {
...
func (m *UpdatePutSingleGroupPublicV2Response) Unpack() (*groupclientmodels.ModelsGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
