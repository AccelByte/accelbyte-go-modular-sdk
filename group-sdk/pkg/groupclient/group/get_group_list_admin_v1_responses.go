...
type GetGroupListAdminV1Response struct {
...
func (m *GetGroupListAdminV1Response) Unpack() (*groupclientmodels.ModelsGetGroupsListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
