...
type GetGroupListPublicV1Response struct {
	groupclientmodels.ApiResponse
	Data *groupclientmodels.ModelsGetGroupsListResponseV1
...
func (m *GetGroupListPublicV1Response) Unpack() (*groupclientmodels.ModelsGetGroupsListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
