...
type UpdatePatchSingleGroupPublicV1Response struct {
...
func (m *UpdatePatchSingleGroupPublicV1Response) Unpack() (*groupclientmodels.ModelsGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
