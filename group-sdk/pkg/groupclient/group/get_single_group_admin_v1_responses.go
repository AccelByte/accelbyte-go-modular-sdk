...
type GetSingleGroupAdminV1Response struct {
...
func (m *GetSingleGroupAdminV1Response) Unpack() (*groupclientmodels.ModelsGroupResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
