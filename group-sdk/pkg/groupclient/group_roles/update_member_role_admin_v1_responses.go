...
type UpdateMemberRoleAdminV1Response struct {
...
func (m *UpdateMemberRoleAdminV1Response) Unpack() (*groupclientmodels.ModelsMemberRoleResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
