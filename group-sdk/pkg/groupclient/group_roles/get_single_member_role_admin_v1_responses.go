...
type GetSingleMemberRoleAdminV1Response struct {
...
func (m *GetSingleMemberRoleAdminV1Response) Unpack() (*groupclientmodels.ModelsMemberRoleResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
