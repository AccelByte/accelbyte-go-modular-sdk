...
type CreateMemberRoleAdminV1Response struct {
...
func (m *CreateMemberRoleAdminV1Response) Unpack() (*groupclientmodels.ModelsMemberRoleResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
