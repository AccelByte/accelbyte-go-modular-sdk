...
type GetMemberRolesListPublicV2Response struct {
...
func (m *GetMemberRolesListPublicV2Response) Unpack() (*groupclientmodels.ModelsGetMemberRolesListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
