...
type UpdateMemberRolePublicV2Response struct {
...
func (m *UpdateMemberRolePublicV2Response) Unpack() (*groupclientmodels.ModelsGetUserGroupInformationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
