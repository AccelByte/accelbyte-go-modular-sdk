...
type GetMemberRolesListAdminV1Response struct {
...
func (m *GetMemberRolesListAdminV1Response) Unpack() (*groupclientmodels.ModelsGetMemberRolesListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
