...
type UpdateMemberRolePublicV1Response struct {
...
func (m *UpdateMemberRolePublicV1Response) Unpack() (*groupclientmodels.ModelsGetUserGroupInformationResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
