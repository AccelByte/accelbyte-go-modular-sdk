...
type GetMemberRolesListPublicV1Response struct {
	groupclientmodels.ApiResponse
	Data *groupclientmodels.ModelsGetMemberRolesListResponseV1
...
func (m *GetMemberRolesListPublicV1Response) Unpack() (*groupclientmodels.ModelsGetMemberRolesListResponseV1, *groupclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
