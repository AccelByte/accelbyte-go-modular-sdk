...
func (m *ModelsListConfigurationResponseV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsListConfigurationResponseV1) validateData(formats strfmt.Registry) error {
...
func (m *ModelsListConfigurationResponseV1) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsListConfigurationResponseV1) UnmarshalBinary(b []byte) error {
	var res ModelsListConfigurationResponseV1
