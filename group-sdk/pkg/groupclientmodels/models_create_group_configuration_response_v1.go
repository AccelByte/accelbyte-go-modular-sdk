...
func (m *ModelsCreateGroupConfigurationResponseV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsCreateGroupConfigurationResponseV1) validateAllowMultiple(formats strfmt.Registry) error {
...
func (m *ModelsCreateGroupConfigurationResponseV1) validateConfigurationCode(formats strfmt.Registry) error {
...
func (m *ModelsCreateGroupConfigurationResponseV1) validateDescription(formats strfmt.Registry) error {
...
func (m *ModelsCreateGroupConfigurationResponseV1) validateGlobalRules(formats strfmt.Registry) error {
...
func (m *ModelsCreateGroupConfigurationResponseV1) validateGroupAdminRoleID(formats strfmt.Registry) error {
...
func (m *ModelsCreateGroupConfigurationResponseV1) validateGroupMaxMember(formats strfmt.Registry) error {
...
func (m *ModelsCreateGroupConfigurationResponseV1) validateGroupMemberRoleID(formats strfmt.Registry) error {
...
func (m *ModelsCreateGroupConfigurationResponseV1) validateName(formats strfmt.Registry) error {
...
func (m *ModelsCreateGroupConfigurationResponseV1) UnmarshalBinary(b []byte) error {
	var res ModelsCreateGroupConfigurationResponseV1
