...
func (m *ModelsGetGroupsListResponseV1) validateData(formats strfmt.Registry) error {
...
func (m *ModelsGetGroupsListResponseV1) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsGetGroupsListResponseV1) UnmarshalBinary(b []byte) error {
	var res ModelsGetGroupsListResponseV1
