...
func (m *ModelsGetMemberRequestsListResponseV1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsGetMemberRequestsListResponseV1) validateData(formats strfmt.Registry) error {
...
func (m *ModelsGetMemberRequestsListResponseV1) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsGetMemberRequestsListResponseV1) UnmarshalBinary(b []byte) error {
	var res ModelsGetMemberRequestsListResponseV1
