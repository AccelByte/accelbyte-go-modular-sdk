...
type AdminGetInputValidationsResponse struct {
...
func (m *AdminGetInputValidationsResponse) Unpack() (*iamclientmodels.ModelInputValidationsResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
