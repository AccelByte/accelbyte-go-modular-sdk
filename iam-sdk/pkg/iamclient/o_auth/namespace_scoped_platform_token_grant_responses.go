...
type NamespaceScopedPlatformTokenGrantResponse struct {
...
func (m *NamespaceScopedPlatformTokenGrantResponse) Unpack() (*iamclientmodels.OauthmodelTokenResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
