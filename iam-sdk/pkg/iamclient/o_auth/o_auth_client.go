...
/*
	  AuthorizationShort os auth2 authorize API
...
/*
	  GetJWKSShort JSONs web key set for verifying j w t
...
/*
	  GetRevocationListShort os auth2 revocation list API
...
/*
	  PlatformTokenRequestHandlerShort os auth2 access token generation specific to platform
...
/*
	  RevokeAUserShort os auth2 user revocation API
...
/*
	  RevokeTokenShort os auth2 token revocation API
...
/*
	  TokenGrantShort os auth2 access token generation endpoint
...
/*
	  VerifyTokenShort os auth2 token verification API
