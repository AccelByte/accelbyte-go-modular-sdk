...
func (m *GetRevocationListResponse) Unpack() (*iamclientmodels.OauthapiRevocationList, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
		...
		case 401:
			return nil, &iamclientmodels.ApiError{Code: "401", Message: m.Error401}
