...
type AdminGetConfigValueV3Response struct {
...
func (m *AdminGetConfigValueV3Response) Unpack() (*iamclientmodels.ModelConfigValueResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
