...
type PublicGetSystemConfigV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelInternalConfigResponseV3

	Error500 *iamclientmodels.RestErrorResponse
}

func (m *PublicGetSystemConfigV3Response) Unpack() (*iamclientmodels.ModelInternalConfigResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
