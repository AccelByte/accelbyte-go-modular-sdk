...
// WithTimeout adds the timeout to the platform authenticate SAML v3 handler params
...
// SetTimeout adds the timeout to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) WithContext(ctx context.Context) *PlatformAuthenticateSAMLV3HandlerParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// SetAuthInfoWriter adds the authInfoWriter to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) SetAuthInfoWriter(authInfoWriter runtime.ClientAuthInfoWriter) {
	o.AuthInfoWriter = authInfoWriter
}

// WithHTTPClient adds the HTTPClient to the platform authenticate SAML v3 handler params
...
// SetHTTPClient adds the HTTPClient to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// SetHTTPClient adds the HTTPClient Transport to the platform authenticate SAML v3 handler params
...
// WithCode adds the code to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) WithCode(code *string) *PlatformAuthenticateSAMLV3HandlerParams {
	o.SetCode(code)
	return o
}

// SetCode adds the code to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) SetCode(code *string) {
	o.Code = code
}

// WithError adds the error to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) WithError(error *string) *PlatformAuthenticateSAMLV3HandlerParams {
	o.SetError(error)
	return o
}

// SetError adds the error to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) SetError(error *string) {
	o.Error = error
}

// WithPlatformID adds the platformID to the platform authenticate SAML v3 handler params
...
// SetPlatformID adds the platformId to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) SetPlatformID(platformID string) {
	o.PlatformID = platformID
}

// WithState adds the state to the platform authenticate SAML v3 handler params
func (o *PlatformAuthenticateSAMLV3HandlerParams) WithState(state string) *PlatformAuthenticateSAMLV3HandlerParams {
	o.SetState(state)
	return o
}

// SetState adds the state to the platform authenticate SAML v3 handler params
