...
type TokenGrantV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.OauthmodelTokenWithDeviceCookieResponseV3
	...
	Error429 *iamclientmodels.OauthmodelErrorResponse
}

func (m *TokenGrantV3Response) Unpack() (*iamclientmodels.OauthmodelTokenWithDeviceCookieResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
