...
type OAuthDynamicClientRegisterWithNamespaceV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.OauthmodelClientRegisterResponse

	Error400 *iamclientmodels.OauthmodelErrorResponse
	Error429 *iamclientmodels.RestErrorResponse
	Error500 *iamclientmodels.OauthmodelErrorResponse
	Error501 *iamclientmodels.RestErrorResponse
}

func (m *OAuthDynamicClientRegisterWithNamespaceV3Response) Unpack() (*iamclientmodels.OauthmodelClientRegisterResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
