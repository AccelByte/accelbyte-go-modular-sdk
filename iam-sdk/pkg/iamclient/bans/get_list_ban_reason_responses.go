...
type GetListBanReasonResponse struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.AccountcommonBanReasons

	Error401 *iamclientmodels.RestErrorResponse
	Error403 *iamclientmodels.RestErrorResponse
}

func (m *GetListBanReasonResponse) Unpack() (*iamclientmodels.AccountcommonBanReasons, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
