...
type AdminUnbanUserBulkV3Response struct {
...
func (m *AdminUnbanUserBulkV3Response) Unpack() (*iamclientmodels.ModelListBulkUserBanResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
