...
type GetBansTypeResponse struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.AccountcommonBans

	Error401 *iamclientmodels.RestErrorResponse
	Error403 *iamclientmodels.RestErrorResponse
}

func (m *GetBansTypeResponse) Unpack() (*iamclientmodels.AccountcommonBans, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
