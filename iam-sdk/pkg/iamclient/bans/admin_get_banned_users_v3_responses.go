...
type AdminGetBannedUsersV3Response struct {
...
func (m *AdminGetBannedUsersV3Response) Unpack() (*iamclientmodels.ModelGetUserBanV3Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
