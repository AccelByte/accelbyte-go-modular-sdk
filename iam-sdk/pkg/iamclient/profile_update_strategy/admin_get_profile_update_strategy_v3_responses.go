...
type AdminGetProfileUpdateStrategyV3Response struct {
...
func (m *AdminGetProfileUpdateStrategyV3Response) Unpack() (*iamclientmodels.ModelGetProfileUpdateStrategyConfigResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
