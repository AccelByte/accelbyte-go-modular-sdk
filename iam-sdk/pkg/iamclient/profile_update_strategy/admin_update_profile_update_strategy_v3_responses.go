...
type AdminUpdateProfileUpdateStrategyV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelSimpleProfileUpdateStrategyConfigs
...
func (m *AdminUpdateProfileUpdateStrategyV3Response) Unpack() (*iamclientmodels.ModelSimpleProfileUpdateStrategyConfigs, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
