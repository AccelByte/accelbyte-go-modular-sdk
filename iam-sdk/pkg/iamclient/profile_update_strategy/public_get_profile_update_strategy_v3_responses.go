...
type PublicGetProfileUpdateStrategyV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelGetProfileUpdateStrategyConfigResponse
...
func (m *PublicGetProfileUpdateStrategyV3Response) Unpack() (*iamclientmodels.ModelGetProfileUpdateStrategyConfigResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
