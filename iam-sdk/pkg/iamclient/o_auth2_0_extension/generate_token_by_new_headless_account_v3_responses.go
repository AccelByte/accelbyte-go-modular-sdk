...
type GenerateTokenByNewHeadlessAccountV3Response struct {
...
func (m *GenerateTokenByNewHeadlessAccountV3Response) Unpack() (*iamclientmodels.OauthmodelTokenResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
