...
func (o *ValidateOneTimeLinkingCodeV3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewValidateOneTimeLinkingCodeV3OK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested POST /iam/v3/link/code/validate returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ValidateOneTimeLinkingCodeV3OK) Error() string {
	return fmt.Sprintf("[POST /iam/v3/link/code/validate][%d] validateOneTimeLinkingCodeV3OK  %+v", 200, o.ToJSONString())
}
...
func (o *ValidateOneTimeLinkingCodeV3OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(iamclientmodels.OauthmodelOneTimeLinkingCodeValidationResponse)
