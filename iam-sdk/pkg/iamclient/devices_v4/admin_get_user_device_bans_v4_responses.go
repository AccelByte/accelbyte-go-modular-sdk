...
type AdminGetUserDeviceBansV4Response struct {
...
func (m *AdminGetUserDeviceBansV4Response) Unpack() (*iamclientmodels.ModelDeviceBansResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
