...
type AdminGetDeviceTypesV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelDeviceTypesResponseV4
...
func (m *AdminGetDeviceTypesV4Response) Unpack() (*iamclientmodels.ModelDeviceTypesResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
