...
type AdminGetBannedDevicesV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelDeviceBannedResponseV4
...
func (m *AdminGetBannedDevicesV4Response) Unpack() (*iamclientmodels.ModelDeviceBannedResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
