...
type AdminGetDeviceBanV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelDeviceBanResponseV4
...
func (m *AdminGetDeviceBanV4Response) Unpack() (*iamclientmodels.ModelDeviceBanResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
