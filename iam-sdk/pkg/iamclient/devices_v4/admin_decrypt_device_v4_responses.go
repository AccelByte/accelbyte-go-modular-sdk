...
type AdminDecryptDeviceV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelDeviceIDDecryptResponseV4
...
func (m *AdminDecryptDeviceV4Response) Unpack() (*iamclientmodels.ModelDeviceIDDecryptResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
