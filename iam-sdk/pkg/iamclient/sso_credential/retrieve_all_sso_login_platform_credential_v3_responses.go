...
type RetrieveAllSSOLoginPlatformCredentialV3Response struct {
...
func (m *RetrieveAllSSOLoginPlatformCredentialV3Response) Unpack() ([]*iamclientmodels.ModelSSOPlatformCredentialResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
