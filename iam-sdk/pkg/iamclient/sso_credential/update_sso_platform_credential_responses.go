...
type UpdateSSOPlatformCredentialResponse struct {
...
func (m *UpdateSSOPlatformCredentialResponse) Unpack() (*iamclientmodels.ModelSSOPlatformCredentialResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
