...
type AddSSOLoginPlatformCredentialResponse struct {
...
func (m *AddSSOLoginPlatformCredentialResponse) Unpack() (*iamclientmodels.ModelSSOPlatformCredentialResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
