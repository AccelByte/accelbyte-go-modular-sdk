...
type AdminGetRolesV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelListRoleV4Response
...
func (m *AdminGetRolesV4Response) Unpack() (*iamclientmodels.ModelListRoleV4Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
