...
type AdminGetRolesV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelRoleResponseWithManagersAndPaginationV3
...
func (m *AdminGetRolesV3Response) Unpack() (*iamclientmodels.ModelRoleResponseWithManagersAndPaginationV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
