...
type AdminAssignUserToRoleV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelAssignedUserV4Response
...
func (m *AdminAssignUserToRoleV4Response) Unpack() (*iamclientmodels.ModelAssignedUserV4Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
