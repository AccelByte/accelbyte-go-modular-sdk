...
type AdminGetRoleAdminStatusV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelRoleAdminStatusResponseV3
...
func (m *AdminGetRoleAdminStatusV3Response) Unpack() (*iamclientmodels.ModelRoleAdminStatusResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
