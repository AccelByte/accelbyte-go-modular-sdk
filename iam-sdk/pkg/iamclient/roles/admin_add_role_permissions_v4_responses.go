...
type AdminAddRolePermissionsV4Response struct {
...
func (m *AdminAddRolePermissionsV4Response) Unpack() (*iamclientmodels.ModelRoleV4Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
