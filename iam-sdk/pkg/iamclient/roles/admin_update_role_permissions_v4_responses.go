...
type AdminUpdateRolePermissionsV4Response struct {
...
func (m *AdminUpdateRolePermissionsV4Response) Unpack() (*iamclientmodels.ModelRoleV4Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
