...
type GetRoleMembersResponse struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelRoleMembersResponse
...
func (m *GetRoleMembersResponse) Unpack() (*iamclientmodels.ModelRoleMembersResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
