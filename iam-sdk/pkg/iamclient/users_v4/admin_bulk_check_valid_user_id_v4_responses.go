...
type AdminBulkCheckValidUserIDV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelListValidUserIDResponseV4
...
func (m *AdminBulkCheckValidUserIDV4Response) Unpack() (*iamclientmodels.ModelListValidUserIDResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
