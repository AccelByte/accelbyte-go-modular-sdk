...
type PublicGetUserByPlatformUserIDV4Response struct {
...
func (m *PublicGetUserByPlatformUserIDV4Response) Unpack() (*iamclientmodels.ModelUserResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
