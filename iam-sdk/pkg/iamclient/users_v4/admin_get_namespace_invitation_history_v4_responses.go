...
type AdminGetNamespaceInvitationHistoryV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelInvitationHistoryResponse
...
func (m *AdminGetNamespaceInvitationHistoryV4Response) Unpack() (*iamclientmodels.ModelInvitationHistoryResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
