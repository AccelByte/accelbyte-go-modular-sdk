...
type AdminGetMyMFAStatusV4Response struct {
...
func (m *AdminGetMyMFAStatusV4Response) Unpack() (*iamclientmodels.ModelUserMFAStatusResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
