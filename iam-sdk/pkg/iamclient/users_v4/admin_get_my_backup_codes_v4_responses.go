...
type AdminGetMyBackupCodesV4Response struct {
...
func (m *AdminGetMyBackupCodesV4Response) Unpack() (*iamclientmodels.ModelBackupCodesResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
