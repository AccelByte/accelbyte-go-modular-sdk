...
// NewAdminGetMyMFAStatusV4Params creates a new AdminGetMyMFAStatusV4Params object
// with the default values initialized.
func NewAdminGetMyMFAStatusV4Params() *AdminGetMyMFAStatusV4Params {
	var ()
	return &AdminGetMyMFAStatusV4Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminGetMyMFAStatusV4ParamsWithTimeout creates a new AdminGetMyMFAStatusV4Params object
...
// NewAdminGetMyMFAStatusV4ParamsWithContext creates a new AdminGetMyMFAStatusV4Params object
...
// NewAdminGetMyMFAStatusV4ParamsWithHTTPClient creates a new AdminGetMyMFAStatusV4Params object
...
/*
AdminGetMyMFAStatusV4Params contains all the parameters to send to the API endpoint
for the admin get my mfa status v4 operation typically these are written to a http.Request
*/
type AdminGetMyMFAStatusV4Params struct {
