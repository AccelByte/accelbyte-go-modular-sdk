...
type AdminUpdateUserRoleV4Response struct {
...
func (m *AdminUpdateUserRoleV4Response) Unpack() (*iamclientmodels.ModelListUserRolesV4Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
