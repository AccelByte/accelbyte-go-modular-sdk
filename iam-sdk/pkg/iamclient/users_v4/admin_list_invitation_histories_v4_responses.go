...
type AdminListInvitationHistoriesV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelListInvitationHistoriesV4Response
...
func (m *AdminListInvitationHistoriesV4Response) Unpack() (*iamclientmodels.ModelListInvitationHistoriesV4Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
