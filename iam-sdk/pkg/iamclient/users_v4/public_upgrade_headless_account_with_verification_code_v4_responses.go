...
type PublicUpgradeHeadlessAccountWithVerificationCodeV4Response struct {
...
func (m *PublicUpgradeHeadlessAccountWithVerificationCodeV4Response) Unpack() (*iamclientmodels.AccountUserResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
