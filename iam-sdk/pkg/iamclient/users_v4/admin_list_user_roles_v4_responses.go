...
type AdminListUserRolesV4Response struct {
...
func (m *AdminListUserRolesV4Response) Unpack() (*iamclientmodels.ModelListUserRolesV4Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
