...
type PublicCreateUserV4Response struct {
...
func (m *PublicCreateUserV4Response) Unpack() (*iamclientmodels.AccountCreateUserResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *PublicCreateUserV4Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 409:
		...
		return result, nil
	case 429:
		result := NewPublicCreateUserV4TooManyRequests()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func (o *PublicCreateUserV4TooManyRequests) Error() string {
	return fmt.Sprintf("[POST /iam/v4/public/namespaces/{namespace}/users][%d] publicCreateUserV4TooManyRequests  %+v", 429, o.ToJSONString())
}
