...
type PublicEnableMyBackupCodesV4Response struct {
...
func (m *PublicEnableMyBackupCodesV4Response) Unpack() (*iamclientmodels.ModelBackupCodesResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
