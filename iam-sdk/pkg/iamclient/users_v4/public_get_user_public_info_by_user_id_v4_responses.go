...
type PublicGetUserPublicInfoByUserIDV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserPublicInfoResponseV4
...
func (m *PublicGetUserPublicInfoByUserIDV4Response) Unpack() (*iamclientmodels.ModelUserPublicInfoResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
