...
type PublicGenerateMyAuthenticatorKeyV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelAuthenticatorKeyResponseV4
...
func (m *PublicGenerateMyAuthenticatorKeyV4Response) Unpack() (*iamclientmodels.ModelAuthenticatorKeyResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
