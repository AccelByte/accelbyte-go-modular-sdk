...
type PublicGetMyEnabledFactorsV4Response struct {
...
func (m *PublicGetMyEnabledFactorsV4Response) Unpack() (*iamclientmodels.ModelEnabledFactorsResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
