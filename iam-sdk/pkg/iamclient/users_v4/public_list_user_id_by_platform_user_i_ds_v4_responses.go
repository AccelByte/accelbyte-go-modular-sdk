...
type PublicListUserIDByPlatformUserIDsV4Response struct {
...
func (m *PublicListUserIDByPlatformUserIDsV4Response) Unpack() (*iamclientmodels.AccountcommonUserPlatforms, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
