...
type AdminGetUserMFAStatusV4Response struct {
...
func (m *AdminGetUserMFAStatusV4Response) Unpack() (*iamclientmodels.ModelUserMFAStatusResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
