...
type AdminGetNamespaceUserInvitationHistoryV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelNamespaceInvitationHistoryUserV4Response
...
func (m *AdminGetNamespaceUserInvitationHistoryV4Response) Unpack() (*iamclientmodels.ModelNamespaceInvitationHistoryUserV4Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
