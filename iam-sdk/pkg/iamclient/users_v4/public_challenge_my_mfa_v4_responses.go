...
type PublicChallengeMyMFAV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserMFATokenResponseV4
...
func (m *PublicChallengeMyMFAV4Response) Unpack() (*iamclientmodels.ModelUserMFATokenResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
