...
type PublicGetMyOwnMFAStatusV4Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserMFAStatusResponseV4
...
func (m *PublicGetMyOwnMFAStatusV4Response) Unpack() (*iamclientmodels.ModelUserMFAStatusResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
