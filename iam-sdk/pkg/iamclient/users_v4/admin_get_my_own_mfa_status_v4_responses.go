...
type AdminGetMyOwnMFAStatusV4Response struct {
...
func (m *AdminGetMyOwnMFAStatusV4Response) Unpack() (*iamclientmodels.ModelUserMFAStatusResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
