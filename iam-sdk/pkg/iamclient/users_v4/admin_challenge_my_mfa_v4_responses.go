...
type AdminChallengeMyMFAV4Response struct {
...
func (m *AdminChallengeMyMFAV4Response) Unpack() (*iamclientmodels.ModelUserMFATokenResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
