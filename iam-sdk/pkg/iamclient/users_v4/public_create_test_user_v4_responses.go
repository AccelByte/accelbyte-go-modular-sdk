...
type PublicCreateTestUserV4Response struct {
...
func (m *PublicCreateTestUserV4Response) Unpack() (*iamclientmodels.AccountCreateUserResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
