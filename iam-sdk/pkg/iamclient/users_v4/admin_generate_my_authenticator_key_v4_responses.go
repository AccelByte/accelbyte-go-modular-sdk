...
type AdminGenerateMyAuthenticatorKeyV4Response struct {
...
func (m *AdminGenerateMyAuthenticatorKeyV4Response) Unpack() (*iamclientmodels.ModelAuthenticatorKeyResponseV4, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
