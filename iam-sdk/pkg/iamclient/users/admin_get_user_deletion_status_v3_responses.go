...
type AdminGetUserDeletionStatusV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserDeletionStatusResponse
...
func (m *AdminGetUserDeletionStatusV3Response) Unpack() (*iamclientmodels.ModelUserDeletionStatusResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
