...
type PublicListUserIDByPlatformUserIDsV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.AccountcommonUserPlatforms
...
func (m *PublicListUserIDByPlatformUserIDsV3Response) Unpack() (*iamclientmodels.AccountcommonUserPlatforms, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
