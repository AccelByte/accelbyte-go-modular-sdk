...
type AdminGetUserStateByUserIDV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserStateResponseV3
...
func (m *AdminGetUserStateByUserIDV3Response) Unpack() (*iamclientmodels.ModelUserStateResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
