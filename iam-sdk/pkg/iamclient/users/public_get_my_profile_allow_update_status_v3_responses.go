...
type PublicGetMyProfileAllowUpdateStatusV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserProfileUpdateAllowStatus
...
func (m *PublicGetMyProfileAllowUpdateStatusV3Response) Unpack() (*iamclientmodels.ModelUserProfileUpdateAllowStatus, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
