...
type AdminGetUserLoginHistoriesV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelLoginHistoriesResponse
...
func (m *AdminGetUserLoginHistoriesV3Response) Unpack() (*iamclientmodels.ModelLoginHistoriesResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *AdminGetUserLoginHistoriesV3OK) Error() string {
	return fmt.Sprintf("[GET /iam/v3/admin/namespaces/{namespace}/users/{userId}/logins/histories][%d] adminGetUserLoginHistoriesV3OK  %+v", 200, o.ToJSONString())
}
