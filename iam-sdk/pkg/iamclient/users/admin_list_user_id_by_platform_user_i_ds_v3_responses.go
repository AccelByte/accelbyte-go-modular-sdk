...
type AdminListUserIDByPlatformUserIDsV3Response struct {
...
func (m *AdminListUserIDByPlatformUserIDsV3Response) Unpack() (*iamclientmodels.AccountcommonUserPlatforms, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
