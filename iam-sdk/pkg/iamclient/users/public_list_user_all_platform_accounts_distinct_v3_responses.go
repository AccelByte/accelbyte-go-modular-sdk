...
type PublicListUserAllPlatformAccountsDistinctV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.AccountcommonDistinctPlatformResponseV3
...
func (m *PublicListUserAllPlatformAccountsDistinctV3Response) Unpack() (*iamclientmodels.AccountcommonDistinctPlatformResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
