...
type AdminListAllDistinctPlatformAccountsV3Response struct {
...
func (m *AdminListAllDistinctPlatformAccountsV3Response) Unpack() (*iamclientmodels.AccountcommonDistinctPlatformResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
