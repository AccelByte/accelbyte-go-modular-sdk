...
type PublicGetUserByUserIDV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelPublicUserResponseV3
...
func (m *PublicGetUserByUserIDV3Response) Unpack() (*iamclientmodels.ModelPublicUserResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
