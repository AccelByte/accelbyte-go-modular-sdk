...
type AdminDeleteUserLinkingHistoryByPlatformIDV3Response struct {
...
func (m *AdminDeleteUserLinkingHistoryByPlatformIDV3Response) Unpack() *iamclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
