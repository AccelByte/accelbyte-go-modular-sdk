...
type AdminSearchUserV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelSearchUsersResponseWithPaginationV3
...
func (m *AdminSearchUserV3Response) Unpack() (*iamclientmodels.ModelSearchUsersResponseWithPaginationV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
