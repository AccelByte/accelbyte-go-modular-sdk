...
type AdminUpdateAgeRestrictionConfigV2Response struct {
...
func (m *AdminUpdateAgeRestrictionConfigV2Response) Unpack() (*iamclientmodels.ModelAgeRestrictionResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
