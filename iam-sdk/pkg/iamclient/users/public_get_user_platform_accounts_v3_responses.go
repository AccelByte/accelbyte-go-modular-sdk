...
type PublicGetUserPlatformAccountsV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.AccountcommonUserLinkedPlatformsResponseV3
...
func (m *PublicGetUserPlatformAccountsV3Response) Unpack() (*iamclientmodels.AccountcommonUserLinkedPlatformsResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
