...
type AdminListUserAllPlatformAccountsDistinctV3Response struct {
...
func (m *AdminListUserAllPlatformAccountsDistinctV3Response) Unpack() (*iamclientmodels.AccountcommonDistinctPlatformResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
