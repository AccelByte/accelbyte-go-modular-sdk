...
type AdminGetUserPlatformAccountsV3Response struct {
...
func (m *AdminGetUserPlatformAccountsV3Response) Unpack() (*iamclientmodels.AccountcommonUserLinkedPlatformsResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
