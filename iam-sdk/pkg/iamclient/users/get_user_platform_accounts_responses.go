...
type GetUserPlatformAccountsResponse struct {
	iamclientmodels.ApiResponse
	Data []*iamclientmodels.AccountcommonUserLinkedPlatform
...
func (m *GetUserPlatformAccountsResponse) Unpack() ([]*iamclientmodels.AccountcommonUserLinkedPlatform, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
