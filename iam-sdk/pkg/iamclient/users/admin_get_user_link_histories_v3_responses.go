...
type AdminGetUserLinkHistoriesV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserPlatformLinkHistories
...
func (m *AdminGetUserLinkHistoriesV3Response) Unpack() (*iamclientmodels.ModelUserPlatformLinkHistories, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
