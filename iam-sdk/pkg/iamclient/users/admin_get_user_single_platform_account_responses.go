...
type AdminGetUserSinglePlatformAccountResponse struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserPlatformMetadata
...
func (m *AdminGetUserSinglePlatformAccountResponse) Unpack() (*iamclientmodels.ModelUserPlatformMetadata, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
