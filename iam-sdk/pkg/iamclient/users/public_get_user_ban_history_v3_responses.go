...
type PublicGetUserBanHistoryV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelGetUserBanV3Response
...
func (m *PublicGetUserBanHistoryV3Response) Unpack() (*iamclientmodels.ModelGetUserBanV3Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
