...
type PublicForgotPasswordWithoutNamespaceV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelForgotPasswordResponseV3

	Error400 *iamclientmodels.RestErrorResponse
	Error500 *iamclientmodels.RestErrorResponse
}

func (m *PublicForgotPasswordWithoutNamespaceV3Response) Unpack() (*iamclientmodels.ModelForgotPasswordResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
