...
type AdminGetBulkUserByEmailAddressV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelListUserResponseV3
...
func (m *AdminGetBulkUserByEmailAddressV3Response) Unpack() (*iamclientmodels.ModelListUserResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
