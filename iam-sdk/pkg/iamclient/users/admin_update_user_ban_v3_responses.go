...
type AdminUpdateUserBanV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserBanResponseV3
...
func (m *AdminUpdateUserBanV3Response) Unpack() (*iamclientmodels.ModelUserBanResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
