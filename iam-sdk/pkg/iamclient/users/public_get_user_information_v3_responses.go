...
type PublicGetUserInformationV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.AccountcommonUserInformationV3
...
func (m *PublicGetUserInformationV3Response) Unpack() (*iamclientmodels.AccountcommonUserInformationV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
