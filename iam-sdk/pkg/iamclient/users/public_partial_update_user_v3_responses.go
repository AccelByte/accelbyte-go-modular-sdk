...
type PublicPartialUpdateUserV3Response struct {
...
func (m *PublicPartialUpdateUserV3Response) Unpack() (*iamclientmodels.ModelUserResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
