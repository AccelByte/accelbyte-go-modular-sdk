...
type PublicWebReauthPlatformResponse struct {
...
func (m *PublicWebReauthPlatformResponse) Unpack() (*iamclientmodels.ModelWebLinkingResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
