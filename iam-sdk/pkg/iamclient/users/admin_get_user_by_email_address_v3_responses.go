...
type AdminGetUserByEmailAddressV3Response struct {
...
func (m *AdminGetUserByEmailAddressV3Response) Unpack() (*iamclientmodels.ModelUserResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
