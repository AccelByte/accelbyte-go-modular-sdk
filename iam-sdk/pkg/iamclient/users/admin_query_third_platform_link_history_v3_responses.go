...
type AdminQueryThirdPlatformLinkHistoryV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelLinkingHistoryResponseWithPaginationV3
...
func (m *AdminQueryThirdPlatformLinkHistoryV3Response) Unpack() (*iamclientmodels.ModelLinkingHistoryResponseWithPaginationV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
