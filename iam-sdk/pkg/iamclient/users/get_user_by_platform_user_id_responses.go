...
type GetUserByPlatformUserIDResponse struct {
...
func (m *GetUserByPlatformUserIDResponse) Unpack() (*iamclientmodels.ModelPublicUserResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
