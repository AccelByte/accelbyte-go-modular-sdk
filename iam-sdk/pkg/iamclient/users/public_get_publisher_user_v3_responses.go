...
type PublicGetPublisherUserV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelGetPublisherUserResponse
...
func (m *PublicGetPublisherUserV3Response) Unpack() (*iamclientmodels.ModelGetPublisherUserResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
