...
type AdminUpdateAgeRestrictionConfigV3Response struct {
...
func (m *AdminUpdateAgeRestrictionConfigV3Response) Unpack() (*iamclientmodels.ModelAgeRestrictionResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
