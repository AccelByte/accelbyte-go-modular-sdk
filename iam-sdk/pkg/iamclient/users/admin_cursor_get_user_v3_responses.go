...
type AdminCursorGetUserV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelCursorGetUserResponse
...
func (m *AdminCursorGetUserV3Response) Unpack() (*iamclientmodels.ModelCursorGetUserResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
