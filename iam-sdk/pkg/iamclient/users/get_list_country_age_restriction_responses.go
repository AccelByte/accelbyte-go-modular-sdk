...
type GetListCountryAgeRestrictionResponse struct {
	iamclientmodels.ApiResponse
	Data []*iamclientmodels.AccountcommonCountryAgeRestriction
...
func (m *GetListCountryAgeRestrictionResponse) Unpack() ([]*iamclientmodels.AccountcommonCountryAgeRestriction, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
