...
type PublicGetMyRedirectionAfterLinkV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelOneTimeCodeLinkRedirectionResponse
...
func (m *PublicGetMyRedirectionAfterLinkV3Response) Unpack() (*iamclientmodels.ModelOneTimeCodeLinkRedirectionResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
