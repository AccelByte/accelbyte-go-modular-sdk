...
// NewCreateUserFromInvitationV3Params creates a new CreateUserFromInvitationV3Params object
// with the default values initialized.
func NewCreateUserFromInvitationV3Params() *CreateUserFromInvitationV3Params {
	var ()
	return &CreateUserFromInvitationV3Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateUserFromInvitationV3ParamsWithTimeout creates a new CreateUserFromInvitationV3Params object
...
// NewCreateUserFromInvitationV3ParamsWithContext creates a new CreateUserFromInvitationV3Params object
...
// NewCreateUserFromInvitationV3ParamsWithHTTPClient creates a new CreateUserFromInvitationV3Params object
...
/*
CreateUserFromInvitationV3Params contains all the parameters to send to the API endpoint
for the create user from invitation v3 operation typically these are written to a http.Request
*/
...
func (o *CreateUserFromInvitationV3Params) WithBody(body *iamclientmodels.ModelUserCreateRequestV3) *CreateUserFromInvitationV3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create user from invitation v3 params
func (o *CreateUserFromInvitationV3Params) SetBody(body *iamclientmodels.ModelUserCreateRequestV3) {
	o.Body = body
}
