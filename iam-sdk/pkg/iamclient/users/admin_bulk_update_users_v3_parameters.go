...
// NewAdminBulkUpdateUsersV3Params creates a new AdminBulkUpdateUsersV3Params object
// with the default values initialized.
func NewAdminBulkUpdateUsersV3Params() *AdminBulkUpdateUsersV3Params {
	var ()
	return &AdminBulkUpdateUsersV3Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminBulkUpdateUsersV3ParamsWithTimeout creates a new AdminBulkUpdateUsersV3Params object
...
// NewAdminBulkUpdateUsersV3ParamsWithContext creates a new AdminBulkUpdateUsersV3Params object
...
// NewAdminBulkUpdateUsersV3ParamsWithHTTPClient creates a new AdminBulkUpdateUsersV3Params object
...
/*
AdminBulkUpdateUsersV3Params contains all the parameters to send to the API endpoint
for the admin bulk update users v3 operation typically these are written to a http.Request
*/
...
func (o *AdminBulkUpdateUsersV3Params) WithTimeout(timeout time.Duration) *AdminBulkUpdateUsersV3Params {
...
func (o *AdminBulkUpdateUsersV3Params) WithContext(ctx context.Context) *AdminBulkUpdateUsersV3Params {
	o.SetContext(ctx)
	return o
}
...
func (o *AdminBulkUpdateUsersV3Params) WithHTTPClient(client *http.Client) *AdminBulkUpdateUsersV3Params {
...
func (o *AdminBulkUpdateUsersV3Params) WithBody(body *iamclientmodels.ModelUsersUpdateRequestV3) *AdminBulkUpdateUsersV3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the admin bulk update users v3 params
func (o *AdminBulkUpdateUsersV3Params) SetBody(body *iamclientmodels.ModelUsersUpdateRequestV3) {
	o.Body = body
}

// WithNamespace adds the namespace to the admin bulk update users v3 params
func (o *AdminBulkUpdateUsersV3Params) WithNamespace(namespace string) *AdminBulkUpdateUsersV3Params {
...
func (o *AdminBulkUpdateUsersV3Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
