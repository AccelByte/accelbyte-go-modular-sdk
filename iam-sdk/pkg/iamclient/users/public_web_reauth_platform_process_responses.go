...
type PublicWebReauthPlatformProcessResponse struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelWebReauthProcessResponse

	Error400 *iamclientmodels.RestErrorResponse
	Error500 *iamclientmodels.RestErrorResponse
}

func (m *PublicWebReauthPlatformProcessResponse) Unpack() (*iamclientmodels.ModelWebReauthProcessResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
