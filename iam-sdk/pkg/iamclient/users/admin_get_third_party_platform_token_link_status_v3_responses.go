...
type AdminGetThirdPartyPlatformTokenLinkStatusV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelTokenThirdPartyLinkStatusResponse
...
func (m *AdminGetThirdPartyPlatformTokenLinkStatusV3Response) Unpack() (*iamclientmodels.ModelTokenThirdPartyLinkStatusResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
