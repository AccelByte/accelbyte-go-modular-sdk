...
type PublicCreateUserV2Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelUserCreateResponse
...
func (m *PublicCreateUserV2Response) Unpack() (*iamclientmodels.ModelUserCreateResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
