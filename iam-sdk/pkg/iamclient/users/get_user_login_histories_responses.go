...
type GetUserLoginHistoriesResponse struct {
...
func (m *GetUserLoginHistoriesResponse) Unpack() (*iamclientmodels.ModelLoginHistoriesResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
