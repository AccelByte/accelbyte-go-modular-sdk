...
type PublicGetUserLoginHistoriesV3Response struct {
...
func (m *PublicGetUserLoginHistoriesV3Response) Unpack() (*iamclientmodels.ModelLoginHistoriesResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
