...
type AdminSearchUsersV2Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelSearchUsersByPlatformIDResponse
...
func (m *AdminSearchUsersV2Response) Unpack() (*iamclientmodels.ModelSearchUsersByPlatformIDResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
