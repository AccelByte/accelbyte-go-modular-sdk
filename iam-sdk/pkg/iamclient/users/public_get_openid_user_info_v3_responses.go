...
type PublicGetOpenidUserInfoV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelPublicOpenIDUserInfoResponse

	Error401 *iamclientmodels.RestErrorResponse
	Error500 *iamclientmodels.RestErrorResponse
}

func (m *PublicGetOpenidUserInfoV3Response) Unpack() (*iamclientmodels.ModelPublicOpenIDUserInfoResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
