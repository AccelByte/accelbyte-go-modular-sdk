...
type AdminGetUserBanSummaryV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelGetUserBanSummaryV3
...
func (m *AdminGetUserBanSummaryV3Response) Unpack() (*iamclientmodels.ModelGetUserBanSummaryV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
