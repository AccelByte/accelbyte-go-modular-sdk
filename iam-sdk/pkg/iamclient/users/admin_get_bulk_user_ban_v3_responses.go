...
type AdminGetBulkUserBanV3Response struct {
...
func (m *AdminGetBulkUserBanV3Response) Unpack() (*iamclientmodels.ModelGetUserBanV3Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
