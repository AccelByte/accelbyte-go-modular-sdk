...
type AdminGetUserByPlatformUserIDV3Response struct {
...
func (m *AdminGetUserByPlatformUserIDV3Response) Unpack() (*iamclientmodels.ModelUserResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
