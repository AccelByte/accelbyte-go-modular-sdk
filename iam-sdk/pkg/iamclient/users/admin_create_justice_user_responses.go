...
type AdminCreateJusticeUserResponse struct {
...
func (m *AdminCreateJusticeUserResponse) Unpack() (*iamclientmodels.ModelCreateJusticeUserResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
