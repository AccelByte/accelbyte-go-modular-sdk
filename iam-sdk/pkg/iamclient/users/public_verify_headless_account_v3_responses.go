...
type PublicVerifyHeadlessAccountV3Response struct {
...
func (m *PublicVerifyHeadlessAccountV3Response) Unpack() (*iamclientmodels.ModelUserResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
