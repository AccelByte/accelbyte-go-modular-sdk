...
type PublicGetLinkHeadlessAccountToMyAccountConflictV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelGetLinkHeadlessAccountConflictResponse
...
func (m *PublicGetLinkHeadlessAccountToMyAccountConflictV3Response) Unpack() (*iamclientmodels.ModelGetLinkHeadlessAccountConflictResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
