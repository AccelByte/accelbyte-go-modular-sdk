...
type UpdateCountryAgeRestrictionResponse struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelCountry
...
func (m *UpdateCountryAgeRestrictionResponse) Unpack() (*iamclientmodels.ModelCountry, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
