...
type PublicGetCountryAgeRestrictionResponse struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.AccountcommonCountry

	Error401 *iamclientmodels.RestErrorResponse
	Error404 string
}

func (m *PublicGetCountryAgeRestrictionResponse) Unpack() (*iamclientmodels.AccountcommonCountry, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
