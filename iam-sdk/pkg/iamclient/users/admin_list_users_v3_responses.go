...
type AdminListUsersV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.AccountcommonListUsersWithPlatformAccountsResponse
...
func (m *AdminListUsersV3Response) Unpack() (*iamclientmodels.AccountcommonListUsersWithPlatformAccountsResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
