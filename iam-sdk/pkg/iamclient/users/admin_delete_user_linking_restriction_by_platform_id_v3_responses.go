...
type AdminDeleteUserLinkingRestrictionByPlatformIDV3Response struct {
...
func (m *AdminDeleteUserLinkingRestrictionByPlatformIDV3Response) Unpack() *iamclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
