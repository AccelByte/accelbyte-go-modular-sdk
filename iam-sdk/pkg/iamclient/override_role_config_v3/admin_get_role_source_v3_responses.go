...
type AdminGetRoleSourceV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelRoleOverrideSourceResponse
...
func (m *AdminGetRoleSourceV3Response) Unpack() (*iamclientmodels.ModelRoleOverrideSourceResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
