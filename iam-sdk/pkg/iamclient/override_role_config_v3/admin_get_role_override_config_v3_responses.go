...
type AdminGetRoleOverrideConfigV3Response struct {
...
func (m *AdminGetRoleOverrideConfigV3Response) Unpack() (*iamclientmodels.ModelRoleOverrideResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
