...
type AdminGetRoleNamespacePermissionV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelRolePermissionResponseV3
...
func (m *AdminGetRoleNamespacePermissionV3Response) Unpack() (*iamclientmodels.ModelRolePermissionResponseV3, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
