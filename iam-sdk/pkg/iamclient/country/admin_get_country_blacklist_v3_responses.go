...
type AdminGetCountryBlacklistV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelCountryBlacklistResponse
...
func (m *AdminGetCountryBlacklistV3Response) Unpack() (*iamclientmodels.ModelCountryBlacklistResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
