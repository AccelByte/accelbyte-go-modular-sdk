...
type PublicGetCountryListV3Response struct {
	iamclientmodels.ApiResponse
	Data []*iamclientmodels.ModelCountryResponse

	Error500 *iamclientmodels.RestErrorResponse
}

func (m *PublicGetCountryListV3Response) Unpack() ([]*iamclientmodels.ModelCountryResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
