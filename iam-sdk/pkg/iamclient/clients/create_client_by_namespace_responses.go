...
type CreateClientByNamespaceResponse struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ClientmodelClientCreationResponse
...
func (m *CreateClientByNamespaceResponse) Unpack() (*iamclientmodels.ClientmodelClientCreationResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
