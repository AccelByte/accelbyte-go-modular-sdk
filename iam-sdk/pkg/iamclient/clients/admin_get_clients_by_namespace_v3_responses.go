...
type AdminGetClientsByNamespaceV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ClientmodelClientsV3Response
...
func (m *AdminGetClientsByNamespaceV3Response) Unpack() (*iamclientmodels.ClientmodelClientsV3Response, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
