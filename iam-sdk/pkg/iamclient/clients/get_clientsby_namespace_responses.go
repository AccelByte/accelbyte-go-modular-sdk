...
type GetClientsbyNamespaceResponse struct {
...
func (m *GetClientsbyNamespaceResponse) Unpack() ([]*iamclientmodels.ClientmodelClientResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
