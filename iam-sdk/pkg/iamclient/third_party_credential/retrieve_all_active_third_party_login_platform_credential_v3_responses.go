...
type RetrieveAllActiveThirdPartyLoginPlatformCredentialV3Response struct {
...
func (m *RetrieveAllActiveThirdPartyLoginPlatformCredentialV3Response) Unpack() ([]*iamclientmodels.ModelThirdPartyLoginPlatformCredentialResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
