...
type PartialUpdateThirdPartyLoginPlatformDomainV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelPlatformDomainResponse
...
func (m *PartialUpdateThirdPartyLoginPlatformDomainV3Response) Unpack() (*iamclientmodels.ModelPlatformDomainResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
