...
type GetThirdPartyLoginPlatformDefaultsV3Response struct {
	iamclientmodels.ApiResponse
	Data *iamclientmodels.ModelPlatformDefaultsResponse
}

func (m *GetThirdPartyLoginPlatformDefaultsV3Response) Unpack() (*iamclientmodels.ModelPlatformDefaultsResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
