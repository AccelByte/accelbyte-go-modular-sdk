...
type AddThirdPartyLoginPlatformCredentialV3Response struct {
...
func (m *AddThirdPartyLoginPlatformCredentialV3Response) Unpack() (*iamclientmodels.ModelThirdPartyLoginPlatformCredentialResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
