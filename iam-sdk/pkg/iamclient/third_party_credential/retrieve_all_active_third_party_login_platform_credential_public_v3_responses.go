...
type RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3Response struct {
...
func (m *RetrieveAllActiveThirdPartyLoginPlatformCredentialPublicV3Response) Unpack() ([]*iamclientmodels.ModelPublicThirdPartyPlatformInfo, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
