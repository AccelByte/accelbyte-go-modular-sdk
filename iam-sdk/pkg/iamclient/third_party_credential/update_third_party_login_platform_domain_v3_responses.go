...
type UpdateThirdPartyLoginPlatformDomainV3Response struct {
...
func (m *UpdateThirdPartyLoginPlatformDomainV3Response) Unpack() (*iamclientmodels.ModelPlatformDomainResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
