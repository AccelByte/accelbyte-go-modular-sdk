...
type RetrieveAllThirdPartyLoginPlatformCredentialV3Response struct {
...
func (m *RetrieveAllThirdPartyLoginPlatformCredentialV3Response) Unpack() ([]*iamclientmodels.ModelThirdPartyLoginPlatformCredentialResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
