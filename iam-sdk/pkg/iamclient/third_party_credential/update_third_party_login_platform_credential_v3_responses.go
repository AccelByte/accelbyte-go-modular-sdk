...
type UpdateThirdPartyLoginPlatformCredentialV3Response struct {
...
func (m *UpdateThirdPartyLoginPlatformCredentialV3Response) Unpack() (*iamclientmodels.ModelThirdPartyLoginPlatformCredentialResponse, *iamclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
