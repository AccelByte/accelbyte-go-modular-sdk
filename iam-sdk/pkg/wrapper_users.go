...
func (aaa *UsersService) AdminCursorGetUserV3Short(input *users.AdminCursorGetUserV3Params) (*users.AdminCursorGetUserV3Response, error) {
	authInfoWriter := input.AuthInfoWriter
	if authInfoWriter == nil {
		security := [][]string{
			{"bearer"},
...
func (aaa *UsersService) AdminGetUserStateByUserIDV3Short(input *users.AdminGetUserStateByUserIDV3Params) (*users.AdminGetUserStateByUserIDV3Response, error) {
	authInfoWriter := input.AuthInfoWriter
	if authInfoWriter == nil {
		security := [][]string{
			{"bearer"},
...
func (aaa *UsersService) PublicWebReauthPlatformShort(input *users.PublicWebReauthPlatformParams) (*users.PublicWebReauthPlatformResponse, error) {
	authInfoWriter := input.AuthInfoWriter
	if authInfoWriter == nil {
		security := [][]string{
			{"bearer"},
...
func (aaa *UsersService) PublicWebReauthPlatformProcessShort(input *users.PublicWebReauthPlatformProcessParams) (*users.PublicWebReauthPlatformProcessResponse, error) {
	authInfoWriter := input.AuthInfoWriter
	if authInfoWriter == nil {
		security := [][]string{
			{"bearer"},
...
func (aaa *UsersService) PublicForgotPasswordWithoutNamespaceV3Short(input *users.PublicForgotPasswordWithoutNamespaceV3Params) (*users.PublicForgotPasswordWithoutNamespaceV3Response, error) {
	authInfoWriter := input.AuthInfoWriter
	if authInfoWriter == nil {
		security := [][]string{
			{"bearer"},
