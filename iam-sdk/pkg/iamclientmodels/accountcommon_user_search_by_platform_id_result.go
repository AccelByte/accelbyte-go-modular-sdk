...
func (m *AccountcommonUserSearchByPlatformIDResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AccountcommonUserSearchByPlatformIDResult) validateDisplayName(formats strfmt.Registry) error {
...
func (m *AccountcommonUserSearchByPlatformIDResult) validateEmailAddress(formats strfmt.Registry) error {
...
func (m *AccountcommonUserSearchByPlatformIDResult) validateLinkedPlatforms(formats strfmt.Registry) error {
...
func (m *AccountcommonUserSearchByPlatformIDResult) validatePhoneNumber(formats strfmt.Registry) error {
...
func (m *AccountcommonUserSearchByPlatformIDResult) validateUserID(formats strfmt.Registry) error {
...
func (m *AccountcommonUserSearchByPlatformIDResult) UnmarshalBinary(b []byte) error {
	var res AccountcommonUserSearchByPlatformIDResult
