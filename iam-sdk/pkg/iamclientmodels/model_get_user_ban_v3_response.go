...
func (m *ModelGetUserBanV3Response) validateData(formats strfmt.Registry) error {
...
func (m *ModelGetUserBanV3Response) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelGetUserBanV3Response) UnmarshalBinary(b []byte) error {
	var res ModelGetUserBanV3Response
