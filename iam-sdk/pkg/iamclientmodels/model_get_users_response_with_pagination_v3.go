...
func (m *ModelGetUsersResponseWithPaginationV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelGetUsersResponseWithPaginationV3) validateData(formats strfmt.Registry) error {
...
func (m *ModelGetUsersResponseWithPaginationV3) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelGetUsersResponseWithPaginationV3) UnmarshalBinary(b []byte) error {
	var res ModelGetUsersResponseWithPaginationV3
