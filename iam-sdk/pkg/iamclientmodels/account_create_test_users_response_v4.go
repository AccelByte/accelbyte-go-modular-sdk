...
func (m *AccountCreateTestUsersResponseV4) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AccountCreateTestUsersResponseV4) validateData(formats strfmt.Registry) error {
...
func (m *AccountCreateTestUsersResponseV4) UnmarshalBinary(b []byte) error {
	var res AccountCreateTestUsersResponseV4
