...
func (m *ModelListUserRolesV4Response) validateData(formats strfmt.Registry) error {
...
func (m *ModelListUserRolesV4Response) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelListUserRolesV4Response) UnmarshalBinary(b []byte) error {
	var res ModelListUserRolesV4Response
