...
func (m *ModelListRoleV4Response) validateData(formats strfmt.Registry) error {
...
func (m *ModelListRoleV4Response) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelListRoleV4Response) UnmarshalBinary(b []byte) error {
	var res ModelListRoleV4Response
