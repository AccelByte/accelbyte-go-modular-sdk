...
func (m *ModelSearchUsersResponseWithPaginationV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelSearchUsersResponseWithPaginationV3) validateData(formats strfmt.Registry) error {
...
func (m *ModelSearchUsersResponseWithPaginationV3) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelSearchUsersResponseWithPaginationV3) validateTotalData(formats strfmt.Registry) error {
...
func (m *ModelSearchUsersResponseWithPaginationV3) UnmarshalBinary(b []byte) error {
	var res ModelSearchUsersResponseWithPaginationV3
