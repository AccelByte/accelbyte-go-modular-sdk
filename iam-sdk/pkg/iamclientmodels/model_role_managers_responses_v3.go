...
func (m *ModelRoleManagersResponsesV3) validateData(formats strfmt.Registry) error {
...
func (m *ModelRoleManagersResponsesV3) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelRoleManagersResponsesV3) UnmarshalBinary(b []byte) error {
	var res ModelRoleManagersResponsesV3
