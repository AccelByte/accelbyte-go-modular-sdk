...
func (m *ModelPublicUserInformationResponseV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelPublicUserInformationResponseV3) validateData(formats strfmt.Registry) error {
...
func (m *ModelPublicUserInformationResponseV3) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelPublicUserInformationResponseV3) UnmarshalBinary(b []byte) error {
	var res ModelPublicUserInformationResponseV3
