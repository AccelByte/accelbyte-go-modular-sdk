...
func (m *ModelUsersPlatformInfosResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelUsersPlatformInfosResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelUsersPlatformInfosResponse) UnmarshalBinary(b []byte) error {
	var res ModelUsersPlatformInfosResponse
