...
func (m *ModelListInvitationHistoriesV4Response) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelListInvitationHistoriesV4Response) validateData(formats strfmt.Registry) error {
...
func (m *ModelListInvitationHistoriesV4Response) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelListInvitationHistoriesV4Response) UnmarshalBinary(b []byte) error {
	var res ModelListInvitationHistoriesV4Response
