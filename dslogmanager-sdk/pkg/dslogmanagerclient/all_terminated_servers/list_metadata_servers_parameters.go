...
// NewListMetadataServersParams creates a new ListMetadataServersParams object
// with the default values initialized.
func NewListMetadataServersParams() *ListMetadataServersParams {
	var ()
	return &ListMetadataServersParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewListMetadataServersParamsWithTimeout creates a new ListMetadataServersParams object
...
// NewListMetadataServersParamsWithContext creates a new ListMetadataServersParams object
...
// NewListMetadataServersParamsWithHTTPClient creates a new ListMetadataServersParams object
...
/*ListMetadataServersParams contains all the parameters to send to the API endpoint
for the list metadata servers operation typically these are written to a http.Request
*/
...
func (o *ListMetadataServersParams) WithTimeout(timeout time.Duration) *ListMetadataServersParams {
...
func (o *ListMetadataServersParams) WithContext(ctx context.Context) *ListMetadataServersParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ListMetadataServersParams) WithBody(body *dslogmanagerclientmodels.ModelsMetadataServersRequest) *ListMetadataServersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the list metadata servers params
func (o *ListMetadataServersParams) SetBody(body *dslogmanagerclientmodels.ModelsMetadataServersRequest) {
	o.Body = body
}

// WriteToRequest writes these params to a swagger request
func (o *ListMetadataServersParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
