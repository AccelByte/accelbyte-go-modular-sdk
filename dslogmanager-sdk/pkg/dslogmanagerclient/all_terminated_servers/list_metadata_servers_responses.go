...
type ListMetadataServersResponse struct {
...
func (m *ListMetadataServersResponse) Unpack() (*dslogmanagerclientmodels.ModelsListTerminatedServersResponse, *dslogmanagerclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
