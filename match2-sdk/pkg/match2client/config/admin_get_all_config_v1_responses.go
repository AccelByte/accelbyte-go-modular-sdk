...
type AdminGetAllConfigV1Response struct {
	...
	Data *match2clientmodels.APINamespaceConfigList
...
func (m *AdminGetAllConfigV1Response) Unpack() (*match2clientmodels.APINamespaceConfigList, *match2clientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
