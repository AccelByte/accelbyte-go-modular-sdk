...
type AdminPatchConfigV1Response struct {
	match2clientmodels.ApiResponse
	Data *match2clientmodels.ConfigmodelsNamespaceConfig
...
func (m *AdminPatchConfigV1Response) Unpack() (*match2clientmodels.ConfigmodelsNamespaceConfig, *match2clientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
