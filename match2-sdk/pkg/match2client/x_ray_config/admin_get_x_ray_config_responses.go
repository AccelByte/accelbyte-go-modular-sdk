...
type AdminGetXRayConfigResponse struct {
	match2clientmodels.ApiResponse
	Data *match2clientmodels.ModelsXRayConfigHTTPResponse
...
func (m *AdminGetXRayConfigResponse) Unpack() (*match2clientmodels.ModelsXRayConfigHTTPResponse, *match2clientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
