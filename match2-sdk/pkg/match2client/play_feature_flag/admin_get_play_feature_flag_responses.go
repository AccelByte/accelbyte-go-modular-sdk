...
type AdminGetPlayFeatureFlagResponse struct {
...
func (m *AdminGetPlayFeatureFlagResponse) Unpack() (*match2clientmodels.ModelsPlayFeatureFlag, *match2clientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
