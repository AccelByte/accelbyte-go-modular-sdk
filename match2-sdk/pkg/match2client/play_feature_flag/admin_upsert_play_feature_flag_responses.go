...
type AdminUpsertPlayFeatureFlagResponse struct {
	match2clientmodels.ApiResponse
	Data *match2clientmodels.ModelsPlayFeatureFlag
...
func (m *AdminUpsertPlayFeatureFlagResponse) Unpack() (*match2clientmodels.ModelsPlayFeatureFlag, *match2clientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
