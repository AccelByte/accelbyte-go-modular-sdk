...
type CreateMatchTicketResponse struct {
	...
	Data *match2clientmodels.APIMatchTicketResponse
...
func (m *CreateMatchTicketResponse) Unpack() (*match2clientmodels.APIMatchTicketResponse, *match2clientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
