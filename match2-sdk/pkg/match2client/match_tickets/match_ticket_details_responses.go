...
type MatchTicketDetailsResponse struct {
	match2clientmodels.ApiResponse
	Data *match2clientmodels.APIMatchTicketStatus
...
func (m *MatchTicketDetailsResponse) Unpack() (*match2clientmodels.APIMatchTicketStatus, *match2clientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
