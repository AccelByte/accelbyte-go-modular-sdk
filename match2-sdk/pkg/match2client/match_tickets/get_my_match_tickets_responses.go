...
type GetMyMatchTicketsResponse struct {
	match2clientmodels.ApiResponse
	Data *match2clientmodels.APIMatchTicketStatuses
...
func (m *GetMyMatchTicketsResponse) Unpack() (*match2clientmodels.APIMatchTicketStatuses, *match2clientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
