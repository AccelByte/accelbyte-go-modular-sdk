...
// Validate validates this Api list backfill query response
func (m *APIListBackfillQueryResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APIListBackfillQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *APIListBackfillQueryResponse) UnmarshalBinary(b []byte) error {
	var res APIListBackfillQueryResponse
