...
func (m *ModelsConfiguration) validateClientVersion(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateDeployment(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateInactiveTimeout(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateInviteTimeout(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateJoinability(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateMaxPlayers(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateMinPlayers(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateName(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateRequestedRegions(formats strfmt.Registry) error {
...
func (m *ModelsConfiguration) validateType(formats strfmt.Registry) error {
