...
func (m *APIListEnvironmentVariablesResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *APIListEnvironmentVariablesResponse) validateData(formats strfmt.Registry) error {
...
func (m *APIListEnvironmentVariablesResponse) UnmarshalBinary(b []byte) error {
	var res APIListEnvironmentVariablesResponse
