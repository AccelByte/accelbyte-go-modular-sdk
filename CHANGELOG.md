...
- **docs:** add migration guide for ags 2026.1
- **:** version bump
- **:** removal of old enum (phase 1)
- **:** remove deprecated old enum (separate pr)
- **docs:** update migrate_from_monolitic.md
- **:** release services-api v0.1.0
- **sdk:** generated from openapi spec commit: f978585cf033ca064e014d1ad081e8eb17f67d7d
- **docs:** add migration guide for ags 2026.2
- **:** version bump
- **:** use services-api v0.1.0
- **sdk:** generated from openapi spec commit: 97cf55b3f6d77751e659f9479dbefe0c655e7c05
- **:** bump version and go mod tidy
- **token-validation:** - cache roles by roleId:namespace (was roleId only) - add global role fetch for wildcard namespace (AB_ALLOW_GLOBAL_ROLE_FETCH) - suppress role fetch errors with empty role (AB_SUPPRESS_GET_ROLE_ERROR) - add namespace context fallback: derive hierarchy from AB_NAMESPACE - refresh JWK set on missing kid before returning error - add GetAllowGlobalRoleFetch and GetSuppressGetRoleError to utils
- **:** removal of deprecated codes CG-5783
- **:** add default retry policy CG-5783
- **:** remove unnecessary files and dead codes
- **:** run lint
...
- **:** fix CHANGELOG version to 2026.2
### feat
...
- **:** session wrapper in go modular CG-5783
- **:** adjustment in hand-written codes
- **:** adjustment in samples
### test
...
- **:** formatting for manual generation of code
### ci
