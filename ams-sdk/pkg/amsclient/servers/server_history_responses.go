...
type ServerHistoryResponse struct {
	...
	Data *amsclientmodels.APIFleetServerHistoryResponse
...
func (m *ServerHistoryResponse) Unpack() (*amsclientmodels.APIFleetServerHistoryResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
