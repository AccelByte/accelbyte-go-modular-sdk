...
type FleetServerInfoResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIFleetServerInfoResponse
...
func (m *FleetServerInfoResponse) Unpack() (*amsclientmodels.APIFleetServerInfoResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
