...
type FleetServerConnectionInfoResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIFleetServerConnectionInfoResponse
...
func (m *FleetServerConnectionInfoResponse) Unpack() (*amsclientmodels.APIFleetServerConnectionInfoResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
