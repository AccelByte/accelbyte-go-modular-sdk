...
type FleetServerHistoryResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIDSHistoryList
...
func (m *FleetServerHistoryResponse) Unpack() (*amsclientmodels.APIDSHistoryList, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
