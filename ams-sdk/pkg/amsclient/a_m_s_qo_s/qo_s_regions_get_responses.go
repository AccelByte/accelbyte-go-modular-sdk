...
type QoSRegionsGetResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIQoSEndpointResponse
...
func (m *QoSRegionsGetResponse) Unpack() (*amsclientmodels.APIQoSEndpointResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
