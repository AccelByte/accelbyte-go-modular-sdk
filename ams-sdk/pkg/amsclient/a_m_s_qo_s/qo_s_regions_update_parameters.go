...
// NewQoSRegionsUpdateParams creates a new QoSRegionsUpdateParams object
// with the default values initialized.
func NewQoSRegionsUpdateParams() *QoSRegionsUpdateParams {
	var ()
	return &QoSRegionsUpdateParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewQoSRegionsUpdateParamsWithTimeout creates a new QoSRegionsUpdateParams object
...
// NewQoSRegionsUpdateParamsWithContext creates a new QoSRegionsUpdateParams object
...
// NewQoSRegionsUpdateParamsWithHTTPClient creates a new QoSRegionsUpdateParams object
...
/*
QoSRegionsUpdateParams contains all the parameters to send to the API endpoint
for the qo s regions update operation typically these are written to a http.Request
*/
...
func (o *QoSRegionsUpdateParams) WithTimeout(timeout time.Duration) *QoSRegionsUpdateParams {
...
func (o *QoSRegionsUpdateParams) WithContext(ctx context.Context) *QoSRegionsUpdateParams {
	o.SetContext(ctx)
	return o
}
...
func (o *QoSRegionsUpdateParams) WithBody(body *amsclientmodels.APIUpdateServerRequest) *QoSRegionsUpdateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the qo s regions update params
func (o *QoSRegionsUpdateParams) SetBody(body *amsclientmodels.APIUpdateServerRequest) {
	o.Body = body
}
...
func (o *QoSRegionsUpdateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
