...
type ImagesStorageResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIImageStorage
...
func (m *ImagesStorageResponse) Unpack() (*amsclientmodels.APIImageStorage, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
