...
type ImagePatchResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIImageDetails
...
func (m *ImagePatchResponse) Unpack() (*amsclientmodels.APIImageDetails, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
