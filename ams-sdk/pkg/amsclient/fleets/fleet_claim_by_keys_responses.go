...
type FleetClaimByKeysResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIFleetClaimResponse
...
func (m *FleetClaimByKeysResponse) Unpack() (*amsclientmodels.APIFleetClaimResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
