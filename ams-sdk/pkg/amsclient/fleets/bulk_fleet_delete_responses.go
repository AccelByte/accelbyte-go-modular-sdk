...
type BulkFleetDeleteResponse struct {
	amsclientmodels.ApiResponse
	Data    *amsclientmodels.APIFleetBulkDeleteResponse
	Data207 *amsclientmodels.APIFleetBulkDeleteResponse
	...
	Error422 *amsclientmodels.APIFleetBulkDeleteResponse
	Error500 *amsclientmodels.ResponseErrorResponse
}

func (m *BulkFleetDeleteResponse) Unpack() (*amsclientmodels.APIFleetBulkDeleteResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
