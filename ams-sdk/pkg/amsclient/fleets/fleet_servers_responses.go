...
type FleetServersResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIFleetServersResponse
...
func (m *FleetServersResponse) Unpack() (*amsclientmodels.APIFleetServersResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
