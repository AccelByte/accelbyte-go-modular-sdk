...
type FleetArtifactSamplingRulesGetResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIFleetArtifactsSampleRules
...
func (m *FleetArtifactSamplingRulesGetResponse) Unpack() (*amsclientmodels.APIFleetArtifactsSampleRules, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
