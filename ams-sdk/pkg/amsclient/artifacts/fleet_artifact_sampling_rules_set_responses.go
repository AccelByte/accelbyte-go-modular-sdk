...
type FleetArtifactSamplingRulesSetResponse struct {
...
func (m *FleetArtifactSamplingRulesSetResponse) Unpack() (*amsclientmodels.APIFleetArtifactsSampleRules, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
