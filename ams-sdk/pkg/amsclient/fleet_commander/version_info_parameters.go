...
// NewVersionInfoParams creates a new VersionInfoParams object
// with the default values initialized.
func NewVersionInfoParams() *VersionInfoParams {
	var ()
	return &VersionInfoParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewVersionInfoParamsWithTimeout creates a new VersionInfoParams object
...
// NewVersionInfoParamsWithContext creates a new VersionInfoParams object
...
// NewVersionInfoParamsWithHTTPClient creates a new VersionInfoParams object
...
/*
VersionInfoParams contains all the parameters to send to the API endpoint
for the version info operation typically these are written to a http.Request
*/
