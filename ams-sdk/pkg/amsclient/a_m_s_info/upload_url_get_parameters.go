...
// NewUploadURLGetParams creates a new UploadURLGetParams object
// with the default values initialized.
func NewUploadURLGetParams() *UploadURLGetParams {
	var ()
	return &UploadURLGetParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewUploadURLGetParamsWithTimeout creates a new UploadURLGetParams object
...
// NewUploadURLGetParamsWithContext creates a new UploadURLGetParams object
...
// NewUploadURLGetParamsWithHTTPClient creates a new UploadURLGetParams object
...
/*UploadURLGetParams contains all the parameters to send to the API endpoint
for the upload url get operation typically these are written to a http.Request
*/
