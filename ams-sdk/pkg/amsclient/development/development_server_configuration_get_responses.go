...
type DevelopmentServerConfigurationGetResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIDevelopmentServerConfigurationGetResponse
...
func (m *DevelopmentServerConfigurationGetResponse) Unpack() (*amsclientmodels.APIDevelopmentServerConfigurationGetResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
