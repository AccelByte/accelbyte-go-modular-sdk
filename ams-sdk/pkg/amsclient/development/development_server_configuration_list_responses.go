...
type DevelopmentServerConfigurationListResponse struct {
	amsclientmodels.ApiResponse
	Data *amsclientmodels.APIDevelopmentServerConfigurationListResponse
...
func (m *DevelopmentServerConfigurationListResponse) Unpack() (*amsclientmodels.APIDevelopmentServerConfigurationListResponse, *amsclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
