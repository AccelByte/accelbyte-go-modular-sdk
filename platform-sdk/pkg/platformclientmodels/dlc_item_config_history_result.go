...
// Validate validates this DLC item config history result
func (m *DLCItemConfigHistoryResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DLCItemConfigHistoryResult) UnmarshalBinary(b []byte) error {
	var res DLCItemConfigHistoryResult
