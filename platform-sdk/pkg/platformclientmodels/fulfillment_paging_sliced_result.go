...
// Validate validates this Fulfillment paging sliced result
func (m *FulfillmentPagingSlicedResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *FulfillmentPagingSlicedResult) validateData(formats strfmt.Registry) error {
...
func (m *FulfillmentPagingSlicedResult) UnmarshalBinary(b []byte) error {
	var res FulfillmentPagingSlicedResult
