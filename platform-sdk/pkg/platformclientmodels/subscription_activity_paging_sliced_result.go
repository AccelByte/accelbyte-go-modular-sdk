...
func (m *SubscriptionActivityPagingSlicedResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *SubscriptionActivityPagingSlicedResult) validateData(formats strfmt.Registry) error {
...
func (m *SubscriptionActivityPagingSlicedResult) UnmarshalBinary(b []byte) error {
	var res SubscriptionActivityPagingSlicedResult
