...
func (m *PaymentProviderConfigPagingSlicedResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentProviderConfigPagingSlicedResult) validateData(formats strfmt.Registry) error {
...
func (m *PaymentProviderConfigPagingSlicedResult) UnmarshalBinary(b []byte) error {
	var res PaymentProviderConfigPagingSlicedResult
