...
func (m *PaymentNotificationPagingSlicedResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentNotificationPagingSlicedResult) validateData(formats strfmt.Registry) error {
...
func (m *PaymentNotificationPagingSlicedResult) UnmarshalBinary(b []byte) error {
	var res PaymentNotificationPagingSlicedResult
