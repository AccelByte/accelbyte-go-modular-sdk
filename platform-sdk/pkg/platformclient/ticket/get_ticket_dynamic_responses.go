...
type GetTicketDynamicResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TicketDynamicInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetTicketDynamicResponse) Unpack() (*platformclientmodels.TicketDynamicInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
