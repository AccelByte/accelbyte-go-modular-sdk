...
type AcquireUserTicketResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TicketAcquireResult
...
func (m *AcquireUserTicketResponse) Unpack() (*platformclientmodels.TicketAcquireResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
