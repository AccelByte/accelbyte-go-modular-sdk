...
type GetTicketBoothIDResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TicketBoothID

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetTicketBoothIDResponse) Unpack() (*platformclientmodels.TicketBoothID, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
