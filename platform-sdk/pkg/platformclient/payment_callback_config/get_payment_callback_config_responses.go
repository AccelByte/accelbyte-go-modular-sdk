...
type GetPaymentCallbackConfigResponse struct {
...
func (m *GetPaymentCallbackConfigResponse) Unpack() (*platformclientmodels.PaymentCallbackConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
