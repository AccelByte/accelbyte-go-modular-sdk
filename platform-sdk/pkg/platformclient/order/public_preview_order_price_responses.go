...
type PublicPreviewOrderPriceResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.OrderDiscountPreviewResponse
...
func (m *PublicPreviewOrderPriceResponse) Unpack() (*platformclientmodels.OrderDiscountPreviewResponse, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
