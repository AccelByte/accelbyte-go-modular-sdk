...
type GetUserOrderHistoriesResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.OrderHistoryInfo
}

func (m *GetUserOrderHistoriesResponse) Unpack() ([]*platformclientmodels.OrderHistoryInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetUserOrderHistoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetUserOrderHistoriesOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/history returns an error %d: %s", response.Code(), string(data))
	}
}
...
func NewGetUserOrderHistoriesOK() *GetUserOrderHistoriesOK {
	return &GetUserOrderHistoriesOK{}
}
...
func (o *GetUserOrderHistoriesOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/orders/{orderNo}/history][%d] getUserOrderHistoriesOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetUserOrderHistoriesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
