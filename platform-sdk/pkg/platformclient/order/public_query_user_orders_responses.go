...
type PublicQueryUserOrdersResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.OrderPagingSlicedResult
}

func (m *PublicQueryUserOrdersResponse) Unpack() (*platformclientmodels.OrderPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
