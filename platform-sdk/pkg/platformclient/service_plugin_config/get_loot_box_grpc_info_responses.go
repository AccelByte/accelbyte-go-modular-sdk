...
type GetLootBoxGrpcInfoResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.GrpcServerInfo
}

func (m *GetLootBoxGrpcInfoResponse) Unpack() (*platformclientmodels.GrpcServerInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetLootBoxGrpcInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetLootBoxGrpcInfoOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/catalog/plugins/lootbox/grpcInfo returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetLootBoxGrpcInfoOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/catalog/plugins/lootbox/grpcInfo][%d] getLootBoxGrpcInfoOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetLootBoxGrpcInfoOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(platformclientmodels.GrpcServerInfo)
