...
type UpdateSectionPluginConfigResponse struct {
...
func (m *UpdateSectionPluginConfigResponse) Unpack() (*platformclientmodels.SectionPluginConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
