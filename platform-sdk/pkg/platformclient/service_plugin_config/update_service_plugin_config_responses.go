...
type UpdateServicePluginConfigResponse struct {
...
func (m *UpdateServicePluginConfigResponse) Unpack() (*platformclientmodels.ServicePluginConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
