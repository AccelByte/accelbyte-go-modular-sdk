...
type UpdateRevocationPluginConfigResponse struct {
...
func (m *UpdateRevocationPluginConfigResponse) Unpack() (*platformclientmodels.RevocationPluginConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
