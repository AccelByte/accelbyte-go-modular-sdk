...
type UploadRevocationPluginConfigCertV2Response struct {
...
func (m *UploadRevocationPluginConfigCertV2Response) Unpack() (*platformclientmodels.RevocationPluginConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
