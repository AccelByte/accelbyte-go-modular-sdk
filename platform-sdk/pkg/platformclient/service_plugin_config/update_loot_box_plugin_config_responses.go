...
type UpdateLootBoxPluginConfigResponse struct {
...
func (m *UpdateLootBoxPluginConfigResponse) Unpack() (*platformclientmodels.LootBoxPluginConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
