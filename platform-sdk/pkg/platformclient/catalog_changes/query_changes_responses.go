...
type QueryChangesResponse struct {
	...
	Data *platformclientmodels.CatalogChangePagingResult
}

func (m *QueryChangesResponse) Unpack() (*platformclientmodels.CatalogChangePagingResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
