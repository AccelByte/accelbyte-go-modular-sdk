...
type GetStatisticResponse struct {
	...
	Data *platformclientmodels.CatalogChangeStatistics
}

func (m *GetStatisticResponse) Unpack() (*platformclientmodels.CatalogChangeStatistics, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
