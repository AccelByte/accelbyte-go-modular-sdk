...
type PublicListActiveSectionsResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.SectionInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *PublicListActiveSectionsResponse) Unpack() ([]*platformclientmodels.SectionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
