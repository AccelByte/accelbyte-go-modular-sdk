...
type GetCurrencyConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.CurrencyConfig

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetCurrencyConfigResponse) Unpack() (*platformclientmodels.CurrencyConfig, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
