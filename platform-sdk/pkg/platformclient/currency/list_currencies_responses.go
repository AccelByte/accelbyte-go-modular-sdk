...
func (m *ListCurrenciesResponse) Unpack() ([]*platformclientmodels.CurrencyInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *ListCurrenciesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/currencies returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ListCurrenciesOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/currencies][%d] listCurrenciesOK  %+v", 200, o.ToJSONString())
}
...
func (o *ListCurrenciesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
