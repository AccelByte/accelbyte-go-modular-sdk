...
type PublicListCurrenciesResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.CurrencyInfo
}

func (m *PublicListCurrenciesResponse) Unpack() ([]*platformclientmodels.CurrencyInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *PublicListCurrenciesOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/currencies][%d] publicListCurrenciesOK  %+v", 200, o.ToJSONString())
}
