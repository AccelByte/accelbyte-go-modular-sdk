...
type GetCurrencySummaryResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.CurrencySummary

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetCurrencySummaryResponse) Unpack() (*platformclientmodels.CurrencySummary, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetCurrencySummaryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCurrencySummaryOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 404:
		result := NewGetCurrencySummaryNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func (o *GetCurrencySummaryOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(platformclientmodels.CurrencySummary)
