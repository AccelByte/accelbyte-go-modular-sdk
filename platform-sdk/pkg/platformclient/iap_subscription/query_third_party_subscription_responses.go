...
type QueryThirdPartySubscriptionResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ThirdPartyUserSubscriptionPagingSlicedResult
}

func (m *QueryThirdPartySubscriptionResponse) Unpack() (*platformclientmodels.ThirdPartyUserSubscriptionPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *QueryThirdPartySubscriptionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewQueryThirdPartySubscriptionOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/iap/subscriptions returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *QueryThirdPartySubscriptionOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/iap/subscriptions][%d] queryThirdPartySubscriptionOK  %+v", 200, o.ToJSONString())
}
...
func (o *QueryThirdPartySubscriptionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
