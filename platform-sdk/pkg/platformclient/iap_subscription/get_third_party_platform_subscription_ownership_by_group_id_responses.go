...
type GetThirdPartyPlatformSubscriptionOwnershipByGroupIDResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ThirdPartySubscriptionOwnership
}

func (m *GetThirdPartyPlatformSubscriptionOwnershipByGroupIDResponse) Unpack() (*platformclientmodels.ThirdPartySubscriptionOwnership, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetThirdPartyPlatformSubscriptionOwnershipByGroupIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetThirdPartyPlatformSubscriptionOwnershipByGroupIDOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/users/{userId}/iap/subscriptions/platforms/{platform}/ownership/byGroupId returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetThirdPartyPlatformSubscriptionOwnershipByGroupIDOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/iap/subscriptions/platforms/{platform}/ownership/byGroupId][%d] getThirdPartyPlatformSubscriptionOwnershipByGroupIdOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetThirdPartyPlatformSubscriptionOwnershipByGroupIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
