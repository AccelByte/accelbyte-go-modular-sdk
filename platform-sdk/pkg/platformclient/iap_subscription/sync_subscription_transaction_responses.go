...
type SyncSubscriptionTransactionResponse struct {
...
func (m *SyncSubscriptionTransactionResponse) Unpack() (*platformclientmodels.ThirdPartySubscriptionTransactionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
