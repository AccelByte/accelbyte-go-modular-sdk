...
type QueryUserThirdPartySubscriptionResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ThirdPartyUserSubscriptionPagingSlicedResult
}

func (m *QueryUserThirdPartySubscriptionResponse) Unpack() (*platformclientmodels.ThirdPartyUserSubscriptionPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
