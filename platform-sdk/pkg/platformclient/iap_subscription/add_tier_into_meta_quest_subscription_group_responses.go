...
type AddTierIntoMetaQuestSubscriptionGroupResponse struct {
...
func (m *AddTierIntoMetaQuestSubscriptionGroupResponse) Unpack() (*platformclientmodels.ThirdPartySubscriptionTierInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
