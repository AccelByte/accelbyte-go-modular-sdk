...
type GetThirdPartyUserSubscriptionDetailsResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ThirdPartyUserSubscriptionInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetThirdPartyUserSubscriptionDetailsResponse) Unpack() (*platformclientmodels.ThirdPartyUserSubscriptionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
