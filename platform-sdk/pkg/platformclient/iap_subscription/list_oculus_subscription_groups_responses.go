...
type ListOculusSubscriptionGroupsResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.ThirdPartySubscriptionGroupInfo
}

func (m *ListOculusSubscriptionGroupsResponse) Unpack() ([]*platformclientmodels.ThirdPartySubscriptionGroupInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
