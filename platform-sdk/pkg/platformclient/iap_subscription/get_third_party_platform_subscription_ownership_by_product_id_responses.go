...
type GetThirdPartyPlatformSubscriptionOwnershipByProductIDResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ThirdPartySubscriptionOwnership
}

func (m *GetThirdPartyPlatformSubscriptionOwnershipByProductIDResponse) Unpack() (*platformclientmodels.ThirdPartySubscriptionOwnership, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetThirdPartyPlatformSubscriptionOwnershipByProductIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetThirdPartyPlatformSubscriptionOwnershipByProductIDOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/users/{userId}/iap/subscriptions/platforms/{platform}/ownership/byProductId returns an error %d: %s", response.Code(), string(data))
	}
}
...
func NewGetThirdPartyPlatformSubscriptionOwnershipByProductIDOK() *GetThirdPartyPlatformSubscriptionOwnershipByProductIDOK {
	return &GetThirdPartyPlatformSubscriptionOwnershipByProductIDOK{}
}
...
func (o *GetThirdPartyPlatformSubscriptionOwnershipByProductIDOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/iap/subscriptions/platforms/{platform}/ownership/byProductId][%d] getThirdPartyPlatformSubscriptionOwnershipByProductIdOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetThirdPartyPlatformSubscriptionOwnershipByProductIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(platformclientmodels.ThirdPartySubscriptionOwnership)
