...
type CreateOculusSubscriptionGroupResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ThirdPartySubscriptionGroupInfo

	Error409 *platformclientmodels.ErrorEntity
}

func (m *CreateOculusSubscriptionGroupResponse) Unpack() (*platformclientmodels.ThirdPartySubscriptionGroupInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
