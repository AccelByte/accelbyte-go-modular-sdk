...
type GetThirdPartySubscriptionDetailsResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ThirdPartySubscriptionTransactionInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetThirdPartySubscriptionDetailsResponse) Unpack() (*platformclientmodels.ThirdPartySubscriptionTransactionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
