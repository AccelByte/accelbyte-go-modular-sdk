...
type ListCategoriesBasicResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.BasicCategoryInfo
}

func (m *ListCategoriesBasicResponse) Unpack() ([]*platformclientmodels.BasicCategoryInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *ListCategoriesBasicReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/categories/basic returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ListCategoriesBasicOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/categories/basic][%d] listCategoriesBasicOK  %+v", 200, o.ToJSONString())
}
