...
type PublicGetChildCategoriesResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.CategoryInfo
}

func (m *PublicGetChildCategoriesResponse) Unpack() ([]*platformclientmodels.CategoryInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
