...
type PublicGetDescendantCategoriesResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.CategoryInfo
}

func (m *PublicGetDescendantCategoriesResponse) Unpack() ([]*platformclientmodels.CategoryInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
