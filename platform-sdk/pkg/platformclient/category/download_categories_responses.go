...
type DownloadCategoriesResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.HierarchicalCategoryInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *DownloadCategoriesResponse) Unpack() ([]*platformclientmodels.HierarchicalCategoryInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
