...
type UpdatePaymentProviderConfigResponse struct {
...
func (m *UpdatePaymentProviderConfigResponse) Unpack() (*platformclientmodels.PaymentProviderConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
