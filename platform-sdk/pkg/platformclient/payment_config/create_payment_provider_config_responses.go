...
type CreatePaymentProviderConfigResponse struct {
...
func (m *CreatePaymentProviderConfigResponse) Unpack() (*platformclientmodels.PaymentProviderConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
