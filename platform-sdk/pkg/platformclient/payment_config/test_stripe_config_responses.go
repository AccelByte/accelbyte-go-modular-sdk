...
type TestStripeConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TestResult
}

func (m *TestStripeConfigResponse) Unpack() (*platformclientmodels.TestResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *TestStripeConfigOK) Error() string {
	return fmt.Sprintf("[POST /platform/admin/payment/config/merchant/stripeconfig/test][%d] testStripeConfigOK  %+v", 200, o.ToJSONString())
}

func (o *TestStripeConfigOK) ToJSONString() string {
	if o.Payload == nil {
		return "{}"
	}
