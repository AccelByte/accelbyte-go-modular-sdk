...
type GetPaymentMerchantConfig1Response struct {
...
func (m *GetPaymentMerchantConfig1Response) Unpack() (*platformclientmodels.PaymentMerchantConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
