...
type DebugMatchedPaymentProviderConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.PaymentProviderConfigInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *DebugMatchedPaymentProviderConfigResponse) Unpack() (*platformclientmodels.PaymentProviderConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
