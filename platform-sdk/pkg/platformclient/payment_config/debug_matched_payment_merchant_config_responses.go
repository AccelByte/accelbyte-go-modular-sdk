...
type DebugMatchedPaymentMerchantConfigResponse struct {
...
func (m *DebugMatchedPaymentMerchantConfigResponse) Unpack() (*platformclientmodels.PaymentMerchantConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
