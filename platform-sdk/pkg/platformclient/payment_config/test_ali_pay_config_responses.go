...
type TestAliPayConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TestResult
}

func (m *TestAliPayConfigResponse) Unpack() (*platformclientmodels.TestResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *TestAliPayConfigOK) Error() string {
	return fmt.Sprintf("[POST /platform/admin/payment/config/merchant/alipayconfig/test][%d] testAliPayConfigOK  %+v", 200, o.ToJSONString())
}

func (o *TestAliPayConfigOK) ToJSONString() string {
	if o.Payload == nil {
		return "{}"
	}
