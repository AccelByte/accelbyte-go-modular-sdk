...
type UpdateAliPayConfigResponse struct {
...
func (m *UpdateAliPayConfigResponse) Unpack() (*platformclientmodels.PaymentMerchantConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
