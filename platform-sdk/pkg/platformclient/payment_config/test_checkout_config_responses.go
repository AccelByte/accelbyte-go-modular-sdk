...
type TestCheckoutConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TestResult
}

func (m *TestCheckoutConfigResponse) Unpack() (*platformclientmodels.TestResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *TestCheckoutConfigOK) Error() string {
	return fmt.Sprintf("[POST /platform/admin/payment/config/merchant/checkoutconfig/test][%d] testCheckoutConfigOK  %+v", 200, o.ToJSONString())
}

func (o *TestCheckoutConfigOK) ToJSONString() string {
	if o.Payload == nil {
		return "{}"
	}
