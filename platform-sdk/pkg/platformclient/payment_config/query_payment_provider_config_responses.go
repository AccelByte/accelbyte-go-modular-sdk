...
type QueryPaymentProviderConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.PaymentProviderConfigPagingSlicedResult
}

func (m *QueryPaymentProviderConfigResponse) Unpack() (*platformclientmodels.PaymentProviderConfigPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
