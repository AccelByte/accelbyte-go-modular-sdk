...
// NewUpdateXsollaUIConfigParams creates a new UpdateXsollaUIConfigParams object
// with the default values initialized.
func NewUpdateXsollaUIConfigParams() *UpdateXsollaUIConfigParams {
	var ()
	return &UpdateXsollaUIConfigParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateXsollaUIConfigParamsWithTimeout creates a new UpdateXsollaUIConfigParams object
...
// NewUpdateXsollaUIConfigParamsWithContext creates a new UpdateXsollaUIConfigParams object
...
// NewUpdateXsollaUIConfigParamsWithHTTPClient creates a new UpdateXsollaUIConfigParams object
...
func (o *UpdateXsollaUIConfigParams) SetFlightId(flightId string) {
	if o.XFlightId != nil {
...
// WithID adds the idVar to the update xsolla ui config params
func (o *UpdateXsollaUIConfigParams) WithID(idVar string) *UpdateXsollaUIConfigParams {
	o.SetID(idVar)
	return o
}

// SetID adds the id to the update xsolla ui config params
func (o *UpdateXsollaUIConfigParams) SetID(idVar string) {
	o.ID = idVar
}
