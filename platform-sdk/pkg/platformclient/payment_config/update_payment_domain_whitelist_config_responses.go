...
type UpdatePaymentDomainWhitelistConfigResponse struct {
...
func (m *UpdatePaymentDomainWhitelistConfigResponse) Unpack() (*platformclientmodels.PaymentDomainWhitelistConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
