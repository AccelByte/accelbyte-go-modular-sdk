...
type UpdateXsollaUIConfigResponse struct {
...
func (m *UpdateXsollaUIConfigResponse) Unpack() (*platformclientmodels.PaymentMerchantConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
