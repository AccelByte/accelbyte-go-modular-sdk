...
// SetHTTPClient adds the HTTPClient Transport to the test ali pay config by id params
func (o *TestAliPayConfigByIDParams) SetHTTPClientTransport(roundTripper http.RoundTripper) {
	if o.HTTPClient != nil {
...
func (o *TestAliPayConfigByIDParams) SetFlightId(flightId string) {
	if o.XFlightId != nil {
...
// WithID adds the idVar to the test ali pay config by id params
func (o *TestAliPayConfigByIDParams) WithID(idVar string) *TestAliPayConfigByIDParams {
	o.SetID(idVar)
	return o
}

// SetID adds the id to the test ali pay config by id params
func (o *TestAliPayConfigByIDParams) SetID(idVar string) {
	o.ID = idVar
}
