...
type QueryItemsV2Response struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.FullItemPagingResult

	Error404 *platformclientmodels.ErrorEntity
	Error422 *platformclientmodels.ValidationErrorEntity
}

func (m *QueryItemsV2Response) Unpack() (*platformclientmodels.FullItemPagingResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
