...
// WithID adds the id to the delete item type config params
func (o *DeleteItemTypeConfigParams) WithID(id string) *DeleteItemTypeConfigParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete item type config params
func (o *DeleteItemTypeConfigParams) SetID(id string) {
	o.ID = id
}
