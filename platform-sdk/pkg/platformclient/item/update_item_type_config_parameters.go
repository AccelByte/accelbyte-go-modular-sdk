...
// WithID adds the id to the update item type config params
func (o *UpdateItemTypeConfigParams) WithID(id string) *UpdateItemTypeConfigParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the update item type config params
func (o *UpdateItemTypeConfigParams) SetID(id string) {
	o.ID = id
}
