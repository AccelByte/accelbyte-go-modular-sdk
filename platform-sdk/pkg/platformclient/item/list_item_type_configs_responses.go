...
type ListItemTypeConfigsResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.ItemTypeConfigInfo
}

func (m *ListItemTypeConfigsResponse) Unpack() ([]*platformclientmodels.ItemTypeConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
