...
type AcquireItemResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ItemAcquireResult

	Error404 *platformclientmodels.ErrorEntity
}

func (m *AcquireItemResponse) Unpack() (*platformclientmodels.ItemAcquireResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
