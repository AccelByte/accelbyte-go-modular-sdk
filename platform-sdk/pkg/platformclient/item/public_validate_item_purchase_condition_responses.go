...
type PublicValidateItemPurchaseConditionResponse struct {
...
func (m *PublicValidateItemPurchaseConditionResponse) Unpack() ([]*platformclientmodels.ItemPurchaseConditionValidateResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
