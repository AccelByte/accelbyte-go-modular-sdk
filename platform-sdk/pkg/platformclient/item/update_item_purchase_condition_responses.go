...
type UpdateItemPurchaseConditionResponse struct {
...
func (m *UpdateItemPurchaseConditionResponse) Unpack() (*platformclientmodels.FullItemInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
