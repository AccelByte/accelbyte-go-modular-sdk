...
type QueryItemReferencesResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ItemDependency

	Error404 *platformclientmodels.ErrorEntity
}

func (m *QueryItemReferencesResponse) Unpack() (*platformclientmodels.ItemDependency, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
