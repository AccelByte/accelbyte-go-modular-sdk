...
type PublicGetEstimatedPriceResponse struct {
...
func (m *PublicGetEstimatedPriceResponse) Unpack() ([]*platformclientmodels.EstimatedPriceInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
