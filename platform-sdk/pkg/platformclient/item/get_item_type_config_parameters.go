...
// WithID adds the id to the get item type config params
func (o *GetItemTypeConfigParams) WithID(id string) *GetItemTypeConfigParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get item type config params
func (o *GetItemTypeConfigParams) SetID(id string) {
	o.ID = id
}
