...
type SearchItemTypeConfigResponse struct {
...
func (m *SearchItemTypeConfigResponse) Unpack() (*platformclientmodels.ItemTypeConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
