...
type QueryUncategorizedItemsResponse struct {
...
func (m *QueryUncategorizedItemsResponse) Unpack() (*platformclientmodels.FullItemPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
