...
type QueryCampaignsResponse struct {
	...
	Data *platformclientmodels.CampaignPagingSlicedResult
}

func (m *QueryCampaignsResponse) Unpack() (*platformclientmodels.CampaignPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *QueryCampaignsOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/campaigns][%d] queryCampaignsOK  %+v", 200, o.ToJSONString())
}

func (o *QueryCampaignsOK) ToJSONString() string {
	if o.Payload == nil {
		return "{}"
	}
