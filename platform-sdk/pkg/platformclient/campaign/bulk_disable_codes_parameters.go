...
// WithBatchName_ adds the batchName to the bulk disable codes params
func (o *BulkDisableCodesParams) WithBatchName_(batchName *string) *BulkDisableCodesParams {
	o.SetBatchName(batchName)
	return o
}

// SetBatchName adds the batchName to the bulk disable codes params
func (o *BulkDisableCodesParams) SetBatchName(batchName *string) {
