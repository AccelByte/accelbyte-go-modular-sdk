...
type ApplyUserRedemptionResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.RedeemResult
...
func (m *ApplyUserRedemptionResponse) Unpack() (*platformclientmodels.RedeemResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
