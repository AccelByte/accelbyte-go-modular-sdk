...
type GetPaymentCustomizationResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.Customization
}

func (m *GetPaymentCustomizationResponse) Unpack() (*platformclientmodels.Customization, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
