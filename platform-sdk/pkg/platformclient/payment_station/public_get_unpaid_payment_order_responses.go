...
type PublicGetUnpaidPaymentOrderResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.PaymentOrderDetails

	Error404 *platformclientmodels.ErrorEntity
	Error409 *platformclientmodels.ErrorEntity
}

func (m *PublicGetUnpaidPaymentOrderResponse) Unpack() (*platformclientmodels.PaymentOrderDetails, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
