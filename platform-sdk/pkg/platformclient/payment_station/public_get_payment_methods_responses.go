...
type PublicGetPaymentMethodsResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.PaymentMethod

	Error404 *platformclientmodels.ErrorEntity
}

func (m *PublicGetPaymentMethodsResponse) Unpack() ([]*platformclientmodels.PaymentMethod, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
