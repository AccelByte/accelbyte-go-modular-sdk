...
type ExistsAnyUserActiveEntitlementByItemIdsResponse struct {
...
func (o *ExistsAnyUserActiveEntitlementByItemIdsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/ownership/anyOf returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ExistsAnyUserActiveEntitlementByItemIdsOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/ownership/anyOf][%d] existsAnyUserActiveEntitlementByItemIdsOK  %+v", 200, o.ToJSONString())
}
