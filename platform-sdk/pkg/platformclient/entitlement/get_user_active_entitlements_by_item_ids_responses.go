...
func (o *GetUserActiveEntitlementsByItemIdsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetUserActiveEntitlementsByItemIdsOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byItemIds returns an error %d: %s", response.Code(), string(data))
	}
}
...
func NewGetUserActiveEntitlementsByItemIdsOK() *GetUserActiveEntitlementsByItemIdsOK {
	return &GetUserActiveEntitlementsByItemIdsOK{}
}
...
func (o *GetUserActiveEntitlementsByItemIdsOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byItemIds][%d] getUserActiveEntitlementsByItemIdsOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetUserActiveEntitlementsByItemIdsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
