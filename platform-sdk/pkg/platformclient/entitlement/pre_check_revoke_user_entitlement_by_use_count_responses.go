...
type PreCheckRevokeUserEntitlementByUseCountResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.EntitlementPrechekResult

	Error404 *platformclientmodels.ErrorEntity
}

func (m *PreCheckRevokeUserEntitlementByUseCountResponse) Unpack() (*platformclientmodels.EntitlementPrechekResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
