...
type PublicExistsAnyUserActiveEntitlementResponse struct {
...
func (o *PublicExistsAnyUserActiveEntitlementOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements/ownership/any][%d] publicExistsAnyUserActiveEntitlementOK  %+v", 200, o.ToJSONString())
}
