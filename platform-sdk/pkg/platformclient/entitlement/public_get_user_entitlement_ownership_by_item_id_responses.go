...
type PublicGetUserEntitlementOwnershipByItemIDResponse struct {
...
func (o *PublicGetUserEntitlementOwnershipByItemIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPublicGetUserEntitlementOwnershipByItemIDOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements/ownership/byItemId returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *PublicGetUserEntitlementOwnershipByItemIDOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements/ownership/byItemId][%d] publicGetUserEntitlementOwnershipByItemIdOK  %+v", 200, o.ToJSONString())
}
...
func (o *PublicGetUserEntitlementOwnershipByItemIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
