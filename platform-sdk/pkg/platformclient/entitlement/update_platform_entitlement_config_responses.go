...
type UpdatePlatformEntitlementConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.EntitlementPlatformConfigInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *UpdatePlatformEntitlementConfigResponse) Unpack() (*platformclientmodels.EntitlementPlatformConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
