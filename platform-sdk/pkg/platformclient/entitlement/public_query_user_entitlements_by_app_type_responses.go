...
type PublicQueryUserEntitlementsByAppTypeResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.AppEntitlementPagingSlicedResult
}

func (m *PublicQueryUserEntitlementsByAppTypeResponse) Unpack() (*platformclientmodels.AppEntitlementPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *PublicQueryUserEntitlementsByAppTypeOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements/byAppType][%d] publicQueryUserEntitlementsByAppTypeOK  %+v", 200, o.ToJSONString())
}
