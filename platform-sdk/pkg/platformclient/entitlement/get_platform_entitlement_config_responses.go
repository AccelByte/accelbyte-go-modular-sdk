...
type GetPlatformEntitlementConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.EntitlementPlatformConfigInfo
}

func (m *GetPlatformEntitlementConfigResponse) Unpack() (*platformclientmodels.EntitlementPlatformConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
