...
type GetUserEntitlementsByIdsResponse struct {
...
func (o *GetUserEntitlementsByIdsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetUserEntitlementsByIdsOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byIds returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetUserEntitlementsByIdsOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/entitlements/byIds][%d] getUserEntitlementsByIdsOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetUserEntitlementsByIdsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
