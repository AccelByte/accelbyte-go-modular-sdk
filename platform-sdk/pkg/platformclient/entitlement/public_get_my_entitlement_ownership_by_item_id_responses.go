...
type PublicGetMyEntitlementOwnershipByItemIDResponse struct {
...
func (o *PublicGetMyEntitlementOwnershipByItemIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPublicGetMyEntitlementOwnershipByItemIDOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/public/namespaces/{namespace}/users/me/entitlements/ownership/byItemId returns an error %d: %s", response.Code(), string(data))
	}
}
...
func NewPublicGetMyEntitlementOwnershipByItemIDOK() *PublicGetMyEntitlementOwnershipByItemIDOK {
	return &PublicGetMyEntitlementOwnershipByItemIDOK{}
}
...
func (o *PublicGetMyEntitlementOwnershipByItemIDOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/me/entitlements/ownership/byItemId][%d] publicGetMyEntitlementOwnershipByItemIdOK  %+v", 200, o.ToJSONString())
}
...
func (o *PublicGetMyEntitlementOwnershipByItemIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
