...
// Deprecated: 2025-07-16 - Use PublicGetUserEntitlementBySkuEntitlementClazz<EnumValue>Constant instead.
...
// Get the enum in PublicGetUserEntitlementBySkuParams
const (
	PublicGetUserEntitlementBySkuEntitlementClazzAPPConstant          = "APP"
	PublicGetUserEntitlementBySkuEntitlementClazzCODEConstant         = "CODE"
	PublicGetUserEntitlementBySkuEntitlementClazzENTITLEMENTConstant  = "ENTITLEMENT"
	PublicGetUserEntitlementBySkuEntitlementClazzLOOTBOXConstant      = "LOOTBOX"
	PublicGetUserEntitlementBySkuEntitlementClazzMEDIAConstant        = "MEDIA"
	PublicGetUserEntitlementBySkuEntitlementClazzOPTIONBOXConstant    = "OPTIONBOX"
	PublicGetUserEntitlementBySkuEntitlementClazzSUBSCRIPTIONConstant = "SUBSCRIPTION"
)
