...
type QueryEntitlementsByItemIdsResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.EntitlementPagingSlicedResult
}

func (m *QueryEntitlementsByItemIdsResponse) Unpack() (*platformclientmodels.EntitlementPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
