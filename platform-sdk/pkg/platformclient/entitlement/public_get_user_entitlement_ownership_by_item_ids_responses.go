...
type PublicGetUserEntitlementOwnershipByItemIdsResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.EntitlementOwnership
}
...
func (o *PublicGetUserEntitlementOwnershipByItemIdsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPublicGetUserEntitlementOwnershipByItemIdsOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements/ownership/byItemIds returns an error %d: %s", response.Code(), string(data))
	}
}
...
func NewPublicGetUserEntitlementOwnershipByItemIdsOK() *PublicGetUserEntitlementOwnershipByItemIdsOK {
	return &PublicGetUserEntitlementOwnershipByItemIdsOK{}
}
...
func (o *PublicGetUserEntitlementOwnershipByItemIdsOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/{userId}/entitlements/ownership/byItemIds][%d] publicGetUserEntitlementOwnershipByItemIdsOK  %+v", 200, o.ToJSONString())
}
...
func (o *PublicGetUserEntitlementOwnershipByItemIdsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
