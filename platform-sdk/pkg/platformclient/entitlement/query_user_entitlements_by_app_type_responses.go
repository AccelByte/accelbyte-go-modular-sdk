...
type QueryUserEntitlementsByAppTypeResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.AppEntitlementPagingSlicedResult
}

func (m *QueryUserEntitlementsByAppTypeResponse) Unpack() (*platformclientmodels.AppEntitlementPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
