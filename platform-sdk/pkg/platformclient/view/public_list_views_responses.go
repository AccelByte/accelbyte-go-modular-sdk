...
type PublicListViewsResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.ViewInfo
}

func (m *PublicListViewsResponse) Unpack() ([]*platformclientmodels.ViewInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
