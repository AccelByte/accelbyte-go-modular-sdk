...
/*
	  CreatePaymentOrderByDedicatedShort creates payment order by dedicated server
...
/*
	  RefundPaymentOrderByDedicatedShort refunds payment order by dedicated server
...
/*
SyncPaymentOrdersShort syncs payment orders
