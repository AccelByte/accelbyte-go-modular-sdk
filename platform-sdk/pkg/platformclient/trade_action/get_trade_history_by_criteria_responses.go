...
type GetTradeHistoryByCriteriaResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TradeActionPagingSlicedResult
}

func (m *GetTradeHistoryByCriteriaResponse) Unpack() (*platformclientmodels.TradeActionPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetTradeHistoryByCriteriaOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/trade/history/byCriteria][%d] getTradeHistoryByCriteriaOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetTradeHistoryByCriteriaOK) GetPayload() *platformclientmodels.TradeActionPagingSlicedResult {
	return o.Payload
}
...
func (o *GetTradeHistoryByCriteriaOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(platformclientmodels.TradeActionPagingSlicedResult)
