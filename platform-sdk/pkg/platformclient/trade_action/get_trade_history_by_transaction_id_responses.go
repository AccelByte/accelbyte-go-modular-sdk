...
type GetTradeHistoryByTransactionIDResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TradeChainActionHistoryInfo
}

func (m *GetTradeHistoryByTransactionIDResponse) Unpack() (*platformclientmodels.TradeChainActionHistoryInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
