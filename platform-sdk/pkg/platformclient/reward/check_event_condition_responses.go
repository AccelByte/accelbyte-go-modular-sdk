...
type CheckEventConditionResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ConditionMatchResult

	Error404 *platformclientmodels.ErrorEntity
}

func (m *CheckEventConditionResponse) Unpack() (*platformclientmodels.ConditionMatchResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
