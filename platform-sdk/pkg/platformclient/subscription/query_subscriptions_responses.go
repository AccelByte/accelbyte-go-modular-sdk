...
func (m *QuerySubscriptionsResponse) Unpack() (*platformclientmodels.SubscriptionPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *QuerySubscriptionsOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/subscriptions][%d] querySubscriptionsOK  %+v", 200, o.ToJSONString())
}
