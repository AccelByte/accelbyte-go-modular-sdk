...
type PublicGetUserSubscriptionResponse struct {
...
func (m *PublicGetUserSubscriptionResponse) Unpack() (*platformclientmodels.SubscriptionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
