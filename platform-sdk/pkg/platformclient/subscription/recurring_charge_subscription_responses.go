...
type RecurringChargeSubscriptionResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.RecurringChargeResult
}

func (m *RecurringChargeSubscriptionResponse) Unpack() (*platformclientmodels.RecurringChargeResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
