...
type PublicGetUserSubscriptionBillingHistoriesResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.BillingHistoryPagingSlicedResult
}

func (m *PublicGetUserSubscriptionBillingHistoriesResponse) Unpack() (*platformclientmodels.BillingHistoryPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
