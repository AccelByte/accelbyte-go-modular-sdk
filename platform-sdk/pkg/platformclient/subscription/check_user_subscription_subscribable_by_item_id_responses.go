...
func (o *CheckUserSubscriptionSubscribableByItemIDOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/users/{userId}/subscriptions/subscribable/byItemId][%d] checkUserSubscriptionSubscribableByItemIdOK  %+v", 200, o.ToJSONString())
}
