...
type PlatformSubscribeSubscriptionResponse struct {
...
func (m *PlatformSubscribeSubscriptionResponse) Unpack() (*platformclientmodels.SubscriptionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
