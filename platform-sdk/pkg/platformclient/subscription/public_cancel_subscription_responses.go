...
type PublicCancelSubscriptionResponse struct {
...
func (m *PublicCancelSubscriptionResponse) Unpack() (*platformclientmodels.SubscriptionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
