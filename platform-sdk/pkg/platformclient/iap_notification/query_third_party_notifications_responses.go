...
type QueryThirdPartyNotificationsResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.NotificationPagingSlicedResult
}

func (m *QueryThirdPartyNotificationsResponse) Unpack() (*platformclientmodels.NotificationPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
