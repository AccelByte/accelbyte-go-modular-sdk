...
type UpdateRevocationConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.RevocationConfigInfo
}

func (m *UpdateRevocationConfigResponse) Unpack() (*platformclientmodels.RevocationConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
