...
type GetRevocationConfigResponse struct {
...
func (m *GetRevocationConfigResponse) Unpack() (*platformclientmodels.RevocationConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
