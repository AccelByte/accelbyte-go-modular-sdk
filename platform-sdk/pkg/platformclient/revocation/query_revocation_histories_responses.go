...
type QueryRevocationHistoriesResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.RevocationHistoryPagingSlicedResult
}

func (m *QueryRevocationHistoriesResponse) Unpack() (*platformclientmodels.RevocationHistoryPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
