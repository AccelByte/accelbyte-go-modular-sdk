...
type QueryWalletsResponse struct {
	...
	Data *platformclientmodels.WalletPagingSlicedResult
}

func (m *QueryWalletsResponse) Unpack() (*platformclientmodels.WalletPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
