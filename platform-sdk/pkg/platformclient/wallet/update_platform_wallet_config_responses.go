...
type UpdatePlatformWalletConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.PlatformWalletConfigInfo
}

func (m *UpdatePlatformWalletConfigResponse) Unpack() (*platformclientmodels.PlatformWalletConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *UpdatePlatformWalletConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdatePlatformWalletConfigOK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested PUT /platform/admin/namespaces/{namespace}/platforms/{platform}/wallet/config returns an error %d: %s", response.Code(), string(data))
	}
}
...
func NewUpdatePlatformWalletConfigOK() *UpdatePlatformWalletConfigOK {
	return &UpdatePlatformWalletConfigOK{}
}
...
func (o *UpdatePlatformWalletConfigOK) Error() string {
	return fmt.Sprintf("[PUT /platform/admin/namespaces/{namespace}/platforms/{platform}/wallet/config][%d] updatePlatformWalletConfigOK  %+v", 200, o.ToJSONString())
}
...
func (o *UpdatePlatformWalletConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
