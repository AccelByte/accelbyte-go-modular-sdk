...
type BulkCreditResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.BulkCreditResult

	Error422 *platformclientmodels.ValidationErrorEntity
}

func (m *BulkCreditResponse) Unpack() (*platformclientmodels.BulkCreditResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
