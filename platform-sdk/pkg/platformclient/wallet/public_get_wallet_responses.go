...
type PublicGetWalletResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.PlatformWallet
}

func (m *PublicGetWalletResponse) Unpack() (*platformclientmodels.PlatformWallet, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *PublicGetWalletOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/users/{userId}/wallets/{currencyCode}][%d] publicGetWalletOK  %+v", 200, o.ToJSONString())
}
