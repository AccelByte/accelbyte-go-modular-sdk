...
type DebitByWalletPlatformResponse struct {
...
func (m *DebitByWalletPlatformResponse) Unpack() (*platformclientmodels.PlatformWallet, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
