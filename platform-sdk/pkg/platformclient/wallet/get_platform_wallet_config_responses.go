...
type GetPlatformWalletConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.PlatformWalletConfigInfo
}

func (m *GetPlatformWalletConfigResponse) Unpack() (*platformclientmodels.PlatformWalletConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetPlatformWalletConfigOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/platforms/{platform}/wallet/config][%d] getPlatformWalletConfigOK  %+v", 200, o.ToJSONString())
}
