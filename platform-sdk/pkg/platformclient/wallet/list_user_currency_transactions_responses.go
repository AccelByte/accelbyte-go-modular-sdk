...
type ListUserCurrencyTransactionsResponse struct {
...
func (m *ListUserCurrencyTransactionsResponse) Unpack() (*platformclientmodels.WalletTransactionPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
