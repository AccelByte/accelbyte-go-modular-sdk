...
type BulkDebitResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.BulkDebitResult

	Error422 *platformclientmodels.ValidationErrorEntity
}

func (m *BulkDebitResponse) Unpack() (*platformclientmodels.BulkDebitResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
