...
// NewBulkDebitParams creates a new BulkDebitParams object
// with the default values initialized.
func NewBulkDebitParams() *BulkDebitParams {
	var ()
	return &BulkDebitParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewBulkDebitParamsWithTimeout creates a new BulkDebitParams object
...
// NewBulkDebitParamsWithContext creates a new BulkDebitParams object
...
// NewBulkDebitParamsWithHTTPClient creates a new BulkDebitParams object
...
func (o *BulkDebitParams) WithBody(body []*platformclientmodels.BulkDebitRequest) *BulkDebitParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the bulk debit params
func (o *BulkDebitParams) SetBody(body []*platformclientmodels.BulkDebitRequest) {
	o.Body = body
}
