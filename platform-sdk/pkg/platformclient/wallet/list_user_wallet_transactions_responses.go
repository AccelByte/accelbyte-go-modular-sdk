...
type ListUserWalletTransactionsResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.DetailedWalletTransactionPagingSlicedResult

	Error404 *platformclientmodels.ErrorEntity
}

func (m *ListUserWalletTransactionsResponse) Unpack() (*platformclientmodels.DetailedWalletTransactionPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
