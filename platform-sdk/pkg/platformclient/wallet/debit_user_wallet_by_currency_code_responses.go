...
type DebitUserWalletByCurrencyCodeResponse struct {
...
func (m *DebitUserWalletByCurrencyCodeResponse) Unpack() (*platformclientmodels.WalletInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
