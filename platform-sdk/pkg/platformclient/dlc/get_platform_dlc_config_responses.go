...
type GetPlatformDLCConfigResponse struct {
...
func (m *GetPlatformDLCConfigResponse) Unpack() (*platformclientmodels.PlatformDLCConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
