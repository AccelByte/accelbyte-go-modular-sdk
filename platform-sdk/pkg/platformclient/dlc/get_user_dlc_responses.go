...
type GetUserDLCResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.UserDLCRecord
}

func (m *GetUserDLCResponse) Unpack() ([]*platformclientmodels.UserDLCRecord, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
