...
type GetDLCItemConfigHistoryResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.DLCItemConfigHistoryResult

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetDLCItemConfigHistoryResponse) Unpack() (*platformclientmodels.DLCItemConfigHistoryResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
