...
type PublicSyncPsnDLCInventoryWithMultipleServiceLabelsResponse struct {
...
func (m *PublicSyncPsnDLCInventoryWithMultipleServiceLabelsResponse) Unpack() *platformclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
