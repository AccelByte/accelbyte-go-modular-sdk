...
type GenerateInvoiceSummaryResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.InvoiceSummary

	Error422 *platformclientmodels.ValidationErrorEntity
}

func (m *GenerateInvoiceSummaryResponse) Unpack() (*platformclientmodels.InvoiceSummary, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
