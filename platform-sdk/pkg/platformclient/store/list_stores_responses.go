...
func (m *ListStoresResponse) Unpack() ([]*platformclientmodels.StoreInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *ListStoresOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/stores][%d] listStoresOK  %+v", 200, o.ToJSONString())
}
