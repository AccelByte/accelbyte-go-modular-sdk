...
type UpdateCatalogConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.CatalogConfigInfo

	Error422 *platformclientmodels.ValidationErrorEntity
}

func (m *UpdateCatalogConfigResponse) Unpack() (*platformclientmodels.CatalogConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
