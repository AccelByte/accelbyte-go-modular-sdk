...
type GetPublishedStoreBackupResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.StoreBackupInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetPublishedStoreBackupResponse) Unpack() (*platformclientmodels.StoreBackupInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
