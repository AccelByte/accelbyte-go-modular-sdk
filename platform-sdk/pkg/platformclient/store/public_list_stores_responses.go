...
type PublicListStoresResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.StoreInfo
}

func (m *PublicListStoresResponse) Unpack() ([]*platformclientmodels.StoreInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *PublicListStoresOK) Error() string {
	return fmt.Sprintf("[GET /platform/public/namespaces/{namespace}/stores][%d] publicListStoresOK  %+v", 200, o.ToJSONString())
}
