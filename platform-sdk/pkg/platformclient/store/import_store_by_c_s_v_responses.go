...
type ImportStoreByCSVResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.ImportStoreResult
...
func (m *ImportStoreByCSVResponse) Unpack() (*platformclientmodels.ImportStoreResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
