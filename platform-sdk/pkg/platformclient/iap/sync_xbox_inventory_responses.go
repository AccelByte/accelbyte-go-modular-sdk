...
type SyncXboxInventoryResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.XblReconcileResult

	Error400 *platformclientmodels.ErrorEntity
	Error404 *platformclientmodels.ErrorEntity
}

func (m *SyncXboxInventoryResponse) Unpack() ([]*platformclientmodels.XblReconcileResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
