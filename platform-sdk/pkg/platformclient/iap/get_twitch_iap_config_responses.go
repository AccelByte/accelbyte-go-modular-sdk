...
type GetTwitchIAPConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.TwitchIAPConfigInfo
}

func (m *GetTwitchIAPConfigResponse) Unpack() (*platformclientmodels.TwitchIAPConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetTwitchIAPConfigOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/iap/config/twitch][%d] getTwitchIapConfigOK  %+v", 200, o.ToJSONString())
}
