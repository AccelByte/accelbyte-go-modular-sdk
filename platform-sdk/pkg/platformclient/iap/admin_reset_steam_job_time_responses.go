...
type AdminResetSteamJobTimeResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.SteamReportJobInfo
}

func (m *AdminResetSteamJobTimeResponse) Unpack() (*platformclientmodels.SteamReportJobInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
