...
type AdminSyncSteamIAPByTransactionResponse struct {
...
func (m *AdminSyncSteamIAPByTransactionResponse) Unpack() (*platformclientmodels.IAPOrderShortInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
