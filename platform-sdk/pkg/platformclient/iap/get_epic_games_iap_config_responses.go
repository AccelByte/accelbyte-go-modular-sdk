...
type GetEpicGamesIAPConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.EpicGamesIAPConfigInfo
}

func (m *GetEpicGamesIAPConfigResponse) Unpack() (*platformclientmodels.EpicGamesIAPConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
