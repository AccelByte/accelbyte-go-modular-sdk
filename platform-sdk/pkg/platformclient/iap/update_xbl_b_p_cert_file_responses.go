...
type UpdateXblBPCertFileResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.XblIAPConfigInfo

	Error400 *platformclientmodels.ErrorEntity
}

func (m *UpdateXblBPCertFileResponse) Unpack() (*platformclientmodels.XblIAPConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
