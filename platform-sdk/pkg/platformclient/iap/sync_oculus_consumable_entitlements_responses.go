...
type SyncOculusConsumableEntitlementsResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.OculusReconcileResult

	Error400 *platformclientmodels.ErrorEntity
	Error404 *platformclientmodels.ErrorEntity
}

func (m *SyncOculusConsumableEntitlementsResponse) Unpack() ([]*platformclientmodels.OculusReconcileResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
