...
type AdminSyncOculusSubscriptionsResponse struct {
...
func (m *AdminSyncOculusSubscriptionsResponse) Unpack() ([]*platformclientmodels.ThirdPartySubscriptionTransactionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
