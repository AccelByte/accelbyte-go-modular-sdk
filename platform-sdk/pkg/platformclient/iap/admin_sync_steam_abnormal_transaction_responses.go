...
type AdminSyncSteamAbnormalTransactionResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.IAPOrderShortInfo
...
func (m *AdminSyncSteamAbnormalTransactionResponse) Unpack() (*platformclientmodels.IAPOrderShortInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
