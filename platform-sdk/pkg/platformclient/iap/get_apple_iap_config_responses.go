...
func (o *GetAppleIAPConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /platform/admin/namespaces/{namespace}/iap/config/apple returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GetAppleIAPConfigOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/iap/config/apple][%d] getAppleIapConfigOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetAppleIAPConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
