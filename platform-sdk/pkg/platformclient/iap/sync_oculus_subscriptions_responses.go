...
type SyncOculusSubscriptionsResponse struct {
...
func (m *SyncOculusSubscriptionsResponse) Unpack() ([]*platformclientmodels.ThirdPartySubscriptionTransactionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
