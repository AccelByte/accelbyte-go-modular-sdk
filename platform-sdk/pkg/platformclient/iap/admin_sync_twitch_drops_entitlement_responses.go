...
type AdminSyncTwitchDropsEntitlementResponse struct {
	platformclientmodels.ApiResponse

	Error429 string
}

func (m *AdminSyncTwitchDropsEntitlementResponse) Unpack() *platformclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
		...
		case 429:
			return &platformclientmodels.ApiError{Code: "429", Message: m.Error429}
