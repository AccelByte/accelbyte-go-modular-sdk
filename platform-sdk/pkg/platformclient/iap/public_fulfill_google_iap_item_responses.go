...
type PublicFulfillGoogleIAPItemResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.GoogleReceiptResolveResult
...
func (m *PublicFulfillGoogleIAPItemResponse) Unpack() (*platformclientmodels.GoogleReceiptResolveResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
