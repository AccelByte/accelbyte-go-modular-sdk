...
type SyncSteamIAPByTransactionResponse struct {
...
func (m *SyncSteamIAPByTransactionResponse) Unpack() (*platformclientmodels.IAPOrderShortInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
