...
type PublicReconcilePlayStationStoreWithMultipleServiceLabelsResponse struct {
...
func (m *PublicReconcilePlayStationStoreWithMultipleServiceLabelsResponse) Unpack() ([]*platformclientmodels.PlayStationReconcileResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
