...
type GetAppleConfigVersionResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.AppleIAPConfigVersionInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetAppleConfigVersionResponse) Unpack() (*platformclientmodels.AppleIAPConfigVersionInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
