...
type AdminRefundIAPOrderResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.IAPOrderInfo
...
func (m *AdminRefundIAPOrderResponse) Unpack() (*platformclientmodels.IAPOrderInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
