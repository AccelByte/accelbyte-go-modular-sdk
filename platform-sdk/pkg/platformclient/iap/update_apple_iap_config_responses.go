...
type UpdateAppleIAPConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.AppleIAPConfigInfo
}

func (m *UpdateAppleIAPConfigResponse) Unpack() (*platformclientmodels.AppleIAPConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
