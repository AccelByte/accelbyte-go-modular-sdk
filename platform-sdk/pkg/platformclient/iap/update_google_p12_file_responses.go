...
type UpdateGoogleP12FileResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.GoogleIAPConfigInfo
}

func (m *UpdateGoogleP12FileResponse) Unpack() (*platformclientmodels.GoogleIAPConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
