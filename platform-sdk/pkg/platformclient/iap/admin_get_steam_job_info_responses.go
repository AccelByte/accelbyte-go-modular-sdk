...
type AdminGetSteamJobInfoResponse struct {
	platformclientmodels.ApiResponse
	Data []*platformclientmodels.SteamReportJobInfo
}

func (m *AdminGetSteamJobInfoResponse) Unpack() ([]*platformclientmodels.SteamReportJobInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
