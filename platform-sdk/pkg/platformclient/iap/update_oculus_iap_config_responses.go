...
type UpdateOculusIAPConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.OculusIAPConfigInfo
}

func (m *UpdateOculusIAPConfigResponse) Unpack() (*platformclientmodels.OculusIAPConfigInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
