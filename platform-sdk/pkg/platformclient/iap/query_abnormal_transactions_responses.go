...
type QueryAbnormalTransactionsResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.SteamAbnormalTransactionPagingSlicedResult
}

func (m *QueryAbnormalTransactionsResponse) Unpack() (*platformclientmodels.SteamAbnormalTransactionPagingSlicedResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
