...
type SyncSteamAbnormalTransactionResponse struct {
...
func (m *SyncSteamAbnormalTransactionResponse) Unpack() (*platformclientmodels.IAPOrderShortInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
