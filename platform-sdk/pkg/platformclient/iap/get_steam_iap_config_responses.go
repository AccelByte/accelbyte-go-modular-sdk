...
type GetSteamIAPConfigResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.SteamIAPConfig
}

func (m *GetSteamIAPConfigResponse) Unpack() (*platformclientmodels.SteamIAPConfig, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetSteamIAPConfigOK) Error() string {
	return fmt.Sprintf("[GET /platform/admin/namespaces/{namespace}/iap/config/steam][%d] getSteamIapConfigOK  %+v", 200, o.ToJSONString())
}
...
func (o *GetSteamIAPConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(platformclientmodels.SteamIAPConfig)
