...
type SimulatePaymentOrderNotificationResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.NotificationProcessResult

	Error400 *platformclientmodels.ErrorEntity
	Error404 *platformclientmodels.ErrorEntity
}

func (m *SimulatePaymentOrderNotificationResponse) Unpack() (*platformclientmodels.NotificationProcessResult, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
