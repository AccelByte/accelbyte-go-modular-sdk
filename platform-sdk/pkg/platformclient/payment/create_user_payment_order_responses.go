...
type CreateUserPaymentOrderResponse struct {
...
func (m *CreateUserPaymentOrderResponse) Unpack() (*platformclientmodels.PaymentOrderInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
