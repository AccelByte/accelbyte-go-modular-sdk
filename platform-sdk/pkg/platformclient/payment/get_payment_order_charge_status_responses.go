...
type GetPaymentOrderChargeStatusResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.PaymentOrderChargeStatus

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetPaymentOrderChargeStatusResponse) Unpack() (*platformclientmodels.PaymentOrderChargeStatus, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
