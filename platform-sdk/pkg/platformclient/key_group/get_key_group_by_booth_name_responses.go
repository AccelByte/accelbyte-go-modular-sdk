...
type GetKeyGroupByBoothNameResponse struct {
...
func (m *GetKeyGroupByBoothNameResponse) Unpack() (*platformclientmodels.KeyGroupInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
