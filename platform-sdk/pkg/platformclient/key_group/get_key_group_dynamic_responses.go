...
type GetKeyGroupDynamicResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.KeyGroupDynamicInfo

	Error404 *platformclientmodels.ErrorEntity
}

func (m *GetKeyGroupDynamicResponse) Unpack() (*platformclientmodels.KeyGroupDynamicInfo, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
