...
type GetXboxEntitlementOwnershipResponse struct {
	platformclientmodels.ApiResponse
	Data *platformclientmodels.PlatformOwnership
}

func (m *GetXboxEntitlementOwnershipResponse) Unpack() (*platformclientmodels.PlatformOwnership, *platformclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
