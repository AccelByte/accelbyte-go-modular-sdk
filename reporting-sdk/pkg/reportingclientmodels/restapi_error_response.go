...
func (m *RestapiErrorResponse) validateErrorCode(formats strfmt.Registry) error {
...
func (m *RestapiErrorResponse) validateErrorMessage(formats strfmt.Registry) error {
...
func (m *RestapiErrorResponse) TranslateToApiError() (*ApiError, error) {
