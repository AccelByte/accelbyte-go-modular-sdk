...
func (m *RestapiPublicReasonListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RestapiPublicReasonListResponse) validateData(formats strfmt.Registry) error {
...
func (m *RestapiPublicReasonListResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *RestapiPublicReasonListResponse) UnmarshalBinary(b []byte) error {
	var res RestapiPublicReasonListResponse
