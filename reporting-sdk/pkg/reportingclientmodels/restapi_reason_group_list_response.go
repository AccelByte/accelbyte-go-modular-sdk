...
func (m *RestapiReasonGroupListResponse) validateData(formats strfmt.Registry) error {
...
func (m *RestapiReasonGroupListResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *RestapiReasonGroupListResponse) UnmarshalBinary(b []byte) error {
	var res RestapiReasonGroupListResponse
