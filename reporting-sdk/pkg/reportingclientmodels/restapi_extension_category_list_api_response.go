...
func (m *RestapiExtensionCategoryListAPIResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RestapiExtensionCategoryListAPIResponse) validateData(formats strfmt.Registry) error {
...
func (m *RestapiExtensionCategoryListAPIResponse) UnmarshalBinary(b []byte) error {
	var res RestapiExtensionCategoryListAPIResponse
