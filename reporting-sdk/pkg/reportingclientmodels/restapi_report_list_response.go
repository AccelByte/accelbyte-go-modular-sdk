...
func (m *RestapiReportListResponse) validateData(formats strfmt.Registry) error {
...
func (m *RestapiReportListResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *RestapiReportListResponse) UnmarshalBinary(b []byte) error {
	var res RestapiReportListResponse
