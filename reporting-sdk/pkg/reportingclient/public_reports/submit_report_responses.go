...
type SubmitReportResponse struct {
	...
	Error429 *reportingclientmodels.RestapiErrorResponse
	Error500 *reportingclientmodels.RestapiErrorResponse
}

func (m *SubmitReportResponse) Unpack() (*reportingclientmodels.RestapiSubmitReportResponse, *reportingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
