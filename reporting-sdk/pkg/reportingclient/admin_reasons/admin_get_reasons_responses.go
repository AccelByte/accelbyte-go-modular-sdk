...
type AdminGetReasonsResponse struct {
	reportingclientmodels.ApiResponse
	Data *reportingclientmodels.RestapiAdminReasonListResponse

	Error404 *reportingclientmodels.RestapiErrorResponse
	Error500 *reportingclientmodels.RestapiErrorResponse
}

func (m *AdminGetReasonsResponse) Unpack() (*reportingclientmodels.RestapiAdminReasonListResponse, *reportingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
