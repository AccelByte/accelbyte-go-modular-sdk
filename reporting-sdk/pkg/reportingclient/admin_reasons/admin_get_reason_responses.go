...
type AdminGetReasonResponse struct {
...
func (m *AdminGetReasonResponse) Unpack() (*reportingclientmodels.RestapiAdminReasonResponse, *reportingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
