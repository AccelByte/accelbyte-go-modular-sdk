...
type UpdateReasonGroupResponse struct {
...
func (m *UpdateReasonGroupResponse) Unpack() (*reportingclientmodels.RestapiReasonGroupResponse, *reportingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
