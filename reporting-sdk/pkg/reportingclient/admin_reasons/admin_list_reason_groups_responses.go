...
type AdminListReasonGroupsResponse struct {
...
func (m *AdminListReasonGroupsResponse) Unpack() (*reportingclientmodels.RestapiReasonGroupListResponse, *reportingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
