...
// NewDeleteReasonGroupParams creates a new DeleteReasonGroupParams object
// with the default values initialized.
func NewDeleteReasonGroupParams() *DeleteReasonGroupParams {
	var ()
	return &DeleteReasonGroupParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteReasonGroupParamsWithTimeout creates a new DeleteReasonGroupParams object
...
// NewDeleteReasonGroupParamsWithContext creates a new DeleteReasonGroupParams object
...
// NewDeleteReasonGroupParamsWithHTTPClient creates a new DeleteReasonGroupParams object
...
/*
DeleteReasonGroupParams contains all the parameters to send to the API endpoint
for the delete reason group operation typically these are written to a http.Request
*/
...
func (o *DeleteReasonGroupParams) SetFlightId(flightId string) {
	if o.XFlightId != nil {
