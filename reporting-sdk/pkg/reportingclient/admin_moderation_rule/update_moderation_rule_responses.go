...
type UpdateModerationRuleResponse struct {
...
func (m *UpdateModerationRuleResponse) Unpack() (*reportingclientmodels.RestapiModerationRuleResponse, *reportingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
