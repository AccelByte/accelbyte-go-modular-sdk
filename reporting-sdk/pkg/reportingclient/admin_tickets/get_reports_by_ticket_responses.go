...
type GetReportsByTicketResponse struct {
...
func (m *GetReportsByTicketResponse) Unpack() (*reportingclientmodels.RestapiReportListResponse, *reportingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
