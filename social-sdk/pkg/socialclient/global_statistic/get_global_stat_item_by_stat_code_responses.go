...
type GetGlobalStatItemByStatCodeResponse struct {
...
func (m *GetGlobalStatItemByStatCodeResponse) Unpack() (*socialclientmodels.GlobalStatItemInfo, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
