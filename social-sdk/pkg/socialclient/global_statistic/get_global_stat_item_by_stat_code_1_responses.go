...
type GetGlobalStatItemByStatCode1Response struct {
	socialclientmodels.ApiResponse
	Data *socialclientmodels.GlobalStatItemInfo
...
func (m *GetGlobalStatItemByStatCode1Response) Unpack() (*socialclientmodels.GlobalStatItemInfo, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
