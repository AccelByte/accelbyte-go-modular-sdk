...
type GetGlobalStatItemsResponse struct {
...
func (m *GetGlobalStatItemsResponse) Unpack() (*socialclientmodels.GlobalStatItemPagingSlicedResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
