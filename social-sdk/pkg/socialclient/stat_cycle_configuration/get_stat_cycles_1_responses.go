...
type GetStatCycles1Response struct {
	socialclientmodels.ApiResponse
	Data *socialclientmodels.StatCyclePagingSlicedResult
...
func (m *GetStatCycles1Response) Unpack() (*socialclientmodels.StatCyclePagingSlicedResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
