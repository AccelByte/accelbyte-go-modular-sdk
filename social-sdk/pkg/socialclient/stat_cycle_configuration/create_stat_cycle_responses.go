...
type CreateStatCycleResponse struct {
	socialclientmodels.ApiResponse
	Data *socialclientmodels.StatCycleInfo
...
func (m *CreateStatCycleResponse) Unpack() (*socialclientmodels.StatCycleInfo, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
