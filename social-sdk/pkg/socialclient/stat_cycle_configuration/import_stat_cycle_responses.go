...
type ImportStatCycleResponse struct {
	socialclientmodels.ApiResponse
	Data *socialclientmodels.StatImportInfo
...
func (m *ImportStatCycleResponse) Unpack() (*socialclientmodels.StatImportInfo, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
