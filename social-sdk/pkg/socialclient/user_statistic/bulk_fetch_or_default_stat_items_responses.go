...
type BulkFetchOrDefaultStatItemsResponse struct {
...
func (m *BulkFetchOrDefaultStatItemsResponse) Unpack() ([]*socialclientmodels.ADTOObjectForUserStatItemValue, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
