...
type PublicBulkIncUserStatItemResponse struct {
...
func (m *PublicBulkIncUserStatItemResponse) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
