...
type BulkIncUserStatItemValueResponse struct {
...
func (m *BulkIncUserStatItemValueResponse) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
