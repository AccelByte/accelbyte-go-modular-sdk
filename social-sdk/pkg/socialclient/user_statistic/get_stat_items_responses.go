...
type GetStatItemsResponse struct {
	socialclientmodels.ApiResponse
	Data *socialclientmodels.StatItemValuePagingSlicedResult
...
func (m *GetStatItemsResponse) Unpack() (*socialclientmodels.StatItemValuePagingSlicedResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
