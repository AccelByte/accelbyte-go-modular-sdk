...
type PublicBulkCreateUserStatItemsResponse struct {
...
func (m *PublicBulkCreateUserStatItemsResponse) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
