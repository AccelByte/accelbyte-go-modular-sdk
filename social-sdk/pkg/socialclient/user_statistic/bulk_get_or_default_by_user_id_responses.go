...
type BulkGetOrDefaultByUserIDResponse struct {
...
func (m *BulkGetOrDefaultByUserIDResponse) Unpack() ([]*socialclientmodels.ADTOObjectForUserStatItemValue, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
