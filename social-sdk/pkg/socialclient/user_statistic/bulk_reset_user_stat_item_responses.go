...
type BulkResetUserStatItemResponse struct {
...
func (m *BulkResetUserStatItemResponse) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
