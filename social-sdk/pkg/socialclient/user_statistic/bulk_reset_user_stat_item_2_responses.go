...
type BulkResetUserStatItem2Response struct {
...
func (m *BulkResetUserStatItem2Response) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
