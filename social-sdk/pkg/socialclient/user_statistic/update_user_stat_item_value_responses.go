...
type UpdateUserStatItemValueResponse struct {
...
func (m *UpdateUserStatItemValueResponse) Unpack() (*socialclientmodels.StatItemIncResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
