...
type PublicBulkIncUserStatItem1Response struct {
...
func (m *PublicBulkIncUserStatItem1Response) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
