...
type BulkFetchStatItems1Response struct {
	socialclientmodels.ApiResponse
	Data []*socialclientmodels.UserStatItemInfo
...
func (m *BulkFetchStatItems1Response) Unpack() ([]*socialclientmodels.UserStatItemInfo, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
