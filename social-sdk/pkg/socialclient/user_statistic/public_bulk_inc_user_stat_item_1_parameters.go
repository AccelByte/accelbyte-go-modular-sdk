...
// NewPublicBulkIncUserStatItem1Params creates a new PublicBulkIncUserStatItem1Params object
// with the default values initialized.
func NewPublicBulkIncUserStatItem1Params() *PublicBulkIncUserStatItem1Params {
	var ()
	return &PublicBulkIncUserStatItem1Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewPublicBulkIncUserStatItem1ParamsWithTimeout creates a new PublicBulkIncUserStatItem1Params object
...
// NewPublicBulkIncUserStatItem1ParamsWithContext creates a new PublicBulkIncUserStatItem1Params object
...
// NewPublicBulkIncUserStatItem1ParamsWithHTTPClient creates a new PublicBulkIncUserStatItem1Params object
...
/*PublicBulkIncUserStatItem1Params contains all the parameters to send to the API endpoint
for the public bulk inc user stat item 1 operation typically these are written to a http.Request
*/
...
func (o *PublicBulkIncUserStatItem1Params) WithTimeout(timeout time.Duration) *PublicBulkIncUserStatItem1Params {
...
func (o *PublicBulkIncUserStatItem1Params) WithContext(ctx context.Context) *PublicBulkIncUserStatItem1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the public bulk inc user stat item 1 params
func (o *PublicBulkIncUserStatItem1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *PublicBulkIncUserStatItem1Params) WithHTTPClient(client *http.Client) *PublicBulkIncUserStatItem1Params {
...
func (o *PublicBulkIncUserStatItem1Params) SetBody(body []*socialclientmodels.BulkStatItemInc) {
	o.Body = body
}

// WithNamespace adds the namespace to the public bulk inc user stat item 1 params
func (o *PublicBulkIncUserStatItem1Params) WithNamespace(namespace string) *PublicBulkIncUserStatItem1Params {
...
func (o *PublicBulkIncUserStatItem1Params) WithUserID(userID string) *PublicBulkIncUserStatItem1Params {
	o.SetUserID(userID)
	return o
}
...
func (o *PublicBulkIncUserStatItem1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
