...
type BulkResetUserStatItem1Response struct {
...
func (m *BulkResetUserStatItem1Response) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
