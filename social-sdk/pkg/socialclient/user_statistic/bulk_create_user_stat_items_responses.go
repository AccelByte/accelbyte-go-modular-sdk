...
type BulkCreateUserStatItemsResponse struct {
...
func (m *BulkCreateUserStatItemsResponse) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
