...
type ResetUserStatItemValueResponse struct {
...
func (m *ResetUserStatItemValueResponse) Unpack() (*socialclientmodels.StatItemIncResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
