...
// NewBulkUpdateUserStatItemV2Params creates a new BulkUpdateUserStatItemV2Params object
// with the default values initialized.
func NewBulkUpdateUserStatItemV2Params() *BulkUpdateUserStatItemV2Params {
	var ()
	return &BulkUpdateUserStatItemV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewBulkUpdateUserStatItemV2ParamsWithTimeout creates a new BulkUpdateUserStatItemV2Params object
...
// NewBulkUpdateUserStatItemV2ParamsWithContext creates a new BulkUpdateUserStatItemV2Params object
...
// NewBulkUpdateUserStatItemV2ParamsWithHTTPClient creates a new BulkUpdateUserStatItemV2Params object
...
/*BulkUpdateUserStatItemV2Params contains all the parameters to send to the API endpoint
for the bulk update user stat item v2 operation typically these are written to a http.Request
*/
...
func (o *BulkUpdateUserStatItemV2Params) WithTimeout(timeout time.Duration) *BulkUpdateUserStatItemV2Params {
...
func (o *BulkUpdateUserStatItemV2Params) WithContext(ctx context.Context) *BulkUpdateUserStatItemV2Params {
	o.SetContext(ctx)
	return o
}
...
func (o *BulkUpdateUserStatItemV2Params) WithHTTPClient(client *http.Client) *BulkUpdateUserStatItemV2Params {
...
func (o *BulkUpdateUserStatItemV2Params) WithBody(body []*socialclientmodels.BulkUserStatItemUpdate) *BulkUpdateUserStatItemV2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the bulk update user stat item v2 params
func (o *BulkUpdateUserStatItemV2Params) SetBody(body []*socialclientmodels.BulkUserStatItemUpdate) {
	o.Body = body
}

// WithNamespace adds the namespace to the bulk update user stat item v2 params
func (o *BulkUpdateUserStatItemV2Params) WithNamespace(namespace string) *BulkUpdateUserStatItemV2Params {
...
func (o *BulkUpdateUserStatItemV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
