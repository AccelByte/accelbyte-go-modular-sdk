...
type PublicBulkIncUserStatItemValueResponse struct {
...
func (m *PublicBulkIncUserStatItemValueResponse) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
