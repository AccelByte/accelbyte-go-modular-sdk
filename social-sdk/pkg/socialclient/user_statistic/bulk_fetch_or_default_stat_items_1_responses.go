...
type BulkFetchOrDefaultStatItems1Response struct {
...
func (m *BulkFetchOrDefaultStatItems1Response) Unpack() ([]*socialclientmodels.ADTOObjectForUserStatItemValue, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
