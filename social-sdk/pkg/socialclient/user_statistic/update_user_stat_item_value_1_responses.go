...
type UpdateUserStatItemValue1Response struct {
...
func (m *UpdateUserStatItemValue1Response) Unpack() (*socialclientmodels.StatItemIncResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
