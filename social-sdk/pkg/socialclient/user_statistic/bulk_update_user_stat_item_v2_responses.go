...
type BulkUpdateUserStatItemV2Response struct {
...
func (m *BulkUpdateUserStatItemV2Response) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
