...
type BulkIncUserStatItemValue2Response struct {
...
func (m *BulkIncUserStatItemValue2Response) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
