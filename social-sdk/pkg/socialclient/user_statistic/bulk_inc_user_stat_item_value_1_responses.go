...
type BulkIncUserStatItemValue1Response struct {
...
func (m *BulkIncUserStatItemValue1Response) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
