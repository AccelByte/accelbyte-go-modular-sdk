...
type GetUserStatItemsResponse struct {
...
func (m *GetUserStatItemsResponse) Unpack() (*socialclientmodels.UserStatItemPagingSlicedResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
