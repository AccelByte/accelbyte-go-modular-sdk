...
type BulkUpdateUserStatItem2Response struct {
...
func (m *BulkUpdateUserStatItem2Response) Unpack() ([]*socialclientmodels.BulkStatOperationResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
