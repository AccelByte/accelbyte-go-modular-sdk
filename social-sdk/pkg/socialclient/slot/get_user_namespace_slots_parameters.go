...
// SetHTTPClient adds the HTTPClient Transport to the get user namespace slots params
func (o *GetUserNamespaceSlotsParams) SetHTTPClientTransport(roundTripper http.RoundTripper) {
	if o.HTTPClient != nil {
...
func (o *GetUserNamespaceSlotsParams) SetFlightId(flightId string) {
	if o.XFlightId != nil {
