...
type CreateStat1Response struct {
	socialclientmodels.ApiResponse
	Data *socialclientmodels.StatInfo
...
func (m *CreateStat1Response) Unpack() (*socialclientmodels.StatInfo, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
