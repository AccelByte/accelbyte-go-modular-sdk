...
type GetUserStatCycleItems1Response struct {
...
func (m *GetUserStatCycleItems1Response) Unpack() (*socialclientmodels.UserStatCycleItemPagingSlicedResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
