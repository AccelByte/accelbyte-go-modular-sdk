...
type GetUserStatCycleItemsResponse struct {
...
func (m *GetUserStatCycleItemsResponse) Unpack() (*socialclientmodels.UserStatCycleItemPagingSlicedResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
