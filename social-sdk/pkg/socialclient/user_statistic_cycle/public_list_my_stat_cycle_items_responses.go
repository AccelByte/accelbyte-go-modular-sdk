...
type PublicListMyStatCycleItemsResponse struct {
	socialclientmodels.ApiResponse
	Data *socialclientmodels.UserStatCycleItemPagingSlicedResult
...
func (m *PublicListMyStatCycleItemsResponse) Unpack() (*socialclientmodels.UserStatCycleItemPagingSlicedResult, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
