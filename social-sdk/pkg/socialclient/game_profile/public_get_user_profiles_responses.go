...
type PublicGetUserProfilesResponse struct {
	socialclientmodels.ApiResponse
	Data []*socialclientmodels.GameProfileHeader
...
func (m *PublicGetUserProfilesResponse) Unpack() ([]*socialclientmodels.GameProfileHeader, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
