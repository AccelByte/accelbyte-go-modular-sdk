...
type PublicGetProfileAttributeResponse struct {
	socialclientmodels.ApiResponse
	Data *socialclientmodels.Attribute
...
func (m *PublicGetProfileAttributeResponse) Unpack() (*socialclientmodels.Attribute, *socialclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
