...
func (o *RetrieveSinglePolicyVersionOK) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/policies/{policyId}/versions][%d] retrieveSinglePolicyVersionOK  %+v", 200, o.ToJSONString())
}
...
func (o *RetrieveSinglePolicyVersionNotFound) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/policies/{policyId}/versions][%d] retrieveSinglePolicyVersionNotFound  %+v", 404, o.ToJSONString())
}
