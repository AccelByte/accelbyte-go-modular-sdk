...
// WithNamespace adds the namespace to the create policy version params
func (o *CreatePolicyVersionParams) WithNamespace(namespace string) *CreatePolicyVersionParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the create policy version params
func (o *CreatePolicyVersionParams) SetNamespace(namespace string) {
