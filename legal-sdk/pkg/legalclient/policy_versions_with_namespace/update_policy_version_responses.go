...
type UpdatePolicyVersionResponse struct {
	...
	Data *legalclientmodels.UpdatePolicyVersionResponse

	Error400 *legalclientmodels.ErrorEntity
	Error409 *legalclientmodels.ErrorEntity
}

func (m *UpdatePolicyVersionResponse) Unpack() (*legalclientmodels.UpdatePolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *UpdatePolicyVersionOK) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/versions/{policyVersionId}][%d] updatePolicyVersionOK  %+v", 200, o.ToJSONString())
}
...
func (o *UpdatePolicyVersionBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/versions/{policyVersionId}][%d] updatePolicyVersionBadRequest  %+v", 400, o.ToJSONString())
}
...
func (o *UpdatePolicyVersionConflict) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/versions/{policyVersionId}][%d] updatePolicyVersionConflict  %+v", 409, o.ToJSONString())
}
