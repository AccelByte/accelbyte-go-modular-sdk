...
// WithNamespace adds the namespace to the update policy version params
func (o *UpdatePolicyVersionParams) WithNamespace(namespace string) *UpdatePolicyVersionParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the update policy version params
func (o *UpdatePolicyVersionParams) SetNamespace(namespace string) {
