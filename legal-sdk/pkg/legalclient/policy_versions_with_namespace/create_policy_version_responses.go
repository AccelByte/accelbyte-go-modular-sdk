...
func (o *CreatePolicyVersionCreated) Error() string {
	return fmt.Sprintf("[POST /agreement/admin/namespaces/{namespace}/policies/{policyId}/versions][%d] createPolicyVersionCreated  %+v", 201, o.ToJSONString())
}
...
func (o *CreatePolicyVersionBadRequest) Error() string {
	return fmt.Sprintf("[POST /agreement/admin/namespaces/{namespace}/policies/{policyId}/versions][%d] createPolicyVersionBadRequest  %+v", 400, o.ToJSONString())
}
