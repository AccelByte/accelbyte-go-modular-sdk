...
type RetrieveSinglePolicyVersion1Response struct {
...
func (m *RetrieveSinglePolicyVersion1Response) Unpack() ([]*legalclientmodels.RetrievePolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
