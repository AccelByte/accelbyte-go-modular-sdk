...
type PublishPolicyVersionResponse struct {
...
func (m *PublishPolicyVersionResponse) Unpack() *legalclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
...
func (o *PublishPolicyVersionOK) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/versions/{policyVersionId}/latest][%d] publishPolicyVersionOK ", 200)
}
...
func (o *PublishPolicyVersionBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/versions/{policyVersionId}/latest][%d] publishPolicyVersionBadRequest  %+v", 400, o.ToJSONString())
}
...
func (o *PublishPolicyVersionConflict) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/versions/{policyVersionId}/latest][%d] publishPolicyVersionConflict  %+v", 409, o.ToJSONString())
}
