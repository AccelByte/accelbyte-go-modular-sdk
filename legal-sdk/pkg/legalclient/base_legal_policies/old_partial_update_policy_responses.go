...
type OldPartialUpdatePolicyResponse struct {
...
func (m *OldPartialUpdatePolicyResponse) Unpack() (*legalclientmodels.UpdateBasePolicyResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
