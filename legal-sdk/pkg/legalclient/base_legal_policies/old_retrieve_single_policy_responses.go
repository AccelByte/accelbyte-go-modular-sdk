...
type OldRetrieveSinglePolicyResponse struct {
...
func (m *OldRetrieveSinglePolicyResponse) Unpack() (*legalclientmodels.RetrieveBasePolicyResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
