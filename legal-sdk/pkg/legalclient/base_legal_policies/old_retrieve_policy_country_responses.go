...
type OldRetrievePolicyCountryResponse struct {
...
func (m *OldRetrievePolicyCountryResponse) Unpack() (*legalclientmodels.RetrievePolicyResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
