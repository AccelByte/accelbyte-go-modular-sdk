...
type OldRetrieveAllPolicyTypesResponse struct {
	legalclientmodels.ApiResponse
	Data []*legalclientmodels.RetrievePolicyTypeResponse
}

func (m *OldRetrieveAllPolicyTypesResponse) Unpack() ([]*legalclientmodels.RetrievePolicyTypeResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
