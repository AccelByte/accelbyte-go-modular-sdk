...
type PublicRetrieveSingleLocalizedPolicyVersionResponse struct {
...
func (m *PublicRetrieveSingleLocalizedPolicyVersionResponse) Unpack() (*legalclientmodels.RetrieveLocalizedPolicyVersionPublicResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
