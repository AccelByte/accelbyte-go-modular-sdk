...
type CreateLocalizedPolicyVersion1Response struct {
...
func (m *CreateLocalizedPolicyVersion1Response) Unpack() (*legalclientmodels.CreateLocalizedPolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
