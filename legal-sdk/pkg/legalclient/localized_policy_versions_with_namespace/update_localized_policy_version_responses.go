...
func (o *UpdateLocalizedPolicyVersionOK) Error() string {
	return fmt.Sprintf("[PUT /agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}][%d] updateLocalizedPolicyVersionOK  %+v", 200, o.ToJSONString())
}
...
func (o *UpdateLocalizedPolicyVersionBadRequest) Error() string {
	return fmt.Sprintf("[PUT /agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}][%d] updateLocalizedPolicyVersionBadRequest  %+v", 400, o.ToJSONString())
}
