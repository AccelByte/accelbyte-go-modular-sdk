...
// WithNamespace adds the namespace to the retrieve localized policy versions params
func (o *RetrieveLocalizedPolicyVersionsParams) WithNamespace(namespace string) *RetrieveLocalizedPolicyVersionsParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the retrieve localized policy versions params
func (o *RetrieveLocalizedPolicyVersionsParams) SetNamespace(namespace string) {
