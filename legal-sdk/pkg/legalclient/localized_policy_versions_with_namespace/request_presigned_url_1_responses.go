...
type RequestPresignedURL1Response struct {
...
func (m *RequestPresignedURL1Response) Unpack() (*legalclientmodels.UploadLocalizedPolicyVersionAttachmentResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
