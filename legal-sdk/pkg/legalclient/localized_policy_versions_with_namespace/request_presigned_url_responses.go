...
type RequestPresignedURLResponse struct {
	legalclientmodels.ApiResponse
	Data *legalclientmodels.UploadLocalizedPolicyVersionAttachmentResponse

	Error400 *legalclientmodels.ErrorEntity
}

func (m *RequestPresignedURLResponse) Unpack() (*legalclientmodels.UploadLocalizedPolicyVersionAttachmentResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *RequestPresignedURLCreated) Error() string {
	return fmt.Sprintf("[POST /agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}/attachments][%d] requestPresignedUrlCreated  %+v", 201, o.ToJSONString())
}
...
func (o *RequestPresignedURLBadRequest) Error() string {
	return fmt.Sprintf("[POST /agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}/attachments][%d] requestPresignedUrlBadRequest  %+v", 400, o.ToJSONString())
}
