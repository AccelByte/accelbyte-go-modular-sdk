...
// WithNamespace adds the namespace to the retrieve single localized policy version params
func (o *RetrieveSingleLocalizedPolicyVersionParams) WithNamespace(namespace string) *RetrieveSingleLocalizedPolicyVersionParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the retrieve single localized policy version params
func (o *RetrieveSingleLocalizedPolicyVersionParams) SetNamespace(namespace string) {
