...
type RetrieveSingleLocalizedPolicyVersionResponse struct {
...
func (m *RetrieveSingleLocalizedPolicyVersionResponse) Unpack() (*legalclientmodels.RetrieveLocalizedPolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *RetrieveSingleLocalizedPolicyVersionOK) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}][%d] retrieveSingleLocalizedPolicyVersionOK  %+v", 200, o.ToJSONString())
}
...
func (o *RetrieveSingleLocalizedPolicyVersionNotFound) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/localized-policy-versions/{localizedPolicyVersionId}][%d] retrieveSingleLocalizedPolicyVersionNotFound  %+v", 404, o.ToJSONString())
}
