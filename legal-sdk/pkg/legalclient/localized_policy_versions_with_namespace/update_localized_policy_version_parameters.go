...
// WithNamespace adds the namespace to the update localized policy version params
func (o *UpdateLocalizedPolicyVersionParams) WithNamespace(namespace string) *UpdateLocalizedPolicyVersionParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the update localized policy version params
func (o *UpdateLocalizedPolicyVersionParams) SetNamespace(namespace string) {
