...
// WithNamespace adds the namespace to the update policy params
func (o *UpdatePolicyParams) WithNamespace(namespace string) *UpdatePolicyParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the update policy params
func (o *UpdatePolicyParams) SetNamespace(namespace string) {
