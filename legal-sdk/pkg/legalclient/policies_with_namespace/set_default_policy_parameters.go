...
// WithNamespace adds the namespace to the set default policy params
func (o *SetDefaultPolicyParams) WithNamespace(namespace string) *SetDefaultPolicyParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the set default policy params
func (o *SetDefaultPolicyParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithPolicyID adds the policyID to the set default policy params
func (o *SetDefaultPolicyParams) WithPolicyID(policyID string) *SetDefaultPolicyParams {
	o.SetPolicyID(policyID)
	return o
}

// SetPolicyID adds the policyId to the set default policy params
func (o *SetDefaultPolicyParams) SetPolicyID(policyID string) {
	o.PolicyID = policyID
}
