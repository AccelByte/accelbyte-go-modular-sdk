...
func (m *SetDefaultPolicyResponse) Unpack() *legalclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
...
func (o *SetDefaultPolicyOK) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/{policyId}/default][%d] setDefaultPolicyOK ", 200)
}
...
func (o *SetDefaultPolicyBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/{policyId}/default][%d] setDefaultPolicyBadRequest  %+v", 400, o.ToJSONString())
}
