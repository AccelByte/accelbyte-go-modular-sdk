...
func (m *UpdatePolicyResponse) Unpack() *legalclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
...
func (o *UpdatePolicyOK) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/{policyId}][%d] updatePolicyOK ", 200)
}
...
func (o *UpdatePolicyBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/policies/{policyId}][%d] updatePolicyBadRequest  %+v", 400, o.ToJSONString())
}
