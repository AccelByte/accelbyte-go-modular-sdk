...
type RetrieveSinglePolicyResponse struct {
	legalclientmodels.ApiResponse
	Data *legalclientmodels.RetrieveBasePolicyResponse

	Error404 *legalclientmodels.ErrorEntity
}

func (m *RetrieveSinglePolicyResponse) Unpack() (*legalclientmodels.RetrieveBasePolicyResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *RetrieveSinglePolicyOK) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/base-policies/{basePolicyId}][%d] retrieveSinglePolicyOK  %+v", 200, o.ToJSONString())
}
...
func (o *RetrieveSinglePolicyNotFound) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/base-policies/{basePolicyId}][%d] retrieveSinglePolicyNotFound  %+v", 404, o.ToJSONString())
}
