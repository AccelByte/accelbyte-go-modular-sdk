...
type RetrievePolicyCountryResponse struct {
...
func (m *RetrievePolicyCountryResponse) Unpack() (*legalclientmodels.RetrievePolicyResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *RetrievePolicyCountryOK) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/base-policies/{basePolicyId}/countries/{countryCode}][%d] retrievePolicyCountryOK  %+v", 200, o.ToJSONString())
}
...
func (o *RetrievePolicyCountryNotFound) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/base-policies/{basePolicyId}/countries/{countryCode}][%d] retrievePolicyCountryNotFound  %+v", 404, o.ToJSONString())
}
