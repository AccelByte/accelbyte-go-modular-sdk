...
type PartialUpdatePolicyResponse struct {
...
func (m *PartialUpdatePolicyResponse) Unpack() (*legalclientmodels.UpdateBasePolicyResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *PartialUpdatePolicyOK) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/base-policies/{basePolicyId}][%d] partialUpdatePolicyOK  %+v", 200, o.ToJSONString())
}
...
func (o *PartialUpdatePolicyBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /agreement/admin/namespaces/{namespace}/base-policies/{basePolicyId}][%d] partialUpdatePolicyBadRequest  %+v", 400, o.ToJSONString())
}
