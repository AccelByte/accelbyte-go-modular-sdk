...
type RetrieveAllPoliciesFromBasePolicyResponse struct {
	legalclientmodels.ApiResponse
	Data []*legalclientmodels.RetrievePoliciesFromBasePolicyResponse

	Error404 *legalclientmodels.ErrorEntity
}

func (m *RetrieveAllPoliciesFromBasePolicyResponse) Unpack() ([]*legalclientmodels.RetrievePoliciesFromBasePolicyResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
