...
type RetrieveLatestPoliciesByNamespaceAndCountryPublicResponse struct {
	legalclientmodels.ApiResponse
	Data []*legalclientmodels.RetrieveSimplePolicyPublicResponseV2
}

func (m *RetrieveLatestPoliciesByNamespaceAndCountryPublicResponse) Unpack() ([]*legalclientmodels.RetrieveSimplePolicyPublicResponseV2, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *RetrieveLatestPoliciesByNamespaceAndCountryPublicOK) Error() string {
	return fmt.Sprintf("[GET /agreement/v2/public/policies/namespaces/{namespace}/countries/{countryCode}][%d] retrieveLatestPoliciesByNamespaceAndCountryPublicOK  %+v", 200, o.ToJSONString())
}
