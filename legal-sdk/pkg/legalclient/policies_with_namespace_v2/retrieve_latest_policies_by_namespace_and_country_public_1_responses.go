...
type RetrieveLatestPoliciesByNamespaceAndCountryPublic1Response struct {
	legalclientmodels.ApiResponse
	Data []*legalclientmodels.RetrieveSimplePolicyPublicResponseV2
}

func (m *RetrieveLatestPoliciesByNamespaceAndCountryPublic1Response) Unpack() ([]*legalclientmodels.RetrieveSimplePolicyPublicResponseV2, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
