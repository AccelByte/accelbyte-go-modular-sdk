...
type RetrieveAllUsersByPolicyVersionResponse struct {
...
func (m *RetrieveAllUsersByPolicyVersionResponse) Unpack() (*legalclientmodels.PagedRetrieveUserAcceptedAgreementResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *RetrieveAllUsersByPolicyVersionOK) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/agreements/policy-versions/users][%d] retrieveAllUsersByPolicyVersionOK  %+v", 200, o.ToJSONString())
}
...
func (o *RetrieveAllUsersByPolicyVersionNotFound) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/agreements/policy-versions/users][%d] retrieveAllUsersByPolicyVersionNotFound  %+v", 404, o.ToJSONString())
}
