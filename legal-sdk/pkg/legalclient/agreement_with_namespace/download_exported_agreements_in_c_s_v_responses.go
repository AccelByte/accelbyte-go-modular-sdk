...
type DownloadExportedAgreementsInCSVResponse struct {
	...
	Data *legalclientmodels.DownloadExportedAgreementsInCSVResponse

	Error404 *legalclientmodels.ErrorEntity
}

func (m *DownloadExportedAgreementsInCSVResponse) Unpack() (*legalclientmodels.DownloadExportedAgreementsInCSVResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
