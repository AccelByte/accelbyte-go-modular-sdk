...
func (o *RetrieveAcceptedAgreements1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewRetrieveAcceptedAgreements1OK()
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /agreement/admin/namespaces/{namespace}/agreements/policies/users/{userId} returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *RetrieveAcceptedAgreements1OK) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/namespaces/{namespace}/agreements/policies/users/{userId}][%d] retrieveAcceptedAgreements1OK  %+v", 200, o.ToJSONString())
}
...
func (o *RetrieveAcceptedAgreements1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
