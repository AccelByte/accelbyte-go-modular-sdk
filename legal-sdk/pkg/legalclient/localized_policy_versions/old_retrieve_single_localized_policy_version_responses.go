...
type OldRetrieveSingleLocalizedPolicyVersionResponse struct {
...
func (m *OldRetrieveSingleLocalizedPolicyVersionResponse) Unpack() (*legalclientmodels.RetrieveLocalizedPolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
