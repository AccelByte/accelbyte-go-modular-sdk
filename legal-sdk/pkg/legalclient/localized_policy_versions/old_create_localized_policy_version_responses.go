...
type OldCreateLocalizedPolicyVersionResponse struct {
	legalclientmodels.ApiResponse
	Data *legalclientmodels.CreateLocalizedPolicyVersionResponse

	Error400 *legalclientmodels.ErrorEntity
	Error409 *legalclientmodels.ErrorEntity
}

func (m *OldCreateLocalizedPolicyVersionResponse) Unpack() (*legalclientmodels.CreateLocalizedPolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
