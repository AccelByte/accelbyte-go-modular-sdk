...
// NewOldPublicRetrieveSingleLocalizedPolicyVersionParams creates a new OldPublicRetrieveSingleLocalizedPolicyVersionParams object
// with the default values initialized.
func NewOldPublicRetrieveSingleLocalizedPolicyVersionParams() *OldPublicRetrieveSingleLocalizedPolicyVersionParams {
	var ()
	return &OldPublicRetrieveSingleLocalizedPolicyVersionParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewOldPublicRetrieveSingleLocalizedPolicyVersionParamsWithTimeout creates a new OldPublicRetrieveSingleLocalizedPolicyVersionParams object
...
// NewOldPublicRetrieveSingleLocalizedPolicyVersionParamsWithContext creates a new OldPublicRetrieveSingleLocalizedPolicyVersionParams object
...
// NewOldPublicRetrieveSingleLocalizedPolicyVersionParamsWithHTTPClient creates a new OldPublicRetrieveSingleLocalizedPolicyVersionParams object
...
/*
OldPublicRetrieveSingleLocalizedPolicyVersionParams contains all the parameters to send to the API endpoint
for the old public retrieve single localized policy version operation typically these are written to a http.Request
*/
