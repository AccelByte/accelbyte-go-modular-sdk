...
// NewOldRetrieveLocalizedPolicyVersionsParams creates a new OldRetrieveLocalizedPolicyVersionsParams object
// with the default values initialized.
func NewOldRetrieveLocalizedPolicyVersionsParams() *OldRetrieveLocalizedPolicyVersionsParams {
	var ()
	return &OldRetrieveLocalizedPolicyVersionsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewOldRetrieveLocalizedPolicyVersionsParamsWithTimeout creates a new OldRetrieveLocalizedPolicyVersionsParams object
...
// NewOldRetrieveLocalizedPolicyVersionsParamsWithContext creates a new OldRetrieveLocalizedPolicyVersionsParams object
...
// NewOldRetrieveLocalizedPolicyVersionsParamsWithHTTPClient creates a new OldRetrieveLocalizedPolicyVersionsParams object
...
/*
OldRetrieveLocalizedPolicyVersionsParams contains all the parameters to send to the API endpoint
for the old retrieve localized policy versions operation typically these are written to a http.Request
*/
