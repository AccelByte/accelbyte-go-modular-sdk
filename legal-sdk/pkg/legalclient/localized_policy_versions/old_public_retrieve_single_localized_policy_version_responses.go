...
type OldPublicRetrieveSingleLocalizedPolicyVersionResponse struct {
...
func (m *OldPublicRetrieveSingleLocalizedPolicyVersionResponse) Unpack() (*legalclientmodels.RetrieveLocalizedPolicyVersionPublicResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
