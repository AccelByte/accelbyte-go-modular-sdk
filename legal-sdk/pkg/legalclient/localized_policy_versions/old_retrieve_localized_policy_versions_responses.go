...
type OldRetrieveLocalizedPolicyVersionsResponse struct {
	legalclientmodels.ApiResponse
	Data []*legalclientmodels.RetrieveLocalizedPolicyVersionResponse
}

func (m *OldRetrieveLocalizedPolicyVersionsResponse) Unpack() ([]*legalclientmodels.RetrieveLocalizedPolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *OldRetrieveLocalizedPolicyVersionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewOldRetrieveLocalizedPolicyVersionsOK()
...
func NewOldRetrieveLocalizedPolicyVersionsOK() *OldRetrieveLocalizedPolicyVersionsOK {
	return &OldRetrieveLocalizedPolicyVersionsOK{}
}
...
func (o *OldRetrieveLocalizedPolicyVersionsOK) Error() string {
	return fmt.Sprintf("[GET /agreement/admin/localized-policy-versions/versions/{policyVersionId}][%d] oldRetrieveLocalizedPolicyVersionsOK  %+v", 200, o.ToJSONString())
}
...
func (o *OldRetrieveLocalizedPolicyVersionsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
