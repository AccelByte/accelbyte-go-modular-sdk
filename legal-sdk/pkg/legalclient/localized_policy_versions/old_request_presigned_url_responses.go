...
type OldRequestPresignedURLResponse struct {
...
func (m *OldRequestPresignedURLResponse) Unpack() (*legalclientmodels.UploadLocalizedPolicyVersionAttachmentResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
