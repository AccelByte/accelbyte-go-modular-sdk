...
type OldUpdateLocalizedPolicyVersionResponse struct {
...
func (m *OldUpdateLocalizedPolicyVersionResponse) Unpack() (*legalclientmodels.UpdateLocalizedPolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
