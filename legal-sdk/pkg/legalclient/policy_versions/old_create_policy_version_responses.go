...
type OldCreatePolicyVersionResponse struct {
...
func (m *OldCreatePolicyVersionResponse) Unpack() (*legalclientmodels.CreatePolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
