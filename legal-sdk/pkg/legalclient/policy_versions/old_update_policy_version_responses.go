...
type OldUpdatePolicyVersionResponse struct {
...
func (m *OldUpdatePolicyVersionResponse) Unpack() (*legalclientmodels.UpdatePolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
