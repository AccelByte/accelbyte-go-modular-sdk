...
type OldRetrieveSinglePolicyVersionResponse struct {
...
func (m *OldRetrieveSinglePolicyVersionResponse) Unpack() ([]*legalclientmodels.RetrievePolicyVersionResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
