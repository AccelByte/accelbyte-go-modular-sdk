...
// NewOldCreatePolicyVersionParams creates a new OldCreatePolicyVersionParams object
// with the default values initialized.
func NewOldCreatePolicyVersionParams() *OldCreatePolicyVersionParams {
	var ()
	return &OldCreatePolicyVersionParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewOldCreatePolicyVersionParamsWithTimeout creates a new OldCreatePolicyVersionParams object
...
// NewOldCreatePolicyVersionParamsWithContext creates a new OldCreatePolicyVersionParams object
...
// NewOldCreatePolicyVersionParamsWithHTTPClient creates a new OldCreatePolicyVersionParams object
...
/*
OldCreatePolicyVersionParams contains all the parameters to send to the API endpoint
for the old create policy version operation typically these are written to a http.Request
*/
