...
type OldRetrieveAllUsersByPolicyVersionResponse struct {
...
func (m *OldRetrieveAllUsersByPolicyVersionResponse) Unpack() (*legalclientmodels.PagedRetrieveUserAcceptedAgreementResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
