...
type PublicIndirectBulkAcceptVersionedPolicyResponse struct {
...
func (m *PublicIndirectBulkAcceptVersionedPolicyResponse) Unpack() (*legalclientmodels.AcceptAgreementResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
