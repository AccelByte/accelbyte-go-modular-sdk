...
type RetrieveAgreementsPublicResponse struct {
...
func (m *RetrieveAgreementsPublicResponse) Unpack() ([]*legalclientmodels.RetrieveAcceptedAgreementResponse, *legalclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
