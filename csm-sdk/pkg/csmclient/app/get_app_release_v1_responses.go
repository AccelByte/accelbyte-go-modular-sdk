...
type GetAppReleaseV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedGetAppReleaseV1Response
...
func (m *GetAppReleaseV1Response) Unpack() (*csmclientmodels.GeneratedGetAppReleaseV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
