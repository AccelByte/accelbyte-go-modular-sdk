...
type GetAppListV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedGetAppListV1Response
...
func (m *GetAppListV1Response) Unpack() (*csmclientmodels.GeneratedGetAppListV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
