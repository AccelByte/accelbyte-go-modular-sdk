...
type UpdateAppV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedUpdateAppV1Response
...
func (m *UpdateAppV1Response) Unpack() (*csmclientmodels.GeneratedUpdateAppV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
