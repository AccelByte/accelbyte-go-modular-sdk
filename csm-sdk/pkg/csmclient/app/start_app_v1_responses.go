...
type StartAppV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedStartAppV1Response
...
func (m *StartAppV1Response) Unpack() (*csmclientmodels.GeneratedStartAppV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
