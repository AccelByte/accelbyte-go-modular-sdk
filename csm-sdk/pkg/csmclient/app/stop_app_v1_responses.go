...
type StopAppV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedStopAppV1Response
...
func (m *StopAppV1Response) Unpack() (*csmclientmodels.GeneratedStopAppV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
