...
type CreateAppV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedCreateAppV1Response
...
func (m *CreateAppV1Response) Unpack() (*csmclientmodels.GeneratedCreateAppV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
