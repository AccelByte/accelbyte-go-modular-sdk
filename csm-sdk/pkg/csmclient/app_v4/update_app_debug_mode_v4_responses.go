...
type UpdateAppDebugModeV4Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelAppItem
...
func (m *UpdateAppDebugModeV4Response) Unpack() (*csmclientmodels.ApimodelAppItem, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
