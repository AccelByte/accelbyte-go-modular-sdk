...
type GetAppDebugInfoV4Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelAppDebugInfoResponse
...
func (m *GetAppDebugInfoV4Response) Unpack() (*csmclientmodels.ApimodelAppDebugInfoResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
