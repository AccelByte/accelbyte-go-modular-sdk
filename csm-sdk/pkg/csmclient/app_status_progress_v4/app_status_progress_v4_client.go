...
type ClientService interface {
	GetAppStatusProgressV4Short(params *GetAppStatusProgressV4Params, authInfo runtime.ClientAuthInfoWriter) (*GetAppStatusProgressV4Response, error)
...
*/
func (a *Client) GetAppStatusProgressV4Short(params *GetAppStatusProgressV4Params, authInfo runtime.ClientAuthInfoWriter) (*GetAppStatusProgressV4Response, error) {
	...
	case *GetAppStatusProgressV4OK:
		response := &GetAppStatusProgressV4Response{}
