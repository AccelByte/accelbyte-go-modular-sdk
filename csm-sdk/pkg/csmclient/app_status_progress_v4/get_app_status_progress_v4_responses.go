...
type GetAppStatusProgressV4Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelGetAppStatusProgressResponse
...
func (m *GetAppStatusProgressV4Response) Unpack() (*csmclientmodels.ApimodelGetAppStatusProgressResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
