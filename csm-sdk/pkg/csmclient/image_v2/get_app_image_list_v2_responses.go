...
type GetAppImageListV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelGetAppImageListV2Response
...
func (m *GetAppImageListV2Response) Unpack() (*csmclientmodels.ApimodelGetAppImageListV2Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
