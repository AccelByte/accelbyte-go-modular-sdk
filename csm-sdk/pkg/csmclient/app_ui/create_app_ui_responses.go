...
type CreateAppUIResponse struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelAppUIResponse
...
func (m *CreateAppUIResponse) Unpack() (*csmclientmodels.ApimodelAppUIResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
