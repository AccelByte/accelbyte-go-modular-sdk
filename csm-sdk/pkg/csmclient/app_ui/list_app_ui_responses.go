...
type ListAppUIResponse struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelListAppUIResponse

	Error400 *csmclientmodels.ResponseErrorResponse
	Error500 *csmclientmodels.ResponseErrorResponse
}

func (m *ListAppUIResponse) Unpack() (*csmclientmodels.ApimodelListAppUIResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
