...
// NewCreateAppUIParams creates a new CreateAppUIParams object
// with the default values initialized.
func NewCreateAppUIParams() *CreateAppUIParams {
	var ()
	return &CreateAppUIParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateAppUIParamsWithTimeout creates a new CreateAppUIParams object
...
// NewCreateAppUIParamsWithContext creates a new CreateAppUIParams object
...
// NewCreateAppUIParamsWithHTTPClient creates a new CreateAppUIParams object
...
/*
CreateAppUIParams contains all the parameters to send to the API endpoint
for the create app ui operation typically these are written to a http.Request
*/
...
func (o *CreateAppUIParams) WithBody(body *csmclientmodels.ApimodelCreateAppUIRequest) *CreateAppUIParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create app ui params
func (o *CreateAppUIParams) SetBody(body *csmclientmodels.ApimodelCreateAppUIRequest) {
	o.Body = body
}
