...
type GetListOfDeploymentV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelGetDeploymentListV2Response
...
func (m *GetListOfDeploymentV2Response) Unpack() (*csmclientmodels.ApimodelGetDeploymentListV2Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
