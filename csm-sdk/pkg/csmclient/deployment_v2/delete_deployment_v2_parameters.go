...
// NewDeleteDeploymentV2Params creates a new DeleteDeploymentV2Params object
// with the default values initialized.
func NewDeleteDeploymentV2Params() *DeleteDeploymentV2Params {
	var ()
	return &DeleteDeploymentV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteDeploymentV2ParamsWithTimeout creates a new DeleteDeploymentV2Params object
...
// NewDeleteDeploymentV2ParamsWithContext creates a new DeleteDeploymentV2Params object
...
// NewDeleteDeploymentV2ParamsWithHTTPClient creates a new DeleteDeploymentV2Params object
...
/*
DeleteDeploymentV2Params contains all the parameters to send to the API endpoint
for the delete deployment v2 operation typically these are written to a http.Request
*/
...
func (o *DeleteDeploymentV2Params) WithTimeout(timeout time.Duration) *DeleteDeploymentV2Params {
...
func (o *DeleteDeploymentV2Params) WithContext(ctx context.Context) *DeleteDeploymentV2Params {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteDeploymentV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
