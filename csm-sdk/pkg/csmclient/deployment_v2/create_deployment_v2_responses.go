...
type CreateDeploymentV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelCreateDeploymentV2Response
...
func (m *CreateDeploymentV2Response) Unpack() (*csmclientmodels.ApimodelCreateDeploymentV2Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
