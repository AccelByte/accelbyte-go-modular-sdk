...
type UpdateNoSQLClusterV2Response struct {
...
func (m *UpdateNoSQLClusterV2Response) Unpack() (*csmclientmodels.ApimodelNoSQLResourceResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
