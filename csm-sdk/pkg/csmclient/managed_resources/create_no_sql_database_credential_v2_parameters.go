...
// NewCreateNoSQLDatabaseCredentialV2Params creates a new CreateNoSQLDatabaseCredentialV2Params object
// with the default values initialized.
func NewCreateNoSQLDatabaseCredentialV2Params() *CreateNoSQLDatabaseCredentialV2Params {
	var ()
	return &CreateNoSQLDatabaseCredentialV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateNoSQLDatabaseCredentialV2ParamsWithTimeout creates a new CreateNoSQLDatabaseCredentialV2Params object
...
// NewCreateNoSQLDatabaseCredentialV2ParamsWithContext creates a new CreateNoSQLDatabaseCredentialV2Params object
...
// NewCreateNoSQLDatabaseCredentialV2ParamsWithHTTPClient creates a new CreateNoSQLDatabaseCredentialV2Params object
...
/*
CreateNoSQLDatabaseCredentialV2Params contains all the parameters to send to the API endpoint
for the create no sql database credential v2 operation typically these are written to a http.Request
*/
