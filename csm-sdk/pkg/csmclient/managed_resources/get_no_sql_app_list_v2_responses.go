...
type GetNoSQLAppListV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelNoSQLAppListResponse
...
func (m *GetNoSQLAppListV2Response) Unpack() (*csmclientmodels.ApimodelNoSQLAppListResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
