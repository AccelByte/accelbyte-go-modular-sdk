...
type CreateNewNoSQLDatabaseCredentialV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelNoSQLDatabaseCredentialResponse
	...
	Error409 *csmclientmodels.ResponseErrorResponse
	Error500 *csmclientmodels.ResponseErrorResponse
	Error503 *csmclientmodels.ResponseErrorResponse
}

func (m *CreateNewNoSQLDatabaseCredentialV2Response) Unpack() (*csmclientmodels.ApimodelNoSQLDatabaseCredentialResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
