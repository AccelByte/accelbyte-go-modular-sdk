...
type GetNoSQLAccessTunnelV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelTunnelInfoResponse
...
func (m *GetNoSQLAccessTunnelV2Response) Unpack() (*csmclientmodels.ApimodelTunnelInfoResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
