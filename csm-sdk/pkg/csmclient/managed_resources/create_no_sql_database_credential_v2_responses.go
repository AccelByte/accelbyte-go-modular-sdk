...
type CreateNoSQLDatabaseCredentialV2Response struct {
...
func (m *CreateNoSQLDatabaseCredentialV2Response) Unpack() (*csmclientmodels.ApimodelNoSQLDatabaseCredentialResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
