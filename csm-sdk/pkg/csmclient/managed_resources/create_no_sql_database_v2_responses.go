...
type CreateNoSQLDatabaseV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelNoSQLDatabaseResponse
...
func (m *CreateNoSQLDatabaseV2Response) Unpack() (*csmclientmodels.ApimodelNoSQLDatabaseResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
