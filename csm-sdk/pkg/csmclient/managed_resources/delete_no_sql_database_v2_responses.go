...
type DeleteNoSQLDatabaseV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelNoSQLDatabaseDeleteResponse
...
func (m *DeleteNoSQLDatabaseV2Response) Unpack() (*csmclientmodels.ApimodelNoSQLDatabaseDeleteResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
