...
type DeleteNoSQLClusterV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelDeleteNoSQLResourceResponse
...
func (m *DeleteNoSQLClusterV2Response) Unpack() (*csmclientmodels.ApimodelDeleteNoSQLResourceResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
