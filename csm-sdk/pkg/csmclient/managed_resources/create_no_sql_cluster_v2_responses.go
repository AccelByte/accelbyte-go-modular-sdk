...
type CreateNoSQLClusterV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelNoSQLResourceResponse
...
func (m *CreateNoSQLClusterV2Response) Unpack() (*csmclientmodels.ApimodelNoSQLResourceResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
