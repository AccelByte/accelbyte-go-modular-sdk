...
type CreateSQLDatabaseV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelSQLDatabaseResponse
...
func (m *CreateSQLDatabaseV2Response) Unpack() (*csmclientmodels.ApimodelSQLDatabaseResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
