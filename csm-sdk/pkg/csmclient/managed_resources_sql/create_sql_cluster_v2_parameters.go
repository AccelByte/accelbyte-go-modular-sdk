...
// NewCreateSQLClusterV2Params creates a new CreateSQLClusterV2Params object
// with the default values initialized.
func NewCreateSQLClusterV2Params() *CreateSQLClusterV2Params {
	var ()
	return &CreateSQLClusterV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateSQLClusterV2ParamsWithTimeout creates a new CreateSQLClusterV2Params object
...
// NewCreateSQLClusterV2ParamsWithContext creates a new CreateSQLClusterV2Params object
...
// NewCreateSQLClusterV2ParamsWithHTTPClient creates a new CreateSQLClusterV2Params object
...
/*
CreateSQLClusterV2Params contains all the parameters to send to the API endpoint
for the create sql cluster v2 operation typically these are written to a http.Request
*/
...
func (o *CreateSQLClusterV2Params) WithTimeout(timeout time.Duration) *CreateSQLClusterV2Params {
...
func (o *CreateSQLClusterV2Params) WithContext(ctx context.Context) *CreateSQLClusterV2Params {
	o.SetContext(ctx)
	return o
}
...
func (o *CreateSQLClusterV2Params) WithBody(body *csmclientmodels.SqlresourceSQLResourceConfiguration) *CreateSQLClusterV2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create sql cluster v2 params
func (o *CreateSQLClusterV2Params) SetBody(body *csmclientmodels.SqlresourceSQLResourceConfiguration) {
	o.Body = body
}
...
func (o *CreateSQLClusterV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
