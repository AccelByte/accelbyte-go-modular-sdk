...
type DeleteSQLDatabaseV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelSQLDatabaseDeleteResponse
...
func (m *DeleteSQLDatabaseV2Response) Unpack() (*csmclientmodels.ApimodelSQLDatabaseDeleteResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
