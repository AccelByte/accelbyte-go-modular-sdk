...
type UpdateSQLClusterV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelSQLResourceResponse
...
func (m *UpdateSQLClusterV2Response) Unpack() (*csmclientmodels.ApimodelSQLResourceResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
