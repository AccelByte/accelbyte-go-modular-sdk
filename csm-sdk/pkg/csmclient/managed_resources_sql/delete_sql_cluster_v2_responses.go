...
type DeleteSQLClusterV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelDeleteSQLResourceResponse
...
func (m *DeleteSQLClusterV2Response) Unpack() (*csmclientmodels.ApimodelDeleteSQLResourceResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
