...
type GetSQLAppListV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelSQLAppListResponse
...
func (m *GetSQLAppListV2Response) Unpack() (*csmclientmodels.ApimodelSQLAppListResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
