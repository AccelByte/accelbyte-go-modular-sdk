...
// NewGetSQLDatabaseV2Params creates a new GetSQLDatabaseV2Params object
// with the default values initialized.
func NewGetSQLDatabaseV2Params() *GetSQLDatabaseV2Params {
	var ()
	return &GetSQLDatabaseV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetSQLDatabaseV2ParamsWithTimeout creates a new GetSQLDatabaseV2Params object
...
// NewGetSQLDatabaseV2ParamsWithContext creates a new GetSQLDatabaseV2Params object
...
// NewGetSQLDatabaseV2ParamsWithHTTPClient creates a new GetSQLDatabaseV2Params object
...
/*
GetSQLDatabaseV2Params contains all the parameters to send to the API endpoint
for the get sql database v2 operation typically these are written to a http.Request
*/
...
func (o *GetSQLDatabaseV2Params) WithTimeout(timeout time.Duration) *GetSQLDatabaseV2Params {
...
func (o *GetSQLDatabaseV2Params) WithContext(ctx context.Context) *GetSQLDatabaseV2Params {
	o.SetContext(ctx)
	return o
}
...
func (o *GetSQLDatabaseV2Params) WithApp(app string) *GetSQLDatabaseV2Params {
	o.SetApp(app)
	return o
}
...
func (o *GetSQLDatabaseV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
