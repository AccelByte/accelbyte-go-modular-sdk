...
// NewCreateSQLDatabaseV2Params creates a new CreateSQLDatabaseV2Params object
// with the default values initialized.
func NewCreateSQLDatabaseV2Params() *CreateSQLDatabaseV2Params {
	var ()
	return &CreateSQLDatabaseV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateSQLDatabaseV2ParamsWithTimeout creates a new CreateSQLDatabaseV2Params object
...
// NewCreateSQLDatabaseV2ParamsWithContext creates a new CreateSQLDatabaseV2Params object
...
// NewCreateSQLDatabaseV2ParamsWithHTTPClient creates a new CreateSQLDatabaseV2Params object
...
/*
CreateSQLDatabaseV2Params contains all the parameters to send to the API endpoint
for the create sql database v2 operation typically these are written to a http.Request
*/
...
func (o *CreateSQLDatabaseV2Params) WithTimeout(timeout time.Duration) *CreateSQLDatabaseV2Params {
...
func (o *CreateSQLDatabaseV2Params) WithContext(ctx context.Context) *CreateSQLDatabaseV2Params {
	o.SetContext(ctx)
	return o
}
...
func (o *CreateSQLDatabaseV2Params) WithBody(body *csmclientmodels.ApimodelCreateSQLAppDatabaseRequest) *CreateSQLDatabaseV2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create sql database v2 params
func (o *CreateSQLDatabaseV2Params) SetBody(body *csmclientmodels.ApimodelCreateSQLAppDatabaseRequest) {
	o.Body = body
}

// WithApp adds the app to the create sql database v2 params
func (o *CreateSQLDatabaseV2Params) WithApp(app string) *CreateSQLDatabaseV2Params {
	o.SetApp(app)
	return o
}
...
func (o *CreateSQLDatabaseV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
