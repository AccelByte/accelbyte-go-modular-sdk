...
type CreateSQLDatabaseCredentialV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelSQLDatabaseCredentialResponse
...
func (m *CreateSQLDatabaseCredentialV2Response) Unpack() (*csmclientmodels.ApimodelSQLDatabaseCredentialResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
