...
type GetAppImageListV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedGetAppImageListV1Response
...
func (m *GetAppImageListV1Response) Unpack() (*csmclientmodels.GeneratedGetAppImageListV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
