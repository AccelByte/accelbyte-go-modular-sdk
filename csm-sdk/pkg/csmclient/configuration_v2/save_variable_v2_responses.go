...
type SaveVariableV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelSaveConfigurationV2Response
...
func (m *SaveVariableV2Response) Unpack() (*csmclientmodels.ApimodelSaveConfigurationV2Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
