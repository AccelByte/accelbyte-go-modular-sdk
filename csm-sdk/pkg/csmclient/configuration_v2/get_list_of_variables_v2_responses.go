...
type GetListOfVariablesV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelGetListOfConfigurationsV2Response
...
func (m *GetListOfVariablesV2Response) Unpack() (*csmclientmodels.ApimodelGetListOfConfigurationsV2Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
