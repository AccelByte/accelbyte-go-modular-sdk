...
type GetListOfSecretsV2Response struct {
...
func (m *GetListOfSecretsV2Response) Unpack() (*csmclientmodels.ApimodelGetListOfConfigurationsV2Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
