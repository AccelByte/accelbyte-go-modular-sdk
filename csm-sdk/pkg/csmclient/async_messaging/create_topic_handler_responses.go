...
type CreateTopicHandlerResponse struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelTopicResponse
...
func (m *CreateTopicHandlerResponse) Unpack() (*csmclientmodels.ApimodelTopicResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
