...
type UnsubscribeTopicHandlerResponse struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelTopicSubscription
...
func (m *UnsubscribeTopicHandlerResponse) Unpack() (*csmclientmodels.ApimodelTopicSubscription, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
