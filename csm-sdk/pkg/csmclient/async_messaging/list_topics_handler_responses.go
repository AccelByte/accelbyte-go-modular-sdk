...
type ListTopicsHandlerResponse struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelListTopicsResponse
...
func (m *ListTopicsHandlerResponse) Unpack() (*csmclientmodels.ApimodelListTopicsResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
