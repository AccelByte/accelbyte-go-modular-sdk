...
// NewUpdateAppResourcesV2Params creates a new UpdateAppResourcesV2Params object
// with the default values initialized.
func NewUpdateAppResourcesV2Params() *UpdateAppResourcesV2Params {
	var ()
	return &UpdateAppResourcesV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateAppResourcesV2ParamsWithTimeout creates a new UpdateAppResourcesV2Params object
...
// NewUpdateAppResourcesV2ParamsWithContext creates a new UpdateAppResourcesV2Params object
...
// NewUpdateAppResourcesV2ParamsWithHTTPClient creates a new UpdateAppResourcesV2Params object
...
/*UpdateAppResourcesV2Params contains all the parameters to send to the API endpoint
for the update app resources v2 operation typically these are written to a http.Request
*/
...
func (o *UpdateAppResourcesV2Params) WithTimeout(timeout time.Duration) *UpdateAppResourcesV2Params {
...
func (o *UpdateAppResourcesV2Params) WithContext(ctx context.Context) *UpdateAppResourcesV2Params {
	o.SetContext(ctx)
	return o
}
...
func (o *UpdateAppResourcesV2Params) WithHTTPClient(client *http.Client) *UpdateAppResourcesV2Params {
...
func (o *UpdateAppResourcesV2Params) WithBody(body *csmclientmodels.ApimodelUpdateAppResourceRequest) *UpdateAppResourcesV2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update app resources v2 params
func (o *UpdateAppResourcesV2Params) SetBody(body *csmclientmodels.ApimodelUpdateAppResourceRequest) {
	o.Body = body
}

// WithApp adds the app to the update app resources v2 params
func (o *UpdateAppResourcesV2Params) WithApp(app string) *UpdateAppResourcesV2Params {
	o.SetApp(app)
	return o
}
...
func (o *UpdateAppResourcesV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
