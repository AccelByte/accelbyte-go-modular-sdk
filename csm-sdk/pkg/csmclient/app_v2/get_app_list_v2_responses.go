...
type GetAppListV2Response struct {
	...
	Data *csmclientmodels.ApimodelGetAppListV2Response
...
func (m *GetAppListV2Response) Unpack() (*csmclientmodels.ApimodelGetAppListV2Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
