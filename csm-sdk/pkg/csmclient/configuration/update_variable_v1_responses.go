...
type UpdateVariableV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedUpdateConfigurationV1Response
...
func (m *UpdateVariableV1Response) Unpack() (*csmclientmodels.GeneratedUpdateConfigurationV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
