...
type GetListOfVariablesV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedGetListOfConfigurationsV1Response
...
func (m *GetListOfVariablesV1Response) Unpack() (*csmclientmodels.GeneratedGetListOfConfigurationsV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
