...
type GetListOfSecretsV1Response struct {
...
func (m *GetListOfSecretsV1Response) Unpack() (*csmclientmodels.GeneratedGetListOfConfigurationsV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
