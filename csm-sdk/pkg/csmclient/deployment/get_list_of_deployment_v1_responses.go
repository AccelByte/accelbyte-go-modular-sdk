...
type GetListOfDeploymentV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedGetDeploymentListV1Response
...
func (m *GetListOfDeploymentV1Response) Unpack() (*csmclientmodels.GeneratedGetDeploymentListV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
