...
type GetDeploymentV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedGetDeploymentV1Response
...
func (m *GetDeploymentV1Response) Unpack() (*csmclientmodels.GeneratedGetDeploymentV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
