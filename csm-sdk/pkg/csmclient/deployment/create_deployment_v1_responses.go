...
type CreateDeploymentV1Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.GeneratedCreateDeploymentV1Response
...
func (m *CreateDeploymentV1Response) Unpack() (*csmclientmodels.GeneratedCreateDeploymentV1Response, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
