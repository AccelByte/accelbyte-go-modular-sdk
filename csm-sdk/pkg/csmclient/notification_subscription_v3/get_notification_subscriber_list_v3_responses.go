...
type GetNotificationSubscriberListV3Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelGetNotificationSubscriberListResponseV2
...
func (m *GetNotificationSubscriberListV3Response) Unpack() (*csmclientmodels.ApimodelGetNotificationSubscriberListResponseV2, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
