...
type CreateAppV5Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelAppItemV5
...
func (m *CreateAppV5Response) Unpack() (*csmclientmodels.ApimodelAppItemV5, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
