...
type ClientService interface {
	CreateAppV5Short(params *CreateAppV5Params, authInfo runtime.ClientAuthInfoWriter) (*CreateAppV5Response, error)
...
- `app-remove-timeout`
*/
func (a *Client) CreateAppV5Short(params *CreateAppV5Params, authInfo runtime.ClientAuthInfoWriter) (*CreateAppV5Response, error) {
