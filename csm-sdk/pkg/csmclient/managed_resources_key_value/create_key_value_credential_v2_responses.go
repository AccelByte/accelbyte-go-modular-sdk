...
type CreateKeyValueCredentialV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelCreateKeyValueCredentialResponse
...
func (m *CreateKeyValueCredentialV2Response) Unpack() (*csmclientmodels.ApimodelCreateKeyValueCredentialResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
