...
type ListKeyValueClusterV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelKeyValueResourceListResponse
...
func (m *ListKeyValueClusterV2Response) Unpack() (*csmclientmodels.ApimodelKeyValueResourceListResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
