...
type GetListIntegratedAppKeyValueClusterV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelListIntegratedAppsKeyValueResponse
...
func (m *GetListIntegratedAppKeyValueClusterV2Response) Unpack() (*csmclientmodels.ApimodelListIntegratedAppsKeyValueResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
