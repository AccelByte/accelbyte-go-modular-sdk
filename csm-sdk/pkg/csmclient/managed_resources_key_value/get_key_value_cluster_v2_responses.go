...
type GetKeyValueClusterV2Response struct {
...
func (m *GetKeyValueClusterV2Response) Unpack() (*csmclientmodels.ApimodelKeyValueResourceResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
