...
type CreateKeyValueClusterV2Response struct {
...
func (m *CreateKeyValueClusterV2Response) Unpack() (*csmclientmodels.ApimodelKeyValueResourceResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
