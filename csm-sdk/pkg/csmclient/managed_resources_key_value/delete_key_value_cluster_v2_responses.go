...
type DeleteKeyValueClusterV2Response struct {
...
func (m *DeleteKeyValueClusterV2Response) Unpack() (*csmclientmodels.ApimodelKeyValueResourceResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
