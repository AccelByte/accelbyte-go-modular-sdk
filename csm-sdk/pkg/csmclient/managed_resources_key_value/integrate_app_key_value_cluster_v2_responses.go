...
type IntegrateAppKeyValueClusterV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelIntegrateAppKeyValueResponse
...
func (m *IntegrateAppKeyValueClusterV2Response) Unpack() (*csmclientmodels.ApimodelIntegrateAppKeyValueResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
