...
type GetKeyValueClusterLimitConfigV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.DomainKeyValueClusterConfig
...
func (m *GetKeyValueClusterLimitConfigV2Response) Unpack() (*csmclientmodels.DomainKeyValueClusterConfig, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
