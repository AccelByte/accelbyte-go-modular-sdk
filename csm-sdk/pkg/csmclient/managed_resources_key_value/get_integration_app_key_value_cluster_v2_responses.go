...
type GetIntegrationAppKeyValueClusterV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelGetIntegrationAppKeyValueResponse
...
func (m *GetIntegrationAppKeyValueClusterV2Response) Unpack() (*csmclientmodels.ApimodelGetIntegrationAppKeyValueResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
