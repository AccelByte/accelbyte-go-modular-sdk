...
// NewGetIntegrationAppKeyValueClusterV2Params creates a new GetIntegrationAppKeyValueClusterV2Params object
// with the default values initialized.
func NewGetIntegrationAppKeyValueClusterV2Params() *GetIntegrationAppKeyValueClusterV2Params {
	var ()
	return &GetIntegrationAppKeyValueClusterV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetIntegrationAppKeyValueClusterV2ParamsWithTimeout creates a new GetIntegrationAppKeyValueClusterV2Params object
...
// NewGetIntegrationAppKeyValueClusterV2ParamsWithContext creates a new GetIntegrationAppKeyValueClusterV2Params object
...
// NewGetIntegrationAppKeyValueClusterV2ParamsWithHTTPClient creates a new GetIntegrationAppKeyValueClusterV2Params object
...
/*
GetIntegrationAppKeyValueClusterV2Params contains all the parameters to send to the API endpoint
for the get integration app key value cluster v2 operation typically these are written to a http.Request
*/
...
func (o *GetIntegrationAppKeyValueClusterV2Params) WithTimeout(timeout time.Duration) *GetIntegrationAppKeyValueClusterV2Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get integration app key value cluster v2 params
func (o *GetIntegrationAppKeyValueClusterV2Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get integration app key value cluster v2 params
func (o *GetIntegrationAppKeyValueClusterV2Params) WithContext(ctx context.Context) *GetIntegrationAppKeyValueClusterV2Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get integration app key value cluster v2 params
func (o *GetIntegrationAppKeyValueClusterV2Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *GetIntegrationAppKeyValueClusterV2Params) WithHTTPClient(client *http.Client) *GetIntegrationAppKeyValueClusterV2Params {
...
func (o *GetIntegrationAppKeyValueClusterV2Params) WithApp(app string) *GetIntegrationAppKeyValueClusterV2Params {
	o.SetApp(app)
	return o
}

// SetApp adds the app to the get integration app key value cluster v2 params
func (o *GetIntegrationAppKeyValueClusterV2Params) SetApp(app string) {
	o.App = app
}

// WithNamespace adds the namespace to the get integration app key value cluster v2 params
func (o *GetIntegrationAppKeyValueClusterV2Params) WithNamespace(namespace string) *GetIntegrationAppKeyValueClusterV2Params {
...
func (o *GetIntegrationAppKeyValueClusterV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
