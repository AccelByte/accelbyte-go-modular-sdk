...
type DeleteSubscriptionAppNotificationByUserIDV2Response struct {
...
func (m *DeleteSubscriptionAppNotificationByUserIDV2Response) Unpack() *csmclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
