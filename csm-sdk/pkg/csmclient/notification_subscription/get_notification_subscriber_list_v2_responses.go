...
type GetNotificationSubscriberListV2Response struct {
...
func (m *GetNotificationSubscriberListV2Response) Unpack() (*csmclientmodels.ApimodelGetNotificationSubscriberListResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
