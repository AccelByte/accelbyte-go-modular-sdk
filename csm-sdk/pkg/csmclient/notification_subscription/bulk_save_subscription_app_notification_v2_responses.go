...
type BulkSaveSubscriptionAppNotificationV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelGetNotificationSubscriberListResponse
...
func (m *BulkSaveSubscriptionAppNotificationV2Response) Unpack() (*csmclientmodels.ApimodelGetNotificationSubscriberListResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
