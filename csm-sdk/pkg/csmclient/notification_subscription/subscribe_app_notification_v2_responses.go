...
type SubscribeAppNotificationV2Response struct {
	csmclientmodels.ApiResponse
	Data *csmclientmodels.ApimodelSubscribeNotificationResponse
...
func (m *SubscribeAppNotificationV2Response) Unpack() (*csmclientmodels.ApimodelSubscribeNotificationResponse, *csmclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
