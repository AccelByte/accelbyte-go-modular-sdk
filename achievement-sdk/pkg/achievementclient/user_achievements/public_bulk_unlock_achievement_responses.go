...
type PublicBulkUnlockAchievementResponse struct {
	achievementclientmodels.ApiResponse
	Data []*achievementclientmodels.ModelsBulkUnlockAchievementResponse
...
func (m *PublicBulkUnlockAchievementResponse) Unpack() ([]*achievementclientmodels.ModelsBulkUnlockAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
