...
type PublicListUserAchievementsResponse struct {
...
func (m *PublicListUserAchievementsResponse) Unpack() (*achievementclientmodels.ModelsPaginatedUserAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
