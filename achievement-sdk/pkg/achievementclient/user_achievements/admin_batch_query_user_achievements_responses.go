...
type AdminBatchQueryUserAchievementsResponse struct {
	achievementclientmodels.ApiResponse
	Data []*achievementclientmodels.ModelsUserAchievementResponse

	Error400 *achievementclientmodels.ResponseError
	Error401 *achievementclientmodels.ResponseError
}

func (m *AdminBatchQueryUserAchievementsResponse) Unpack() ([]*achievementclientmodels.ModelsUserAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
