...
type AdminBulkUnlockAchievementResponse struct {
...
func (m *AdminBulkUnlockAchievementResponse) Unpack() ([]*achievementclientmodels.ModelsBulkUnlockAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
