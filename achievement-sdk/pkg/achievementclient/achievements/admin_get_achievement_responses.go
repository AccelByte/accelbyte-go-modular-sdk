...
type AdminGetAchievementResponse struct {
...
func (m *AdminGetAchievementResponse) Unpack() (*achievementclientmodels.ModelsAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
