...
type PublicGetAchievementResponse struct {
	achievementclientmodels.ApiResponse
	Data *achievementclientmodels.ModelsPublicAchievementResponse
...
func (m *PublicGetAchievementResponse) Unpack() (*achievementclientmodels.ModelsPublicAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
