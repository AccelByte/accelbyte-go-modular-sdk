...
type AdminCreateNewAchievementResponse struct {
...
func (m *AdminCreateNewAchievementResponse) Unpack() (*achievementclientmodels.ModelsAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
