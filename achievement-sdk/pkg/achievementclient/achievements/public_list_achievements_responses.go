...
type PublicListAchievementsResponse struct {
	achievementclientmodels.ApiResponse
	Data *achievementclientmodels.ModelsPublicAchievementsResponse
...
func (m *PublicListAchievementsResponse) Unpack() (*achievementclientmodels.ModelsPublicAchievementsResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
