...
type AdminListAchievementsResponse struct {
	...
	Data *achievementclientmodels.ModelsPaginatedAchievementResponse
...
func (m *AdminListAchievementsResponse) Unpack() (*achievementclientmodels.ModelsPaginatedAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
