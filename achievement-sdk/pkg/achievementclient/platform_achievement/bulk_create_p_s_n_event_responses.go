...
type BulkCreatePSNEventResponse struct {
	achievementclientmodels.ApiResponse
	Data *achievementclientmodels.ModelsBulkCreatePSNEventResponse
...
func (m *BulkCreatePSNEventResponse) Unpack() (*achievementclientmodels.ModelsBulkCreatePSNEventResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
