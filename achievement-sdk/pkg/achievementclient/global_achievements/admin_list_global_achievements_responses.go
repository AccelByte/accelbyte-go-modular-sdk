...
type AdminListGlobalAchievementsResponse struct {
...
func (m *AdminListGlobalAchievementsResponse) Unpack() (*achievementclientmodels.ModelsPaginatedGlobalAchievementResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
