...
type AdminListUserContributionsResponse struct {
...
func (m *AdminListUserContributionsResponse) Unpack() (*achievementclientmodels.ModelsPaginatedUserContributionResponse, *achievementclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
