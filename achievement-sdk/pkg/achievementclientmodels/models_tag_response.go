...
func (m *ModelsTagResponse) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *ModelsTagResponse) validateName(formats strfmt.Registry) error {
...
func (m *ModelsTagResponse) validateNamespace(formats strfmt.Registry) error {
