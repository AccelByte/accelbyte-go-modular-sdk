...
func (m *ModelsPaginatedTagResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedTagResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedTagResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPaginatedTagResponse
