...
func (m *ModelsPublicAchievementsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsPublicAchievementsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPublicAchievementsResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPublicAchievementsResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPublicAchievementsResponse
