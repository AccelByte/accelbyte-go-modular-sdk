...
func (m *ModelsPaginatedContributorResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsPaginatedContributorResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedContributorResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedContributorResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPaginatedContributorResponse
