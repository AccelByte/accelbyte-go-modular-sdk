...
func (m *ModelListPeriodsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelListPeriodsResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelListPeriodsResponse) UnmarshalBinary(b []byte) error {
	var res ModelListPeriodsResponse
