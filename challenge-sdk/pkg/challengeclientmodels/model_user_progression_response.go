...
func (m *ModelUserProgressionResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelUserProgressionResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *ModelUserProgressionResponse) UnmarshalBinary(b []byte) error {
	var res ModelUserProgressionResponse
