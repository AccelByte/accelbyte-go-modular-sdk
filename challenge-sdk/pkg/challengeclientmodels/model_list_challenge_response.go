...
func (m *ModelListChallengeResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelListChallengeResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelListChallengeResponse) UnmarshalBinary(b []byte) error {
	var res ModelListChallengeResponse
