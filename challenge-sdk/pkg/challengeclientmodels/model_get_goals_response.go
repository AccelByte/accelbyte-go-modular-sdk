...
func (m *ModelGetGoalsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelGetGoalsResponse) validatePaging(formats strfmt.Registry) error {
