...
func (m *ModelListUserRewardsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelListUserRewardsResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelListUserRewardsResponse) UnmarshalBinary(b []byte) error {
	var res ModelListUserRewardsResponse
