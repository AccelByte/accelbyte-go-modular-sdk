...
type PublicListSchedulesResponse struct {
	challengeclientmodels.ApiResponse
	Data *challengeclientmodels.ModelListSchedulesResponse
...
func (m *PublicListSchedulesResponse) Unpack() (*challengeclientmodels.ModelListSchedulesResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
