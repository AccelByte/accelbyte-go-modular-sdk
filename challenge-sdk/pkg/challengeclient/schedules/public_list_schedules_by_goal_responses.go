...
type PublicListSchedulesByGoalResponse struct {
	challengeclientmodels.ApiResponse
	Data *challengeclientmodels.ModelListScheduleByGoalResponse
...
func (m *PublicListSchedulesByGoalResponse) Unpack() (*challengeclientmodels.ModelListScheduleByGoalResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
