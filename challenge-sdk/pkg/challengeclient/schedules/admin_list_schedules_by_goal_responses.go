...
type AdminListSchedulesByGoalResponse struct {
...
func (m *AdminListSchedulesByGoalResponse) Unpack() (*challengeclientmodels.ModelListScheduleByGoalResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
