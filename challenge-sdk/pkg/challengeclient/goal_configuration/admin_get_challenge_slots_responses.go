...
type AdminGetChallengeSlotsResponse struct {
	challengeclientmodels.ApiResponse
	Data *challengeclientmodels.ModelGetSlotsResponse
...
func (m *AdminGetChallengeSlotsResponse) Unpack() (*challengeclientmodels.ModelGetSlotsResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
