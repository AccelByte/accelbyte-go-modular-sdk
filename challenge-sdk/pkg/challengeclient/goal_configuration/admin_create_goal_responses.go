...
type AdminCreateGoalResponse struct {
	challengeclientmodels.ApiResponse
	Data *challengeclientmodels.ModelGoalResponse
	...
	Error409 *challengeclientmodels.ResponseError
	Error422 *challengeclientmodels.IamErrorResponse
	Error500 *challengeclientmodels.ResponseError
}

func (m *AdminCreateGoalResponse) Unpack() (*challengeclientmodels.ModelGoalResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
