...
type PublicClaimUserRewardsByGoalCodeResponse struct {
...
func (m *PublicClaimUserRewardsByGoalCodeResponse) Unpack() ([]*challengeclientmodels.ModelUserReward, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
