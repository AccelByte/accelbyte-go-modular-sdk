...
type AdminClaimUserRewardsResponse struct {
...
func (m *AdminClaimUserRewardsResponse) Unpack() ([]*challengeclientmodels.ModelUserReward, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
