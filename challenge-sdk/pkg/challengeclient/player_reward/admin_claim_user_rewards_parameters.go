...
// NewAdminClaimUserRewardsParams creates a new AdminClaimUserRewardsParams object
// with the default values initialized.
func NewAdminClaimUserRewardsParams() *AdminClaimUserRewardsParams {
	var ()
	return &AdminClaimUserRewardsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminClaimUserRewardsParamsWithTimeout creates a new AdminClaimUserRewardsParams object
...
// NewAdminClaimUserRewardsParamsWithContext creates a new AdminClaimUserRewardsParams object
...
// NewAdminClaimUserRewardsParamsWithHTTPClient creates a new AdminClaimUserRewardsParams object
...
/*AdminClaimUserRewardsParams contains all the parameters to send to the API endpoint
for the admin claim user rewards operation typically these are written to a http.Request
*/
...
func (o *AdminClaimUserRewardsParams) WithTimeout(timeout time.Duration) *AdminClaimUserRewardsParams {
...
func (o *AdminClaimUserRewardsParams) WithContext(ctx context.Context) *AdminClaimUserRewardsParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AdminClaimUserRewardsParams) WithHTTPClient(client *http.Client) *AdminClaimUserRewardsParams {
...
func (o *AdminClaimUserRewardsParams) WithBody(body *challengeclientmodels.ModelClaimUserRewardsReq) *AdminClaimUserRewardsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the admin claim user rewards params
func (o *AdminClaimUserRewardsParams) SetBody(body *challengeclientmodels.ModelClaimUserRewardsReq) {
	o.Body = body
}
...
func (o *AdminClaimUserRewardsParams) WithUserID(userID string) *AdminClaimUserRewardsParams {
	o.SetUserID(userID)
	return o
}
...
func (o *AdminClaimUserRewardsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
