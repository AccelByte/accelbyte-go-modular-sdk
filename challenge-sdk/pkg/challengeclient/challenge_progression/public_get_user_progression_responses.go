...
type PublicGetUserProgressionResponse struct {
...
func (m *PublicGetUserProgressionResponse) Unpack() (*challengeclientmodels.ModelUserProgressionResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
