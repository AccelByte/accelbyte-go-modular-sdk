...
type AdminGetUserProgressionResponse struct {
...
func (m *AdminGetUserProgressionResponse) Unpack() (*challengeclientmodels.ModelUserProgressionResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
