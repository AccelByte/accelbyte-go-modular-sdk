...
type PublicGetChallengesResponse struct {
...
func (m *PublicGetChallengesResponse) Unpack() (*challengeclientmodels.ModelListChallengeResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *PublicGetChallengesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPublicGetChallengesOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 400:
		result := NewPublicGetChallengesBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 401:
		result := NewPublicGetChallengesUnauthorized()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 403:
		result := NewPublicGetChallengesForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 500:
		result := NewPublicGetChallengesInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func (o *PublicGetChallengesOK) Error() string {
	return fmt.Sprintf("[GET /challenge/v1/public/namespaces/{namespace}/challenges][%d] publicGetChallengesOK  %+v", 200, o.ToJSONString())
}
...
func (o *PublicGetChallengesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPublicGetChallengesBadRequest() *PublicGetChallengesBadRequest {
	return &PublicGetChallengesBadRequest{}
}
...
func (o *PublicGetChallengesBadRequest) Error() string {
	return fmt.Sprintf("[GET /challenge/v1/public/namespaces/{namespace}/challenges][%d] publicGetChallengesBadRequest  %+v", 400, o.ToJSONString())
}
...
func (o *PublicGetChallengesBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPublicGetChallengesUnauthorized() *PublicGetChallengesUnauthorized {
	return &PublicGetChallengesUnauthorized{}
}
...
func (o *PublicGetChallengesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /challenge/v1/public/namespaces/{namespace}/challenges][%d] publicGetChallengesUnauthorized  %+v", 401, o.ToJSONString())
}
...
func (o *PublicGetChallengesUnauthorized) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPublicGetChallengesForbidden() *PublicGetChallengesForbidden {
	return &PublicGetChallengesForbidden{}
}
...
func (o *PublicGetChallengesForbidden) Error() string {
	return fmt.Sprintf("[GET /challenge/v1/public/namespaces/{namespace}/challenges][%d] publicGetChallengesForbidden  %+v", 403, o.ToJSONString())
}
...
func (o *PublicGetChallengesForbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewPublicGetChallengesInternalServerError() *PublicGetChallengesInternalServerError {
	return &PublicGetChallengesInternalServerError{}
}
...
func (o *PublicGetChallengesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /challenge/v1/public/namespaces/{namespace}/challenges][%d] publicGetChallengesInternalServerError  %+v", 500, o.ToJSONString())
}
...
func (o *PublicGetChallengesInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
