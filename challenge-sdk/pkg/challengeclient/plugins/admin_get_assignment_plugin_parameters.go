...
// NewAdminGetAssignmentPluginParams creates a new AdminGetAssignmentPluginParams object
// with the default values initialized.
func NewAdminGetAssignmentPluginParams() *AdminGetAssignmentPluginParams {
	var ()
	return &AdminGetAssignmentPluginParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminGetAssignmentPluginParamsWithTimeout creates a new AdminGetAssignmentPluginParams object
...
// NewAdminGetAssignmentPluginParamsWithContext creates a new AdminGetAssignmentPluginParams object
...
// NewAdminGetAssignmentPluginParamsWithHTTPClient creates a new AdminGetAssignmentPluginParams object
...
func (o *AdminGetAssignmentPluginParams) WithTimeout(timeout time.Duration) *AdminGetAssignmentPluginParams {
...
func (o *AdminGetAssignmentPluginParams) WithContext(ctx context.Context) *AdminGetAssignmentPluginParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AdminGetAssignmentPluginParams) WithHTTPClient(client *http.Client) *AdminGetAssignmentPluginParams {
...
func (o *AdminGetAssignmentPluginParams) WithNamespace(namespace string) *AdminGetAssignmentPluginParams {
...
func (o *AdminGetAssignmentPluginParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
