...
type AdminUpdateAssignmentPluginResponse struct {
...
func (m *AdminUpdateAssignmentPluginResponse) Unpack() (*challengeclientmodels.ModelPluginAssignmentResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
