...
type AdminGetAssignmentPluginResponse struct {
...
func (m *AdminGetAssignmentPluginResponse) Unpack() (*challengeclientmodels.ModelPluginAssignmentResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
