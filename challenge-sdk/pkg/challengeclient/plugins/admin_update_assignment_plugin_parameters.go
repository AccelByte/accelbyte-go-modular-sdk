...
// NewAdminUpdateAssignmentPluginParams creates a new AdminUpdateAssignmentPluginParams object
// with the default values initialized.
func NewAdminUpdateAssignmentPluginParams() *AdminUpdateAssignmentPluginParams {
	var ()
	return &AdminUpdateAssignmentPluginParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminUpdateAssignmentPluginParamsWithTimeout creates a new AdminUpdateAssignmentPluginParams object
...
// NewAdminUpdateAssignmentPluginParamsWithContext creates a new AdminUpdateAssignmentPluginParams object
...
// NewAdminUpdateAssignmentPluginParamsWithHTTPClient creates a new AdminUpdateAssignmentPluginParams object
...
/*
AdminUpdateAssignmentPluginParams contains all the parameters to send to the API endpoint
for the admin update assignment plugin operation typically these are written to a http.Request
*/
...
func (o *AdminUpdateAssignmentPluginParams) WithTimeout(timeout time.Duration) *AdminUpdateAssignmentPluginParams {
...
func (o *AdminUpdateAssignmentPluginParams) WithContext(ctx context.Context) *AdminUpdateAssignmentPluginParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the admin update assignment plugin params
func (o *AdminUpdateAssignmentPluginParams) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *AdminUpdateAssignmentPluginParams) WithHTTPClient(client *http.Client) *AdminUpdateAssignmentPluginParams {
...
func (o *AdminUpdateAssignmentPluginParams) WithBody(body *challengeclientmodels.ModelPluginAssignmentRequest) *AdminUpdateAssignmentPluginParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the admin update assignment plugin params
func (o *AdminUpdateAssignmentPluginParams) SetBody(body *challengeclientmodels.ModelPluginAssignmentRequest) {
	o.Body = body
}

// WithNamespace adds the namespace to the admin update assignment plugin params
func (o *AdminUpdateAssignmentPluginParams) WithNamespace(namespace string) *AdminUpdateAssignmentPluginParams {
...
func (o *AdminUpdateAssignmentPluginParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
