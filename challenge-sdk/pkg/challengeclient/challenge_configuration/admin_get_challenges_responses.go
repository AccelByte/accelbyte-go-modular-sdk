...
type AdminGetChallengesResponse struct {
...
func (m *AdminGetChallengesResponse) Unpack() (*challengeclientmodels.ModelListChallengeResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
