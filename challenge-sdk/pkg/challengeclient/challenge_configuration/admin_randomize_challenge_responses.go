...
type AdminRandomizeChallengeResponse struct {
	challengeclientmodels.ApiResponse
	Data []*challengeclientmodels.ModelSchedule
...
func (m *AdminRandomizeChallengeResponse) Unpack() ([]*challengeclientmodels.ModelSchedule, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
