...
// NewAdminCreateChallengeParams creates a new AdminCreateChallengeParams object
// with the default values initialized.
func NewAdminCreateChallengeParams() *AdminCreateChallengeParams {
	var ()
	return &AdminCreateChallengeParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminCreateChallengeParamsWithTimeout creates a new AdminCreateChallengeParams object
...
// NewAdminCreateChallengeParamsWithContext creates a new AdminCreateChallengeParams object
...
// NewAdminCreateChallengeParamsWithHTTPClient creates a new AdminCreateChallengeParams object
...
/*
AdminCreateChallengeParams contains all the parameters to send to the API endpoint
for the admin create challenge operation typically these are written to a http.Request
*/
