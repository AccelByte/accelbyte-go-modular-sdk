...
type AdminGetPeriodsResponse struct {
	challengeclientmodels.ApiResponse
	Data *challengeclientmodels.ModelListPeriodsResponse
...
func (m *AdminGetPeriodsResponse) Unpack() (*challengeclientmodels.ModelListPeriodsResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
