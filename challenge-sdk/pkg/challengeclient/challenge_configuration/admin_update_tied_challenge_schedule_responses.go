...
type AdminUpdateTiedChallengeScheduleResponse struct {
...
func (m *AdminUpdateTiedChallengeScheduleResponse) Unpack() (*challengeclientmodels.ModelChallengeResponse, *challengeclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
