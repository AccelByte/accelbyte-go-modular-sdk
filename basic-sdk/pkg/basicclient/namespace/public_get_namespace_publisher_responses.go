...
type PublicGetNamespacePublisherResponse struct {
	basicclientmodels.ApiResponse
	Data *basicclientmodels.NamespacePublisherInfo
...
func (m *PublicGetNamespacePublisherResponse) Unpack() (*basicclientmodels.NamespacePublisherInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
