...
type GetNamespacePublisherResponse struct {
...
func (m *GetNamespacePublisherResponse) Unpack() (*basicclientmodels.NamespacePublisherInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
