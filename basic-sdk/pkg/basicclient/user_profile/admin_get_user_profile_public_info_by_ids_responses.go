...
type AdminGetUserProfilePublicInfoByIdsResponse struct {
...
func (m *AdminGetUserProfilePublicInfoByIdsResponse) Unpack() ([]*basicclientmodels.UserProfilePublicInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
