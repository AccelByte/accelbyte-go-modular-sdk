...
type PublicUpdateCustomAttributesPartiallyResponse struct {
...
func (m *PublicUpdateCustomAttributesPartiallyResponse) Unpack() (map[string]interface{}, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
