...
type PublicBulkGetUserProfilePublicInfoResponse struct {
...
func (m *PublicBulkGetUserProfilePublicInfoResponse) Unpack() ([]*basicclientmodels.UserProfilePublicInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
