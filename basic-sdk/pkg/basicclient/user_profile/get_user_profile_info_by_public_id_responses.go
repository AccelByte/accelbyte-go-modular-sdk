...
type GetUserProfileInfoByPublicIDResponse struct {
...
func (m *GetUserProfileInfoByPublicIDResponse) Unpack() (*basicclientmodels.UserProfileInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
