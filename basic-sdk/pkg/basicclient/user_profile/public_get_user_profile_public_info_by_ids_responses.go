...
type PublicGetUserProfilePublicInfoByIdsResponse struct {
...
func (m *PublicGetUserProfilePublicInfoByIdsResponse) Unpack() ([]*basicclientmodels.UserProfilePublicInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
