...
type PublicUpdateUserProfileStatusResponse struct {
	basicclientmodels.ApiResponse
	Data *basicclientmodels.UserProfileInfo
...
func (m *PublicUpdateUserProfileStatusResponse) Unpack() (*basicclientmodels.UserProfileInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
