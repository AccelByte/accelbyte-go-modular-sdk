...
type PublicGetUserProfileInfoResponse struct {
...
func (m *PublicGetUserProfileInfoResponse) Unpack() (*basicclientmodels.UserProfileInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
