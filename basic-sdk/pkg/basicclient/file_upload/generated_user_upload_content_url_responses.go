...
type GeneratedUserUploadContentURLResponse struct {
...
func (m *GeneratedUserUploadContentURLResponse) Unpack() (*basicclientmodels.FileUploadURLInfo, *basicclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
