...
// NewPublicGetTimeZonesParams creates a new PublicGetTimeZonesParams object
// with the default values initialized.
func NewPublicGetTimeZonesParams() *PublicGetTimeZonesParams {
	var ()
	return &PublicGetTimeZonesParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPublicGetTimeZonesParamsWithTimeout creates a new PublicGetTimeZonesParams object
...
// NewPublicGetTimeZonesParamsWithContext creates a new PublicGetTimeZonesParams object
...
// NewPublicGetTimeZonesParamsWithHTTPClient creates a new PublicGetTimeZonesParams object
...
/*PublicGetTimeZonesParams contains all the parameters to send to the API endpoint
for the public get time zones operation typically these are written to a http.Request
*/
