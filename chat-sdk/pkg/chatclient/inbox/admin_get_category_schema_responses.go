...
type AdminGetCategorySchemaResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsJSONSchemaType
...
func (m *AdminGetCategorySchemaResponse) Unpack() (*chatclientmodels.ModelsJSONSchemaType, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
