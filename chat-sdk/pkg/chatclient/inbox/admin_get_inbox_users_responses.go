...
type AdminGetInboxUsersResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsGetInboxUsersResponse
...
func (m *AdminGetInboxUsersResponse) Unpack() (*chatclientmodels.ModelsGetInboxUsersResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
