...
type AdminGetInboxStatsResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsGetInboxStatsResponse
...
func (m *AdminGetInboxStatsResponse) Unpack() (*chatclientmodels.ModelsGetInboxStatsResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
