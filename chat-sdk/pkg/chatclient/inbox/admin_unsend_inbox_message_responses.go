...
type AdminUnsendInboxMessageResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsUnsendInboxMessageResponse
...
func (m *AdminUnsendInboxMessageResponse) Unpack() (*chatclientmodels.ModelsUnsendInboxMessageResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
