...
type AdminListKafkaTopicResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsGetListTopicKafkaResponse
...
func (m *AdminListKafkaTopicResponse) Unpack() (*chatclientmodels.ModelsGetListTopicKafkaResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
