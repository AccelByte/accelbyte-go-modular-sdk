...
type AdminAddInboxCategoryResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsAddInboxCategoryResponse
...
func (m *AdminAddInboxCategoryResponse) Unpack() (*chatclientmodels.ModelsAddInboxCategoryResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
