...
type AdminGetInboxMessagesResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsGetInboxMessagesResponse
...
func (m *AdminGetInboxMessagesResponse) Unpack() (*chatclientmodels.ModelsGetInboxMessagesResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
