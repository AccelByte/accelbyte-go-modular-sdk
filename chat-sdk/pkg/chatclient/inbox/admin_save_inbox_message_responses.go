...
type AdminSaveInboxMessageResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsSaveInboxMessageResponse
...
func (m *AdminSaveInboxMessageResponse) Unpack() (*chatclientmodels.ModelsSaveInboxMessageResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
