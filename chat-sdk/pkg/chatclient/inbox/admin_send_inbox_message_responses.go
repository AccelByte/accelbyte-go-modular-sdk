...
type AdminSendInboxMessageResponse struct {
	...
	Data *chatclientmodels.ModelsSendInboxMessageResponse
...
func (m *AdminSendInboxMessageResponse) Unpack() (*chatclientmodels.ModelsSendInboxMessageResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
