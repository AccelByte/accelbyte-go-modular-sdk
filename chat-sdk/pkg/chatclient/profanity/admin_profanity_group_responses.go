...
type AdminProfanityGroupResponse struct {
	chatclientmodels.ApiResponse
	Data []*chatclientmodels.ModelsDictionaryGroup
...
func (m *AdminProfanityGroupResponse) Unpack() ([]*chatclientmodels.ModelsDictionaryGroup, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
