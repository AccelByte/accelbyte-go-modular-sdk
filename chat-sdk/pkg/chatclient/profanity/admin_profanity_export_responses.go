...
type AdminProfanityExportResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsDictionaryExport
...
func (m *AdminProfanityExportResponse) Unpack() (*chatclientmodels.ModelsDictionaryExport, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
