...
type AdminProfanityImportResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsDictionaryImportResult
...
func (m *AdminProfanityImportResponse) Unpack() (*chatclientmodels.ModelsDictionaryImportResult, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
