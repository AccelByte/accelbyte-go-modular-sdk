...
type AdminProfanityQueryResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsDictionaryQueryResult
...
func (m *AdminProfanityQueryResponse) Unpack() (*chatclientmodels.ModelsDictionaryQueryResult, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
