...
func (m *AdminGetLogConfigResponse) Unpack() (*chatclientmodels.LogconfigConfiguration, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *AdminGetLogConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /chat/v1/admin/config/log returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *AdminGetLogConfigOK) Error() string {
	return fmt.Sprintf("[GET /chat/v1/admin/config/log][%d] adminGetLogConfigOK  %+v", 200, o.ToJSONString())
}
...
func (o *AdminGetLogConfigOK) GetPayload() *chatclientmodels.LogconfigConfiguration {
	return o.Payload
}
...
func (o *AdminGetLogConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(chatclientmodels.LogconfigConfiguration)
