...
type AdminUpdateConfigV1Response struct {
	...
	Error412 *chatclientmodels.RestapiErrorResponseBody
	Error500 *chatclientmodels.RestapiErrorResponseBody
}

func (m *AdminUpdateConfigV1Response) Unpack() (*chatclientmodels.ModelsConfigResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *AdminUpdateConfigV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested PUT /chat/v1/admin/config/namespaces/{namespace} returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *AdminUpdateConfigV1OK) Error() string {
	return fmt.Sprintf("[PUT /chat/v1/admin/config/namespaces/{namespace}][%d] adminUpdateConfigV1OK  %+v", 200, o.ToJSONString())
}
...
func (o *AdminUpdateConfigV1OK) GetPayload() *chatclientmodels.ModelsConfigResponse {
	return o.Payload
}
...
func (o *AdminUpdateConfigV1BadRequest) Error() string {
	return fmt.Sprintf("[PUT /chat/v1/admin/config/namespaces/{namespace}][%d] adminUpdateConfigV1BadRequest  %+v", 400, o.ToJSONString())
}
...
func (o *AdminUpdateConfigV1BadRequest) GetPayload() *chatclientmodels.RestapiErrorResponseBody {
	return o.Payload
}
...
func (o *AdminUpdateConfigV1Unauthorized) Error() string {
	return fmt.Sprintf("[PUT /chat/v1/admin/config/namespaces/{namespace}][%d] adminUpdateConfigV1Unauthorized  %+v", 401, o.ToJSONString())
}
...
func (o *AdminUpdateConfigV1Unauthorized) GetPayload() *chatclientmodels.RestapiErrorResponseBody {
	return o.Payload
}
...
func (o *AdminUpdateConfigV1Forbidden) Error() string {
	return fmt.Sprintf("[PUT /chat/v1/admin/config/namespaces/{namespace}][%d] adminUpdateConfigV1Forbidden  %+v", 403, o.ToJSONString())
}
...
func (o *AdminUpdateConfigV1Forbidden) GetPayload() *chatclientmodels.RestapiErrorResponseBody {
	return o.Payload
}
...
func (o *AdminUpdateConfigV1NotFound) Error() string {
	return fmt.Sprintf("[PUT /chat/v1/admin/config/namespaces/{namespace}][%d] adminUpdateConfigV1NotFound  %+v", 404, o.ToJSONString())
}
...
func (o *AdminUpdateConfigV1NotFound) GetPayload() *chatclientmodels.RestapiErrorResponseBody {
	return o.Payload
}
...
func (o *AdminUpdateConfigV1PreconditionFailed) Error() string {
	return fmt.Sprintf("[PUT /chat/v1/admin/config/namespaces/{namespace}][%d] adminUpdateConfigV1PreconditionFailed  %+v", 412, o.ToJSONString())
}
...
func (o *AdminUpdateConfigV1PreconditionFailed) GetPayload() *chatclientmodels.RestapiErrorResponseBody {
	return o.Payload
}
...
func (o *AdminUpdateConfigV1InternalServerError) Error() string {
	return fmt.Sprintf("[PUT /chat/v1/admin/config/namespaces/{namespace}][%d] adminUpdateConfigV1InternalServerError  %+v", 500, o.ToJSONString())
}
...
func (o *AdminUpdateConfigV1InternalServerError) GetPayload() *chatclientmodels.RestapiErrorResponseBody {
	return o.Payload
}
