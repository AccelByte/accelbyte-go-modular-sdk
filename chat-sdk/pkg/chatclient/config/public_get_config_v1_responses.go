...
type PublicGetConfigV1Response struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsPublicConfigResponse
...
func (m *PublicGetConfigV1Response) Unpack() (*chatclientmodels.ModelsPublicConfigResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
