...
type AdminPatchUpdateLogConfigParams struct {
	...
	/*Body*/
	Body *chatclientmodels.LogconfigConfiguration
...
func (o *AdminPatchUpdateLogConfigParams) WithBody(body *chatclientmodels.LogconfigConfiguration) *AdminPatchUpdateLogConfigParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the admin patch update log config params
func (o *AdminPatchUpdateLogConfigParams) SetBody(body *chatclientmodels.LogconfigConfiguration) {
	o.Body = body
}
