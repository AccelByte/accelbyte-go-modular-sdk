...
func (o *AdminPatchUpdateLogConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested PATCH /chat/v1/admin/config/log returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *AdminPatchUpdateLogConfigOK) Error() string {
	return fmt.Sprintf("[PATCH /chat/v1/admin/config/log][%d] adminPatchUpdateLogConfigOK  %+v", 200, o.ToJSONString())
}
...
func (o *AdminPatchUpdateLogConfigOK) GetPayload() *chatclientmodels.LogconfigConfiguration {
	return o.Payload
}
