...
type PublicGetChatSnapshotResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsChatSnapshots
...
func (m *PublicGetChatSnapshotResponse) Unpack() (*chatclientmodels.ModelsChatSnapshots, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
