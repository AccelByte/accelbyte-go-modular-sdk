...
type AdminQueryUsersTopicResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsTopicLogWithPaginationResponse
...
func (m *AdminQueryUsersTopicResponse) Unpack() (*chatclientmodels.ModelsTopicLogWithPaginationResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
