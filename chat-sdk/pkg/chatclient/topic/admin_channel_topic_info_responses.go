...
type AdminChannelTopicInfoResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsChannelTopicResponse
...
func (m *AdminChannelTopicInfoResponse) Unpack() (*chatclientmodels.ModelsChannelTopicResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
