...
type AdminFilterChatMessageResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsMessageResultWithAttributes
...
func (m *AdminFilterChatMessageResponse) Unpack() (*chatclientmodels.ModelsMessageResultWithAttributes, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
