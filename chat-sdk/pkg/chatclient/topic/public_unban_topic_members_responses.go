...
type PublicUnbanTopicMembersResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsPublicUnbanTopicMembersResponse
...
func (m *PublicUnbanTopicMembersResponse) Unpack() (*chatclientmodels.ModelsPublicUnbanTopicMembersResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
