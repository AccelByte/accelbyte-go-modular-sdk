...
type AdminChatHistoryResponse struct {
...
func (m *AdminChatHistoryResponse) Unpack() (*chatclientmodels.ModelsChatMessageWithPaginationResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
