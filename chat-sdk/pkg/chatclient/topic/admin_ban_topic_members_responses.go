...
type AdminBanTopicMembersResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsBanTopicMemberResult
...
func (m *AdminBanTopicMembersResponse) Unpack() (*chatclientmodels.ModelsBanTopicMemberResult, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
