...
type AdminDeleteTopicResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.MessageActionDeleteTopicResult
...
func (m *AdminDeleteTopicResponse) Unpack() (*chatclientmodels.MessageActionDeleteTopicResult, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
