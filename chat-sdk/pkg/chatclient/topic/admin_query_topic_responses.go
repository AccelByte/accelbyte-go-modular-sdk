...
type AdminQueryTopicResponse struct {
	chatclientmodels.ApiResponse
	Data []*chatclientmodels.ModelsTopicInfo
...
func (m *AdminQueryTopicResponse) Unpack() ([]*chatclientmodels.ModelsTopicInfo, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
