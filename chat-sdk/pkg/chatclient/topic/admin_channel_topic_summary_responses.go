...
type AdminChannelTopicSummaryResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsChannelTopicSummaryResponse
...
func (m *AdminChannelTopicSummaryResponse) Unpack() (*chatclientmodels.ModelsChannelTopicSummaryResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
