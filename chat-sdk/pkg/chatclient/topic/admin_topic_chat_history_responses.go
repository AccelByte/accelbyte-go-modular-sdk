...
type AdminTopicChatHistoryResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsChatMessageWithPaginationResponse
...
func (m *AdminTopicChatHistoryResponse) Unpack() (*chatclientmodels.ModelsChatMessageWithPaginationResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
