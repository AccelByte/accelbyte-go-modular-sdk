...
type AdminChannelTopicListResponse struct {
	chatclientmodels.ApiResponse
	Data *chatclientmodels.ModelsChannelTopicWithPaginationResponse
...
func (m *AdminChannelTopicListResponse) Unpack() (*chatclientmodels.ModelsChannelTopicWithPaginationResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
