...
type PublicGetMutedTopicsResponse struct {
	chatclientmodels.ApiResponse
	Data []*chatclientmodels.APIMutedTopicResponse
...
func (m *PublicGetMutedTopicsResponse) Unpack() ([]*chatclientmodels.APIMutedTopicResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
