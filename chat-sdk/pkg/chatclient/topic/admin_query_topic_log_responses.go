...
type AdminQueryTopicLogResponse struct {
...
func (m *AdminQueryTopicLogResponse) Unpack() (*chatclientmodels.ModelsTopicLogWithPaginationResponse, *chatclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
