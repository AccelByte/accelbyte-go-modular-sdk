...
func (m *ModelsChatMessageWithPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsChatMessageWithPaginationResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsChatMessageWithPaginationResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsChatMessageWithPaginationResponse) validateTotalData(formats strfmt.Registry) error {
...
func (m *ModelsChatMessageWithPaginationResponse) UnmarshalBinary(b []byte) error {
	var res ModelsChatMessageWithPaginationResponse
