...
func (m *ModelsTopicLogWithPaginationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsTopicLogWithPaginationResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsTopicLogWithPaginationResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsTopicLogWithPaginationResponse) UnmarshalBinary(b []byte) error {
	var res ModelsTopicLogWithPaginationResponse
