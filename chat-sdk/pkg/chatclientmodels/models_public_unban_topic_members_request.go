...
func (m *ModelsPublicUnbanTopicMembersRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsPublicUnbanTopicMembersRequest) validateUserIDs(formats strfmt.Registry) error {
...
func (m *ModelsPublicUnbanTopicMembersRequest) UnmarshalBinary(b []byte) error {
	var res ModelsPublicUnbanTopicMembersRequest
