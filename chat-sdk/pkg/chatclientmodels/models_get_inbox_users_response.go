...
func (m *ModelsGetInboxUsersResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsGetInboxUsersResponse) validateNext(formats strfmt.Registry) error {
...
func (m *ModelsGetInboxUsersResponse) validatePrevious(formats strfmt.Registry) error {
...
func (m *ModelsGetInboxUsersResponse) UnmarshalBinary(b []byte) error {
	var res ModelsGetInboxUsersResponse
