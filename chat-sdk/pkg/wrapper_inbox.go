...
func (aaa *InboxService) AdminGetInboxCategories(input *inbox.AdminGetInboxCategoriesParams) ([]*chatclientmodels.ModelsGetInboxCategoriesResponseItem, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminGetInboxCategories(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *InboxService) AdminAddInboxCategory(input *inbox.AdminAddInboxCategoryParams) (*chatclientmodels.ModelsAddInboxCategoryResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminAddInboxCategory(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminDeleteInboxCategory(input *inbox.AdminDeleteInboxCategoryParams) error {
	...
	_, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminDeleteInboxCategory(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminUpdateInboxCategory(input *inbox.AdminUpdateInboxCategoryParams) error {
	...
	_, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminUpdateInboxCategory(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminGetCategorySchema(input *inbox.AdminGetCategorySchemaParams) (*chatclientmodels.ModelsJSONSchemaType, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Inbox.AdminGetCategorySchema(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminDeleteInboxMessage(input *inbox.AdminDeleteInboxMessageParams) error {
	...
	_, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminDeleteInboxMessage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminGetInboxMessages(input *inbox.AdminGetInboxMessagesParams) (*chatclientmodels.ModelsGetInboxMessagesResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminGetInboxMessages(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminSaveInboxMessage(input *inbox.AdminSaveInboxMessageParams) (*chatclientmodels.ModelsSaveInboxMessageResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminSaveInboxMessage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminUnsendInboxMessage(input *inbox.AdminUnsendInboxMessageParams) (*chatclientmodels.ModelsUnsendInboxMessageResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminUnsendInboxMessage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminGetInboxUsers(input *inbox.AdminGetInboxUsersParams) (*chatclientmodels.ModelsGetInboxUsersResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminGetInboxUsers(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminUpdateInboxMessage(input *inbox.AdminUpdateInboxMessageParams) error {
	...
	_, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminUpdateInboxMessage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminSendInboxMessage(input *inbox.AdminSendInboxMessageParams) (*chatclientmodels.ModelsSendInboxMessageResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminSendInboxMessage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *InboxService) AdminGetInboxStats(input *inbox.AdminGetInboxStatsParams) (*chatclientmodels.ModelsGetInboxStatsResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Inbox.AdminGetInboxStats(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
