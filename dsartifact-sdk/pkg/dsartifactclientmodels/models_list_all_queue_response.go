...
func (m *ModelsListAllQueueResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsListAllQueueResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsListAllQueueResponse) UnmarshalBinary(b []byte) error {
	var res ModelsListAllQueueResponse
