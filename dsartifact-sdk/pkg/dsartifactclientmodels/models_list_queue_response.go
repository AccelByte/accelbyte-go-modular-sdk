...
func (m *ModelsListQueueResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsListQueueResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsListQueueResponse) UnmarshalBinary(b []byte) error {
	var res ModelsListQueueResponse
