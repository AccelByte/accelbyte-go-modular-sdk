...
type PublicGetMessagesResponse struct {
	...
	Data []*dsartifactclientmodels.LogAppMessageDeclaration

	Error500 *dsartifactclientmodels.ResponseError
}

func (m *PublicGetMessagesResponse) Unpack() ([]*dsartifactclientmodels.LogAppMessageDeclaration, *dsartifactclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *PublicGetMessagesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /dsartifact/v1/messages returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *PublicGetMessagesOK) Error() string {
	return fmt.Sprintf("[GET /dsartifact/v1/messages][%d] publicGetMessagesOK  %+v", 200, o.ToJSONString())
}
...
func (o *PublicGetMessagesOK) GetPayload() []*dsartifactclientmodels.LogAppMessageDeclaration {
	return o.Payload
}
...
func (o *PublicGetMessagesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /dsartifact/v1/messages][%d] publicGetMessagesInternalServerError  %+v", 500, o.ToJSONString())
}
...
func (o *PublicGetMessagesInternalServerError) GetPayload() *dsartifactclientmodels.ResponseError {
	return o.Payload
}
