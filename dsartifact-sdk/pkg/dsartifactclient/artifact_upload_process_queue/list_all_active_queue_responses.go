...
type ListAllActiveQueueResponse struct {
...
func (m *ListAllActiveQueueResponse) Unpack() (*dsartifactclientmodels.ModelsListAllQueueResponse, *dsartifactclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
