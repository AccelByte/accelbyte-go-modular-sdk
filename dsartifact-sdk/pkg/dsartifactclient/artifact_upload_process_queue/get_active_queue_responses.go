...
type GetActiveQueueResponse struct {
	dsartifactclientmodels.ApiResponse
	Data *dsartifactclientmodels.ModelsQueue
...
func (m *GetActiveQueueResponse) Unpack() (*dsartifactclientmodels.ModelsQueue, *dsartifactclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
