...
type ListTerminatedServersWithNamespaceResponse struct {
	dsartifactclientmodels.ApiResponse
	Data *dsartifactclientmodels.ModelsListTerminatedServersResponse
...
func (m *ListTerminatedServersWithNamespaceResponse) Unpack() (*dsartifactclientmodels.ModelsListTerminatedServersResponse, *dsartifactclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
