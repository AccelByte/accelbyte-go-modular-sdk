...
func (o *PublicGetMessagesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /matchmaking/v1/messages returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *PublicGetMessagesOK) Error() string {
	return fmt.Sprintf("[GET /matchmaking/v1/messages][%d] publicGetMessagesOK  %+v", 200, o.ToJSONString())
}
...
func (o *PublicGetMessagesOK) GetPayload() []*matchmakingclientmodels.LogAppMessageDeclaration {
	return o.Payload
}
...
func (o *PublicGetMessagesInternalServerError) Error() string {
	return fmt.Sprintf("[GET /matchmaking/v1/messages][%d] publicGetMessagesInternalServerError  %+v", 500, o.ToJSONString())
}
...
func (o *PublicGetMessagesInternalServerError) GetPayload() *matchmakingclientmodels.ResponseError {
	return o.Payload
}
