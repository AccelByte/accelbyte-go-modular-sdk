...
type PublicGetAllMatchmakingChannelResponse struct {
	matchmakingclientmodels.ApiResponse
	Data []*matchmakingclientmodels.ModelsChannelV1
...
func (m *PublicGetAllMatchmakingChannelResponse) Unpack() ([]*matchmakingclientmodels.ModelsChannelV1, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
