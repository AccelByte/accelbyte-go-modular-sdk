...
type GetSingleMatchmakingChannelResponse struct {
...
func (m *GetSingleMatchmakingChannelResponse) Unpack() (*matchmakingclientmodels.ModelsChannelV1, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
