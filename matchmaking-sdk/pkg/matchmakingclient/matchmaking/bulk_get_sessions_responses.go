...
type BulkGetSessionsResponse struct {
...
func (m *BulkGetSessionsResponse) Unpack() ([]*matchmakingclientmodels.ModelsMatchmakingResult, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
