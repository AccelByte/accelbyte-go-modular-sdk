...
type QuerySessionHandlerResponse struct {
	matchmakingclientmodels.ApiResponse
	Data *matchmakingclientmodels.ModelsMatchmakingResult
...
func (m *QuerySessionHandlerResponse) Unpack() (*matchmakingclientmodels.ModelsMatchmakingResult, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
