...
type CreateChannelHandlerResponse struct {
	matchmakingclientmodels.ApiResponse
	Data *matchmakingclientmodels.ModelsCreateChannelResponse
	...
	Error409 *matchmakingclientmodels.ResponseError
	Error500 *matchmakingclientmodels.ResponseError
}

func (m *CreateChannelHandlerResponse) Unpack() (*matchmakingclientmodels.ModelsCreateChannelResponse, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
