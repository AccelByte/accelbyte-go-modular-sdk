...
type GetStatDataResponse struct {
	matchmakingclientmodels.ApiResponse
	Data *matchmakingclientmodels.ModelsStatResumeResponse
...
func (m *GetStatDataResponse) Unpack() (*matchmakingclientmodels.ModelsStatResumeResponse, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
