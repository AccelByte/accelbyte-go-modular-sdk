...
type PublicGetSingleMatchmakingChannelResponse struct {
...
func (m *PublicGetSingleMatchmakingChannelResponse) Unpack() (*matchmakingclientmodels.ModelsChannelV1, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
