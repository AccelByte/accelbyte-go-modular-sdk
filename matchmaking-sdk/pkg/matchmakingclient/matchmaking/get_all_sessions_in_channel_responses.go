...
type GetAllSessionsInChannelResponse struct {
...
func (m *GetAllSessionsInChannelResponse) Unpack() ([]*matchmakingclientmodels.ModelsMatchmakingResult, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
