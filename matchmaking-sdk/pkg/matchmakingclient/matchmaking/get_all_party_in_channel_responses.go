...
type GetAllPartyInChannelResponse struct {
	matchmakingclientmodels.ApiResponse
	Data []*matchmakingclientmodels.ModelsMatchingParty
...
func (m *GetAllPartyInChannelResponse) Unpack() ([]*matchmakingclientmodels.ModelsMatchingParty, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
