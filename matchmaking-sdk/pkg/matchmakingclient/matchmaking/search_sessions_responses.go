...
type SearchSessionsResponse struct {
	...
	Data *matchmakingclientmodels.ServiceGetSessionHistorySearchResponse
...
func (m *SearchSessionsResponse) Unpack() (*matchmakingclientmodels.ServiceGetSessionHistorySearchResponse, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
