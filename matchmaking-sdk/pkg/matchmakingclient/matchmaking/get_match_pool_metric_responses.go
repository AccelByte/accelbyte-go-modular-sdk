...
type GetMatchPoolMetricResponse struct {
	matchmakingclientmodels.ApiResponse
	Data *matchmakingclientmodels.ModelsTicketMetricResultRecord

	Error401 *matchmakingclientmodels.ResponseError
	Error403 *matchmakingclientmodels.ResponseError
	Error404 *matchmakingclientmodels.ResponseError
	Error500 *matchmakingclientmodels.ResponseError
}

func (m *GetMatchPoolMetricResponse) Unpack() (*matchmakingclientmodels.ModelsTicketMetricResultRecord, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
