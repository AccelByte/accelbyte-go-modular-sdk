...
type RebalanceResponse struct {
	...
	Data *matchmakingclientmodels.ModelsRebalanceResponse
...
func (m *RebalanceResponse) Unpack() (*matchmakingclientmodels.ModelsRebalanceResponse, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
