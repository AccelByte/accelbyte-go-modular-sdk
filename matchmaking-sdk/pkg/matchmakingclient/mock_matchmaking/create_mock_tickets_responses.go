...
type CreateMockTicketsResponse struct {
	matchmakingclientmodels.ApiResponse
	Data []*matchmakingclientmodels.ModelsMockTicket
...
func (m *CreateMockTicketsResponse) Unpack() ([]*matchmakingclientmodels.ModelsMockTicket, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
