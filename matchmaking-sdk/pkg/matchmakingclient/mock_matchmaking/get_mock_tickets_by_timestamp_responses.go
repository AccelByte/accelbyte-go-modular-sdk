...
type GetMockTicketsByTimestampResponse struct {
	matchmakingclientmodels.ApiResponse
	Data *matchmakingclientmodels.ModelsGetMockTicketsResponse
...
func (m *GetMockTicketsByTimestampResponse) Unpack() (*matchmakingclientmodels.ModelsGetMockTicketsResponse, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
