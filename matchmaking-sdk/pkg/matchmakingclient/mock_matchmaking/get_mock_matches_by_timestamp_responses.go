...
type GetMockMatchesByTimestampResponse struct {
	matchmakingclientmodels.ApiResponse
	Data *matchmakingclientmodels.ModelsGetMockMatchesResponse
...
func (m *GetMockMatchesByTimestampResponse) Unpack() (*matchmakingclientmodels.ModelsGetMockMatchesResponse, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
