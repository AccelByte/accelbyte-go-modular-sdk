...
type GetAllMockMatchesResponse struct {
...
func (m *GetAllMockMatchesResponse) Unpack() (*matchmakingclientmodels.ModelsGetMockMatchesResponse, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
