...
type GetAllMockTicketsResponse struct {
...
func (m *GetAllMockTicketsResponse) Unpack() (*matchmakingclientmodels.ModelsGetMockTicketsResponse, *matchmakingclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
