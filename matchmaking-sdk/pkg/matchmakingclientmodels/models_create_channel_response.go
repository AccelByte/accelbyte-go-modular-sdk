...
func (m *ModelsCreateChannelResponse) validateBlockedPlayerOption(formats strfmt.Registry) error {
...
func (m *ModelsCreateChannelResponse) validateSubGamemodeSelection(formats strfmt.Registry) error {
