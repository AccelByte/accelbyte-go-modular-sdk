...
func (m *ServiceGetSessionHistorySearchResponseV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceGetSessionHistorySearchResponseV2) validateData(formats strfmt.Registry) error {
...
func (m *ServiceGetSessionHistorySearchResponseV2) validatePagination(formats strfmt.Registry) error {
...
func (m *ServiceGetSessionHistorySearchResponseV2) UnmarshalBinary(b []byte) error {
	var res ServiceGetSessionHistorySearchResponseV2
