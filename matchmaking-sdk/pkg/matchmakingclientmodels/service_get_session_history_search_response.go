...
func (m *ServiceGetSessionHistorySearchResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ServiceGetSessionHistorySearchResponse) validateData(formats strfmt.Registry) error {
...
func (m *ServiceGetSessionHistorySearchResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *ServiceGetSessionHistorySearchResponse) UnmarshalBinary(b []byte) error {
	var res ServiceGetSessionHistorySearchResponse
