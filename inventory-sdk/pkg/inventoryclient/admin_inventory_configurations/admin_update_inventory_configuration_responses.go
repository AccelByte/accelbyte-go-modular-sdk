...
type AdminUpdateInventoryConfigurationResponse struct {
...
func (m *AdminUpdateInventoryConfigurationResponse) Unpack() (*inventoryclientmodels.ApimodelsInventoryConfigurationResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
