...
type AdminGetInventoryConfigurationResponse struct {
...
func (m *AdminGetInventoryConfigurationResponse) Unpack() (*inventoryclientmodels.ApimodelsInventoryConfigurationResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
