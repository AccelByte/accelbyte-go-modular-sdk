...
type AdminListItemTypesResponse struct {
...
func (m *AdminListItemTypesResponse) Unpack() (*inventoryclientmodels.ApimodelsListItemTypesResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
