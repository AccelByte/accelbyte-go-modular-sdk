...
// NewAdminDeleteItemTypeParams creates a new AdminDeleteItemTypeParams object
// with the default values initialized.
func NewAdminDeleteItemTypeParams() *AdminDeleteItemTypeParams {
	var ()
	return &AdminDeleteItemTypeParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminDeleteItemTypeParamsWithTimeout creates a new AdminDeleteItemTypeParams object
...
// NewAdminDeleteItemTypeParamsWithContext creates a new AdminDeleteItemTypeParams object
...
// NewAdminDeleteItemTypeParamsWithHTTPClient creates a new AdminDeleteItemTypeParams object
...
func (o *AdminDeleteItemTypeParams) WithTimeout(timeout time.Duration) *AdminDeleteItemTypeParams {
...
func (o *AdminDeleteItemTypeParams) WithContext(ctx context.Context) *AdminDeleteItemTypeParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AdminDeleteItemTypeParams) WithItemTypeName(itemTypeName string) *AdminDeleteItemTypeParams {
	o.SetItemTypeName(itemTypeName)
	return o
}
...
func (o *AdminDeleteItemTypeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param itemTypeName
	if err := r.SetPathParam("itemTypeName", o.ItemTypeName); err != nil {
		return err
	}
