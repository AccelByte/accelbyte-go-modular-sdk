...
type PublicListItemsResponse struct {
	inventoryclientmodels.ApiResponse
	Data *inventoryclientmodels.ApimodelsListItemResp

	Error400 *inventoryclientmodels.ApimodelsErrorResponse
	Error500 *inventoryclientmodels.ApimodelsErrorResponse
}

func (m *PublicListItemsResponse) Unpack() (*inventoryclientmodels.ApimodelsListItemResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
