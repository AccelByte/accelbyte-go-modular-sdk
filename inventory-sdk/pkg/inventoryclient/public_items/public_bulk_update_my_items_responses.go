...
type PublicBulkUpdateMyItemsResponse struct {
	inventoryclientmodels.ApiResponse
	Data []*inventoryclientmodels.ApimodelsUpdateItemResp
...
func (m *PublicBulkUpdateMyItemsResponse) Unpack() ([]*inventoryclientmodels.ApimodelsUpdateItemResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
