...
type PublicMoveMyItemsResponse struct {
	inventoryclientmodels.ApiResponse
	Data *inventoryclientmodels.ApimodelsMoveItemsResp

	Error400 *inventoryclientmodels.ApimodelsErrorResponse
	Error500 *inventoryclientmodels.ApimodelsErrorResponse
}

func (m *PublicMoveMyItemsResponse) Unpack() (*inventoryclientmodels.ApimodelsMoveItemsResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
