...
type PublicConsumeMyItemResponse struct {
	inventoryclientmodels.ApiResponse
	Data *inventoryclientmodels.ApimodelsItemResp
...
func (m *PublicConsumeMyItemResponse) Unpack() (*inventoryclientmodels.ApimodelsItemResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
