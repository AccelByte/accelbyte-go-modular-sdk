...
type PublicBulkRemoveMyItemsResponse struct {
...
func (m *PublicBulkRemoveMyItemsResponse) Unpack() ([]*inventoryclientmodels.ApimodelsUpdateItemResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
