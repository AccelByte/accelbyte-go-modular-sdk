...
type AdminListInventoriesResponse struct {
...
func (m *AdminListInventoriesResponse) Unpack() (*inventoryclientmodels.ApimodelsListInventoryResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
