...
type AdminUpdateInventoryResponse struct {
...
func (m *AdminUpdateInventoryResponse) Unpack() (*inventoryclientmodels.ApimodelsInventoryResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
