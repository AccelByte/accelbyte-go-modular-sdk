...
type AdminGetInventoryResponse struct {
...
func (m *AdminGetInventoryResponse) Unpack() (*inventoryclientmodels.ApimodelsInventoryResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
