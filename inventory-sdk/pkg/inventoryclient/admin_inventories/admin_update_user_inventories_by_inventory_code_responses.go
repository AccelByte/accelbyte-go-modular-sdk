...
type AdminUpdateUserInventoriesByInventoryCodeResponse struct {
	inventoryclientmodels.ApiResponse
	Data []*inventoryclientmodels.ApimodelsInventoryResp
...
func (m *AdminUpdateUserInventoriesByInventoryCodeResponse) Unpack() ([]*inventoryclientmodels.ApimodelsInventoryResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
