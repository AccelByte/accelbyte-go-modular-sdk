...
type AdminCreateInventoryResponse struct {
...
func (m *AdminCreateInventoryResponse) Unpack() (*inventoryclientmodels.ApimodelsInventoryResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
