...
type PublicListInventoriesResponse struct {
	inventoryclientmodels.ApiResponse
	Data *inventoryclientmodels.ApimodelsListInventoryResp

	Error400 *inventoryclientmodels.ApimodelsErrorResponse
	Error500 *inventoryclientmodels.ApimodelsErrorResponse
}

func (m *PublicListInventoriesResponse) Unpack() (*inventoryclientmodels.ApimodelsListInventoryResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
