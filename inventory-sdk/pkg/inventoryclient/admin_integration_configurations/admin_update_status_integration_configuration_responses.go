...
type AdminUpdateStatusIntegrationConfigurationResponse struct {
	inventoryclientmodels.ApiResponse
	Data *inventoryclientmodels.ApimodelsIntegrationConfigurationResp
...
func (m *AdminUpdateStatusIntegrationConfigurationResponse) Unpack() (*inventoryclientmodels.ApimodelsIntegrationConfigurationResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
