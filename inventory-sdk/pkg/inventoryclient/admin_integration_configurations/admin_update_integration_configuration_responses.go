...
type AdminUpdateIntegrationConfigurationResponse struct {
...
func (m *AdminUpdateIntegrationConfigurationResponse) Unpack() (*inventoryclientmodels.ApimodelsIntegrationConfigurationResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
