...
type AdminListIntegrationConfigurationsResponse struct {
	inventoryclientmodels.ApiResponse
	Data *inventoryclientmodels.ApimodelsListIntegrationConfigurationsResp

	Error400 *inventoryclientmodels.ApimodelsErrorResponse
	Error500 *inventoryclientmodels.ApimodelsErrorResponse
}

func (m *AdminListIntegrationConfigurationsResponse) Unpack() (*inventoryclientmodels.ApimodelsListIntegrationConfigurationsResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
