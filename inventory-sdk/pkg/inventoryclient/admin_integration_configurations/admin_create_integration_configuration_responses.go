...
type AdminCreateIntegrationConfigurationResponse struct {
...
func (m *AdminCreateIntegrationConfigurationResponse) Unpack() (*inventoryclientmodels.ApimodelsIntegrationConfigurationResp, *inventoryclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
