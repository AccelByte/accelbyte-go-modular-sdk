...
func (m *ApimodelsListInventoryResp) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsListInventoryResp) validatePaging(formats strfmt.Registry) error {
...
func (m *ApimodelsListInventoryResp) UnmarshalBinary(b []byte) error {
	var res ApimodelsListInventoryResp
