...
func (m *ApimodelsCreateItemTypeResp) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *ApimodelsCreateItemTypeResp) validateName(formats strfmt.Registry) error {
...
func (m *ApimodelsCreateItemTypeResp) validateNamespace(formats strfmt.Registry) error {
...
func (m *ApimodelsCreateItemTypeResp) UnmarshalBinary(b []byte) error {
	var res ApimodelsCreateItemTypeResp
