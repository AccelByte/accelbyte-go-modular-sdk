...
func (m *ApimodelsListTagsResp) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsListTagsResp) validatePaging(formats strfmt.Registry) error {
