...
func (m *ApimodelsRemoveItem) validateInventoryID(formats strfmt.Registry) error {
...
func (m *ApimodelsRemoveItem) validateSlotID(formats strfmt.Registry) error {
...
func (m *ApimodelsRemoveItem) validateSourceItemID(formats strfmt.Registry) error {
