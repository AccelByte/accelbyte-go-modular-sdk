...
func (m *ApimodelsListInventoryConfigurationsResp) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsListInventoryConfigurationsResp) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsListInventoryConfigurationsResp) validatePaging(formats strfmt.Registry) error {
...
func (m *ApimodelsListInventoryConfigurationsResp) UnmarshalBinary(b []byte) error {
	var res ApimodelsListInventoryConfigurationsResp
