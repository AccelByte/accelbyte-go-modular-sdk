...
func (m *ApimodelsListIntegrationConfigurationsResp) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsListIntegrationConfigurationsResp) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsListIntegrationConfigurationsResp) validatePaging(formats strfmt.Registry) error {
...
func (m *ApimodelsListIntegrationConfigurationsResp) UnmarshalBinary(b []byte) error {
	var res ApimodelsListIntegrationConfigurationsResp
