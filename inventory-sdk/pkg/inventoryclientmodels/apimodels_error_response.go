...
func (m *ApimodelsErrorResponse) validateErrorCode(formats strfmt.Registry) error {
...
func (m *ApimodelsErrorResponse) validateErrorMessage(formats strfmt.Registry) error {
...
func (m *ApimodelsErrorResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsErrorResponse
...
func (m *ApimodelsErrorResponse) TranslateToApiError() (*ApiError, error) {
