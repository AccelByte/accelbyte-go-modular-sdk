...
func (m *ApimodelsListItemResp) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsListItemResp) validatePaging(formats strfmt.Registry) error {
