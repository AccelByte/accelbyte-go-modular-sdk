...
func (m *ApimodelsPaging) validateFirst(formats strfmt.Registry) error {
...
func (m *ApimodelsPaging) validateLast(formats strfmt.Registry) error {
...
func (m *ApimodelsPaging) validateNext(formats strfmt.Registry) error {
...
func (m *ApimodelsPaging) validatePrevious(formats strfmt.Registry) error {
