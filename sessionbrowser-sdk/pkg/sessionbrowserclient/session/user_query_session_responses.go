...
type UserQuerySessionResponse struct {
...
func (m *UserQuerySessionResponse) Unpack() (*sessionbrowserclientmodels.ModelsSessionQueryResponse, *sessionbrowserclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
