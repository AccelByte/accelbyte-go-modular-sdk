...
type RemovePlayerFromSessionResponse struct {
...
func (m *RemovePlayerFromSessionResponse) Unpack() (*sessionbrowserclientmodels.ModelsAddPlayerResponse, *sessionbrowserclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
