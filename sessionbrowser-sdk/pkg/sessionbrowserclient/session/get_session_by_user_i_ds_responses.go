...
type GetSessionByUserIDsResponse struct {
	sessionbrowserclientmodels.ApiResponse
	Data *sessionbrowserclientmodels.ModelsSessionByUserIDsResponse

	Error400 *sessionbrowserclientmodels.ResponseError
	Error500 *sessionbrowserclientmodels.ResponseError
}

func (m *GetSessionByUserIDsResponse) Unpack() (*sessionbrowserclientmodels.ModelsSessionByUserIDsResponse, *sessionbrowserclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
