...
type AdminQuerySessionResponse struct {
	sessionbrowserclientmodels.ApiResponse
	Data *sessionbrowserclientmodels.ModelsSessionQueryResponse

	Error400 *sessionbrowserclientmodels.RestapiErrorResponseV2
	Error500 *sessionbrowserclientmodels.RestapiErrorResponseV2
}

func (m *AdminQuerySessionResponse) Unpack() (*sessionbrowserclientmodels.ModelsSessionQueryResponse, *sessionbrowserclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
