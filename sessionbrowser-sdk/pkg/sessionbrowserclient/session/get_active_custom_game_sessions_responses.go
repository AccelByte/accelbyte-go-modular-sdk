...
type GetActiveCustomGameSessionsResponse struct {
	sessionbrowserclientmodels.ApiResponse
	Data *sessionbrowserclientmodels.ModelsActiveCustomGameResponse

	Error400 *sessionbrowserclientmodels.RestapiErrorResponseV2
	Error500 *sessionbrowserclientmodels.RestapiErrorResponseV2
}

func (m *GetActiveCustomGameSessionsResponse) Unpack() (*sessionbrowserclientmodels.ModelsActiveCustomGameResponse, *sessionbrowserclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
