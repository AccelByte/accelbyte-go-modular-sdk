...
type GetServerSessionTimeoutResponse struct {
	dsmcclientmodels.ApiResponse
	Data *dsmcclientmodels.ModelsServerDeploymentConfigSessionTimeoutResponse
...
func (m *GetServerSessionTimeoutResponse) Unpack() (*dsmcclientmodels.ModelsServerDeploymentConfigSessionTimeoutResponse, *dsmcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
