...
type GetServerSessionResponse struct {
	dsmcclientmodels.ApiResponse
	Data *dsmcclientmodels.ModelsServerSessionResponse
...
func (m *GetServerSessionResponse) Unpack() (*dsmcclientmodels.ModelsServerSessionResponse, *dsmcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
