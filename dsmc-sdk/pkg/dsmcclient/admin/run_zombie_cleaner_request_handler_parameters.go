...
// NewRunZombieCleanerRequestHandlerParams creates a new RunZombieCleanerRequestHandlerParams object
// with the default values initialized.
func NewRunZombieCleanerRequestHandlerParams() *RunZombieCleanerRequestHandlerParams {
	var ()
	return &RunZombieCleanerRequestHandlerParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewRunZombieCleanerRequestHandlerParamsWithTimeout creates a new RunZombieCleanerRequestHandlerParams object
...
// NewRunZombieCleanerRequestHandlerParamsWithContext creates a new RunZombieCleanerRequestHandlerParams object
...
// NewRunZombieCleanerRequestHandlerParamsWithHTTPClient creates a new RunZombieCleanerRequestHandlerParams object
...
/*RunZombieCleanerRequestHandlerParams contains all the parameters to send to the API endpoint
for the run zombie cleaner request handler operation typically these are written to a http.Request
*/
