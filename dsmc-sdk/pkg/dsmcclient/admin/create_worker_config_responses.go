...
type CreateWorkerConfigResponse struct {
	dsmcclientmodels.ApiResponse
	Data *dsmcclientmodels.ModelsWorkerConfig
...
func (m *CreateWorkerConfigResponse) Unpack() (*dsmcclientmodels.ModelsWorkerConfig, *dsmcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
