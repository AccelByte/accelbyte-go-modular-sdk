...
type GetServerResponse struct {
	...
	Data *dsmcclientmodels.ModelsServerDetailsResponse
...
func (m *GetServerResponse) Unpack() (*dsmcclientmodels.ModelsServerDetailsResponse, *dsmcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
