...
type CreatePodConfigClientResponse struct {
	dsmcclientmodels.ApiResponse
	Data *dsmcclientmodels.ModelsPodConfigRecord
...
func (m *CreatePodConfigClientResponse) Unpack() (*dsmcclientmodels.ModelsPodConfigRecord, *dsmcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
