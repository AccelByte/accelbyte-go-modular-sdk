...
type GetAllPodConfigClientResponse struct {
	dsmcclientmodels.ApiResponse
	Data *dsmcclientmodels.ModelsListPodConfigResponse
...
func (m *GetAllPodConfigClientResponse) Unpack() (*dsmcclientmodels.ModelsListPodConfigResponse, *dsmcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
