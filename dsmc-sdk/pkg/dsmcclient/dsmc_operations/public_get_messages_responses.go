...
type PublicGetMessagesResponse struct {
	...
	Data []*dsmcclientmodels.LogAppMessageDeclaration

	Error500 *dsmcclientmodels.ResponseError
}

func (m *PublicGetMessagesResponse) Unpack() ([]*dsmcclientmodels.LogAppMessageDeclaration, *dsmcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
