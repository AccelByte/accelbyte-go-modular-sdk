...
func (m *PagedResponseGetNamespaceEventResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PagedResponseGetNamespaceEventResponse) validateData(formats strfmt.Registry) error {
...
func (m *PagedResponseGetNamespaceEventResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *PagedResponseGetNamespaceEventResponse) UnmarshalBinary(b []byte) error {
	var res PagedResponseGetNamespaceEventResponse
