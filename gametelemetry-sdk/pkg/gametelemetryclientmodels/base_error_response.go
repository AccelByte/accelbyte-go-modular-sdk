...
func (m *BaseErrorResponse) validateErrorCode(formats strfmt.Registry) error {
...
func (m *BaseErrorResponse) validateErrorMessage(formats strfmt.Registry) error {
...
func (m *BaseErrorResponse) TranslateToApiError() (*ApiError, error) {
