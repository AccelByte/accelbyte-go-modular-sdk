...
type GetUserLeaderboardRankingsAdminV3Response struct {
...
func (m *GetUserLeaderboardRankingsAdminV3Response) Unpack() (*leaderboardclientmodels.ModelsGetAllUserLeaderboardsRespV3, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
