...
type GetTodayLeaderboardRankingPublicV1Response struct {
...
func (m *GetTodayLeaderboardRankingPublicV1Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
