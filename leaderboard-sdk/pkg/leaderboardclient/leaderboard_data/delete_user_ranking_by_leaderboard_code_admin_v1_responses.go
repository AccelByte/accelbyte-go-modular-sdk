...
type DeleteUserRankingByLeaderboardCodeAdminV1Response struct {
...
func (m *DeleteUserRankingByLeaderboardCodeAdminV1Response) Unpack() *leaderboardclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
