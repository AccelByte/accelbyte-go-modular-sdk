...
func (o *GetCurrentSeasonLeaderboardRankingAdminV1Params) SetFlightId(flightId string) {
	if o.XFlightId != nil {
...
func (o *GetCurrentSeasonLeaderboardRankingAdminV1Params) WithPreviousVersion(previousVersion *int64) *GetCurrentSeasonLeaderboardRankingAdminV1Params {
