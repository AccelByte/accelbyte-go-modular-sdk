...
type CreateArchivedLeaderboardRankingDataV1HandlerResponse struct {
...
func (m *CreateArchivedLeaderboardRankingDataV1HandlerResponse) Unpack() *leaderboardclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
