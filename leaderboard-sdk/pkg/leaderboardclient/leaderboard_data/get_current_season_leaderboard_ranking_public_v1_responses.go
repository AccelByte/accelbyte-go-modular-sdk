...
type GetCurrentSeasonLeaderboardRankingPublicV1Response struct {
...
func (m *GetCurrentSeasonLeaderboardRankingPublicV1Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
