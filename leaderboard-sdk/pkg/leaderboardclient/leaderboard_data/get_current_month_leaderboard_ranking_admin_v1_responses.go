...
type GetCurrentMonthLeaderboardRankingAdminV1Response struct {
...
func (m *GetCurrentMonthLeaderboardRankingAdminV1Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
