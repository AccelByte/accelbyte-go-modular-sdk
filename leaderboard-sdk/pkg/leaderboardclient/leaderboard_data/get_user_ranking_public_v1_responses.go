...
type GetUserRankingPublicV1Response struct {
...
func (m *GetUserRankingPublicV1Response) Unpack() (*leaderboardclientmodels.ModelsUserRankingResponse, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
