...
type GetAllTimeLeaderboardRankingPublicV2Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.V2GetPublicLeaderboardRankingResponse
...
func (m *GetAllTimeLeaderboardRankingPublicV2Response) Unpack() (*leaderboardclientmodels.V2GetPublicLeaderboardRankingResponse, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
