...
type AdminGetArchivedLeaderboardRankingDataV1HandlerResponse struct {
	leaderboardclientmodels.ApiResponse
	Data []*leaderboardclientmodels.ModelsArchiveLeaderboardSignedURLResponse
...
func (m *AdminGetArchivedLeaderboardRankingDataV1HandlerResponse) Unpack() ([]*leaderboardclientmodels.ModelsArchiveLeaderboardSignedURLResponse, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
