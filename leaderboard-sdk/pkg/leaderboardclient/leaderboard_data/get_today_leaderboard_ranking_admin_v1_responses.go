...
type GetTodayLeaderboardRankingAdminV1Response struct {
...
func (m *GetTodayLeaderboardRankingAdminV1Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
