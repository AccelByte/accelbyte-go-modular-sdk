...
type GetArchivedLeaderboardRankingDataV1HandlerResponse struct {
...
func (m *GetArchivedLeaderboardRankingDataV1HandlerResponse) Unpack() ([]*leaderboardclientmodels.ModelsArchiveLeaderboardSignedURLResponse, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
