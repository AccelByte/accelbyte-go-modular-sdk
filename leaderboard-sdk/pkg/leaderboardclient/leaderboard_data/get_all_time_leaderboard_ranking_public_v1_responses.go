...
type GetAllTimeLeaderboardRankingPublicV1Response struct {
...
func (m *GetAllTimeLeaderboardRankingPublicV1Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
