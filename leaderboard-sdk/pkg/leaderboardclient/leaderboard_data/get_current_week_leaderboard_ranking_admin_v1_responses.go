...
type GetCurrentWeekLeaderboardRankingAdminV1Response struct {
...
func (m *GetCurrentWeekLeaderboardRankingAdminV1Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
