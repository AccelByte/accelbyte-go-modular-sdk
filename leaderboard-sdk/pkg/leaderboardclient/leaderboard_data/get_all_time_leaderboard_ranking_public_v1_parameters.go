...
// NewGetAllTimeLeaderboardRankingPublicV1Params creates a new GetAllTimeLeaderboardRankingPublicV1Params object
// with the default values initialized.
func NewGetAllTimeLeaderboardRankingPublicV1Params() *GetAllTimeLeaderboardRankingPublicV1Params {
	var ()
	return &GetAllTimeLeaderboardRankingPublicV1Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAllTimeLeaderboardRankingPublicV1ParamsWithTimeout creates a new GetAllTimeLeaderboardRankingPublicV1Params object
...
// NewGetAllTimeLeaderboardRankingPublicV1ParamsWithContext creates a new GetAllTimeLeaderboardRankingPublicV1Params object
...
// NewGetAllTimeLeaderboardRankingPublicV1ParamsWithHTTPClient creates a new GetAllTimeLeaderboardRankingPublicV1Params object
...
/*GetAllTimeLeaderboardRankingPublicV1Params contains all the parameters to send to the API endpoint
for the get all time leaderboard ranking public v1 operation typically these are written to a http.Request
*/
...
func (o *GetAllTimeLeaderboardRankingPublicV1Params) WithTimeout(timeout time.Duration) *GetAllTimeLeaderboardRankingPublicV1Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get all time leaderboard ranking public v1 params
func (o *GetAllTimeLeaderboardRankingPublicV1Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get all time leaderboard ranking public v1 params
func (o *GetAllTimeLeaderboardRankingPublicV1Params) WithContext(ctx context.Context) *GetAllTimeLeaderboardRankingPublicV1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get all time leaderboard ranking public v1 params
func (o *GetAllTimeLeaderboardRankingPublicV1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *GetAllTimeLeaderboardRankingPublicV1Params) WithHTTPClient(client *http.Client) *GetAllTimeLeaderboardRankingPublicV1Params {
...
func (o *GetAllTimeLeaderboardRankingPublicV1Params) WithLeaderboardCode(leaderboardCode string) *GetAllTimeLeaderboardRankingPublicV1Params {
...
func (o *GetAllTimeLeaderboardRankingPublicV1Params) WithNamespace(namespace string) *GetAllTimeLeaderboardRankingPublicV1Params {
...
func (o *GetAllTimeLeaderboardRankingPublicV1Params) WithLimit(limit *int64) *GetAllTimeLeaderboardRankingPublicV1Params {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get all time leaderboard ranking public v1 params
func (o *GetAllTimeLeaderboardRankingPublicV1Params) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOffset adds the offset to the get all time leaderboard ranking public v1 params
func (o *GetAllTimeLeaderboardRankingPublicV1Params) WithOffset(offset *int64) *GetAllTimeLeaderboardRankingPublicV1Params {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAllTimeLeaderboardRankingPublicV1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
