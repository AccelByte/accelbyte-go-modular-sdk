...
type GetLeaderboardConfigurationsAdminV3Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.ModelsGetAllLeaderboardConfigsRespV3
...
func (m *GetLeaderboardConfigurationsAdminV3Response) Unpack() (*leaderboardclientmodels.ModelsGetAllLeaderboardConfigsRespV3, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
