...
type DeleteBulkLeaderboardConfigurationAdminV3Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.ModelsDeleteBulkLeaderboardsResp
...
func (m *DeleteBulkLeaderboardConfigurationAdminV3Response) Unpack() (*leaderboardclientmodels.ModelsDeleteBulkLeaderboardsResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
