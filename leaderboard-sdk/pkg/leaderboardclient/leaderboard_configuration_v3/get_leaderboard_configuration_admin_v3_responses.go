...
type GetLeaderboardConfigurationAdminV3Response struct {
...
func (m *GetLeaderboardConfigurationAdminV3Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardConfigRespV3, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
