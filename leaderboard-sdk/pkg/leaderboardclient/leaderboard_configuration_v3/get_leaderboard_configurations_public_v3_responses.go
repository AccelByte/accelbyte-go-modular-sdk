...
type GetLeaderboardConfigurationsPublicV3Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.ModelsGetAllLeaderboardConfigsPublicRespV3
...
func (m *GetLeaderboardConfigurationsPublicV3Response) Unpack() (*leaderboardclientmodels.ModelsGetAllLeaderboardConfigsPublicRespV3, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
