...
// NewUpdateLeaderboardConfigurationAdminV3Params creates a new UpdateLeaderboardConfigurationAdminV3Params object
// with the default values initialized.
func NewUpdateLeaderboardConfigurationAdminV3Params() *UpdateLeaderboardConfigurationAdminV3Params {
	var ()
	return &UpdateLeaderboardConfigurationAdminV3Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewUpdateLeaderboardConfigurationAdminV3ParamsWithTimeout creates a new UpdateLeaderboardConfigurationAdminV3Params object
...
// NewUpdateLeaderboardConfigurationAdminV3ParamsWithContext creates a new UpdateLeaderboardConfigurationAdminV3Params object
...
// NewUpdateLeaderboardConfigurationAdminV3ParamsWithHTTPClient creates a new UpdateLeaderboardConfigurationAdminV3Params object
...
/*
UpdateLeaderboardConfigurationAdminV3Params contains all the parameters to send to the API endpoint
for the update leaderboard configuration admin v3 operation typically these are written to a http.Request
*/
...
func (o *UpdateLeaderboardConfigurationAdminV3Params) SetFlightId(flightId string) {
	if o.XFlightId != nil {
