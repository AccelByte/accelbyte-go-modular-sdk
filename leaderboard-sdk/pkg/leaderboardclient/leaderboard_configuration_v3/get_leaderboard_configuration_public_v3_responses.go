...
type GetLeaderboardConfigurationPublicV3Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.ModelsGetLeaderboardConfigPublicRespV3
...
func (m *GetLeaderboardConfigurationPublicV3Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardConfigPublicRespV3, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
