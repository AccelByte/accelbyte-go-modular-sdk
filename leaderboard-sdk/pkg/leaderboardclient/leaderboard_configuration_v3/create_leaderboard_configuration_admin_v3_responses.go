...
type CreateLeaderboardConfigurationAdminV3Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.ModelsGetLeaderboardConfigRespV3
...
func (m *CreateLeaderboardConfigurationAdminV3Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardConfigRespV3, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
