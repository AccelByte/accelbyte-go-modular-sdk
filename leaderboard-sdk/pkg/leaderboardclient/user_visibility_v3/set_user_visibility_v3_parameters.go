...
// NewSetUserVisibilityV3Params creates a new SetUserVisibilityV3Params object
// with the default values initialized.
func NewSetUserVisibilityV3Params() *SetUserVisibilityV3Params {
	var ()
	return &SetUserVisibilityV3Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewSetUserVisibilityV3ParamsWithTimeout creates a new SetUserVisibilityV3Params object
...
// NewSetUserVisibilityV3ParamsWithContext creates a new SetUserVisibilityV3Params object
...
// NewSetUserVisibilityV3ParamsWithHTTPClient creates a new SetUserVisibilityV3Params object
...
func (o *SetUserVisibilityV3Params) WithTimeout(timeout time.Duration) *SetUserVisibilityV3Params {
...
func (o *SetUserVisibilityV3Params) WithContext(ctx context.Context) *SetUserVisibilityV3Params {
	o.SetContext(ctx)
	return o
}
...
func (o *SetUserVisibilityV3Params) WithBody(body *leaderboardclientmodels.ModelsSetUserVisibilityRequest) *SetUserVisibilityV3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the set user visibility v3 params
func (o *SetUserVisibilityV3Params) SetBody(body *leaderboardclientmodels.ModelsSetUserVisibilityRequest) {
	o.Body = body
}
...
func (o *SetUserVisibilityV3Params) WithUserID(userID string) *SetUserVisibilityV3Params {
	o.SetUserID(userID)
	return o
}
...
func (o *SetUserVisibilityV3Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
