...
type GetUserVisibilityStatusV3Response struct {
...
func (m *GetUserVisibilityStatusV3Response) Unpack() (*leaderboardclientmodels.ModelsGetUserVisibilityResponse, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
