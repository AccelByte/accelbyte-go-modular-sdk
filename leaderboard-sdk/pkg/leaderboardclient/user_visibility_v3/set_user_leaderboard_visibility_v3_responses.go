...
func (o *SetUserLeaderboardVisibilityV3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 403:
		...
		return result, nil
	case 404:
		result := NewSetUserLeaderboardVisibilityV3NotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewSetUserLeaderboardVisibilityV3NotFound creates a SetUserLeaderboardVisibilityV3NotFound with default headers values
func NewSetUserLeaderboardVisibilityV3NotFound() *SetUserLeaderboardVisibilityV3NotFound {
	return &SetUserLeaderboardVisibilityV3NotFound{}
}

/*SetUserLeaderboardVisibilityV3NotFound handles this case with default header values.

  Not Found
*/
type SetUserLeaderboardVisibilityV3NotFound struct {
	Payload *leaderboardclientmodels.ResponseErrorResponse
}

func (o *SetUserLeaderboardVisibilityV3NotFound) Error() string {
	return fmt.Sprintf("[PUT /leaderboard/v3/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/users/{userId}/visibility][%d] setUserLeaderboardVisibilityV3NotFound  %+v", 404, o.ToJSONString())
}

func (o *SetUserLeaderboardVisibilityV3NotFound) ToJSONString() string {
	if o.Payload == nil {
		return "{}"
	}
...
func (o *SetUserLeaderboardVisibilityV3NotFound) GetPayload() *leaderboardclientmodels.ResponseErrorResponse {
	return o.Payload
}

func (o *SetUserLeaderboardVisibilityV3NotFound) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	// handle file responses
	contentDisposition := response.GetHeader("Content-Disposition")
	if strings.Contains(strings.ToLower(contentDisposition), "filename=") {
		consumer = runtime.ByteStreamConsumer()
