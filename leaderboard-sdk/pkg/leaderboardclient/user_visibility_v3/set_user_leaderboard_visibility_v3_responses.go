...
type SetUserLeaderboardVisibilityV3Response struct {
...
func (m *SetUserLeaderboardVisibilityV3Response) Unpack() (*leaderboardclientmodels.ModelsGetUserVisibilityResponse, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
