...
type SetUserVisibilityV3Response struct {
...
func (m *SetUserVisibilityV3Response) Unpack() (*leaderboardclientmodels.ModelsGetUserVisibilityResponse, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
