...
type GetLeaderboardConfigurationsAdminV1Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.ModelsGetAllLeaderboardConfigsResp
...
func (m *GetLeaderboardConfigurationsAdminV1Response) Unpack() (*leaderboardclientmodels.ModelsGetAllLeaderboardConfigsResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
