...
type CreateLeaderboardConfigurationAdminV1Response struct {
...
func (m *CreateLeaderboardConfigurationAdminV1Response) Unpack() (*leaderboardclientmodels.ModelsLeaderboardConfigReq, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
