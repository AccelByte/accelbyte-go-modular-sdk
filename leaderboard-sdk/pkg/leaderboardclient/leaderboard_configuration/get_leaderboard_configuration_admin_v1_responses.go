...
type GetLeaderboardConfigurationAdminV1Response struct {
...
func (m *GetLeaderboardConfigurationAdminV1Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardConfigResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
