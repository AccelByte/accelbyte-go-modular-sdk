...
type CreateLeaderboardConfigurationPublicV1Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.ModelsLeaderboardConfigReq
...
func (m *CreateLeaderboardConfigurationPublicV1Response) Unpack() (*leaderboardclientmodels.ModelsLeaderboardConfigReq, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
