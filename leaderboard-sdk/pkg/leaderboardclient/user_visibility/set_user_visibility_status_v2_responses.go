...
type SetUserVisibilityStatusV2Response struct {
...
func (m *SetUserVisibilityStatusV2Response) Unpack() (*leaderboardclientmodels.ModelsGetUserVisibilityResponse, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
