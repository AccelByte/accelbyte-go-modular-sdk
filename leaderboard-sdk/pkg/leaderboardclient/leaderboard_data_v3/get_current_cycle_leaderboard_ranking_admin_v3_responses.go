...
type GetCurrentCycleLeaderboardRankingAdminV3Response struct {
...
func (m *GetCurrentCycleLeaderboardRankingAdminV3Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
