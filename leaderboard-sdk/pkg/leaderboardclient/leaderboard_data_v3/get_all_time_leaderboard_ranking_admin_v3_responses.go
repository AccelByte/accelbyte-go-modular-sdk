...
type GetAllTimeLeaderboardRankingAdminV3Response struct {
...
func (m *GetAllTimeLeaderboardRankingAdminV3Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
