...
// WithPreviousVersion adds the previousVersion to the get user ranking admin v3 params
func (o *GetUserRankingAdminV3Params) WithPreviousVersion(previousVersion *int64) *GetUserRankingAdminV3Params {
	o.SetPreviousVersion(previousVersion)
	return o
}

// SetPreviousVersion adds the previousVersion to the get user ranking admin v3 params
func (o *GetUserRankingAdminV3Params) SetPreviousVersion(previousVersion *int64) {
