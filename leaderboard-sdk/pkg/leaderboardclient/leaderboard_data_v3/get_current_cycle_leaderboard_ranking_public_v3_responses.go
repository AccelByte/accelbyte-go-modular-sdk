...
type GetCurrentCycleLeaderboardRankingPublicV3Response struct {
...
func (m *GetCurrentCycleLeaderboardRankingPublicV3Response) Unpack() (*leaderboardclientmodels.ModelsGetLeaderboardRankingResp, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
