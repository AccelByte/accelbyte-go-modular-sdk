...
type GetUserRankingAdminV3Response struct {
...
func (m *GetUserRankingAdminV3Response) Unpack() (*leaderboardclientmodels.ModelsUserRankingResponseV3, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
