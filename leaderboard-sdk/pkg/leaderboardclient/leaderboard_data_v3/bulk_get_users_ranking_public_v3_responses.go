...
type BulkGetUsersRankingPublicV3Response struct {
	leaderboardclientmodels.ApiResponse
	Data *leaderboardclientmodels.ModelsBulkUserRankingResponseV3
...
func (m *BulkGetUsersRankingPublicV3Response) Unpack() (*leaderboardclientmodels.ModelsBulkUserRankingResponseV3, *leaderboardclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
