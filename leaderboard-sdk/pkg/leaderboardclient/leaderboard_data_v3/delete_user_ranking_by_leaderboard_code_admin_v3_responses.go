...
type DeleteUserRankingByLeaderboardCodeAdminV3Response struct {
...
func (m *DeleteUserRankingByLeaderboardCodeAdminV3Response) Unpack() *leaderboardclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
