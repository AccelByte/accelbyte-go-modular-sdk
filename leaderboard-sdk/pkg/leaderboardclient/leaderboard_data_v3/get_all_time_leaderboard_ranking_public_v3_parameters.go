...
// NewGetAllTimeLeaderboardRankingPublicV3Params creates a new GetAllTimeLeaderboardRankingPublicV3Params object
// with the default values initialized.
func NewGetAllTimeLeaderboardRankingPublicV3Params() *GetAllTimeLeaderboardRankingPublicV3Params {
	var ()
	return &GetAllTimeLeaderboardRankingPublicV3Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetAllTimeLeaderboardRankingPublicV3ParamsWithTimeout creates a new GetAllTimeLeaderboardRankingPublicV3Params object
...
// NewGetAllTimeLeaderboardRankingPublicV3ParamsWithContext creates a new GetAllTimeLeaderboardRankingPublicV3Params object
...
// NewGetAllTimeLeaderboardRankingPublicV3ParamsWithHTTPClient creates a new GetAllTimeLeaderboardRankingPublicV3Params object
...
/*
GetAllTimeLeaderboardRankingPublicV3Params contains all the parameters to send to the API endpoint
for the get all time leaderboard ranking public v3 operation typically these are written to a http.Request
*/
...
func (o *GetAllTimeLeaderboardRankingPublicV3Params) WithTimeout(timeout time.Duration) *GetAllTimeLeaderboardRankingPublicV3Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get all time leaderboard ranking public v3 params
func (o *GetAllTimeLeaderboardRankingPublicV3Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get all time leaderboard ranking public v3 params
func (o *GetAllTimeLeaderboardRankingPublicV3Params) WithContext(ctx context.Context) *GetAllTimeLeaderboardRankingPublicV3Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get all time leaderboard ranking public v3 params
func (o *GetAllTimeLeaderboardRankingPublicV3Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *GetAllTimeLeaderboardRankingPublicV3Params) WithHTTPClient(client *http.Client) *GetAllTimeLeaderboardRankingPublicV3Params {
...
func (o *GetAllTimeLeaderboardRankingPublicV3Params) WithLeaderboardCode(leaderboardCode string) *GetAllTimeLeaderboardRankingPublicV3Params {
...
func (o *GetAllTimeLeaderboardRankingPublicV3Params) WithNamespace(namespace string) *GetAllTimeLeaderboardRankingPublicV3Params {
...
func (o *GetAllTimeLeaderboardRankingPublicV3Params) WithLimit(limit *int64) *GetAllTimeLeaderboardRankingPublicV3Params {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get all time leaderboard ranking public v3 params
func (o *GetAllTimeLeaderboardRankingPublicV3Params) SetLimit(limit *int64) {
	o.Limit = limit
}

// WithOffset adds the offset to the get all time leaderboard ranking public v3 params
func (o *GetAllTimeLeaderboardRankingPublicV3Params) WithOffset(offset *int64) *GetAllTimeLeaderboardRankingPublicV3Params {
	o.SetOffset(offset)
	return o
}
...
func (o *GetAllTimeLeaderboardRankingPublicV3Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
