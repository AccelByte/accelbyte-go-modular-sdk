...
func (m *V2GetAllLeaderboardConfigsPublicResp) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V2GetAllLeaderboardConfigsPublicResp) validateData(formats strfmt.Registry) error {
...
func (m *V2GetAllLeaderboardConfigsPublicResp) validatePaging(formats strfmt.Registry) error {
...
func (m *V2GetAllLeaderboardConfigsPublicResp) UnmarshalBinary(b []byte) error {
	var res V2GetAllLeaderboardConfigsPublicResp
