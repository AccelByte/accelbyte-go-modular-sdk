...
func (m *ModelsGetAllLeaderboardConfigsRespV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsGetAllLeaderboardConfigsRespV3) validateData(formats strfmt.Registry) error {
...
func (m *ModelsGetAllLeaderboardConfigsRespV3) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsGetAllLeaderboardConfigsRespV3) UnmarshalBinary(b []byte) error {
	var res ModelsGetAllLeaderboardConfigsRespV3
