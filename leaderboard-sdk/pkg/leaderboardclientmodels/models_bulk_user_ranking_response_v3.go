...
func (m *ModelsBulkUserRankingResponseV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsBulkUserRankingResponseV3) validateData(formats strfmt.Registry) error {
...
func (m *ModelsBulkUserRankingResponseV3) UnmarshalBinary(b []byte) error {
	var res ModelsBulkUserRankingResponseV3
