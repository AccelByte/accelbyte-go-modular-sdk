...
func (m *ModelsUserLeaderboardRanking) validateAllTime(formats strfmt.Registry) error {
...
func (m *ModelsUserLeaderboardRanking) validateCurrent(formats strfmt.Registry) error {
...
func (m *ModelsUserLeaderboardRanking) validateDaily(formats strfmt.Registry) error {
...
func (m *ModelsUserLeaderboardRanking) validateLeaderboardCode(formats strfmt.Registry) error {
...
func (m *ModelsUserLeaderboardRanking) validateLeaderboardName(formats strfmt.Registry) error {
...
func (m *ModelsUserLeaderboardRanking) validateMonthly(formats strfmt.Registry) error {
...
func (m *ModelsUserLeaderboardRanking) validateUserID(formats strfmt.Registry) error {
...
func (m *ModelsUserLeaderboardRanking) validateWeekly(formats strfmt.Registry) error {
...
func (m *ModelsUserLeaderboardRanking) UnmarshalBinary(b []byte) error {
	var res ModelsUserLeaderboardRanking
