...
func (m *ModelsGetAllLeaderboardConfigsPublicResp) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsGetAllLeaderboardConfigsPublicResp) validateData(formats strfmt.Registry) error {
...
func (m *ModelsGetAllLeaderboardConfigsPublicResp) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsGetAllLeaderboardConfigsPublicResp) UnmarshalBinary(b []byte) error {
	var res ModelsGetAllLeaderboardConfigsPublicResp
