...
func (m *ModelsGetAllLeaderboardConfigsPublicRespV3) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsGetAllLeaderboardConfigsPublicRespV3) validateData(formats strfmt.Registry) error {
...
func (m *ModelsGetAllLeaderboardConfigsPublicRespV3) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsGetAllLeaderboardConfigsPublicRespV3) UnmarshalBinary(b []byte) error {
	var res ModelsGetAllLeaderboardConfigsPublicRespV3
