...
func (m *ModelsGetAllLeaderboardConfigsResp) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsGetAllLeaderboardConfigsResp) validateData(formats strfmt.Registry) error {
...
func (m *ModelsGetAllLeaderboardConfigsResp) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsGetAllLeaderboardConfigsResp) UnmarshalBinary(b []byte) error {
	var res ModelsGetAllLeaderboardConfigsResp
