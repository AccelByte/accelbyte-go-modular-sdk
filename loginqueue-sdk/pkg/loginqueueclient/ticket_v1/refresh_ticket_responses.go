...
type RefreshTicketResponse struct {
	...
	Data *loginqueueclientmodels.ApimodelsRefreshTicketResponse

	Error401 *loginqueueclientmodels.ResponseError
	Error500 *loginqueueclientmodels.ResponseError
}

func (m *RefreshTicketResponse) Unpack() (*loginqueueclientmodels.ApimodelsRefreshTicketResponse, *loginqueueclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
