...
type AdminGetConfigurationResponse struct {
...
func (m *AdminGetConfigurationResponse) Unpack() (*loginqueueclientmodels.ApimodelsConfigurationResponse, *loginqueueclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
