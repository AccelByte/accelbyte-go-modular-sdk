...
type AdminGetStatusResponse struct {
	...
	Data *loginqueueclientmodels.ApimodelsQueueStatusResponse
...
func (m *AdminGetStatusResponse) Unpack() (*loginqueueclientmodels.ApimodelsQueueStatusResponse, *loginqueueclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
