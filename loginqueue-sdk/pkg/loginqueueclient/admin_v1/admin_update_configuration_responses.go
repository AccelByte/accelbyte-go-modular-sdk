...
type AdminUpdateConfigurationResponse struct {
	loginqueueclientmodels.ApiResponse
	Data *loginqueueclientmodels.ApimodelsConfigurationResponse

	Error400 *loginqueueclientmodels.ResponseError
	Error401 *loginqueueclientmodels.ResponseError
	Error403 *loginqueueclientmodels.ResponseError
	Error500 *loginqueueclientmodels.ResponseError
}

func (m *AdminUpdateConfigurationResponse) Unpack() (*loginqueueclientmodels.ApimodelsConfigurationResponse, *loginqueueclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
		...
		default:
			return nil, &loginqueueclientmodels.ApiError{Code: "500", Message: "Unknown error"}
		}
	}
