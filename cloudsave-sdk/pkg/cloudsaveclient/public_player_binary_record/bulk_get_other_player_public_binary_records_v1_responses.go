...
type BulkGetOtherPlayerPublicBinaryRecordsV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsBulkGetPlayerBinaryRecordResponse
...
func (m *BulkGetOtherPlayerPublicBinaryRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
