...
type BulkGetPlayerPublicBinaryRecordsV1Response struct {
...
func (m *BulkGetPlayerPublicBinaryRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
