...
type ListMyBinaryRecordsV1Response struct {
...
func (m *ListMyBinaryRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsListPlayerBinaryRecordsResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
