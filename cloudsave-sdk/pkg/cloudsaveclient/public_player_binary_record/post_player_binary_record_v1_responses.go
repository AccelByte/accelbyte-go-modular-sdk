...
type PostPlayerBinaryRecordV1Response struct {
...
func (m *PostPlayerBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
