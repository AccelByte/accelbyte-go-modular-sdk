...
type PutPlayerBinaryRecorMetadataV1Response struct {
...
func (m *PutPlayerBinaryRecorMetadataV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
