...
type GetPlayerPublicBinaryRecordsV1Response struct {
...
func (m *GetPlayerPublicBinaryRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
