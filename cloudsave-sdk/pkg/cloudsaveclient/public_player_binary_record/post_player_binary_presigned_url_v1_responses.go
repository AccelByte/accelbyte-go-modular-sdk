...
type PostPlayerBinaryPresignedURLV1Response struct {
...
func (m *PostPlayerBinaryPresignedURLV1Response) Unpack() (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
