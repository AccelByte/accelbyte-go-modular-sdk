...
type BulkGetMyBinaryRecordV1Response struct {
...
func (m *BulkGetMyBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
