...
type ListOtherPlayerPublicBinaryRecordsV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsListPlayerBinaryRecordsResponse
...
func (m *ListOtherPlayerPublicBinaryRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsListPlayerBinaryRecordsResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
