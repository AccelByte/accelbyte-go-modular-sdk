...
type GetPlayerBinaryRecordV1Response struct {
...
func (m *GetPlayerBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *GetPlayerBinaryRecordV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 401:
		...
		return result, nil
	case 403:
		result := NewGetPlayerBinaryRecordV1Forbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewGetPlayerBinaryRecordV1Forbidden() *GetPlayerBinaryRecordV1Forbidden {
	return &GetPlayerBinaryRecordV1Forbidden{}
}
...
func (o *GetPlayerBinaryRecordV1Forbidden) Error() string {
	return fmt.Sprintf("[GET /cloudsave/v1/namespaces/{namespace}/users/{userId}/binaries/{key}][%d] getPlayerBinaryRecordV1Forbidden  %+v", 403, o.ToJSONString())
}
...
func (o *GetPlayerBinaryRecordV1Forbidden) GetPayload() *cloudsaveclientmodels.ModelsResponseError {
	return o.Payload
}

func (o *GetPlayerBinaryRecordV1Forbidden) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
