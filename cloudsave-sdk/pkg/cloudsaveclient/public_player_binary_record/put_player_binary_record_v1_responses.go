...
type PutPlayerBinaryRecordV1Response struct {
...
func (m *PutPlayerBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
