...
type ClientService interface {
	...
	AdminDeleteTagHandlerV1(params *AdminDeleteTagHandlerV1Params, authInfo runtime.ClientAuthInfoWriter) (*AdminDeleteTagHandlerV1NoContent, *AdminDeleteTagHandlerV1Unauthorized, *AdminDeleteTagHandlerV1Forbidden, *AdminDeleteTagHandlerV1NotFound, *AdminDeleteTagHandlerV1InternalServerError, error)
...
*/
func (a *Client) AdminDeleteTagHandlerV1(params *AdminDeleteTagHandlerV1Params, authInfo runtime.ClientAuthInfoWriter) (*AdminDeleteTagHandlerV1NoContent, *AdminDeleteTagHandlerV1Unauthorized, *AdminDeleteTagHandlerV1Forbidden, *AdminDeleteTagHandlerV1NotFound, *AdminDeleteTagHandlerV1InternalServerError, error) {
	// TODO: Validate the params before sending
	if params == nil {
