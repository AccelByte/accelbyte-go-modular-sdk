...
type AdminListTagsHandlerV1Response struct {
...
func (m *AdminListTagsHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsListTagsResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
