...
/*AdminListTagsHandlerV1Params contains all the parameters to send to the API endpoint
for the admin list tags handler v1 operation typically these are written to a http.Request
*/
...
func (o *AdminListTagsHandlerV1Params) WithTimeout(timeout time.Duration) *AdminListTagsHandlerV1Params {
...
func (o *AdminListTagsHandlerV1Params) WithContext(ctx context.Context) *AdminListTagsHandlerV1Params {
	o.SetContext(ctx)
	return o
}
...
func (o *AdminListTagsHandlerV1Params) WithHTTPClient(client *http.Client) *AdminListTagsHandlerV1Params {
...
func (o *AdminListTagsHandlerV1Params) WithNamespace(namespace string) *AdminListTagsHandlerV1Params {
