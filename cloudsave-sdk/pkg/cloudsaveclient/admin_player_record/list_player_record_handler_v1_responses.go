...
type ListPlayerRecordHandlerV1Response struct {
...
func (m *ListPlayerRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsListPlayerRecordKeysResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
