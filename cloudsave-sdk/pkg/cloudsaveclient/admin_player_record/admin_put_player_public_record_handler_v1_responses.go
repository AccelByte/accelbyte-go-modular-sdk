...
type AdminPutPlayerPublicRecordHandlerV1Response struct {
...
func (m *AdminPutPlayerPublicRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
