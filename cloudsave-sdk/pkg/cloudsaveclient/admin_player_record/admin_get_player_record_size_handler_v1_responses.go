...
type AdminGetPlayerRecordSizeHandlerV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsPlayerRecordSizeResponse
...
func (m *AdminGetPlayerRecordSizeHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordSizeResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
