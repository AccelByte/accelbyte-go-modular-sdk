...
type AdminRetrievePlayerRecordsResponse struct {
...
func (m *AdminRetrievePlayerRecordsResponse) Unpack() (*cloudsaveclientmodels.ModelsListPlayerRecordKeysResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
