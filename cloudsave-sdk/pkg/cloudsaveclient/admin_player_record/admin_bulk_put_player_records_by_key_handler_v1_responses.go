...
type AdminBulkPutPlayerRecordsByKeyHandlerV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data []*cloudsaveclientmodels.ModelsBulkUpdatePlayerRecordByKeyResponse
...
func (m *AdminBulkPutPlayerRecordsByKeyHandlerV1Response) Unpack() ([]*cloudsaveclientmodels.ModelsBulkUpdatePlayerRecordByKeyResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
