...
type AdminPostPlayerPublicRecordHandlerV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsPlayerRecordResponse
...
func (m *AdminPostPlayerPublicRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
