...
type AdminGetPlayerRecordsHandlerV1Response struct {
...
func (m *AdminGetPlayerRecordsHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetAdminPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
