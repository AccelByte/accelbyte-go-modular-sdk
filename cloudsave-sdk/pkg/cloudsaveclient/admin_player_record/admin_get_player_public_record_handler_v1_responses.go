...
type AdminGetPlayerPublicRecordHandlerV1Response struct {
...
func (m *AdminGetPlayerPublicRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
