...
type AdminGetPlayerRecordHandlerV1Response struct {
...
func (m *AdminGetPlayerRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
