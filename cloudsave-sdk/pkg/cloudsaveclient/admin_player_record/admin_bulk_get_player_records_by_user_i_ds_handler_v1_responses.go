...
type AdminBulkGetPlayerRecordsByUserIDsHandlerV1Response struct {
...
func (m *AdminBulkGetPlayerRecordsByUserIDsHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
