...
type AdminPostPlayerBinaryRecordV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsUploadBinaryRecordResponse
	...
	Error409 *cloudsaveclientmodels.ModelsResponseError
	Error500 *cloudsaveclientmodels.ModelsResponseError
}

func (m *AdminPostPlayerBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
