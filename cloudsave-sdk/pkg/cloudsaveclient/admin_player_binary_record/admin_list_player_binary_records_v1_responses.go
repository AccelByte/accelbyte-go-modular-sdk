...
type AdminListPlayerBinaryRecordsV1Response struct {
...
func (m *AdminListPlayerBinaryRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsListPlayerBinaryRecordsResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
