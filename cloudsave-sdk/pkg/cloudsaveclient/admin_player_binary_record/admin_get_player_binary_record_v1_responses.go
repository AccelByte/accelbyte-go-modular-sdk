...
type AdminGetPlayerBinaryRecordV1Response struct {
...
func (m *AdminGetPlayerBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
