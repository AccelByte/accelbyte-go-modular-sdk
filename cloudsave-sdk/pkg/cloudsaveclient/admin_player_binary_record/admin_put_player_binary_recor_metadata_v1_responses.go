...
type AdminPutPlayerBinaryRecorMetadataV1Response struct {
...
func (m *AdminPutPlayerBinaryRecorMetadataV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
