...
type AdminPostPlayerBinaryPresignedURLV1Response struct {
...
func (m *AdminPostPlayerBinaryPresignedURLV1Response) Unpack() (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
