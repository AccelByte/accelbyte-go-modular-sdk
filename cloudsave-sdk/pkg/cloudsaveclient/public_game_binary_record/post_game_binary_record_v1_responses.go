...
type PostGameBinaryRecordV1Response struct {
...
func (m *PostGameBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
