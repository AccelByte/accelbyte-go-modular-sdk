...
type BulkGetGameBinaryRecordV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsBulkGetGameBinaryRecordResponse
...
func (m *BulkGetGameBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetGameBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
