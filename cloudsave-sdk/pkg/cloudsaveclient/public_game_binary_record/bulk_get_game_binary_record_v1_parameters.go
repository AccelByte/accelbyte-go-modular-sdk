...
// NewBulkGetGameBinaryRecordV1Params creates a new BulkGetGameBinaryRecordV1Params object
// with the default values initialized.
func NewBulkGetGameBinaryRecordV1Params() *BulkGetGameBinaryRecordV1Params {
	var ()
	return &BulkGetGameBinaryRecordV1Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewBulkGetGameBinaryRecordV1ParamsWithTimeout creates a new BulkGetGameBinaryRecordV1Params object
...
// NewBulkGetGameBinaryRecordV1ParamsWithContext creates a new BulkGetGameBinaryRecordV1Params object
...
// NewBulkGetGameBinaryRecordV1ParamsWithHTTPClient creates a new BulkGetGameBinaryRecordV1Params object
...
/*BulkGetGameBinaryRecordV1Params contains all the parameters to send to the API endpoint
for the bulk get game binary record v1 operation typically these are written to a http.Request
*/
