...
type PostGameBinaryPresignedURLV1Response struct {
...
func (m *PostGameBinaryPresignedURLV1Response) Unpack() (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
