...
type ListGameBinaryRecordsV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsListGameBinaryRecordsResponse
...
func (m *ListGameBinaryRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsListGameBinaryRecordsResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
