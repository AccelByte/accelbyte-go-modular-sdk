...
type PutGameRecordHandlerV1Response struct {
...
func (m *PutGameRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsGameRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
