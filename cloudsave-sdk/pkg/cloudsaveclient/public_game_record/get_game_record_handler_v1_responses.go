...
type GetGameRecordHandlerV1Response struct {
...
func (m *GetGameRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsGameRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
