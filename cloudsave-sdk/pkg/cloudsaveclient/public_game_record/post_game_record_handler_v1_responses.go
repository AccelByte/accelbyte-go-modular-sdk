...
type PostGameRecordHandlerV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsGameRecordResponse
...
func (m *PostGameRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsGameRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
