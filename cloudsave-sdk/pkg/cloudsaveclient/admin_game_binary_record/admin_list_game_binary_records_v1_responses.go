...
type AdminListGameBinaryRecordsV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsListGameBinaryRecordsAdminResponse
...
func (m *AdminListGameBinaryRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsListGameBinaryRecordsAdminResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
