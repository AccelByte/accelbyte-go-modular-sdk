...
type AdminPostGameBinaryPresignedURLV1Response struct {
...
func (m *AdminPostGameBinaryPresignedURLV1Response) Unpack() (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
