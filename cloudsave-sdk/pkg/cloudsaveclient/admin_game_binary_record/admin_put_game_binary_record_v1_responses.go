...
type AdminPutGameBinaryRecordV1Response struct {
...
func (m *AdminPutGameBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsGameBinaryRecordAdminResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
