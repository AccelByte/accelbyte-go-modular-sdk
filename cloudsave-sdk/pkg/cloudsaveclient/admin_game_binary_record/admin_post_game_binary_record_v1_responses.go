...
type AdminPostGameBinaryRecordV1Response struct {
...
func (m *AdminPostGameBinaryRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
