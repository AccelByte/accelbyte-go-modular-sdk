...
type AdminPostPlayerAdminRecordV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsAdminPlayerRecordResponse
...
func (m *AdminPostPlayerAdminRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsAdminPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
