...
type BulkGetAdminPlayerRecordByUserIdsV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsBulkGetAdminPlayerRecordResponse
...
func (m *BulkGetAdminPlayerRecordByUserIdsV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetAdminPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
