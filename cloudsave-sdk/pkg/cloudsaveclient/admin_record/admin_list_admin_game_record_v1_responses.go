...
type AdminListAdminGameRecordV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsListAdminGameRecordKeysResponse
...
func (m *AdminListAdminGameRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsListAdminGameRecordKeysResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
