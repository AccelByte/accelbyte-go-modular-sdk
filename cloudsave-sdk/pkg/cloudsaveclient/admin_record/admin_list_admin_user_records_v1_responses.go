...
type AdminListAdminUserRecordsV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsListAdminPlayerRecordKeysResponse
...
func (m *AdminListAdminUserRecordsV1Response) Unpack() (*cloudsaveclientmodels.ModelsListAdminPlayerRecordKeysResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
