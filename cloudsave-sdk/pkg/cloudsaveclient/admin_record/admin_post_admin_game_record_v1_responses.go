...
type AdminPostAdminGameRecordV1Response struct {
...
func (m *AdminPostAdminGameRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsAdminGameRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
