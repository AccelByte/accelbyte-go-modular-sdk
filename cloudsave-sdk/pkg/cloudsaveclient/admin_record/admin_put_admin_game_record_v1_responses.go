...
type AdminPutAdminGameRecordV1Response struct {
...
func (m *AdminPutAdminGameRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsAdminGameRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
