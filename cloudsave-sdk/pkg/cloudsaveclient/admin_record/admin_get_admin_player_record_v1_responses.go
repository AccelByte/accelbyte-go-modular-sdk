...
type AdminGetAdminPlayerRecordV1Response struct {
...
func (m *AdminGetAdminPlayerRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsAdminPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
