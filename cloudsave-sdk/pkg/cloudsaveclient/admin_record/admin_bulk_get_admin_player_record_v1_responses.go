...
type AdminBulkGetAdminPlayerRecordV1Response struct {
...
func (m *AdminBulkGetAdminPlayerRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetAdminPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
