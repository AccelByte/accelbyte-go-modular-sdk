...
type AdminPutAdminPlayerRecordV1Response struct {
...
func (m *AdminPutAdminPlayerRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsAdminPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
