...
// NewAdminBulkGetAdminGameRecordV1Params creates a new AdminBulkGetAdminGameRecordV1Params object
// with the default values initialized.
func NewAdminBulkGetAdminGameRecordV1Params() *AdminBulkGetAdminGameRecordV1Params {
	var ()
	return &AdminBulkGetAdminGameRecordV1Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminBulkGetAdminGameRecordV1ParamsWithTimeout creates a new AdminBulkGetAdminGameRecordV1Params object
...
// NewAdminBulkGetAdminGameRecordV1ParamsWithContext creates a new AdminBulkGetAdminGameRecordV1Params object
...
// NewAdminBulkGetAdminGameRecordV1ParamsWithHTTPClient creates a new AdminBulkGetAdminGameRecordV1Params object
...
func (o *AdminBulkGetAdminGameRecordV1Params) WithTimeout(timeout time.Duration) *AdminBulkGetAdminGameRecordV1Params {
...
func (o *AdminBulkGetAdminGameRecordV1Params) WithContext(ctx context.Context) *AdminBulkGetAdminGameRecordV1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the admin bulk get admin game record v1 params
func (o *AdminBulkGetAdminGameRecordV1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *AdminBulkGetAdminGameRecordV1Params) WithHTTPClient(client *http.Client) *AdminBulkGetAdminGameRecordV1Params {
...
func (o *AdminBulkGetAdminGameRecordV1Params) WithBody(body *cloudsaveclientmodels.ModelsBulkGetAdminGameRecordRequest) *AdminBulkGetAdminGameRecordV1Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the admin bulk get admin game record v1 params
func (o *AdminBulkGetAdminGameRecordV1Params) SetBody(body *cloudsaveclientmodels.ModelsBulkGetAdminGameRecordRequest) {
	o.Body = body
}

// WithNamespace adds the namespace to the admin bulk get admin game record v1 params
func (o *AdminBulkGetAdminGameRecordV1Params) WithNamespace(namespace string) *AdminBulkGetAdminGameRecordV1Params {
...
func (o *AdminBulkGetAdminGameRecordV1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
