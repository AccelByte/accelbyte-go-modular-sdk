...
type AdminBulkGetAdminGameRecordV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsBulkGetAdminGameRecordResponse
...
func (m *AdminBulkGetAdminGameRecordV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetAdminGameRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
