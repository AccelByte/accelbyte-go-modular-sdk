...
type PostPlayerPublicRecordHandlerV1Response struct {
...
func (m *PostPlayerPublicRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
