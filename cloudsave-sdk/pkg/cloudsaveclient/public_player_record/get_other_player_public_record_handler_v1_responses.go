...
type GetOtherPlayerPublicRecordHandlerV1Response struct {
...
func (m *GetOtherPlayerPublicRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsBulkGetPlayerRecordResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
