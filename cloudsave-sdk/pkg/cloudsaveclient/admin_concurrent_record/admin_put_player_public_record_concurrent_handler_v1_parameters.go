...
func (o *AdminPutPlayerPublicRecordConcurrentHandlerV1Params) SetFlightId(flightId string) {
	if o.XFlightId != nil {
...
func (o *AdminPutPlayerPublicRecordConcurrentHandlerV1Params) WithResponseBody(responseBody *bool) *AdminPutPlayerPublicRecordConcurrentHandlerV1Params {
