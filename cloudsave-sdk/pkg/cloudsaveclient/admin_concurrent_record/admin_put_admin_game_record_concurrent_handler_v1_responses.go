...
type AdminPutAdminGameRecordConcurrentHandlerV1Response struct {
...
func (m *AdminPutAdminGameRecordConcurrentHandlerV1Response) Unpack() *cloudsaveclientmodels.ApiError {
	if !m.IsSuccess {
		var errCode int
