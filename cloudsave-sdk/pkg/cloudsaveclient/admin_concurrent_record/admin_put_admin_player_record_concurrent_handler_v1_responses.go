...
type AdminPutAdminPlayerRecordConcurrentHandlerV1Response struct {
...
func (m *AdminPutAdminPlayerRecordConcurrentHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordConcurrentUpdateResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
