...
type PublicListTagsHandlerV1Response struct {
	cloudsaveclientmodels.ApiResponse
	Data *cloudsaveclientmodels.ModelsListTagsResponse
...
func (m *PublicListTagsHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsListTagsResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
