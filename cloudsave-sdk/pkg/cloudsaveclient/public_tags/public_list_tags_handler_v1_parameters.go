...
func (o *PublicListTagsHandlerV1Params) WithLimit(limit *int64) *PublicListTagsHandlerV1Params {
	o.SetLimit(limit)
	return o
}
...
func (o *PublicListTagsHandlerV1Params) WithOffset(offset *int64) *PublicListTagsHandlerV1Params {
	o.SetOffset(offset)
	return o
}
