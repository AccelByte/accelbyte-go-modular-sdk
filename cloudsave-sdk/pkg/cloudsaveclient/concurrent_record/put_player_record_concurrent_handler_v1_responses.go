...
type PutPlayerRecordConcurrentHandlerV1Response struct {
...
func (m *PutPlayerRecordConcurrentHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordConcurrentUpdateResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
