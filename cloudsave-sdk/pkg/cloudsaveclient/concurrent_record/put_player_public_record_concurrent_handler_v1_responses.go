...
type PutPlayerPublicRecordConcurrentHandlerV1Response struct {
...
func (m *PutPlayerPublicRecordConcurrentHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsPlayerRecordConcurrentUpdateResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
