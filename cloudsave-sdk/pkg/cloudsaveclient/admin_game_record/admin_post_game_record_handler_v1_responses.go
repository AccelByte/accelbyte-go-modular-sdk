...
type AdminPostGameRecordHandlerV1Response struct {
...
func (m *AdminPostGameRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsGameRecordAdminResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
