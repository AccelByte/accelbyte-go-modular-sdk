...
type AdminPutGameRecordHandlerV1Response struct {
...
func (m *AdminPutGameRecordHandlerV1Response) Unpack() (*cloudsaveclientmodels.ModelsGameRecordAdminResponse, *cloudsaveclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
