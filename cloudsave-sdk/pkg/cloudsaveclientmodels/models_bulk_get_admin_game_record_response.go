...
func (m *ModelsBulkGetAdminGameRecordResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsBulkGetAdminGameRecordResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsBulkGetAdminGameRecordResponse) UnmarshalBinary(b []byte) error {
	var res ModelsBulkGetAdminGameRecordResponse
