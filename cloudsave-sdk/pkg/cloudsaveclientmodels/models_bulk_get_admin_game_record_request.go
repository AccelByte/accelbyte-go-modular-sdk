...
func (m *ModelsBulkGetAdminGameRecordRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsBulkGetAdminGameRecordRequest) validateKeys(formats strfmt.Registry) error {
...
func (m *ModelsBulkGetAdminGameRecordRequest) UnmarshalBinary(b []byte) error {
	var res ModelsBulkGetAdminGameRecordRequest
