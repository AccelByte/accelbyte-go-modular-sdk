...
func (m *ModelsBulkUpdatePlayerRecordsByKeyRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsBulkUpdatePlayerRecordsByKeyRequest) validateData(formats strfmt.Registry) error {
...
func (m *ModelsBulkUpdatePlayerRecordsByKeyRequest) UnmarshalBinary(b []byte) error {
	var res ModelsBulkUpdatePlayerRecordsByKeyRequest
