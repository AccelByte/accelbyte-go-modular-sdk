...
func (m *ModelsBulkGetGameBinaryRecordResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsBulkGetGameBinaryRecordResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsBulkGetGameBinaryRecordResponse) UnmarshalBinary(b []byte) error {
	var res ModelsBulkGetGameBinaryRecordResponse
