...
func (m *ModelsListGameBinaryRecordsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsListGameBinaryRecordsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsListGameBinaryRecordsResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsListGameBinaryRecordsResponse) UnmarshalBinary(b []byte) error {
	var res ModelsListGameBinaryRecordsResponse
