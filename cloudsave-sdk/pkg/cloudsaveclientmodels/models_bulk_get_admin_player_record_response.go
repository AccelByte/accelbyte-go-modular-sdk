...
func (m *ModelsBulkGetAdminPlayerRecordResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsBulkGetAdminPlayerRecordResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsBulkGetAdminPlayerRecordResponse) UnmarshalBinary(b []byte) error {
	var res ModelsBulkGetAdminPlayerRecordResponse
