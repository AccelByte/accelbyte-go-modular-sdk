...
func (m *ModelsListPlayerBinaryRecordsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsListPlayerBinaryRecordsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsListPlayerBinaryRecordsResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsListPlayerBinaryRecordsResponse) UnmarshalBinary(b []byte) error {
	var res ModelsListPlayerBinaryRecordsResponse
