...
func (m *ModelsAdminGameRecordResponse) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *ModelsAdminGameRecordResponse) validateKey(formats strfmt.Registry) error {
...
func (m *ModelsAdminGameRecordResponse) validateNamespace(formats strfmt.Registry) error {
...
func (m *ModelsAdminGameRecordResponse) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *ModelsAdminGameRecordResponse) UnmarshalBinary(b []byte) error {
	var res ModelsAdminGameRecordResponse
