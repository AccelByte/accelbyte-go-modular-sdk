...
func (m *ModelsListAdminGameRecordKeysResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsListAdminGameRecordKeysResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsListAdminGameRecordKeysResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsListAdminGameRecordKeysResponse) UnmarshalBinary(b []byte) error {
	var res ModelsListAdminGameRecordKeysResponse
