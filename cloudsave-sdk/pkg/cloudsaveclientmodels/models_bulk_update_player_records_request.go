...
func (m *ModelsBulkUpdatePlayerRecordsRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsBulkUpdatePlayerRecordsRequest) validateData(formats strfmt.Registry) error {
...
func (m *ModelsBulkUpdatePlayerRecordsRequest) UnmarshalBinary(b []byte) error {
	var res ModelsBulkUpdatePlayerRecordsRequest
