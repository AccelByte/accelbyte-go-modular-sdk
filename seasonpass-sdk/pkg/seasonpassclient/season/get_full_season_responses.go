...
type GetFullSeasonResponse struct {
	seasonpassclientmodels.ApiResponse
	Data *seasonpassclientmodels.FullSeasonInfo

	Error400 *seasonpassclientmodels.ErrorEntity
	Error404 *seasonpassclientmodels.ErrorEntity
}

func (m *GetFullSeasonResponse) Unpack() (*seasonpassclientmodels.FullSeasonInfo, *seasonpassclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
