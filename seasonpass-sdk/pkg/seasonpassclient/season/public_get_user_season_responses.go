...
type PublicGetUserSeasonResponse struct {
...
func (m *PublicGetUserSeasonResponse) Unpack() (*seasonpassclientmodels.ClaimableUserSeasonInfo, *seasonpassclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
