...
type GetCurrentSeasonResponse struct {
	seasonpassclientmodels.ApiResponse
	Data *seasonpassclientmodels.SeasonSummary

	Error400 *seasonpassclientmodels.ErrorEntity
	Error404 *seasonpassclientmodels.ErrorEntity
}

func (m *GetCurrentSeasonResponse) Unpack() (*seasonpassclientmodels.SeasonSummary, *seasonpassclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
