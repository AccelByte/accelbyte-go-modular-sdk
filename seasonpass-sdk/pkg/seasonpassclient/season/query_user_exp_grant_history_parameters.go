...
// WithFrom adds the from to the query user exp grant history params
func (o *QueryUserExpGrantHistoryParams) WithFrom(from *string) *QueryUserExpGrantHistoryParams {
	o.SetFrom(from)
	return o
}

// SetFrom adds the from to the query user exp grant history params
func (o *QueryUserExpGrantHistoryParams) SetFrom(from *string) {
	o.From = from
}
