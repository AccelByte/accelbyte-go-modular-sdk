...
type PublicGetCurrentUserSeasonResponse struct {
	seasonpassclientmodels.ApiResponse
	Data *seasonpassclientmodels.ClaimableUserSeasonInfo

	Error400 *seasonpassclientmodels.ErrorEntity
	Error404 *seasonpassclientmodels.ErrorEntity
}

func (m *PublicGetCurrentUserSeasonResponse) Unpack() (*seasonpassclientmodels.ClaimableUserSeasonInfo, *seasonpassclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
