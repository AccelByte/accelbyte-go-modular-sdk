...
type PublicBulkClaimUserRewardsResponse struct {
...
func (m *PublicBulkClaimUserRewardsResponse) Unpack() (*seasonpassclientmodels.ClaimableRewards, *seasonpassclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
