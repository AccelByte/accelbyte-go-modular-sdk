...
type GetItemReferencesResponse struct {
	seasonpassclientmodels.ApiResponse
	Data *seasonpassclientmodels.ItemReferenceInfo

	Error400 *seasonpassclientmodels.ErrorEntity
}

func (m *GetItemReferencesResponse) Unpack() (*seasonpassclientmodels.ItemReferenceInfo, *seasonpassclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
