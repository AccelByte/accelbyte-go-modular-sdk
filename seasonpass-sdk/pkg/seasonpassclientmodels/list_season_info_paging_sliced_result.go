...
//
// swagger:model List season info paging sliced result.
...
func (m *ListSeasonInfoPagingSlicedResult) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ListSeasonInfoPagingSlicedResult) validateData(formats strfmt.Registry) error {
...
func (m *ListSeasonInfoPagingSlicedResult) UnmarshalBinary(b []byte) error {
	var res ListSeasonInfoPagingSlicedResult
