...
type GetPublicFollowersResponse struct {
...
func (m *GetPublicFollowersResponse) Unpack() (*ugcclientmodels.ModelsPaginatedCreatorOverviewResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
