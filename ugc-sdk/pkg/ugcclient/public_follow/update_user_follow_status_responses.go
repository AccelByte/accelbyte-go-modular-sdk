...
type UpdateUserFollowStatusResponse struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsUserFollowResponse
...
func (m *UpdateUserFollowStatusResponse) Unpack() (*ugcclientmodels.ModelsUserFollowResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
