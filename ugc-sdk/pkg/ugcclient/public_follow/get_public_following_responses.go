...
type GetPublicFollowingResponse struct {
...
func (m *GetPublicFollowingResponse) Unpack() (*ugcclientmodels.ModelsPaginatedCreatorOverviewResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
