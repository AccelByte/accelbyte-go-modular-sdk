...
type AdminGetOfficialGroupContentsV2Response struct {
...
func (m *AdminGetOfficialGroupContentsV2Response) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
