...
type SingleAdminGetGroupContentsResponse struct {
...
func (m *SingleAdminGetGroupContentsResponse) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
