...
// NewAdminGetUserGroupContentsV2Params creates a new AdminGetUserGroupContentsV2Params object
...
func NewAdminGetUserGroupContentsV2Params() *AdminGetUserGroupContentsV2Params {
	...
	return &AdminGetUserGroupContentsV2Params{
		Limit:  &limitDefault,
...
// NewAdminGetUserGroupContentsV2ParamsWithTimeout creates a new AdminGetUserGroupContentsV2Params object
...
// NewAdminGetUserGroupContentsV2ParamsWithContext creates a new AdminGetUserGroupContentsV2Params object
...
// NewAdminGetUserGroupContentsV2ParamsWithHTTPClient creates a new AdminGetUserGroupContentsV2Params object
...
/*AdminGetUserGroupContentsV2Params contains all the parameters to send to the API endpoint
for the admin get user group contents v2 operation typically these are written to a http.Request
*/
...
func (o *AdminGetUserGroupContentsV2Params) WithTimeout(timeout time.Duration) *AdminGetUserGroupContentsV2Params {
...
func (o *AdminGetUserGroupContentsV2Params) WithContext(ctx context.Context) *AdminGetUserGroupContentsV2Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the admin get user group contents v2 params
func (o *AdminGetUserGroupContentsV2Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *AdminGetUserGroupContentsV2Params) WithHTTPClient(client *http.Client) *AdminGetUserGroupContentsV2Params {
...
func (o *AdminGetUserGroupContentsV2Params) WithGroupID(groupID string) *AdminGetUserGroupContentsV2Params {
...
func (o *AdminGetUserGroupContentsV2Params) WithNamespace(namespace string) *AdminGetUserGroupContentsV2Params {
...
func (o *AdminGetUserGroupContentsV2Params) WithUserID(userID string) *AdminGetUserGroupContentsV2Params {
	o.SetUserID(userID)
	return o
}
...
func (o *AdminGetUserGroupContentsV2Params) WithLimit(limit *int64) *AdminGetUserGroupContentsV2Params {
	o.SetLimit(limit)
	return o
}
...
func (o *AdminGetUserGroupContentsV2Params) WithOffset(offset *int64) *AdminGetUserGroupContentsV2Params {
	o.SetOffset(offset)
	return o
}
...
func (o *AdminGetUserGroupContentsV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
