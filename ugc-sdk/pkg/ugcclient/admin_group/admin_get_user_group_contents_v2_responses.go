...
type AdminGetUserGroupContentsV2Response struct {
...
func (m *AdminGetUserGroupContentsV2Response) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
