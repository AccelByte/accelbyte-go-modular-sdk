...
type SingleAdminGetAllGroupsResponse struct {
...
func (m *SingleAdminGetAllGroupsResponse) Unpack() (*ugcclientmodels.ModelsPaginatedGroupResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
