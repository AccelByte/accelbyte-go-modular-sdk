...
type SingleAdminUpdateGroupResponse struct {
...
func (m *SingleAdminUpdateGroupResponse) Unpack() (*ugcclientmodels.ModelsCreateGroupResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
