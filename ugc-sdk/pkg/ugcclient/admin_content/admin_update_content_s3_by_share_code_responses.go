...
type AdminUpdateContentS3ByShareCodeResponse struct {
...
func (m *AdminUpdateContentS3ByShareCodeResponse) Unpack() (*ugcclientmodels.ModelsCreateContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
