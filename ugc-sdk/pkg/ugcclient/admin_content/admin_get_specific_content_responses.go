...
type AdminGetSpecificContentResponse struct {
...
func (m *AdminGetSpecificContentResponse) Unpack() (*ugcclientmodels.ModelsContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
