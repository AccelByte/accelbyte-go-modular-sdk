...
type AdminHideUserContentResponse struct {
...
func (m *AdminHideUserContentResponse) Unpack() (*ugcclientmodels.ModelsCreateContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
