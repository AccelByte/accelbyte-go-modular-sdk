...
type AdminSearchChannelSpecificContentResponse struct {
...
func (m *AdminSearchChannelSpecificContentResponse) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
