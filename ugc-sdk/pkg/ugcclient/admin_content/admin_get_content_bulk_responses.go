...
type AdminGetContentBulkResponse struct {
...
func (m *AdminGetContentBulkResponse) Unpack() ([]*ugcclientmodels.ModelsContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
