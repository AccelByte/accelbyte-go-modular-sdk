...
type SingleAdminGetContentResponse struct {
...
func (m *SingleAdminGetContentResponse) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
