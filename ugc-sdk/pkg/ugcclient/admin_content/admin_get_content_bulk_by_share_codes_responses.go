...
type AdminGetContentBulkByShareCodesResponse struct {
...
func (m *AdminGetContentBulkByShareCodesResponse) Unpack() ([]*ugcclientmodels.ModelsContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
