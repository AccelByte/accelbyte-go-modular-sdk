...
type AdminUploadContentDirectResponse struct {
...
func (m *AdminUploadContentDirectResponse) Unpack() (*ugcclientmodels.ModelsCreateContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
