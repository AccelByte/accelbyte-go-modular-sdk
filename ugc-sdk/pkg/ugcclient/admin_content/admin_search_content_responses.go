...
type AdminSearchContentResponse struct {
...
func (m *AdminSearchContentResponse) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
