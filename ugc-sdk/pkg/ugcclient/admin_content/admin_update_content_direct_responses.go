...
type AdminUpdateContentDirectResponse struct {
...
func (m *AdminUpdateContentDirectResponse) Unpack() (*ugcclientmodels.ModelsCreateContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
