...
type AdminUploadContentS3Response struct {
...
func (m *AdminUploadContentS3Response) Unpack() (*ugcclientmodels.ModelsCreateContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
