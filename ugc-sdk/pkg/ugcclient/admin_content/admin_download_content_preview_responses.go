...
type AdminDownloadContentPreviewResponse struct {
...
func (m *AdminDownloadContentPreviewResponse) Unpack() (*ugcclientmodels.ModelsGetContentPreviewResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
