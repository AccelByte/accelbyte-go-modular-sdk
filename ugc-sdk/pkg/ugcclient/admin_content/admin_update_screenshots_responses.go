...
type AdminUpdateScreenshotsResponse struct {
...
func (m *AdminUpdateScreenshotsResponse) Unpack() (*ugcclientmodels.ModelsUpdateScreenshotResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
