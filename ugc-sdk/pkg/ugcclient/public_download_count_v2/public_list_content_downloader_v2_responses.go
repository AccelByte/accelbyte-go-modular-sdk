...
type PublicListContentDownloaderV2Response struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsPaginatedContentDownloaderResponse
...
func (m *PublicListContentDownloaderV2Response) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloaderResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
