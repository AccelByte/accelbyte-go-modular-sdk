...
type PublicAddDownloadCountV2Response struct {
...
func (m *PublicAddDownloadCountV2Response) Unpack() (*ugcclientmodels.ModelsAddDownloadCountResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
