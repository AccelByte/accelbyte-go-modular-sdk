...
type UpdateContentLikeStatusResponse struct {
...
func (m *UpdateContentLikeStatusResponse) Unpack() (*ugcclientmodels.ModelsContentLikeResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
