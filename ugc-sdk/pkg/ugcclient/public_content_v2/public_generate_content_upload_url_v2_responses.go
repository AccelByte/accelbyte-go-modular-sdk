...
type PublicGenerateContentUploadURLV2Response struct {
...
func (m *PublicGenerateContentUploadURLV2Response) Unpack() (*ugcclientmodels.ModelsGenerateContentUploadURLResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
