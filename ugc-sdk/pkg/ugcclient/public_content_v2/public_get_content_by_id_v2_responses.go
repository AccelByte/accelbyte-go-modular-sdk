...
type PublicGetContentByIDV2Response struct {
...
func (m *PublicGetContentByIDV2Response) Unpack() (*ugcclientmodels.ModelsContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
