...
type UpdateContentShareCodeV2Response struct {
...
func (m *UpdateContentShareCodeV2Response) Unpack() (*ugcclientmodels.ModelsCreateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
