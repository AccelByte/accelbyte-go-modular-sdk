...
type PublicBulkGetContentByIDV2Response struct {
...
func (m *PublicBulkGetContentByIDV2Response) Unpack() ([]*ugcclientmodels.ModelsContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
