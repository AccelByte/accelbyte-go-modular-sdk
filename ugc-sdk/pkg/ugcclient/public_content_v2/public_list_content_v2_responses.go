...
type PublicListContentV2Response struct {
...
func (m *PublicListContentV2Response) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
