...
type PublicUpdateContentFileLocationResponse struct {
...
func (m *PublicUpdateContentFileLocationResponse) Unpack() (*ugcclientmodels.ModelsUpdateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
