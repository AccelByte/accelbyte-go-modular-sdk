...
type PublicGetContentByShareCodeV2Response struct {
...
func (m *PublicGetContentByShareCodeV2Response) Unpack() (*ugcclientmodels.ModelsContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
