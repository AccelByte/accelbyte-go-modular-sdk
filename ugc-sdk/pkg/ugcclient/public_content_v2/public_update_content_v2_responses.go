...
type PublicUpdateContentV2Response struct {
...
func (m *PublicUpdateContentV2Response) Unpack() (*ugcclientmodels.ModelsUpdateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
