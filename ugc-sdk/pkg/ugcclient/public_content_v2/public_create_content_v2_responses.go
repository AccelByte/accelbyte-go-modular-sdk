...
type PublicCreateContentV2Response struct {
...
func (m *PublicCreateContentV2Response) Unpack() (*ugcclientmodels.ModelsCreateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
