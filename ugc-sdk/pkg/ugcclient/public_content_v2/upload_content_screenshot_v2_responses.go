...
type UploadContentScreenshotV2Response struct {
...
func (m *UploadContentScreenshotV2Response) Unpack() (*ugcclientmodels.ModelsCreateScreenshotResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
