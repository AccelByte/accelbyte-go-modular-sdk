...
type PublicGetContentBulkByShareCodesV2Response struct {
...
func (m *PublicGetContentBulkByShareCodesV2Response) Unpack() ([]*ugcclientmodels.ModelsContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
