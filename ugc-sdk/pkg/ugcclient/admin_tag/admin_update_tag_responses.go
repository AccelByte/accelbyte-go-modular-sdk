...
type AdminUpdateTagResponse struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsCreateTagResponse
...
func (m *AdminUpdateTagResponse) Unpack() (*ugcclientmodels.ModelsCreateTagResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
