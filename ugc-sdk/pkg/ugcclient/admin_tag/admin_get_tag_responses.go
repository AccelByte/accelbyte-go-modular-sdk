...
type AdminGetTagResponse struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsPaginatedGetTagResponse
...
func (m *AdminGetTagResponse) Unpack() (*ugcclientmodels.ModelsPaginatedGetTagResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
