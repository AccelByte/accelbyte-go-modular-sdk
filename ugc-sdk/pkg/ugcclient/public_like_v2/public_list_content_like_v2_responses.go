...
type PublicListContentLikeV2Response struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsPaginatedContentLikersResponse
...
func (m *PublicListContentLikeV2Response) Unpack() (*ugcclientmodels.ModelsPaginatedContentLikersResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
