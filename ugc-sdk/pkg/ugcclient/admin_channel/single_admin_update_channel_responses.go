...
type SingleAdminUpdateChannelResponse struct {
...
func (m *SingleAdminUpdateChannelResponse) Unpack() (*ugcclientmodels.ModelsChannelResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
