...
type SingleAdminGetChannelResponse struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsPaginatedGetChannelResponse
...
func (m *SingleAdminGetChannelResponse) Unpack() (*ugcclientmodels.ModelsPaginatedGetChannelResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
