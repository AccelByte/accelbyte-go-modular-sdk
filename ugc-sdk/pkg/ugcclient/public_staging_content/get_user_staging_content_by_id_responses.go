...
type GetUserStagingContentByIDResponse struct {
...
func (m *GetUserStagingContentByIDResponse) Unpack() (*ugcclientmodels.ModelsStagingContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
