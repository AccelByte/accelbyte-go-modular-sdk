...
type ListUserStagingContentsResponse struct {
...
func (m *ListUserStagingContentsResponse) Unpack() (*ugcclientmodels.ModelsPaginatedListStagingContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
