...
type UpdateStagingContentResponse struct {
...
func (m *UpdateStagingContentResponse) Unpack() (*ugcclientmodels.ModelsStagingContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
