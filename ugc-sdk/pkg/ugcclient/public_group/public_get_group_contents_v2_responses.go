...
type PublicGetGroupContentsV2Response struct {
...
func (m *PublicGetGroupContentsV2Response) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
