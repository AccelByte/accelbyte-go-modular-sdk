...
type AdminUpdateContentHideStatusV2Response struct {
...
func (m *AdminUpdateContentHideStatusV2Response) Unpack() (*ugcclientmodels.ModelsCreateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
