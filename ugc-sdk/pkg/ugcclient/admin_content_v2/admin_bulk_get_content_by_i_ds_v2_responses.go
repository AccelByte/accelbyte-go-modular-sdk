...
type AdminBulkGetContentByIDsV2Response struct {
...
func (m *AdminBulkGetContentByIDsV2Response) Unpack() ([]*ugcclientmodels.ModelsContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
