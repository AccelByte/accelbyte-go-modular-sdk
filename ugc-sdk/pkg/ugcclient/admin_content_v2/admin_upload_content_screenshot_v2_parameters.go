...
// NewAdminUploadContentScreenshotV2Params creates a new AdminUploadContentScreenshotV2Params object
// with the default values initialized.
func NewAdminUploadContentScreenshotV2Params() *AdminUploadContentScreenshotV2Params {
	var ()
	return &AdminUploadContentScreenshotV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminUploadContentScreenshotV2ParamsWithTimeout creates a new AdminUploadContentScreenshotV2Params object
...
// NewAdminUploadContentScreenshotV2ParamsWithContext creates a new AdminUploadContentScreenshotV2Params object
...
// NewAdminUploadContentScreenshotV2ParamsWithHTTPClient creates a new AdminUploadContentScreenshotV2Params object
...
/*AdminUploadContentScreenshotV2Params contains all the parameters to send to the API endpoint
for the admin upload content screenshot v2 operation typically these are written to a http.Request
*/
