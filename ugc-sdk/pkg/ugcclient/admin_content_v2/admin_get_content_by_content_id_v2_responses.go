...
type AdminGetContentByContentIDV2Response struct {
...
func (m *AdminGetContentByContentIDV2Response) Unpack() (*ugcclientmodels.ModelsContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
