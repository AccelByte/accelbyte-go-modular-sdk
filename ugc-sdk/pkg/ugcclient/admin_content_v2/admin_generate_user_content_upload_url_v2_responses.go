...
type AdminGenerateUserContentUploadURLV2Response struct {
...
func (m *AdminGenerateUserContentUploadURLV2Response) Unpack() (*ugcclientmodels.ModelsGenerateContentUploadURLResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
