...
type ListContentVersionsV2Response struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsListContentVersionsResponse
...
func (m *ListContentVersionsV2Response) Unpack() (*ugcclientmodels.ModelsListContentVersionsResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
