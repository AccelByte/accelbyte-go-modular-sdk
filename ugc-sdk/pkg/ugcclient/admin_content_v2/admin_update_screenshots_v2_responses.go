...
type AdminUpdateScreenshotsV2Response struct {
...
func (m *AdminUpdateScreenshotsV2Response) Unpack() (*ugcclientmodels.ModelsUpdateScreenshotResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
