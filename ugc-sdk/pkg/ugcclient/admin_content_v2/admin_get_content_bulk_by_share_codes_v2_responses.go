...
type AdminGetContentBulkByShareCodesV2Response struct {
...
func (m *AdminGetContentBulkByShareCodesV2Response) Unpack() ([]*ugcclientmodels.ModelsContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
