...
type AdminGenerateOfficialContentUploadURLV2Response struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsGenerateContentUploadURLResponse
...
func (m *AdminGenerateOfficialContentUploadURLV2Response) Unpack() (*ugcclientmodels.ModelsGenerateContentUploadURLResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
