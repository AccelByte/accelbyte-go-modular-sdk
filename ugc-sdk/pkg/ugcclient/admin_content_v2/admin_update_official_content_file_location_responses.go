...
type AdminUpdateOfficialContentFileLocationResponse struct {
...
func (m *AdminUpdateOfficialContentFileLocationResponse) Unpack() (*ugcclientmodels.ModelsUpdateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
