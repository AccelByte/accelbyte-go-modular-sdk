...
type AdminUploadContentScreenshotV2Response struct {
...
func (m *AdminUploadContentScreenshotV2Response) Unpack() (*ugcclientmodels.ModelsCreateScreenshotResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
