...
type AdminUpdateUserContentFileLocationResponse struct {
...
func (m *AdminUpdateUserContentFileLocationResponse) Unpack() (*ugcclientmodels.ModelsUpdateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
