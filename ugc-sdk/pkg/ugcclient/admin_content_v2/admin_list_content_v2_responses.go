...
type AdminListContentV2Response struct {
...
func (m *AdminListContentV2Response) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
