...
type AdminUpdateOfficialContentV2Response struct {
...
func (m *AdminUpdateOfficialContentV2Response) Unpack() (*ugcclientmodels.ModelsUpdateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
