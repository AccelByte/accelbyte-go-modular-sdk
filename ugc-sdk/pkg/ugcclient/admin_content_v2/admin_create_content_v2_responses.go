...
type AdminCreateContentV2Response struct {
...
func (m *AdminCreateContentV2Response) Unpack() (*ugcclientmodels.ModelsCreateContentResponseV2, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
