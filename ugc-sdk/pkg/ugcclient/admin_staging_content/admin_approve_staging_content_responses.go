...
type AdminApproveStagingContentResponse struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsStagingContentResponse
...
func (m *AdminApproveStagingContentResponse) Unpack() (*ugcclientmodels.ModelsStagingContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
