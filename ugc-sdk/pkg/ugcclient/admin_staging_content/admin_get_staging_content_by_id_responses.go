...
type AdminGetStagingContentByIDResponse struct {
...
func (m *AdminGetStagingContentByIDResponse) Unpack() (*ugcclientmodels.ModelsStagingContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
