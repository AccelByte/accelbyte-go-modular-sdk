...
type AdminListUserStagingContentsResponse struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsPaginatedListStagingContentResponse
...
func (m *AdminListUserStagingContentsResponse) Unpack() (*ugcclientmodels.ModelsPaginatedListStagingContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
