...
type AdminGetConfigsResponse struct {
	ugcclientmodels.ApiResponse
	Data *ugcclientmodels.ModelsPaginatedGetConfigsResponse
...
func (m *AdminGetConfigsResponse) Unpack() (*ugcclientmodels.ModelsPaginatedGetConfigsResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
