...
type UpdateContentShareCodeResponse struct {
...
func (m *UpdateContentShareCodeResponse) Unpack() (*ugcclientmodels.ModelsCreateContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
