...
type PublicSearchContentResponse struct {
...
func (m *PublicSearchContentResponse) Unpack() (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
