...
type PublicGetContentBulkResponse struct {
...
func (m *PublicGetContentBulkResponse) Unpack() ([]*ugcclientmodels.ModelsContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
