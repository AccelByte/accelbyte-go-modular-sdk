...
type PublicUpdateContentByShareCodeResponse struct {
...
func (m *PublicUpdateContentByShareCodeResponse) Unpack() (*ugcclientmodels.ModelsCreateContentResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
