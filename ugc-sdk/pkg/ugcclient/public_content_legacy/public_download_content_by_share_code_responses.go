...
type PublicDownloadContentByShareCodeResponse struct {
...
func (m *PublicDownloadContentByShareCodeResponse) Unpack() (*ugcclientmodels.ModelsContentDownloadResponse, *ugcclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
