...
func (m *ModelsPaginatedGetTagResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGetTagResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGetTagResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPaginatedGetTagResponse
