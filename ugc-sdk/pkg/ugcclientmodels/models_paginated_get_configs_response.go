...
func (m *ModelsPaginatedGetConfigsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsPaginatedGetConfigsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGetConfigsResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGetConfigsResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPaginatedGetConfigsResponse
