...
func (m *ModelsUpdateContentResponseV2) validateChannelID(formats strfmt.Registry) error {
...
var modelsUpdateContentResponseV2TypeContentStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		modelsUpdateContentResponseV2TypeContentStatusPropEnum = append(modelsUpdateContentResponseV2TypeContentStatusPropEnum, v)
	}
}
...
// prop value enum
func (m *ModelsUpdateContentResponseV2) validateContentStatusEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, modelsUpdateContentResponseV2TypeContentStatusPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ModelsUpdateContentResponseV2) validateContentStatus(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateCreatedTime(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateFileLocation(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateID(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateIsHidden(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateIsOfficial(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateName(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateNamespace(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateParentNamespace(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateShareCode(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateTags(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) validateUserID(formats strfmt.Registry) error {
...
func (m *ModelsUpdateContentResponseV2) UnmarshalBinary(b []byte) error {
	var res ModelsUpdateContentResponseV2
