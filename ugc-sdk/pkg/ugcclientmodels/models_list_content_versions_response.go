...
func (m *ModelsListContentVersionsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsListContentVersionsResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsListContentVersionsResponse) UnmarshalBinary(b []byte) error {
	var res ModelsListContentVersionsResponse
