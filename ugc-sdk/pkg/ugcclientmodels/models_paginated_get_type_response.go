...
func (m *ModelsPaginatedGetTypeResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGetTypeResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGetTypeResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPaginatedGetTypeResponse
