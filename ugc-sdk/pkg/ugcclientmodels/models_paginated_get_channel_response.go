...
func (m *ModelsPaginatedGetChannelResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsPaginatedGetChannelResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGetChannelResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGetChannelResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPaginatedGetChannelResponse
