...
func (m *ModelsConfigResponse) validateKey(formats strfmt.Registry) error {
...
func (m *ModelsConfigResponse) validateNamespace(formats strfmt.Registry) error {
...
func (m *ModelsConfigResponse) validateValue(formats strfmt.Registry) error {
