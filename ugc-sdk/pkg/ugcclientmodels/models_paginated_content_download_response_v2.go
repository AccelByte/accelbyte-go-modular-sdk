...
func (m *ModelsPaginatedContentDownloadResponseV2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsPaginatedContentDownloadResponseV2) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedContentDownloadResponseV2) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedContentDownloadResponseV2) UnmarshalBinary(b []byte) error {
	var res ModelsPaginatedContentDownloadResponseV2
