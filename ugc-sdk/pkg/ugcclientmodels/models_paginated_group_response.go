...
func (m *ModelsPaginatedGroupResponse) validateData(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGroupResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ModelsPaginatedGroupResponse) UnmarshalBinary(b []byte) error {
	var res ModelsPaginatedGroupResponse
