...
func (m *DTOUserPlatformAccountClosureHistoriesResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DTOUserPlatformAccountClosureHistoriesResponse) validateData(formats strfmt.Registry) error {
...
func (m *DTOUserPlatformAccountClosureHistoriesResponse) validatePagination(formats strfmt.Registry) error {
...
func (m *DTOUserPlatformAccountClosureHistoriesResponse) UnmarshalBinary(b []byte) error {
	var res DTOUserPlatformAccountClosureHistoriesResponse
