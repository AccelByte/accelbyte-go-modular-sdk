...
func (m *ModelsS2SRequestDeleteResponse) validateNamespace(formats strfmt.Registry) error {
...
func (m *ModelsS2SRequestDeleteResponse) validateUserID(formats strfmt.Registry) error {
...
func (m *ModelsS2SRequestDeleteResponse) UnmarshalBinary(b []byte) error {
	var res ModelsS2SRequestDeleteResponse
