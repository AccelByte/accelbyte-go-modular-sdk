...
// Validate validates this Dto platform account closure clients response
func (m *DTOPlatformAccountClosureClientsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DTOPlatformAccountClosureClientsResponse) validateData(formats strfmt.Registry) error {
...
func (m *DTOPlatformAccountClosureClientsResponse) UnmarshalBinary(b []byte) error {
	var res DTOPlatformAccountClosureClientsResponse
