...
type AdminGetUserPlatformAccountClosureHistoriesResponse struct {
	gdprclientmodels.ApiResponse
	Data *gdprclientmodels.DTOUserPlatformAccountClosureHistoriesResponse
...
func (m *AdminGetUserPlatformAccountClosureHistoriesResponse) Unpack() (*gdprclientmodels.DTOUserPlatformAccountClosureHistoriesResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
