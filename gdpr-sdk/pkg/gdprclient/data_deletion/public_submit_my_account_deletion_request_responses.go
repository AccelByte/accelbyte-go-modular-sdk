...
type PublicSubmitMyAccountDeletionRequestResponse struct {
...
func (m *PublicSubmitMyAccountDeletionRequestResponse) Unpack() (*gdprclientmodels.ModelsRequestDeleteResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
