...
type PublicGetMyAccountDeletionStatusResponse struct {
...
func (m *PublicGetMyAccountDeletionStatusResponse) Unpack() (*gdprclientmodels.ModelsDeletionStatus, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
