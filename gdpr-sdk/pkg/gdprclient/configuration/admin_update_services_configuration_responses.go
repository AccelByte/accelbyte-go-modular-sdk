...
type AdminUpdateServicesConfigurationResponse struct {
...
func (m *AdminUpdateServicesConfigurationResponse) Unpack() (*gdprclientmodels.DTOServiceConfigurationUpdateRequest, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
