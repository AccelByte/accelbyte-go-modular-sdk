...
type S2SGetListFinishedAccountDeletionRequestResponse struct {
	gdprclientmodels.ApiResponse
	Data *gdprclientmodels.DTOListFinishedDataDeletion
...
func (m *S2SGetListFinishedAccountDeletionRequestResponse) Unpack() (*gdprclientmodels.DTOListFinishedDataDeletion, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
