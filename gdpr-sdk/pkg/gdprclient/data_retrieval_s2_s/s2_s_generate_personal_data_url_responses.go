...
type S2SGeneratePersonalDataURLResponse struct {
	gdprclientmodels.ApiResponse
	Data *gdprclientmodels.ModelsS2SUserDataURL
...
func (m *S2SGeneratePersonalDataURLResponse) Unpack() (*gdprclientmodels.ModelsS2SUserDataURL, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
