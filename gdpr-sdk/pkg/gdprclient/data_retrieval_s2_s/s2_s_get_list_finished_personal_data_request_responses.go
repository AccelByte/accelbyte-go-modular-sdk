...
type S2SGetListFinishedPersonalDataRequestResponse struct {
	gdprclientmodels.ApiResponse
	Data *gdprclientmodels.DTOListFinishedDataRequests
...
func (m *S2SGetListFinishedPersonalDataRequestResponse) Unpack() (*gdprclientmodels.DTOListFinishedDataRequests, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
