...
type PublicSubmitMyHeadlessDeletionRequestResponse struct {
...
func (m *PublicSubmitMyHeadlessDeletionRequestResponse) Unpack() (*gdprclientmodels.ModelsRequestDeleteResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
