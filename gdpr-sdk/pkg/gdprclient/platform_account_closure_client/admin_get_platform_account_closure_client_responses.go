...
type AdminGetPlatformAccountClosureClientResponse struct {
	gdprclientmodels.ApiResponse
	Data *gdprclientmodels.DTOPlatformAccountClosureClientResponse
...
func (m *AdminGetPlatformAccountClosureClientResponse) Unpack() (*gdprclientmodels.DTOPlatformAccountClosureClientResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
