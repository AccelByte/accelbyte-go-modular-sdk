...
type AdminGetPlatformAccountClosureClientsResponse struct {
	gdprclientmodels.ApiResponse
	Data *gdprclientmodels.DTOPlatformAccountClosureClientsResponse
...
func (m *AdminGetPlatformAccountClosureClientsResponse) Unpack() (*gdprclientmodels.DTOPlatformAccountClosureClientsResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
