...
// NewAdminUpdatePlatformAccountClosureClientParams creates a new AdminUpdatePlatformAccountClosureClientParams object
// with the default values initialized.
func NewAdminUpdatePlatformAccountClosureClientParams() *AdminUpdatePlatformAccountClosureClientParams {
	var ()
	return &AdminUpdatePlatformAccountClosureClientParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminUpdatePlatformAccountClosureClientParamsWithTimeout creates a new AdminUpdatePlatformAccountClosureClientParams object
...
// NewAdminUpdatePlatformAccountClosureClientParamsWithContext creates a new AdminUpdatePlatformAccountClosureClientParams object
...
// NewAdminUpdatePlatformAccountClosureClientParamsWithHTTPClient creates a new AdminUpdatePlatformAccountClosureClientParams object
...
/*
AdminUpdatePlatformAccountClosureClientParams contains all the parameters to send to the API endpoint
for the admin update platform account closure client operation typically these are written to a http.Request
*/
