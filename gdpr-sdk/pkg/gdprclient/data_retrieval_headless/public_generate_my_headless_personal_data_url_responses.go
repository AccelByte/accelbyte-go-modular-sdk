...
type PublicGenerateMyHeadlessPersonalDataURLResponse struct {
	gdprclientmodels.ApiResponse
	Data *gdprclientmodels.ModelsUserDataURL
...
func (m *PublicGenerateMyHeadlessPersonalDataURLResponse) Unpack() (*gdprclientmodels.ModelsUserDataURL, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
