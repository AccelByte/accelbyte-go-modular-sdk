...
type PublicGetMyPersonalDataRequestsResponse struct {
...
func (m *PublicGetMyPersonalDataRequestsResponse) Unpack() (*gdprclientmodels.ModelsUserPersonalDataResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
