...
type PublicSubmitMyHeadlessPersonalDataRequestResponse struct {
...
func (m *PublicSubmitMyHeadlessPersonalDataRequestResponse) Unpack() (*gdprclientmodels.ModelsDataRetrievalResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
