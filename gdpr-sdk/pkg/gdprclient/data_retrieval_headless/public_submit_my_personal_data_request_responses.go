...
type PublicSubmitMyPersonalDataRequestResponse struct {
...
func (m *PublicSubmitMyPersonalDataRequestResponse) Unpack() (*gdprclientmodels.ModelsDataRetrievalResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
