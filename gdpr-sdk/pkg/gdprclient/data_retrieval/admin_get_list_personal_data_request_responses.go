...
type AdminGetListPersonalDataRequestResponse struct {
	gdprclientmodels.ApiResponse
	Data *gdprclientmodels.ModelsListPersonalDataResponse
...
func (m *AdminGetListPersonalDataRequestResponse) Unpack() (*gdprclientmodels.ModelsListPersonalDataResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
