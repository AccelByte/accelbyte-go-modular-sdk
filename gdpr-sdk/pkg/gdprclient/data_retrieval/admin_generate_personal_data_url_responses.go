...
type AdminGeneratePersonalDataURLResponse struct {
...
func (m *AdminGeneratePersonalDataURLResponse) Unpack() (*gdprclientmodels.ModelsUserDataURL, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
