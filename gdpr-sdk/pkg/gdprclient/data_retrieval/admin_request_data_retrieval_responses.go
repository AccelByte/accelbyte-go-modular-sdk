...
type AdminRequestDataRetrievalResponse struct {
...
func (m *AdminRequestDataRetrievalResponse) Unpack() (*gdprclientmodels.ModelsDataRetrievalResponse, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
