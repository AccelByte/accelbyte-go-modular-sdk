...
type PublicGeneratePersonalDataURLResponse struct {
...
func (m *PublicGeneratePersonalDataURLResponse) Unpack() (*gdprclientmodels.ModelsUserDataURL, *gdprclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
