...
func (aaa *SessionStorageService) AdminReadSessionStorage(input *session_storage.AdminReadSessionStorageParams) (map[string]interface{}, error) {
	...
	ok, badRequest, unauthorized, notFound, internalServerError, err := aaa.Client.SessionStorage.AdminReadSessionStorage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *SessionStorageService) AdminDeleteUserSessionStorage(input *session_storage.AdminDeleteUserSessionStorageParams) error {
	...
	_, badRequest, unauthorized, notFound, internalServerError, err := aaa.Client.SessionStorage.AdminDeleteUserSessionStorage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *SessionStorageService) AdminReadUserSessionStorage(input *session_storage.AdminReadUserSessionStorageParams) (map[string]interface{}, error) {
	...
	ok, badRequest, unauthorized, notFound, internalServerError, err := aaa.Client.SessionStorage.AdminReadUserSessionStorage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *SessionStorageService) PublicUpdateInsertSessionStorageLeader(input *session_storage.PublicUpdateInsertSessionStorageLeaderParams) (map[string]interface{}, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.SessionStorage.PublicUpdateInsertSessionStorageLeader(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *SessionStorageService) PublicUpdateInsertSessionStorage(input *session_storage.PublicUpdateInsertSessionStorageParams) (map[string]interface{}, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.SessionStorage.PublicUpdateInsertSessionStorage(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
