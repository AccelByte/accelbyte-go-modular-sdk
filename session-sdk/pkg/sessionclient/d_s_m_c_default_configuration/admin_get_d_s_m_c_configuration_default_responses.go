...
type AdminGetDSMCConfigurationDefaultResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ModelsDefaultDSMCConfig
...
func (m *AdminGetDSMCConfigurationDefaultResponse) Unpack() (*sessionclientmodels.ModelsDefaultDSMCConfig, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
