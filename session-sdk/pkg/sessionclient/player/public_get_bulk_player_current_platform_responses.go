...
type PublicGetBulkPlayerCurrentPlatformResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsPlayersCurrentPlatformResponse
...
func (m *PublicGetBulkPlayerCurrentPlatformResponse) Unpack() (*sessionclientmodels.ApimodelsPlayersCurrentPlatformResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
