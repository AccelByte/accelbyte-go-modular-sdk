...
type PublicGetPlayerAttributesResponse struct {
...
func (m *PublicGetPlayerAttributesResponse) Unpack() (*sessionclientmodels.ApimodelsPlayerAttributesResponseBody, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
