...
type AdminQueryPlayerAttributesResponse struct {
...
func (m *AdminQueryPlayerAttributesResponse) Unpack() ([]*sessionclientmodels.ApimodelsPlayerAttributesResponseBody, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
