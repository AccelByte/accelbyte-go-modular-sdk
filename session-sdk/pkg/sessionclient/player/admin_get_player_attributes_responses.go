...
type AdminGetPlayerAttributesResponse struct {
...
func (m *AdminGetPlayerAttributesResponse) Unpack() (*sessionclientmodels.ApimodelsPlayerAttributesResponseBody, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
