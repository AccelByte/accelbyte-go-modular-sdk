...
type PublicGetPartyPasswordResponse struct {
...
func (m *PublicGetPartyPasswordResponse) Unpack() (*sessionclientmodels.ApimodelsGetPasswordResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
