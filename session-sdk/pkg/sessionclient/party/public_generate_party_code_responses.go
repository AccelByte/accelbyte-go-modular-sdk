...
type PublicGeneratePartyCodeResponse struct {
...
func (m *PublicGeneratePartyCodeResponse) Unpack() (*sessionclientmodels.ApimodelsPartySessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
