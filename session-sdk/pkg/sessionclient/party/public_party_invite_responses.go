...
type PublicPartyInviteResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsSessionInviteResponse
...
func (m *PublicPartyInviteResponse) Unpack() (*sessionclientmodels.ApimodelsSessionInviteResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
