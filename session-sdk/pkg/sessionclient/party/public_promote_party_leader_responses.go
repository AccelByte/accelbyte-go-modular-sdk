...
type PublicPromotePartyLeaderResponse struct {
...
func (m *PublicPromotePartyLeaderResponse) Unpack() (*sessionclientmodels.ApimodelsPartySessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
