...
type PublicCreatePartyResponse struct {
...
func (m *PublicCreatePartyResponse) Unpack() (*sessionclientmodels.ApimodelsPartySessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
