...
type AdminQueryPartiesResponse struct {
...
func (m *AdminQueryPartiesResponse) Unpack() (*sessionclientmodels.ApimodelsPartyQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
