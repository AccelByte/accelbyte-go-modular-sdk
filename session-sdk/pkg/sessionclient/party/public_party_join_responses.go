...
type PublicPartyJoinResponse struct {
...
func (m *PublicPartyJoinResponse) Unpack() (*sessionclientmodels.ApimodelsPartySessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
