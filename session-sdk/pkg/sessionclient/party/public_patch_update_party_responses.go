...
type PublicPatchUpdatePartyResponse struct {
...
func (m *PublicPatchUpdatePartyResponse) Unpack() (*sessionclientmodels.ApimodelsPartySessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
