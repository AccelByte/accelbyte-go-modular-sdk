...
type PublicQueryMyPartiesResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsPartyQueryResponse
...
func (m *PublicQueryMyPartiesResponse) Unpack() (*sessionclientmodels.ApimodelsPartyQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
