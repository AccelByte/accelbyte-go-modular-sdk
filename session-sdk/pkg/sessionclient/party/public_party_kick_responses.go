...
type PublicPartyKickResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsKickResponse
...
func (m *PublicPartyKickResponse) Unpack() (*sessionclientmodels.ApimodelsKickResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
