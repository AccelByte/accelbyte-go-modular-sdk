...
type PublicQueryMyGameSessionsResponse struct {
...
func (m *PublicQueryMyGameSessionsResponse) Unpack() (*sessionclientmodels.ApimodelsGameSessionQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
