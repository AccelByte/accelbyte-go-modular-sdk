...
type AdminUpdateGameSessionMemberResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsUpdateGameSessionMemberStatusResponse
...
func (m *AdminUpdateGameSessionMemberResponse) Unpack() (*sessionclientmodels.ApimodelsUpdateGameSessionMemberStatusResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
