...
type AppendTeamGameSessionResponse struct {
...
func (m *AppendTeamGameSessionResponse) Unpack() (*sessionclientmodels.ApimodelsGameSessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
