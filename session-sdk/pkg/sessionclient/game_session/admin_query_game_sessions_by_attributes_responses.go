...
type AdminQueryGameSessionsByAttributesResponse struct {
...
func (m *AdminQueryGameSessionsByAttributesResponse) Unpack() (*sessionclientmodels.ApimodelsGameSessionQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
