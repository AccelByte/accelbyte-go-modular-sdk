...
type AdminDeleteBulkGameSessionsResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsDeleteBulkGameSessionsAPIResponse
...
func (m *AdminDeleteBulkGameSessionsResponse) Unpack() (*sessionclientmodels.ApimodelsDeleteBulkGameSessionsAPIResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
