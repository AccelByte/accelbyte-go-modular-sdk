...
type PublicQueryGameSessionsByAttributesResponse struct {
...
func (m *PublicQueryGameSessionsByAttributesResponse) Unpack() (*sessionclientmodels.ApimodelsGameSessionQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
