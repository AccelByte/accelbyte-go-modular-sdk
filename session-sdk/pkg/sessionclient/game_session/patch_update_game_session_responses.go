...
type PatchUpdateGameSessionResponse struct {
...
func (m *PatchUpdateGameSessionResponse) Unpack() (*sessionclientmodels.ApimodelsGameSessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
