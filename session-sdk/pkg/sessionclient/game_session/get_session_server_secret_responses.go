...
type GetSessionServerSecretResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsServerSecret
...
func (m *GetSessionServerSecretResponse) Unpack() (*sessionclientmodels.ApimodelsServerSecret, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
