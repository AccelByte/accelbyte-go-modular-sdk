...
type PublicPromoteGameSessionLeaderResponse struct {
...
func (m *PublicPromoteGameSessionLeaderResponse) Unpack() (*sessionclientmodels.ApimodelsGameSessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
