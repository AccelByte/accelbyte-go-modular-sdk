...
type UpdateGameSessionResponse struct {
	...
	Error409 *sessionclientmodels.ResponseError
	Error500 *sessionclientmodels.ResponseError
}

func (m *UpdateGameSessionResponse) Unpack() (*sessionclientmodels.ApimodelsGameSessionResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
...
func (o *UpdateGameSessionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return result, nil
	case 409:
		result := NewUpdateGameSessionConflict()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func (o *UpdateGameSessionConflict) Error() string {
	return fmt.Sprintf("[PUT /session/v1/public/namespaces/{namespace}/gamesessions/{sessionId}][%d] updateGameSessionConflict  %+v", 409, o.ToJSONString())
}
...
func (o *UpdateGameSessionConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
