...
type PublicGetGameSessionPasswordResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsGetPasswordResponse
...
func (m *PublicGetGameSessionPasswordResponse) Unpack() (*sessionclientmodels.ApimodelsGetPasswordResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
