...
type AdminGetDSMCConfigurationResponse struct {
...
func (m *AdminGetDSMCConfigurationResponse) Unpack() (*sessionclientmodels.ModelsDSMConfigRecord, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
