...
type AdminUpdateConfigurationAlertV1Response struct {
...
func (m *AdminUpdateConfigurationAlertV1Response) Unpack() (*sessionclientmodels.ApimodelsConfigAlertResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
