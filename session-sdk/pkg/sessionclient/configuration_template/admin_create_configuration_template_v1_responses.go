...
type AdminCreateConfigurationTemplateV1Response struct {
...
func (m *AdminCreateConfigurationTemplateV1Response) Unpack() (*sessionclientmodels.ApimodelsConfigurationTemplateResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
