...
// NewAdminCreateConfigurationTemplateV1Params creates a new AdminCreateConfigurationTemplateV1Params object
// with the default values initialized.
func NewAdminCreateConfigurationTemplateV1Params() *AdminCreateConfigurationTemplateV1Params {
	var ()
	return &AdminCreateConfigurationTemplateV1Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewAdminCreateConfigurationTemplateV1ParamsWithTimeout creates a new AdminCreateConfigurationTemplateV1Params object
...
// NewAdminCreateConfigurationTemplateV1ParamsWithContext creates a new AdminCreateConfigurationTemplateV1Params object
...
// NewAdminCreateConfigurationTemplateV1ParamsWithHTTPClient creates a new AdminCreateConfigurationTemplateV1Params object
...
func (o *AdminCreateConfigurationTemplateV1Params) WithTimeout(timeout time.Duration) *AdminCreateConfigurationTemplateV1Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the admin create configuration template v1 params
func (o *AdminCreateConfigurationTemplateV1Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the admin create configuration template v1 params
func (o *AdminCreateConfigurationTemplateV1Params) WithContext(ctx context.Context) *AdminCreateConfigurationTemplateV1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the admin create configuration template v1 params
func (o *AdminCreateConfigurationTemplateV1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *AdminCreateConfigurationTemplateV1Params) WithHTTPClient(client *http.Client) *AdminCreateConfigurationTemplateV1Params {
...
func (o *AdminCreateConfigurationTemplateV1Params) WithBody(body *sessionclientmodels.ApimodelsCreateConfigurationTemplateRequest) *AdminCreateConfigurationTemplateV1Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the admin create configuration template v1 params
func (o *AdminCreateConfigurationTemplateV1Params) SetBody(body *sessionclientmodels.ApimodelsCreateConfigurationTemplateRequest) {
	o.Body = body
}

// WithNamespace adds the namespace to the admin create configuration template v1 params
func (o *AdminCreateConfigurationTemplateV1Params) WithNamespace(namespace string) *AdminCreateConfigurationTemplateV1Params {
...
func (o *AdminCreateConfigurationTemplateV1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
