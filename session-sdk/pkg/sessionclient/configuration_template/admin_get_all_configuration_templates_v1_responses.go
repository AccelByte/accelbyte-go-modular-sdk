...
type AdminGetAllConfigurationTemplatesV1Response struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsConfigurationTemplatesResponse
...
func (m *AdminGetAllConfigurationTemplatesV1Response) Unpack() (*sessionclientmodels.ApimodelsConfigurationTemplatesResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
