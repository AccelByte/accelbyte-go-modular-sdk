...
- activePlatforms: list of platforms to sync native sessions to. Allowed values: PSN, XBOX, STEAM. If empty, all platforms are active.
...
0123456789ABCDEFGHJKMNPQRSTVWXYZ (All digits 0â9 and uppercase letters AâZ, excluding I, L, O, and U).
*/
