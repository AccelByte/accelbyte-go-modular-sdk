...
type AdminGetConfigurationAlertV1Response struct {
...
func (m *AdminGetConfigurationAlertV1Response) Unpack() (*sessionclientmodels.ApimodelsConfigAlertResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
