...
type AdminSyncDSMCConfigurationResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ModelsDSMConfigRecord
...
func (m *AdminSyncDSMCConfigurationResponse) Unpack() (*sessionclientmodels.ModelsDSMConfigRecord, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
