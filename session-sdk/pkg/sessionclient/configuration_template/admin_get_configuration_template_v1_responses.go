...
type AdminGetConfigurationTemplateV1Response struct {
...
func (m *AdminGetConfigurationTemplateV1Response) Unpack() (*sessionclientmodels.ApimodelsConfigurationTemplateResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
