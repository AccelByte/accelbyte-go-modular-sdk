...
type AdminCreateConfigurationAlertV1Response struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsConfigAlertResponse
...
func (m *AdminCreateConfigurationAlertV1Response) Unpack() (*sessionclientmodels.ApimodelsConfigAlertResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
