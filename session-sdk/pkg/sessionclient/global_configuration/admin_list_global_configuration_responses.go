...
type AdminListGlobalConfigurationResponse struct {
...
func (m *AdminListGlobalConfigurationResponse) Unpack() (*sessionclientmodels.ApimodelsGlobalConfigurationResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
