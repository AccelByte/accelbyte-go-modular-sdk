...
type AdminUpdateGlobalConfigurationResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsGlobalConfigurationResponse

	Error401 *sessionclientmodels.ResponseError
	Error403 *sessionclientmodels.ResponseError
}

func (m *AdminUpdateGlobalConfigurationResponse) Unpack() (*sessionclientmodels.ApimodelsGlobalConfigurationResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
