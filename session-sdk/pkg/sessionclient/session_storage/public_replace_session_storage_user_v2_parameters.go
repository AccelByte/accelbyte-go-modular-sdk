...
// NewPublicReplaceSessionStorageUserV2Params creates a new PublicReplaceSessionStorageUserV2Params object
// with the default values initialized.
func NewPublicReplaceSessionStorageUserV2Params() *PublicReplaceSessionStorageUserV2Params {
	var ()
	return &PublicReplaceSessionStorageUserV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewPublicReplaceSessionStorageUserV2ParamsWithTimeout creates a new PublicReplaceSessionStorageUserV2Params object
...
// NewPublicReplaceSessionStorageUserV2ParamsWithContext creates a new PublicReplaceSessionStorageUserV2Params object
...
// NewPublicReplaceSessionStorageUserV2ParamsWithHTTPClient creates a new PublicReplaceSessionStorageUserV2Params object
...
/*
PublicReplaceSessionStorageUserV2Params contains all the parameters to send to the API endpoint
for the public replace session storage user v2 operation typically these are written to a http.Request
*/
...
func (o *PublicReplaceSessionStorageUserV2Params) WithTimeout(timeout time.Duration) *PublicReplaceSessionStorageUserV2Params {
...
func (o *PublicReplaceSessionStorageUserV2Params) WithContext(ctx context.Context) *PublicReplaceSessionStorageUserV2Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the public replace session storage user v2 params
func (o *PublicReplaceSessionStorageUserV2Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *PublicReplaceSessionStorageUserV2Params) WithHTTPClient(client *http.Client) *PublicReplaceSessionStorageUserV2Params {
...
func (o *PublicReplaceSessionStorageUserV2Params) WithBody(body map[string]interface{}) *PublicReplaceSessionStorageUserV2Params {
	o.SetBody(body)
	return o
}
...
func (o *PublicReplaceSessionStorageUserV2Params) WithNamespace(namespace string) *PublicReplaceSessionStorageUserV2Params {
...
func (o *PublicReplaceSessionStorageUserV2Params) WithSessionID(sessionID string) *PublicReplaceSessionStorageUserV2Params {
...
func (o *PublicReplaceSessionStorageUserV2Params) WithUserID(userID string) *PublicReplaceSessionStorageUserV2Params {
	o.SetUserID(userID)
	return o
}
...
func (o *PublicReplaceSessionStorageUserV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
