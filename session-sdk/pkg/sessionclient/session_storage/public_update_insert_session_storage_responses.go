...
type PublicUpdateInsertSessionStorageResponse struct {
...
func (m *PublicUpdateInsertSessionStorageResponse) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
