...
type PublicUpdateInsertPartySessionStorageReservedResponse struct {
...
func (m *PublicUpdateInsertPartySessionStorageReservedResponse) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
