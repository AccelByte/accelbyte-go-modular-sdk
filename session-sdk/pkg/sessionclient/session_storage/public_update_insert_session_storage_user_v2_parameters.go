...
// NewPublicUpdateInsertSessionStorageUserV2Params creates a new PublicUpdateInsertSessionStorageUserV2Params object
// with the default values initialized.
func NewPublicUpdateInsertSessionStorageUserV2Params() *PublicUpdateInsertSessionStorageUserV2Params {
	var ()
	return &PublicUpdateInsertSessionStorageUserV2Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewPublicUpdateInsertSessionStorageUserV2ParamsWithTimeout creates a new PublicUpdateInsertSessionStorageUserV2Params object
...
// NewPublicUpdateInsertSessionStorageUserV2ParamsWithContext creates a new PublicUpdateInsertSessionStorageUserV2Params object
...
// NewPublicUpdateInsertSessionStorageUserV2ParamsWithHTTPClient creates a new PublicUpdateInsertSessionStorageUserV2Params object
...
/*
PublicUpdateInsertSessionStorageUserV2Params contains all the parameters to send to the API endpoint
for the public update insert session storage user v2 operation typically these are written to a http.Request
*/
...
func (o *PublicUpdateInsertSessionStorageUserV2Params) WithTimeout(timeout time.Duration) *PublicUpdateInsertSessionStorageUserV2Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the public update insert session storage user v2 params
func (o *PublicUpdateInsertSessionStorageUserV2Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the public update insert session storage user v2 params
func (o *PublicUpdateInsertSessionStorageUserV2Params) WithContext(ctx context.Context) *PublicUpdateInsertSessionStorageUserV2Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the public update insert session storage user v2 params
func (o *PublicUpdateInsertSessionStorageUserV2Params) SetContext(ctx context.Context) {
	o.Context = ctx
}
...
func (o *PublicUpdateInsertSessionStorageUserV2Params) WithHTTPClient(client *http.Client) *PublicUpdateInsertSessionStorageUserV2Params {
...
func (o *PublicUpdateInsertSessionStorageUserV2Params) WithBody(body map[string]interface{}) *PublicUpdateInsertSessionStorageUserV2Params {
	o.SetBody(body)
	return o
}
...
func (o *PublicUpdateInsertSessionStorageUserV2Params) WithNamespace(namespace string) *PublicUpdateInsertSessionStorageUserV2Params {
...
func (o *PublicUpdateInsertSessionStorageUserV2Params) WithSessionID(sessionID string) *PublicUpdateInsertSessionStorageUserV2Params {
...
func (o *PublicUpdateInsertSessionStorageUserV2Params) WithUserID(userID string) *PublicUpdateInsertSessionStorageUserV2Params {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the public update insert session storage user v2 params
func (o *PublicUpdateInsertSessionStorageUserV2Params) SetUserID(userID string) {
	o.UserID = userID
}

// WriteToRequest writes these params to a swagger request
func (o *PublicUpdateInsertSessionStorageUserV2Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
