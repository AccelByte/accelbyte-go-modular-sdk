...
type PublicReadPartySessionStorageResponse struct {
...
func (m *PublicReadPartySessionStorageResponse) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
