...
type PublicUpdateInsertSessionStorageLeaderV2Response struct {
...
func (m *PublicUpdateInsertSessionStorageLeaderV2Response) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
