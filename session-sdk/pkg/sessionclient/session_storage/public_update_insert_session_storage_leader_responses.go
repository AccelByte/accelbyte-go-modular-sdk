...
type PublicUpdateInsertSessionStorageLeaderResponse struct {
...
func (m *PublicUpdateInsertSessionStorageLeaderResponse) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
