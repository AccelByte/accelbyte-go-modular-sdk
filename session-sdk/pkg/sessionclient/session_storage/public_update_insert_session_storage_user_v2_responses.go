...
type PublicUpdateInsertSessionStorageUserV2Response struct {
...
func (m *PublicUpdateInsertSessionStorageUserV2Response) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
