...
type PublicReplaceSessionStorageUserV2Response struct {
...
func (m *PublicReplaceSessionStorageUserV2Response) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
