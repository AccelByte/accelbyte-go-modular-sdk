...
type PublicUpdateInsertPartySessionStorageResponse struct {
...
func (m *PublicUpdateInsertPartySessionStorageResponse) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
