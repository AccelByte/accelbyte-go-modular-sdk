...
type PublicReplaceSessionStorageLeaderV2Response struct {
...
func (m *PublicReplaceSessionStorageLeaderV2Response) Unpack() (map[string]interface{}, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
