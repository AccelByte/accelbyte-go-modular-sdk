...
func (o *GoroutineHandlerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /session/admin/internal/pprof/goroutine returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *GoroutineHandlerOK) Error() string {
	return fmt.Sprintf("[GET /session/admin/internal/pprof/goroutine][%d] goroutineHandlerOK ", 200)
}
