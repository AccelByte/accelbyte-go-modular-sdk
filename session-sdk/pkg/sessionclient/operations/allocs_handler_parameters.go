...
// NewAllocsHandlerParams creates a new AllocsHandlerParams object
// with the default values initialized.
func NewAllocsHandlerParams() *AllocsHandlerParams {
	var ()
	return &AllocsHandlerParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewAllocsHandlerParamsWithTimeout creates a new AllocsHandlerParams object
...
// NewAllocsHandlerParamsWithContext creates a new AllocsHandlerParams object
...
// NewAllocsHandlerParamsWithHTTPClient creates a new AllocsHandlerParams object
...
/*AllocsHandlerParams contains all the parameters to send to the API endpoint
for the allocs handler operation typically these are written to a http.Request
*/
...
func (o *AllocsHandlerParams) WithContext(ctx context.Context) *AllocsHandlerParams {
	o.SetContext(ctx)
	return o
}
