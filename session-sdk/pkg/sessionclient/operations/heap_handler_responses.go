...
func (o *HeapHandlerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /session/admin/internal/pprof/heap returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *HeapHandlerOK) Error() string {
	return fmt.Sprintf("[GET /session/admin/internal/pprof/heap][%d] heapHandlerOK ", 200)
}
