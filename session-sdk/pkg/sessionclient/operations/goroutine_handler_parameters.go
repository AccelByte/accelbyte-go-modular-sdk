...
// NewGoroutineHandlerParams creates a new GoroutineHandlerParams object
// with the default values initialized.
func NewGoroutineHandlerParams() *GoroutineHandlerParams {
	var ()
	return &GoroutineHandlerParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGoroutineHandlerParamsWithTimeout creates a new GoroutineHandlerParams object
...
// NewGoroutineHandlerParamsWithContext creates a new GoroutineHandlerParams object
...
// NewGoroutineHandlerParamsWithHTTPClient creates a new GoroutineHandlerParams object
...
/*GoroutineHandlerParams contains all the parameters to send to the API endpoint
for the goroutine handler operation typically these are written to a http.Request
*/
...
func (o *GoroutineHandlerParams) WithTimeout(timeout time.Duration) *GoroutineHandlerParams {
...
func (o *GoroutineHandlerParams) WithContext(ctx context.Context) *GoroutineHandlerParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GoroutineHandlerParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
