...
func (o *BlockHandlerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /session/admin/internal/pprof/block returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *BlockHandlerOK) Error() string {
	return fmt.Sprintf("[GET /session/admin/internal/pprof/block][%d] blockHandlerOK ", 200)
}
