...
// NewThreadcreateHandlerParams creates a new ThreadcreateHandlerParams object
// with the default values initialized.
func NewThreadcreateHandlerParams() *ThreadcreateHandlerParams {
	var ()
	return &ThreadcreateHandlerParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewThreadcreateHandlerParamsWithTimeout creates a new ThreadcreateHandlerParams object
...
// NewThreadcreateHandlerParamsWithContext creates a new ThreadcreateHandlerParams object
...
// NewThreadcreateHandlerParamsWithHTTPClient creates a new ThreadcreateHandlerParams object
...
/*ThreadcreateHandlerParams contains all the parameters to send to the API endpoint
for the threadcreate handler operation typically these are written to a http.Request
*/
...
func (o *ThreadcreateHandlerParams) WithTimeout(timeout time.Duration) *ThreadcreateHandlerParams {
...
func (o *ThreadcreateHandlerParams) WithContext(ctx context.Context) *ThreadcreateHandlerParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ThreadcreateHandlerParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
