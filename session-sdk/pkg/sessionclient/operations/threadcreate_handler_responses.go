...
func (o *ThreadcreateHandlerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /session/admin/internal/pprof/threadcreate returns an error %d: %s", response.Code(), string(data))
	}
}
...
func (o *ThreadcreateHandlerOK) Error() string {
	return fmt.Sprintf("[GET /session/admin/internal/pprof/threadcreate][%d] threadcreateHandlerOK ", 200)
}
