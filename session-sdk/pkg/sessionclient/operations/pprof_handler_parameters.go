...
// NewPprofHandlerParams creates a new PprofHandlerParams object
// with the default values initialized.
func NewPprofHandlerParams() *PprofHandlerParams {
	var ()
	return &PprofHandlerParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewPprofHandlerParamsWithTimeout creates a new PprofHandlerParams object
...
// NewPprofHandlerParamsWithContext creates a new PprofHandlerParams object
...
// NewPprofHandlerParamsWithHTTPClient creates a new PprofHandlerParams object
...
/*PprofHandlerParams contains all the parameters to send to the API endpoint
for the pprof handler operation typically these are written to a http.Request
*/
...
func (o *PprofHandlerParams) WithContext(ctx context.Context) *PprofHandlerParams {
	o.SetContext(ctx)
	return o
}
