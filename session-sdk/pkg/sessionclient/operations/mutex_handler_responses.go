...
func (o *MutexHandlerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	default:
		...
		return nil, fmt.Errorf("Requested GET /session/admin/internal/pprof/mutex returns an error %d: %s", response.Code(), string(data))
	}
}

// NewMutexHandlerOK creates a MutexHandlerOK with default headers values
func NewMutexHandlerOK() *MutexHandlerOK {
	return &MutexHandlerOK{}
}
...
func (o *MutexHandlerOK) Error() string {
	return fmt.Sprintf("[GET /session/admin/internal/pprof/mutex][%d] mutexHandlerOK ", 200)
}

func (o *MutexHandlerOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
