...
type AdminGetMemberActiveSessionResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ModelsMemberActiveSession
...
func (m *AdminGetMemberActiveSessionResponse) Unpack() (*sessionclientmodels.ModelsMemberActiveSession, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
