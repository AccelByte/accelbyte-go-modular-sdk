...
type PublicGetRecentPlayerResponse struct {
...
func (m *PublicGetRecentPlayerResponse) Unpack() (*sessionclientmodels.ModelsRecentPlayerQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
