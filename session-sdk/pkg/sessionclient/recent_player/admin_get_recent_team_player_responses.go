...
type AdminGetRecentTeamPlayerResponse struct {
...
func (m *AdminGetRecentTeamPlayerResponse) Unpack() (*sessionclientmodels.ModelsRecentPlayerQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
