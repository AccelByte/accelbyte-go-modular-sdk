...
type PublicGetRecentTeamPlayerResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ModelsRecentPlayerQueryResponse
...
func (m *PublicGetRecentTeamPlayerResponse) Unpack() (*sessionclientmodels.ModelsRecentPlayerQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
