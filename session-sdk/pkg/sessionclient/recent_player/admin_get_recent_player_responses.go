...
type AdminGetRecentPlayerResponse struct {
...
func (m *AdminGetRecentPlayerResponse) Unpack() (*sessionclientmodels.ModelsRecentPlayerQueryResponse, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
