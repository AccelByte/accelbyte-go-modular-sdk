...
// NewAdminGetRecentPlayerParams creates a new AdminGetRecentPlayerParams object
// with the default values initialized.
func NewAdminGetRecentPlayerParams() *AdminGetRecentPlayerParams {
	var (
		limitDefault = int64(20)
	)
	return &AdminGetRecentPlayerParams{
		Limit: &limitDefault,
...
// NewAdminGetRecentPlayerParamsWithTimeout creates a new AdminGetRecentPlayerParams object
...
// NewAdminGetRecentPlayerParamsWithContext creates a new AdminGetRecentPlayerParams object
...
// NewAdminGetRecentPlayerParamsWithHTTPClient creates a new AdminGetRecentPlayerParams object
...
func (o *AdminGetRecentPlayerParams) WithTimeout(timeout time.Duration) *AdminGetRecentPlayerParams {
...
func (o *AdminGetRecentPlayerParams) WithContext(ctx context.Context) *AdminGetRecentPlayerParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AdminGetRecentPlayerParams) WithHTTPClient(client *http.Client) *AdminGetRecentPlayerParams {
...
func (o *AdminGetRecentPlayerParams) WithLimit(limit *int64) *AdminGetRecentPlayerParams {
	o.SetLimit(limit)
	return o
}
...
func (o *AdminGetRecentPlayerParams) WithUserID(userID *string) *AdminGetRecentPlayerParams {
	o.SetUserID(userID)
	return o
}
...
func (o *AdminGetRecentPlayerParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
