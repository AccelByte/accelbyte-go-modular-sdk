...
type AdminSyncPlatformCredentialsResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ApimodelsXblCertificateResponseBody
...
func (m *AdminSyncPlatformCredentialsResponse) Unpack() (*sessionclientmodels.ApimodelsXblCertificateResponseBody, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
