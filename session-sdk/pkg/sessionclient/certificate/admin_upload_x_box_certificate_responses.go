...
type AdminUploadXBoxCertificateResponse struct {
	sessionclientmodels.ApiResponse
	Data *sessionclientmodels.ModelsPlatformCredentials
...
func (m *AdminUploadXBoxCertificateResponse) Unpack() (*sessionclientmodels.ModelsPlatformCredentials, *sessionclientmodels.ApiError) {
	if !m.IsSuccess {
		var errCode int
