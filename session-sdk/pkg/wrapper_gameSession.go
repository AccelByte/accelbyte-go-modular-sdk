...
func (aaa *GameSessionService) AdminSetDSReady(input *game_session.AdminSetDSReadyParams) error {
	...
	_, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.GameSession.AdminSetDSReady(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *GameSessionService) PublicPromoteGameSessionLeader(input *game_session.PublicPromoteGameSessionLeaderParams) (*sessionclientmodels.ApimodelsGameSessionResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.GameSession.PublicPromoteGameSessionLeader(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *GameSessionService) GetSessionServerSecret(input *game_session.GetSessionServerSecretParams) (*sessionclientmodels.ApimodelsServerSecret, error) {
	...
	ok, badRequest, unauthorized, notFound, internalServerError, err := aaa.Client.GameSession.GetSessionServerSecret(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
