...
func (m *ModelsRequestReconcileMaxActiveSession) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ModelsRequestReconcileMaxActiveSession) validateUserID(formats strfmt.Registry) error {
...
func (m *ModelsRequestReconcileMaxActiveSession) UnmarshalBinary(b []byte) error {
	var res ModelsRequestReconcileMaxActiveSession
