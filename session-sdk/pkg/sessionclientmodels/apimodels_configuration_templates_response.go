...
func (m *ApimodelsConfigurationTemplatesResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsConfigurationTemplatesResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsConfigurationTemplatesResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ApimodelsConfigurationTemplatesResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsConfigurationTemplatesResponse
