...
const (
	...
	// ApimodelsConfigurationTemplateResponseTextChatModeGAMEANDTEAM captures enum value "GAME_AND_TEAM"
	ApimodelsConfigurationTemplateResponseTextChatModeGAMEANDTEAM string = "GAME_AND_TEAM"
