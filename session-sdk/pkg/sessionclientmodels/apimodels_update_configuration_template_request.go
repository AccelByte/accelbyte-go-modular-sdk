...
const (
	...
	// ApimodelsUpdateConfigurationTemplateRequestTextChatModeGAMEANDTEAM captures enum value "GAME_AND_TEAM"
	ApimodelsUpdateConfigurationTemplateRequestTextChatModeGAMEANDTEAM string = "GAME_AND_TEAM"
