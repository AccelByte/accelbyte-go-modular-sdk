...
func (m *ApimodelsPartyQueryResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsPartyQueryResponse) validatePaging(formats strfmt.Registry) error {
...
func (m *ApimodelsPartyQueryResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsPartyQueryResponse
