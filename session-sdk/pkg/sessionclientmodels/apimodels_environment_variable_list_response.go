...
func (m *ApimodelsEnvironmentVariableListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsEnvironmentVariableListResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsEnvironmentVariableListResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsEnvironmentVariableListResponse
