...
func (m *ApimodelsPlayersCurrentPlatformResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ApimodelsPlayersCurrentPlatformResponse) validateData(formats strfmt.Registry) error {
...
func (m *ApimodelsPlayersCurrentPlatformResponse) UnmarshalBinary(b []byte) error {
	var res ApimodelsPlayersCurrentPlatformResponse
