...
samples/cli/sample-apps Gdpr updateAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --body '["GTRLyUwE", "9QIAAMoG", "5VNWbuYw"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr saveAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --body '["cwKZguTd", "rovoiKXx", "0vG3CgHb"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr deleteAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --emails '["VmckC9c2", "HuUpGvZ0", "slrm1ODj"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminValidateXboxBPCertFile \
    --namespace $AB_NAMESPACE \
    --body '{"bpCert": "VMGSr99L", "password": "hxtAts8T"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminUpdatePlatformAccountClosureClient \
    --namespace $AB_NAMESPACE \
    --platform '9VIWhp3I' \
    --body '{"bpCert": "70zxlyEP", "bpCertFileName": "rjiRelVZ", "clientId": "YUkubJur", "password": "qNZ3ZVRP", "publisherKey": "fYukhwex", "sandboxId": "rM0l7v1A", "secret": "P6esG9yj"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminMockPlatformAccountClosureData \
    --namespace $AB_NAMESPACE \
    --platform '4xdFuPWN' \
    --body '{"platformUserId": "Dbd502Th", "sandbox": "KWZpaKZ7", "startImmediately": true}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminUpdateServicesConfiguration \
    --namespace $AB_NAMESPACE \
    --body '{"services": [{"extendConfig": {"appName": "t40hlcH3", "namespace": "LoXqHWYe"}, "id": "psnozsfU", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "2cqDnjwS"}, "type": "SERVICE"}, {"extendConfig": {"appName": "AZrwNdLf", "namespace": "YXnDzF40"}, "id": "iIlocrcJ", "serviceConfig": {"protocol": "GRPC", "skipAck": true, "url": "cIm7p0BM"}, "type": "EXTEND"}, {"extendConfig": {"appName": "6sp4Oqi6", "namespace": "5UiR4jIe"}, "id": "olKoP7PL", "serviceConfig": {"protocol": "GRPC", "skipAck": false, "url": "EDXgcvHE"}, "type": "EXTEND"}]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminUpdatePlatformAccountClosureServicesConfiguration \
    --namespace $AB_NAMESPACE \
    --body '{"services": [{"extendConfig": {"appName": "dA9WX9UW", "namespace": "HIDQg3eg"}, "id": "tJebOnp3", "serviceConfig": {"protocol": "EVENT", "skipAck": false, "url": "VqJ0Z1Ys"}, "type": "SERVICE"}, {"extendConfig": {"appName": "H2axGxDi", "namespace": "y4sw1GjU"}, "id": "gAVd2LyC", "serviceConfig": {"protocol": "GRPC", "skipAck": false, "url": "vbHdn2IZ"}, "type": "SERVICE"}, {"extendConfig": {"appName": "1IIav0wD", "namespace": "qai6ulNd"}, "id": "3FyR1IXZ", "serviceConfig": {"protocol": "GRPC", "skipAck": false, "url": "BmM2MI6k"}, "type": "EXTEND"}]}' \
    > test.out 2>&1
