...
samples/cli/sample-apps Gdpr updateAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --body '["CLDF30VX", "9fbGKeeA", "EesRbGZJ"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr saveAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --body '["Op1TSqGB", "5zmz8zJn", "m3FP7iRe"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr deleteAdminEmailConfiguration \
    --namespace $AB_NAMESPACE \
    --emails '["zGLRqEgt", "tgnnnmkP", "LPQDALrJ"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminValidateXboxBPCertFile \
    --namespace $AB_NAMESPACE \
    --body '{"bpCert": "jzTcjcoy", "password": "rieFdVbC"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminUpdatePlatformAccountClosureClient \
    --namespace $AB_NAMESPACE \
    --platform 'eWzci2QJ' \
    --body '{"bpCert": "59zOmQrB", "bpCertFileName": "qyJ8LFVX", "clientId": "vY3P4Tg3", "password": "Q0fSKHd0", "publisherKey": "9MScVzoI", "sandboxId": "cU2SJO0B", "secret": "08dYVzJt"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminMockPlatformAccountClosureData \
    --namespace $AB_NAMESPACE \
    --platform 'Ucv7659C' \
    --body '{"platformUserId": "Srtxirny", "sandbox": "mi79Jn8K", "startImmediately": false}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminUpdateServicesConfiguration \
    --namespace $AB_NAMESPACE \
    --body '{"services": [{"extendConfig": {"appName": "lFux2wZc", "namespace": "sBRb3ZU1"}, "id": "gXQXfzp6", "package": "c78TCvyA", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "t8SwfJFL"}, "type": "SERVICE"}, {"extendConfig": {"appName": "r6XzGb3J", "namespace": "PsVp4fzy"}, "id": "dwsP5uPW", "package": "mjntgMFm", "serviceConfig": {"protocol": "EVENT", "skipAck": true, "url": "BTgZfT0c"}, "type": "EXTEND"}, {"extendConfig": {"appName": "FMHih9Mh", "namespace": "CcW5GBjl"}, "id": "1WZXDpwT", "package": "PUkpRVpe", "serviceConfig": {"protocol": "EVENT", "skipAck": false, "url": "qVBQ3zSN"}, "type": "EXTEND"}]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Gdpr adminUpdatePlatformAccountClosureServicesConfiguration \
    --namespace $AB_NAMESPACE \
    --body '{"services": [{"extendConfig": {"appName": "Uzcsn2Ev", "namespace": "Mhpjl9h2"}, "id": "3QH5nLfl", "package": "GL3QYRZe", "serviceConfig": {"protocol": "GRPC", "skipAck": true, "url": "r9M7VS5D"}, "type": "EXTEND"}, {"extendConfig": {"appName": "21VpDobU", "namespace": "TmmkOnWV"}, "id": "eM678fd7", "package": "VyNR5XBG", "serviceConfig": {"protocol": "EVENT", "skipAck": false, "url": "FX39FyQw"}, "type": "EXTEND"}, {"extendConfig": {"appName": "7TXrLYAo", "namespace": "ReHtNnJU"}, "id": "R2ECy6FT", "package": "AcNzkyy0", "serviceConfig": {"protocol": "GRPC", "skipAck": false, "url": "2t7uEmzJ"}, "type": "SERVICE"}]}' \
    > test.out 2>&1
