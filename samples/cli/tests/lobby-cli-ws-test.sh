...
#- 12 ChannelChatNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: channelChatNotif\nchannelSlug: m21OQcCz\nfrom: ALl2dYgN\npayload: rL6l1pRi\nsentAt: 1976-11-19T00:00:00Z' \
    > test.out 2>&1
...
#- 14 ConnectNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: connectNotif\nlobbySessionID: V9VmCqOx' \
    > test.out 2>&1
eval_tap $? 14 'ConnectNotif' test.out

#- 15 DisconnectNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: disconnectNotif\nconnectionId: WRxGTakn\nnamespace: I4qVJ6Qq' \
    > test.out 2>&1
eval_tap $? 15 'DisconnectNotif' test.out

#- 16 DsNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: dsNotif\nalternateIps: [u4EbO4TM,TTmxt6SO,JJXQzEjn]\ncustomAttribute: ktdoR4HN\ndeployment: lJyzsIjH\ngameVersion: 7Ap4okxJ\nimageVersion: 2iZYZXRC\nip: GOtk0Wea\nisOK: False\nisOverrideGameVersion: False\nlastUpdate: GqqxRuGB\nmatchId: TBF9ew58\nmessage: kWc7523d\nnamespace: jurogfxh\npodName: v7FF1TU3\nport: 87\nports: {"tOEUunzM":92,"dzDGOblV":66,"LHBKOD6W":61}\nprotocol: iDzfQUo0\nprovider: MGuEWrfx\nregion: jQeF8EW6\nsessionId: fCLjSyKH\nstatus: riOCj823' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: friendsStatusResponse\nid: 40HNAd9p\nactivity: [d0mNkhbp,ZFq1G6LN,FnBHfCMt]\navailability: [xGiE8UkK,J1SQwREy,GBcXby3d]\ncode: 52\nfriendIds: [Ya2GaKjC,buqkL55n,eVtk2zxH]\nlastSeenAt: [1997-05-14T00:00:00Z,1974-11-04T00:00:00Z,1992-03-28T00:00:00Z]' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: getAllSessionAttributeResponse\nid: OiF7SBGC\nattributes: {"jUpPJEgh":"Z8gRHACm","ha8Cz9JM":"ksRHzEJf","j0NPEtei":"0YOjM7oh"}\ncode: 1' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: listIncomingFriendsResponse\nid: m8NUDdyk\ncode: 5\nuserIds: [rk4ev6DZ,7wj9kxdt,PbHHmd7R]' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: listOfFriendsResponse\nid: F9SjZR69\ncode: 10\nfriendIds: [ERWXN1Dj,D0HkqUaN,5Ogg81ex]' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: listOutgoingFriendsResponse\nid: n6U9WD3c\ncode: 93\nfriendIds: [P8davr3b,EwDMpXjQ,0R4CEvsd]' \
    > test.out 2>&1
eval_tap $? 36 'ListOutgoingFriendsResponse' test.out

#- 37 MatchmakingNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: matchmakingNotif\ncounterPartyMember: [44DpuG8U,zVkBbMDD,FdlLCdzY]\nmatchId: KZPP5kfS\nmessage: IK9N1fdD\npartyMember: [US73DwUO,mgXh8Z8a,jLI87nl2]\nreadyDuration: 22\nstatus: N85YSyY9' \
    > test.out 2>&1
eval_tap $? 37 'MatchmakingNotif' test.out

#- 38 MessageNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: messageNotif\nid: d16ZKxUs\nfrom: BBMHmcvT\npayload: moV60L7A\nsentAt: 1996-02-16T00:00:00Z\nto: hFai1UGl\ntopic: gND3rLUl' \
    > test.out 2>&1
eval_tap $? 38 'MessageNotif' test.out

#- 39 MessageSessionNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: messageSessionNotif\nid: 6g4K9Uoo\nfrom: I5Royn3c\npayload: wsCbW4xG\nsentAt: 1973-07-07T00:00:00Z\nto: XVeKHgIc\ntopic: hWWC4dIE' \
    > test.out 2>&1
...
#- 42 OnlineFriends
samples/cli/sample-apps --wsModeStandalone \
    'type: onlineFriends\nid: 9og2VUnA\ncode: 16\nonlineFriendIds: [BZymUGi9,DYQfviZr,9xBF2kMF]' \
    > test.out 2>&1
eval_tap $? 42 'OnlineFriends' test.out

#- 43 PartyChatNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: partyChatNotif\nid: sUj6FQIV\nfrom: yQJJSBUz\npayload: Lz9zai13\nreceivedAt: 1976-02-19T00:00:00Z\nto: bA2pCjaN' \
    > test.out 2>&1
eval_tap $? 43 'PartyChatNotif' test.out

#- 44 PartyChatRequest
samples/cli/sample-apps --wsModeStandalone \
    'type: partyChatRequest\nid: LW7liATe\nfrom: HY7yXXyk\npayload: WBcl3mBZ\nreceivedAt: 1978-05-22T00:00:00Z\nto: tZmQVtLg' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: partyCreateResponse\nid: ecNrM6iO\ncode: 1\ninvitationToken: xBtlGjS8\ninvitees: v3PAMil3\nleaderId: aisDQQ0i\nmembers: jiSgGGIY\npartyId: mHa9lUIs' \
    > test.out 2>&1
eval_tap $? 47 'PartyCreateResponse' test.out

#- 48 PartyDataUpdateNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: partyDataUpdateNotif\ncustomAttributes: {"fNM9Po9K":{},"QltGs8u7":{},"nYFe8lUO":{}}\ninvitees: [eTdUmgo4,3dhuws4E,WxZTOPtU]\nleader: 5jlrRnPO\nmembers: [qZyXc1Nm,FmWiMYqU,dVrh6mAW]\nnamespace: uW8q9k7F\npartyId: OgiKj7sO\nupdatedAt: 1986-10-28T00:00:00Z' \
    > test.out 2>&1
eval_tap $? 48 'PartyDataUpdateNotif' test.out

#- 49 PartyGetInvitedNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: partyGetInvitedNotif\nfrom: 0asXaTVG\ninvitationToken: GbDl3QJB\npartyId: yjWrgBhq' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: partyInfoResponse\nid: XG9fE2XC\ncode: 26\ncustomAttributes: {"doBiiJqI":{},"nJ0iNAs4":{},"THJ9RpDq":{}}\ninvitationToken: oydD1Y4E\ninvitees: q6qoDN5S\nleaderId: Wh1FzZ4m\nmembers: kli4X1cZ\npartyId: nQ3w9QqN' \
    > test.out 2>&1
...
#- 56 PartyJoinRequest
samples/cli/sample-apps --wsModeStandalone \
    'type: partyJoinRequest\nid: WhGZZUOM\ninvitationToken: r8hMoVXR\npartyId: TjyKGiwB' \
    > test.out 2>&1
eval_tap $? 56 'PartyJoinRequest' test.out

#- 57 PartyJoinResponse
samples/cli/sample-apps --wsModeStandalone \
    'type: partyJoinResponse\nid: 0hzHHh7r\ncode: 60\ninvitationToken: AxUfVBoU\ninvitees: lizz0Gah\nleaderId: kC3MeYpM\nmembers: qHCGSFiZ\npartyId: KktgN1eB' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: partyPromoteLeaderRequest\nid: lo3qGZ1Z\nnewLeaderUserId: C1yPFiXF' \
    > test.out 2>&1
eval_tap $? 64 'PartyPromoteLeaderRequest' test.out

#- 65 PartyPromoteLeaderResponse
samples/cli/sample-apps --wsModeStandalone \
    'type: partyPromoteLeaderResponse\nid: YDWae5Cu\ncode: 75\ninvitationToken: 4OgNHCPc\ninvitees: afYZZsHp\nleaderId: j1GY0xqB\nmembers: 9I7Buba5\npartyId: gc1bHN8B' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: personalChatNotif\nid: 8jyhPUhh\nfrom: PbII0GXe\npayload: MCZ7G5oi\nreceivedAt: 1996-11-01T00:00:00Z\nto: 3Gyunyzr' \
    > test.out 2>&1
eval_tap $? 71 'PersonalChatNotif' test.out

#- 72 PersonalChatRequest
samples/cli/sample-apps --wsModeStandalone \
    'type: personalChatRequest\nid: p5uKQF5L\nfrom: e8dMSeKP\npayload: EuldXAU5\nreceivedAt: 1988-09-11T00:00:00Z\nto: rbYpAwSV' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: signalingP2PNotif\ndestinationId: eoYPQq8s\nmessage: KEekL6VE' \
    > test.out 2>&1
eval_tap $? 93 'SignalingP2PNotif' test.out

#- 94 StartMatchmakingRequest
samples/cli/sample-apps --wsModeStandalone \
    'type: startMatchmakingRequest\nid: 9ct375er\nextraAttributes: AnvSCZ1V\ngameMode: Z9Io0qd0\npartyAttributes: {"cvQOc50P":{},"Idi0aNMU":{},"Hl8XKmsC":{}}\npriority: 63\ntempParty: zQc7O3A4' \
    > test.out 2>&1
...
#- 105 UserStatusNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: userStatusNotif\nactivity: sirYvO3H\navailability: 53\nlastSeenAt: 1993-04-16T00:00:00Z\nuserId: 95RPOoWl' \
    > test.out 2>&1
