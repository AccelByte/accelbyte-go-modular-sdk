...
#- 5 BlockPlayerNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: blockPlayerNotif\nblockedUserId: w9JH9iwC\nuserId: VuXyZH6L' \
    > test.out 2>&1
eval_tap $? 5 'BlockPlayerNotif' test.out

#- 6 BlockPlayerRequest
samples/cli/sample-apps --wsModeStandalone \
    'type: blockPlayerRequest\nid: XyqReS26\nblockUserId: Bhcq66hu\nnamespace: MYp2iEpw' \
    > test.out 2>&1
eval_tap $? 6 'BlockPlayerRequest' test.out

#- 7 BlockPlayerResponse
samples/cli/sample-apps --wsModeStandalone \
    'type: blockPlayerResponse\nid: WJoE8TU3\nblockUserId: CJmSsiXt\ncode: 28\nnamespace: RdCyxotu' \
    > test.out 2>&1
...
#- 15 ConnectNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: connectNotif\nlobbySessionId: YRUWXfzN' \
    > test.out 2>&1
eval_tap $? 15 'ConnectNotif' test.out

#- 16 DisconnectNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: disconnectNotif\nconnectionId: UTcq904R\nnamespace: 5QHMi6kq' \
    > test.out 2>&1
eval_tap $? 16 'DisconnectNotif' test.out

#- 17 DsNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: dsNotif\nalternateIps: [WbiPDXBb,Aw8HfyIv,mmoKzjiQ]\ncustomAttribute: YSgpzMih\ndeployment: BgPR95Lc\ngameVersion: A4ahl5xn\nimageVersion: BvO7aLrj\nip: AaKjBN5I\nisOK: True\nisOverrideGameVersion: True\nlastUpdate: BQHQRttl\nmatchId: koOxTySX\nmessage: XFcYOX1U\nnamespace: ETlxFX8Q\npodName: IhrsbvtT\nport: 48\nports: {"fBIUdeci":73,"egsKzeRI":53,"5CMPloyf":17}\nprotocol: KeHSNV12\nprovider: Ohf6Ijja\nregion: gvejAbNF\nsessionId: c0k9x7gu\nstatus: HjbPrio7' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: friendsStatusResponse\nid: 6VpKyir2\nactivity: [el1751ml,zQq2BXcy,iASEFAJl]\navailability: [qrlkSwFi,zun6LMLz,UHOhggnY]\ncode: 80\nfriendIds: [NhuPOqvM,Dpm9TmTC,wfsw1cEu]\nlastSeenAt: [EdyPEl96,LGEv3r9D,RVzKovUw]' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: getAllSessionAttributeResponse\nid: Syd048f0\nattributes: {"CBleVbeV":"zJNw5kqd","dZsJfMUn":"OePkPd1Y","yy5lcARG":"mdvLcohc"}\ncode: 34' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: listIncomingFriendsResponse\nid: qF4bL8cI\ncode: 5\nuserIds: [ZTW3j1EV,1f0I8fEL,TweZDTzD]' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: listOfFriendsResponse\nid: cQINg6hV\ncode: 40\nfriendIds: [4Zc3gVbr,OoFslMoF,tsqHCLly]' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: listOutgoingFriendsResponse\nid: xXZ2GkAY\ncode: 48\nfriendIds: [31ZX0YWT,yvlrSf4t,lta4e1dW]' \
    > test.out 2>&1
eval_tap $? 37 'ListOutgoingFriendsResponse' test.out

#- 38 MatchmakingNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: matchmakingNotif\ncounterPartyMember: [H3RttQJz,p05L9P2O,d0GvNKrj]\nmatchId: zOX3jbTC\nmessage: 37ej4Sk1\npartyMember: [0Qt4v86O,gldwrKmD,bwajJYRh]\nreadyDuration: 4\nstatus: TYO41dIR' \
    > test.out 2>&1
...
#- 42 OnlineFriends
samples/cli/sample-apps --wsModeStandalone \
    'type: onlineFriends\nid: Uadh9vPm\ncode: 4\nonlineFriendIds: [IQ7mYZKt,WhJVx0GN,otlSldHj]' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: partyCreateResponse\nid: PqorhIOI\ncode: 94\ninvitationToken: QT8IWDbt\ninvitees: Xcq8wKcy\nleaderId: ksHFfIhH\nmembers: 8z637OVJ\npartyId: zUEjV7CW' \
    > test.out 2>&1
eval_tap $? 47 'PartyCreateResponse' test.out

#- 48 PartyDataUpdateNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: partyDataUpdateNotif\ncustomAttributes: {"Ky5mTvoI":{},"BPtxQ2rd":{},"3LjWQyEJ":{}}\ninvitees: [SgZvZFud,wlZ35zfb,g7PtHUs7]\nleader: yR6SRDI2\nmembers: [tNWYn1kN,3NRFsqn3,N6DSvG38]\nnamespace: 1SFQmB9w\npartyId: vRMs66i2\nupdatedAt: 69' \
    > test.out 2>&1
eval_tap $? 48 'PartyDataUpdateNotif' test.out

#- 49 PartyGetInvitedNotif
samples/cli/sample-apps --wsModeStandalone \
    'type: partyGetInvitedNotif\nfrom: yC4nkYlR\ninvitationToken: 8zCDcSlF\npartyId: BWrnYIYO' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: partyInfoResponse\nid: Qzpi1zXs\ncode: 31\ncustomAttributes: {"c93hL8uD":{},"BnJ93oMU":{},"yEafI0lj":{}}\ninvitationToken: ZtIPFwOC\ninvitees: py3iDLgb\nleaderId: tk8tjo3G\nmembers: nm0o3mJl\npartyId: wd1Rqyqr' \
    > test.out 2>&1
...
#- 56 PartyJoinRequest
samples/cli/sample-apps --wsModeStandalone \
    'type: partyJoinRequest\nid: u78uebxe\ninvitationToken: Ga4qqY1I\npartyId: 8uUhpG0T' \
    > test.out 2>&1
eval_tap $? 56 'PartyJoinRequest' test.out

#- 57 PartyJoinResponse
samples/cli/sample-apps --wsModeStandalone \
    'type: partyJoinResponse\nid: no4SHUWr\ncode: 6\ninvitationToken: 3M8eBJKG\ninvitees: 0MA1aBxu\nleaderId: WhfU90t5\nmembers: lNYV1Vm9\npartyId: 4SlMhHLc' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: partyPromoteLeaderRequest\nid: RO7Le3nj\nnewLeaderUserId: uciGRtBu' \
    > test.out 2>&1
eval_tap $? 64 'PartyPromoteLeaderRequest' test.out

#- 65 PartyPromoteLeaderResponse
samples/cli/sample-apps --wsModeStandalone \
    'type: partyPromoteLeaderResponse\nid: MFYs076W\ncode: 95\ninvitationToken: J3dv2BF2\ninvitees: TdjiW5UX\nleaderId: 78onH3J0\nmembers: UwKEjfBK\npartyId: yILVUJx4' \
    > test.out 2>&1
...
samples/cli/sample-apps --wsModeStandalone \
    'type: signalingP2PNotif\ndestinationId: GyoDg0sT\nmessage: yqXOjFZ5' \
    > test.out 2>&1
eval_tap $? 93 'SignalingP2PNotif' test.out

#- 94 StartMatchmakingRequest
samples/cli/sample-apps --wsModeStandalone \
    'type: startMatchmakingRequest\nid: 9DkiIqhM\nextraAttributes: 1u8ARWqB\ngameMode: MlGy3pvy\npartyAttributes: {"ZUrJQYCD":{},"OtF7fCUe":{},"zp0u5hFH":{}}\npriority: 2\ntempParty: OOPGDE24' \
    > test.out 2>&1
