...
samples/cli/sample-apps Lobby userRequestFriend \
    --namespace $AB_NAMESPACE \
    --body '{"friendId": "xVEisJZJ", "friendPublicId": "SHbbaDek"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby addFriendsWithoutConfirmation \
    --namespace $AB_NAMESPACE \
    --userId '3rxkvGwc' \
    --body '{"friendIds": ["sXglKwTw", "agX28wZp", "qRDiuJSr"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby bulkDeleteFriends \
    --namespace $AB_NAMESPACE \
    --userId 'Us06i077' \
    --body '{"friendIds": ["BVX1GTNT", "Jyyw5oEr", "S76Kulcx"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby syncNativeFriends \
    --namespace $AB_NAMESPACE \
    --body '[{"isLogin": true, "platformId": "3hupZhg4", "platformToken": "UUPIitbC", "psnEnv": "9oUOpcbv"}, {"isLogin": false, "platformId": "t0gLOJSt", "platformToken": "aaIjWMtm", "psnEnv": "JoX07fUg"}, {"isLogin": false, "platformId": "z8oRaiou", "platformToken": "bMcftQSD", "psnEnv": "f65pR20R"}]' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateConfigV1 \
    --namespace $AB_NAMESPACE \
    --body '{"allowInviteNonConnectedUser": false, "allowJoinPartyDuringMatchmaking": true, "autoKickOnDisconnect": true, "autoKickOnDisconnectDelay": 93, "cancelTicketOnDisconnect": false, "chatRateLimitBurst": 78, "chatRateLimitDuration": 16, "concurrentUsersLimit": 74, "disableInvitationOnJoinParty": false, "enableChat": false, "entitlementCheck": false, "entitlementItemID": "L3gz5XsA", "generalRateLimitBurst": 18, "generalRateLimitDuration": 100, "keepPresenceActivityOnDisconnect": true, "maxDSWaitTime": 2, "maxFriendsLimit": 81, "maxPartyMember": 91, "profanityFilter": true, "readyConsentTimeout": 1, "unregisterDelay": 80}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateGlobalConfig \
    --body '{"regionRetryMapping": {"fKMX7DBq": ["XdjGT66T", "M1GFrtdZ", "XYdF4tNL"], "YeNvWVoi": ["wN3yjw5Q", "EeiIapFH", "LfGHib3Q"], "Vj1XzxsD": ["euRvSKZw", "Ef2OQAKa", "47om3kCH"]}, "regionURLMapping": ["pHyX8MyA", "kkdMamke", "hi2MYoFD"], "testGameMode": "P2ToyVgr", "testRegionURLMapping": ["sVvYEFFC", "3kofqzPP", "LSjxJIRn"], "testTargetUserIDs": ["UQLIrS3J", "PbT9ALm4", "3KXF9ymS"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendMultipleUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "dT1DxSf1", "topicName": "03T5K9Nl", "userIds": ["fwX1NtzW", "TMpIR9Db", "Bu4MPzEB"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "RNNN16PU", "topicName": "92XN6Szj"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendPartyFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --partyId 'pKIXALtN' \
    --body '{"message": "oE6xPXVp", "topicName": "RkZuz5AN"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendPartyTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --partyId '9dgyI7LN' \
    --body '{"templateContext": {"FpycZGIJ": "x210ZTTj", "ChAO8cXp": "aiZzJm7R", "LOt8Pj5X": "TitV1MfP"}, "templateLanguage": "SLMlMDOn", "templateSlug": "mcz75a1e", "topicName": "g5fnbD7b"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTemplateV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "y4obrH0L", "templateLanguage": "e0bussaA", "templateSlug": "dyCKHa3R"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"grgU62eO": "5bHCmJx0", "GOinixMD": "J1uyvRr0", "FhWQKfJZ": "JwYHqHZG"}, "templateLanguage": "VI11Mwgx", "templateSlug": "ouK4Y7NM", "topicName": "lZtRGE1c"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getSingleTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage '7mMHt9s3' \
    --templateSlug 'mYnggWLK' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'pJSdXg1u' \
    --templateSlug 'tlS2kw8T' \
    --body '{"templateContent": "aVI5NUSI"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'Y81a130N' \
    --templateSlug 'xoInZNyM' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'MBirB0Mx' \
    --templateSlug '3NzuBq8K' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTopicV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"description": "NuPdNyFJ", "topicName": "1UfoqtKv"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'EoOMd0Zj' \
    --body '{"message": "UzhxrHPz", "topicName": "ZOLxFupb"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'dNxzhDwG' \
    --body '{"templateContext": {"glIPZzDQ": "JTGBY0GF", "wpuE3LpM": "fdOz46SZ", "JQys9Di6": "Lg7IRRNf"}, "templateLanguage": "f8aAtDjH", "templateSlug": "pJ6iaHfA", "topicName": "GZUgk2k4"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdatePartyAttributesV1 \
    --namespace $AB_NAMESPACE \
    --partyId 'KW7k4M1t' \
    --body '{"custom_attribute": {"YEIVGMOu": {}, "LqzgAuae": {}, "e5g7KXZ4": {}}, "updatedAt": 6}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminGetBulkPlayerBlockedPlayersV1 \
    --namespace $AB_NAMESPACE \
    --body '{"listBlockedUserId": ["Y6SRxf3Q", "7c7lAlYi", "0kwSzYig"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminSetPlayerSessionAttribute \
    --namespace $AB_NAMESPACE \
    --userId 'uosiJSqc' \
    --body '{"attributes": {"xAdwWOat": "n7aRoFfW", "PGI3Ut6H": "updxdU8W", "BJHv2kd6": "8uRkBoFv"}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminBulkBlockPlayersV1 \
    --namespace $AB_NAMESPACE \
    --userId 'TtXkiG3i' \
    --body '{"listBlockedUserId": ["QwMwqt6M", "ow1WeknL", "QIJFogKb"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminAddProfanityFilterIntoList \
    --list 's9ZxgAOX' \
    --namespace $AB_NAMESPACE \
    --body '{"filter": "EHJi3HSt", "note": "UJGjEaww"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminAddProfanityFilters \
    --list 'G8C73zoU' \
    --namespace $AB_NAMESPACE \
    --body '{"filters": [{"filter": "4imjGOSv", "note": "Cb3SaCbk"}, {"filter": "BFDW5B8i", "note": "1bKSrMHm"}, {"filter": "6JqrLphq", "note": "ZakKUfRq"}]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminCreateProfanityList \
    --namespace $AB_NAMESPACE \
    --body '{"isEnabled": false, "isMandatory": false, "name": "nyR6Asvj"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateProfanityList \
    --list 'nPx5wpxz' \
    --namespace $AB_NAMESPACE \
    --body '{"isEnabled": false, "isMandatory": true, "newName": "V01TphZs"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminVerifyMessageProfanityResponse \
    --namespace $AB_NAMESPACE \
    --body '{"message": "tB5jcXxv", "profanityLevel": "ttCDi4iC"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publicUpdatePartyAttributesV1 \
    --namespace $AB_NAMESPACE \
    --partyId '8Qf10edY' \
    --body '{"custom_attribute": {"Uc20z6Ub": {}, "YlEfhYq2": {}, "2N7QLtgn": {}}, "updatedAt": 78}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotification \
    --namespace $AB_NAMESPACE \
    --body '{"message": "r98C2NQX", "topic": "mSymCjpC"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"dw4jd9dj": "6P2N9HF6", "skxla9Kc": "sVKJoiG3", "Vousr94h": "Ow4ZvTbi"}, "templateLanguage": "Ewoy78Hb", "templateSlug": "qTUyUYdz", "topic": "HTaW13E6"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "zKSn0Fdx", "templateLanguage": "goXnjFBP", "templateSlug": "uzZwG9dG"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'cJGfnWjG' \
    --templateSlug 'aDkGFvf5' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'OSdGoDwy' \
    --templateSlug 'RWP6IuN1' \
    --body '{"templateContent": "QI9h7yR8"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalization \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'DhKuv0vk' \
    --templateSlug 'eGJGzH2T' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage '8ltYQbLr' \
    --templateSlug '3wUcwM1w' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTopic \
    --namespace $AB_NAMESPACE \
    --body '{"description": "3l7IoSFq", "topic": "rWbchuny"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotificationByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'OD800QLQ' \
    --body '{"message": "gamZUO49", "topic": "kHBWcJkD"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplateByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'eJm3LFGr' \
    --body '{"templateContext": {"ChLMuUMI": "SWtyQCdp", "n6J2puDY": "ZWBJBuiC", "97oYTxnw": "c3w6MIJp"}, "templateLanguage": "ouiwbF4r", "templateSlug": "5Cf9Ez4K", "topic": "XIny3TZV"}' \
    > test.out 2>&1
