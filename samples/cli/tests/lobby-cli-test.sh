...
samples/cli/sample-apps Lobby userRequestFriend \
    --namespace $AB_NAMESPACE \
    --body '{"friendId": "gWianrB5", "friendPublicId": "cSJxH8FO", "metadata": {"sEopyUFN": "wYSRk0QW", "5L1GThdi": "wxPP4pBX", "JNVBFure": "Kiz7rmOB"}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby addFriendsWithoutConfirmation \
    --namespace $AB_NAMESPACE \
    --userId '6fpluM9u' \
    --body '{"friendIds": ["blF79A6K", "io33gj1i", "OOf7OKWx"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby bulkDeleteFriends \
    --namespace $AB_NAMESPACE \
    --userId 'Rtb99yzg' \
    --body '{"friendIds": ["XMLq2b9L", "QYmoWHOY", "hI9eSdMN"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby syncNativeFriends \
    --namespace $AB_NAMESPACE \
    --body '[{"isLogin": true, "platformId": "iwcvTSfs", "platformToken": "6KgbQq1M", "psnEnv": "aiuUwxHu"}, {"isLogin": true, "platformId": "86g2Ubc5", "platformToken": "XHO6zoxR", "psnEnv": "BUSeYr3C"}, {"isLogin": false, "platformId": "5wn7H4ms", "platformToken": "mDCK3ldA", "psnEnv": "ZpQLEaOR"}]' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby syncNativeBlockedUser \
    --namespace $AB_NAMESPACE \
    --body '[{"platformId": "HPV2OHN9", "psnEnv": "D7iwYnZw"}, {"platformId": "tzJbCQgp", "psnEnv": "Vx4ybpR5"}, {"platformId": "RlU49yZG", "psnEnv": "pxkoXdG4"}]' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminPatchUpdateLogConfig \
    --body '{"logLevel": "trace", "logLevelDB": "info", "slowQueryThreshold": 74, "socketLogEnabled": true}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateConfigV1 \
    --namespace $AB_NAMESPACE \
    --body '{"allowInviteNonConnectedUser": false, "allowJoinPartyDuringMatchmaking": false, "autoKickOnDisconnect": true, "autoKickOnDisconnectDelay": 22, "cancelTicketOnDisconnect": true, "chatRateLimitBurst": 96, "chatRateLimitDuration": 80, "concurrentUsersLimit": 22, "disableInvitationOnJoinParty": true, "enableChat": true, "entitlementCheck": false, "entitlementItemID": "vUT6XumH", "generalRateLimitBurst": 8, "generalRateLimitDuration": 51, "keepPresenceActivityOnDisconnect": true, "maxDSWaitTime": 17, "maxFriendsLimit": 93, "maxPartyMember": 49, "profanityFilter": true, "readyConsentTimeout": 88, "requestMetadataMaxSize": 100, "unregisterDelay": 96}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getListOfFriends \
    ...
    --userId 'felYa0QS' \
    --friendId 'wvvPkInI' \
    --friendIds '["7GTJuFPk", "5beo649O", "zLVFiQ2k"]' \
    --limit '52' \
    --offset '52' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendMultipleUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "kywV24wy", "topicName": "mhmTi1YW", "userIds": ["z36U7hXq", "9YobTeYI", "rkeDjidN"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "RD5wi1IQ", "topicName": "fbXC8aqE"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTemplateV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "pi1ROQ2I", "templateLanguage": "6kWUPn9j", "templateSlug": "uLjDEv5v"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"ZgciGEpI": "Vll7Me1s", "v7CXFBBZ": "qft9161P", "X7Tpl6Ix": "j1Ct9ETZ"}, "templateLanguage": "hfi2j0Ry", "templateSlug": "uMZK7lPY", "topicName": "eRlqj5Zk"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getSingleTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'BIGdZYmv' \
    --templateSlug 'EQzxvLrh' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'xBplIggN' \
    --templateSlug 'OPxTTTFo' \
    --body '{"templateContent": "iziAdrS7"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage '51xzPONi' \
    --templateSlug 'S5gVpAzL' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage '3CNKfVo3' \
    --templateSlug 'tGAx0s50' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTopicV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"description": "GZUXe1kk", "topicName": "spwS55SN"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'ue5K62d3' \
    --body '{"message": "dCqsYcjZ", "topicName": "T6Rtua8n"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'EY8nYVYG' \
    --body '{"templateContext": {"xJEf87WZ": "auSbX8lo", "e8TplBc5": "ieAmVv4G", "b3YKnFU1": "YrB3n5Ez"}, "templateLanguage": "J5MELOhd", "templateSlug": "aFBg2dIK", "topicName": "fd1qygIP"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminGetBulkPlayerBlockedPlayersV1 \
    --namespace $AB_NAMESPACE \
    --body '{"listBlockedUserId": ["uCI7LRBw", "6JMlPqAf", "WZai6XfH"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminBulkBlockPlayersV1 \
    --namespace $AB_NAMESPACE \
    --userId 'LZMaFacl' \
    --body '{"listBlockedUserId": ["4pGYpf1G", "B6f3adcV", "tpGZU4er"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminBulkUnblockPlayersV1 \
    --namespace $AB_NAMESPACE \
    --userId 'XES1pXNX' \
    --body '{"listUnblockUserId": ["Wmsk5PzV", "bw4WuJeV", "VzE2B6ZR"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby usersPresenceHandlerV2 \
    --namespace $AB_NAMESPACE \
    --countOnly 'false' \
    --body '{"userIDs": ["kpipiG0X", "5e46fW7O", "VriFg7M7"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotification \
    --namespace $AB_NAMESPACE \
    --body '{"message": "stgutZlG", "topic": "JWD4VvWz"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"njtsbfM9": "9GEXMOow", "q3a08Yez": "o3QQREdK", "bDRugL8J": "IIOkg0qc"}, "templateLanguage": "SWibArfp", "templateSlug": "B6uK9bDI", "topic": "AdfMMeMx"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "aBiD3FNe", "templateLanguage": "d1ErBJDi", "templateSlug": "YtiM8srN"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'NittfvxB' \
    --templateSlug 'l3vcIJ1m' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'O6Xczs6j' \
    --templateSlug '4Uj3VFdU' \
    --body '{"templateContent": "1RQ1wJe4"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalization \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'Y5ej2Qmg' \
    --templateSlug 'nJpdAg94' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'ARVlqrKu' \
    --templateSlug 'nuK1hJut' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTopic \
    --namespace $AB_NAMESPACE \
    --body '{"description": "iHMnoxfZ", "topic": "HPHKUQqa"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotificationByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'QUBMyJtZ' \
    --body '{"message": "0FuNZUpz", "topic": "t74u1Eqq"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplateByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'HoiCdqfn' \
    --body '{"templateContext": {"5h67HSoW": "rdsNPJMO", "TschArWJ": "ShMAfo9O", "foIApF5h": "Wasz1CgN"}, "templateLanguage": "Y3aOMKhS", "templateSlug": "ceIK0gEo", "topic": "HwzyTqqb"}' \
    > test.out 2>&1
