...
samples/cli/sample-apps Lobby userRequestFriend \
    --namespace $AB_NAMESPACE \
    --body '{"friendId": "PZXhW3sw", "friendPublicId": "Wumwk8Se"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby addFriendsWithoutConfirmation \
    --namespace $AB_NAMESPACE \
    --userId '9GgdhWjL' \
    --body '{"friendIds": ["XYaOgD0O", "ihUojPN0", "nzukwMQF"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby bulkDeleteFriends \
    --namespace $AB_NAMESPACE \
    --userId '0FmBxaGI' \
    --body '{"friendIds": ["tP05mg60", "cLWeXvKE", "osOLGwEY"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby syncNativeFriends \
    --namespace $AB_NAMESPACE \
    --body '[{"isLogin": false, "platformId": "kz0eiWbK", "platformToken": "k4PYapbn", "psnEnv": "7jAftt8p"}, {"isLogin": false, "platformId": "RhYx9770", "platformToken": "J3pm6QnR", "psnEnv": "RNG3bjLo"}, {"isLogin": true, "platformId": "0SxvA7iG", "platformToken": "YgiZueMO", "psnEnv": "96jywvh9"}]' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateConfigV1 \
    --namespace $AB_NAMESPACE \
    --body '{"allowInviteNonConnectedUser": false, "allowJoinPartyDuringMatchmaking": false, "autoKickOnDisconnect": true, "autoKickOnDisconnectDelay": 99, "cancelTicketOnDisconnect": false, "chatRateLimitBurst": 20, "chatRateLimitDuration": 62, "concurrentUsersLimit": 29, "disableInvitationOnJoinParty": false, "enableChat": false, "entitlementCheck": false, "entitlementItemID": "FxjGE5Hc", "generalRateLimitBurst": 93, "generalRateLimitDuration": 90, "keepPresenceActivityOnDisconnect": true, "maxDSWaitTime": 43, "maxFriendsLimit": 2, "maxPartyMember": 46, "profanityFilter": false, "readyConsentTimeout": 88, "unregisterDelay": 85}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateGlobalConfig \
    --body '{"regionRetryMapping": {"mWf92fao": ["3sb70sfY", "1IYCJOJs", "I9KasbMD"], "IftH6Xad": ["70CWVlP5", "7SRNjCQQ", "BN27c6xO"], "HmRXQvXz": ["WRBnDoH5", "6momq0dU", "F910rrAq"]}, "regionURLMapping": ["p6JNFtT5", "hugB7x0o", "j84NlBlT"], "testGameMode": "c2ujdABj", "testRegionURLMapping": ["FrFdLbQx", "bvPxeOBn", "xK9TfMte"], "testTargetUserIDs": ["iE9CQ6u7", "FMcL2f5B", "JMqjWybi"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendMultipleUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "AzimPI0m", "topicName": "XzxVnF6D", "userIds": ["8jqAbGtt", "8ZUDzbIp", "d3DIDiho"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"message": "WT5kDKQZ", "topicName": "jhg4VaQP"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendPartyFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --partyId 'l8ohHj0O' \
    --body '{"message": "f7PgcsGX", "topicName": "KJG5D5cR"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendPartyTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --partyId 'XShSS3vx' \
    --body '{"templateContext": {"fkEvKuoa": "0JyAwLkq", "k4lilXoZ": "CPHmradJ", "NdXHdkzM": "GPpZJvWc"}, "templateLanguage": "gkzr1tyA", "templateSlug": "gHBqWTpK", "topicName": "sOFhlAgK"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTemplateV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "OaVvEkJN", "templateLanguage": "dQ4BzLm8", "templateSlug": "ZbspXSQv"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendUsersTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"vEtVJAgK": "2b6oCaNq", "4ZMxIPLf": "vViSSu1T", "mPDrugoH": "cpnaazh2"}, "templateLanguage": "Ol6jdMd4", "templateSlug": "rN5SGApx", "topicName": "X4Ga4g2s"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getSingleTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage '6N4iQeZu' \
    --templateSlug '0o6Cg8dr' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'YhENT3j4' \
    --templateSlug 'sOmN1dcz' \
    --body '{"templateContent": "6CbWaHla"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'KPl1FJRX' \
    --templateSlug 'sOZ1geXC' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplateLocalizationV1Admin \
    --namespace $AB_NAMESPACE \
    --templateLanguage '4XwDW60J' \
    --templateSlug 'bhH6n7mx' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createNotificationTopicV1Admin \
    --namespace $AB_NAMESPACE \
    --body '{"description": "upPEXcIS", "topicName": "xLsPIrZ5"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserFreeformNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'x6Fkh7Xz' \
    --body '{"message": "3IP6L0rC", "topicName": "fzlzn8me"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby sendSpecificUserTemplatedNotificationV1Admin \
    --namespace $AB_NAMESPACE \
    --userId 'apD6n9Ny' \
    --body '{"templateContext": {"POTyHwSj": "O0T79xrG", "LYajtRDQ": "dxYcUtOk", "yCOrYM6k": "3Mxm9UTU"}, "templateLanguage": "rSKMGlGm", "templateSlug": "OPsKrq5s", "topicName": "COBiubnj"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdatePartyAttributesV1 \
    --namespace $AB_NAMESPACE \
    --partyId 'L4bGVoCk' \
    --body '{"custom_attribute": {"VQ8dCF7M": {}, "vZBFG3gv": {}, "v6Ywqf18": {}}, "updatedAt": 56}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminGetBulkPlayerBlockedPlayersV1 \
    --namespace $AB_NAMESPACE \
    --body '{"listBlockedUserId": ["hkt3mVWQ", "PZ8XTH7I", "B6G0ILQW"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminSetPlayerSessionAttribute \
    --namespace $AB_NAMESPACE \
    --userId 'HyZADXvJ' \
    --body '{"attributes": {"pnf01ZWP": "t6lYjrYy", "gBXMkFQJ": "8FQXzuOm", "J1B5qLGF": "rGEAzq0p"}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminBulkBlockPlayersV1 \
    --namespace $AB_NAMESPACE \
    --userId 'YM8TBZrs' \
    --body '{"listBlockedUserId": ["ZGiKCqgc", "IWfdln0L", "rDJhlxGY"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminAddProfanityFilterIntoList \
    --list 'YIshHU7y' \
    --namespace $AB_NAMESPACE \
    --body '{"filter": "mIQERLQK", "note": "uPyqf9gK"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminAddProfanityFilters \
    --list 'nbuB00mt' \
    --namespace $AB_NAMESPACE \
    --body '{"filters": [{"filter": "ZoC5wXoa", "note": "X6nqPKkw"}, {"filter": "kaqjY0Bj", "note": "IOaSunoH"}, {"filter": "B8RzUSj1", "note": "MRGbqPO6"}]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminCreateProfanityList \
    --namespace $AB_NAMESPACE \
    --body '{"isEnabled": false, "isMandatory": true, "name": "bOyTRv9A"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminUpdateProfanityList \
    --list 'VHvwmfnk' \
    --namespace $AB_NAMESPACE \
    --body '{"isEnabled": false, "isMandatory": true, "newName": "0OOg0AfG"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby adminVerifyMessageProfanityResponse \
    --namespace $AB_NAMESPACE \
    --body '{"message": "ywxUTZR4", "profanityLevel": "78mHg0qI"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publicUpdatePartyAttributesV1 \
    --namespace $AB_NAMESPACE \
    --partyId 'sjPO6UHe' \
    --body '{"custom_attribute": {"dn3tqm00": {}, "9n25dQcr": {}, "BIcaf31w": {}}, "updatedAt": 23}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotification \
    --namespace $AB_NAMESPACE \
    --body '{"message": "QcWeKB8g", "topic": "I72J5Lwc"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContext": {"0xzPgCVZ": "Z1hAPodK", "t5omZQfk": "yHp3vtqs", "7rWnndk0": "6rUME4cq"}, "templateLanguage": "O8pZuBVw", "templateSlug": "12qb2ZED", "topic": "KUB9h15Y"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTemplate \
    --namespace $AB_NAMESPACE \
    --body '{"templateContent": "7l8rnbic", "templateLanguage": "Z89Aj7KN", "templateSlug": "FJg10EYW"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby getLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'OhZLfvnq' \
    --templateSlug 's5g4gsZ8' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby updateLocalizationTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'QRNAVK2J' \
    --templateSlug '636LRvAi' \
    --body '{"templateContent": "ALRmYUjd"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby deleteTemplateLocalization \
    --namespace $AB_NAMESPACE \
    --templateLanguage 'sRn2wUqd' \
    --templateSlug 'gbqbamqk' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby publishTemplate \
    --namespace $AB_NAMESPACE \
    --templateLanguage '41rZsnIv' \
    --templateSlug 'CnhYt2ER' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby createTopic \
    --namespace $AB_NAMESPACE \
    --body '{"description": "O85gnJMo", "topic": "xactjQcO"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby freeFormNotificationByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'Qvc6olyq' \
    --body '{"message": "Uz1cXcW7", "topic": "Zu519BIL"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Lobby notificationWithTemplateByUserID \
    --namespace $AB_NAMESPACE \
    --userId 'gUuN9mi4' \
    --body '{"templateContext": {"KvIxZYrN": "ar17hfNh", "I1b5BLaP": "Nj1xxM6x", "zcCzjNvm": "loqNLJ4H"}, "templateLanguage": "77N0asxr", "templateSlug": "TVW4NSzZ", "topic": "YPUvFNUy"}' \
    > test.out 2>&1
