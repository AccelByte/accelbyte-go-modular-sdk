...
samples/cli/sample-apps Basic createNamespace \
    --body '{"displayName": "QIgd8tx7", "namespace": "d8vxXYev"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic banUsers \
    --namespace $AB_NAMESPACE \
    --body '{"actionId": 46, "comment": "OIR7hExQ", "userIds": ["L3s8qTaa", "67Gd03mP", "yPcr7Ypt"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic getBannedUsers \
    --namespace $AB_NAMESPACE \
    --userIds '["8IrxScZc", "saERzkWv", "sEwILM3j"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic reportUser \
    --namespace $AB_NAMESPACE \
    --body '{"category": "zv73x940", "description": "8Paz6tda", "gameSessionId": "EDQA7fIT", "subcategory": "2GEUTG7K", "userId": "OkmGs8MM"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic unBanUsers \
    --namespace $AB_NAMESPACE \
    --body '{"comment": "TWahTzjI", "userIds": ["4sbKyWVu", "7ZsbIgJs", "M2P6yMHZ"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic createConfig \
    --namespace $AB_NAMESPACE \
    --body '{"key": "LyrjvZZ5", "value": "nMwbPghp"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic addCountryGroup \
    --namespace $AB_NAMESPACE \
    --body '{"countries": [{"code": "a3arGBPt", "name": "PgXJ9qaH"}, {"code": "9JVk6h4A", "name": "qxZSRpZZ"}, {"code": "1qjuY07l", "name": "X2F0Av3S"}], "countryGroupCode": "RmRb9QDz", "countryGroupName": "yggxxvCf"}' \
    > test.out 2>&1
eval_tap $? 24 'AddCountryGroup' test.out

#- 25 UpdateCountryGroup
samples/cli/sample-apps Basic updateCountryGroup \
    --countryGroupCode 'viv54aaz' \
    --namespace $AB_NAMESPACE \
    --body '{"countries": [{"code": "Tv8GDYxE", "name": "u8YtNfHa"}, {"code": "ayQp03zn", "name": "0TWwuDOn"}, {"code": "7UEmvXrJ", "name": "RlzKXysv"}], "countryGroupName": "yoezMfPK"}' \
    > test.out 2>&1
eval_tap $? 25 'UpdateCountryGroup' test.out

#- 26 DeleteCountryGroup
samples/cli/sample-apps Basic deleteCountryGroup \
    --countryGroupCode 'QisYFeyh' \
    --namespace $AB_NAMESPACE \
    > test.out 2>&1
...
samples/cli/sample-apps Basic adminGetUserProfilePublicInfoByIds \
    --namespace $AB_NAMESPACE \
    --body '{"userIds": ["gI8qCCnF", "ysAFGgkq", "A15HpuTV"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateUserProfile \
    --namespace $AB_NAMESPACE \
    --userId 'JEyFo2zR' \
    --body '{"avatarLargeUrl": "hmxHumc3", "avatarSmallUrl": "PNORnhZw", "avatarUrl": "DQOVPJFQ", "customAttributes": {"k5qu7Xaa": {}, "yZVFpaQa": {}, "y5On4isd": {}}, "dateOfBirth": "1995-09-07", "firstName": "YYVOZeGw", "language": "jsOn_PwNI-464", "lastName": "t7bTpkYe", "privateCustomAttributes": {"cck7dX9v": {}, "EYMvKshF": {}, "CaTUcETi": {}}, "status": "ACTIVE", "timeZone": "bfLIpwaZ", "zipCode": "VO6Fv1Bt"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateCustomAttributesPartially \
    --namespace $AB_NAMESPACE \
    --userId 'M9ucnpIl' \
    --body '{"LLYbG7hW": {}, "O0FIvXh4": {}, "k2zdoBMi": {}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updatePrivateCustomAttributesPartially \
    --namespace $AB_NAMESPACE \
    --userId 'KEUSlNK8' \
    --body '{"CFlCXKL2": {}, "Q9wihjji": {}, "EGWNz5VN": {}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateMyProfile \
    --namespace $AB_NAMESPACE \
    --body '{"avatarLargeUrl": "vRGN9ocd", "avatarSmallUrl": "dsZ8nWzO", "avatarUrl": "3qkc5xjY", "customAttributes": {"eZxdSvnk": {}, "L3qB3fO6": {}, "rCpPQhNc": {}}, "dateOfBirth": "1995-12-09", "firstName": "QXYRVtHv", "language": "eg", "lastName": "LEmwsjFm", "privateCustomAttributes": {"OSs6FUGQ": {}, "RrnUUr3O": {}, "AzWn7Iwm": {}}, "timeZone": "eyjcUGTJ", "zipCode": "YC1UF41z"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic createMyProfile \
    --namespace $AB_NAMESPACE \
    --body '{"avatarLargeUrl": "yBxCXvB8", "avatarSmallUrl": "cnN20pUk", "avatarUrl": "38zqsp7D", "customAttributes": {"QsvCq6ga": {}, "W5kBD1Mb": {}, "Ky9H9mQX": {}}, "dateOfBirth": "1976-04-08", "firstName": "OHrjJH5x", "language": "gPBA_vMQa-305", "lastName": "DE8njb2U", "privateCustomAttributes": {"bWDvWW6f": {}, "VfZXlc0x": {}, "TBrWkPuE": {}}, "timeZone": "b8miOre1"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateMyPrivateCustomAttributesPartially \
    --namespace $AB_NAMESPACE \
    --body '{"tJu708PM": {}, "Yc3Bl8TF": {}, "u2DTaBm5": {}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateMyZipCode \
    --namespace $AB_NAMESPACE \
    --userZipCodeUpdate '{"zipCode": "5vQlzoqp"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic publicReportUser \
    --namespace $AB_NAMESPACE \
    --userId 'CTr1WNVa' \
    --body '{"category": "UJhcRIjW", "description": "pdWrbdvk", "gameSessionId": "BM4GGJNs", "subcategory": "G9QUKYpk", "userId": "aoRbYGue"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic publicUpdateUserProfile \
    --namespace $AB_NAMESPACE \
    --userId 'WlKsSiDt' \
    --body '{"avatarLargeUrl": "YSFcbyzy", "avatarSmallUrl": "uvaYYNNe", "avatarUrl": "x225LkWf", "customAttributes": {"T72Pu2ua": {}, "GyufikKm": {}, "HDb0ZQd6": {}}, "dateOfBirth": "1985-08-20", "firstName": "3TCpYPvm", "language": "oncD", "lastName": "7mXRzaxO", "privateCustomAttributes": {"IjWhZ2IL": {}, "8cRuOmHZ": {}, "rbMAyKsk": {}}, "timeZone": "j2EtoTJj", "zipCode": "FBQjoGQt"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic publicCreateUserProfile \
    --namespace $AB_NAMESPACE \
    --userId 'KVwVTNbK' \
    --body '{"avatarLargeUrl": "vFy8M9mb", "avatarSmallUrl": "KhgSVZQq", "avatarUrl": "KWM8rgYA", "customAttributes": {"TLJhYcpu": {}, "CfIKlavX": {}, "oJ34EiW1": {}}, "dateOfBirth": "1975-01-10", "firstName": "wSWg5ugq", "language": "fjH_299", "lastName": "x7QREQTU", "timeZone": "8shBb8vT"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic publicUpdateCustomAttributesPartially \
    --namespace $AB_NAMESPACE \
    --userId 'A6PiVa7P' \
    --body '{"xHJnAvls": {}, "lJMw1ACu": {}, "3TTd1xsm": {}}' \
    > test.out 2>&1
