...
samples/cli/sample-apps Basic createNamespace \
    --body '{"displayName": "fmNfo8Wm", "namespace": "Zabs4fvu"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic banUsers \
    --namespace $AB_NAMESPACE \
    --body '{"actionId": 28, "comment": "2JELcR69", "userIds": ["sfthl0x9", "DmgnKEFu", "EdZxM3iB"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic getBannedUsers \
    --namespace $AB_NAMESPACE \
    --userIds '["5kuBR5cU", "fkWlIJFu", "xF51yxeY"]' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic reportUser \
    --namespace $AB_NAMESPACE \
    --body '{"category": "Ugjn8CEe", "description": "0D4F4Gj0", "gameSessionId": "JjlXPobq", "subcategory": "kmJBiMw8", "userId": "55zbihvm"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic unBanUsers \
    --namespace $AB_NAMESPACE \
    --body '{"comment": "Rax8m2KQ", "userIds": ["J58lN48L", "p5nPWJYw", "9vqBUvm0"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic createConfig \
    --namespace $AB_NAMESPACE \
    --body '{"key": "uTUnWsk4", "value": "PUxL9zpW"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic addCountryGroup \
    --namespace $AB_NAMESPACE \
    --body '{"countries": [{"code": "xqpPNTGb", "name": "MEB0uVII"}, {"code": "j7GUXqyE", "name": "zKx0YFLw"}, {"code": "8tR1uvSh", "name": "cCxdMJfL"}], "countryGroupCode": "AezTk4bu", "countryGroupName": "1QU3sY4C"}' \
    > test.out 2>&1
eval_tap $? 24 'AddCountryGroup' test.out

#- 25 UpdateCountryGroup
samples/cli/sample-apps Basic updateCountryGroup \
    --countryGroupCode 'taSyXXMr' \
    --namespace $AB_NAMESPACE \
    --body '{"countries": [{"code": "OhSQyOw9", "name": "kFfUxwr3"}, {"code": "ZKMGPJog", "name": "ATVmlfuL"}, {"code": "bWOeePQV", "name": "FCERzcmp"}], "countryGroupName": "ZEwlQEuj"}' \
    > test.out 2>&1
eval_tap $? 25 'UpdateCountryGroup' test.out

#- 26 DeleteCountryGroup
samples/cli/sample-apps Basic deleteCountryGroup \
    --countryGroupCode 'OjeppUrm' \
    --namespace $AB_NAMESPACE \
    > test.out 2>&1
...
samples/cli/sample-apps Basic adminGetUserProfilePublicInfoByIds \
    --namespace $AB_NAMESPACE \
    --body '{"userIds": ["MqQg1yf1", "50Mudil4", "LsPw3uKa"]}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateUserProfile \
    --namespace $AB_NAMESPACE \
    --userId 'OlrtP9Fu' \
    --body '{"avatarLargeUrl": "t83O6TTd", "avatarSmallUrl": "Srnaym6I", "avatarUrl": "M7l6uFJ5", "customAttributes": {"xHCwgHop": {}, "7uoI0NzV": {}, "pKnjHYpa": {}}, "dateOfBirth": "1990-01-09", "firstName": "5oTWvVOx", "language": "DF_DDvO", "lastName": "p0cOQfXq", "privateCustomAttributes": {"zQifQxQK": {}, "5YUrlmPk": {}, "AVzT374O": {}}, "status": "INACTIVE", "timeZone": "XKGZmH78", "zipCode": "6Y3BZreq"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateCustomAttributesPartially \
    --namespace $AB_NAMESPACE \
    --userId 'VdoDxeYk' \
    --body '{"g5xkfMxL": {}, "xAwOManV": {}, "tQSmSIVC": {}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updatePrivateCustomAttributesPartially \
    --namespace $AB_NAMESPACE \
    --userId 'N6XbuEZT' \
    --body '{"zMl7hXpM": {}, "Fo5VqI7v": {}, "nX78GrPL": {}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateMyProfile \
    --namespace $AB_NAMESPACE \
    --body '{"avatarLargeUrl": "5GTN8rkT", "avatarSmallUrl": "uHpblBLX", "avatarUrl": "ym4Kba41", "customAttributes": {"kjdSmWZz": {}, "btIoB3Ng": {}, "030TeeY8": {}}, "dateOfBirth": "1985-04-01", "firstName": "c1jzvEcu", "language": "YeoK-JetF-Mh", "lastName": "4zt1fbDl", "privateCustomAttributes": {"uXEP75oH": {}, "PRKVnd6D": {}, "2RyN1U87": {}}, "timeZone": "ikqXPBFw", "zipCode": "D8bllvLa"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic createMyProfile \
    --namespace $AB_NAMESPACE \
    --body '{"avatarLargeUrl": "YiMfbvn6", "avatarSmallUrl": "DTfkcdRg", "avatarUrl": "e63jiLS5", "customAttributes": {"JMfCpcSx": {}, "f9SgYslx": {}, "xdQUqJ7b": {}}, "dateOfBirth": "1981-03-22", "firstName": "hk7dafwf", "language": "aCp-aE", "lastName": "kDQ8xoUZ", "privateCustomAttributes": {"wgoRm3Xm": {}, "TkhpTYhu": {}, "GTj7Dfm1": {}}, "timeZone": "kwIOgWQX"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateMyPrivateCustomAttributesPartially \
    --namespace $AB_NAMESPACE \
    --body '{"O9zubeG8": {}, "0bHarr2n": {}, "6V9zxktH": {}}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic updateMyZipCode \
    --namespace $AB_NAMESPACE \
    --userZipCodeUpdate '{"zipCode": "BtOYfVoy"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic publicReportUser \
    --namespace $AB_NAMESPACE \
    --userId 'V0ohtw6B' \
    --body '{"category": "x3AbmwfX", "description": "5Ml6KBL4", "gameSessionId": "CqtInChU", "subcategory": "iHkezO5h", "userId": "xLJTjykP"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic publicUpdateUserProfile \
    --namespace $AB_NAMESPACE \
    --userId 'dtt0yFc2' \
    --body '{"avatarLargeUrl": "3dEbRAL5", "avatarSmallUrl": "k3bIdrva", "avatarUrl": "auPMpHSk", "customAttributes": {"JnreKOmC": {}, "j5wHsRNL": {}, "m1jHbSdB": {}}, "dateOfBirth": "1982-03-25", "firstName": "RlTwq5B0", "language": "NI", "lastName": "FHkyPLbk", "privateCustomAttributes": {"87sGtMcl": {}, "M9docR4g": {}, "chYCsINc": {}}, "timeZone": "HF92BWzJ", "zipCode": "83BuMFHF"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic publicCreateUserProfile \
    --namespace $AB_NAMESPACE \
    --userId 'WV39N6e6' \
    --body '{"avatarLargeUrl": "PyCXmbko", "avatarSmallUrl": "ox9R9LHV", "avatarUrl": "R4BM8yjQ", "customAttributes": {"xV4nCVGK": {}, "HTl9KDs0": {}, "L0gIN1Sg": {}}, "dateOfBirth": "1998-02-26", "firstName": "vDLLZQEn", "language": "mu_UmBl", "lastName": "uOaLudcV", "timeZone": "3BXyRmqK"}' \
    > test.out 2>&1
...
samples/cli/sample-apps Basic publicUpdateCustomAttributesPartially \
    --namespace $AB_NAMESPACE \
    --userId 'gaKEOAYH' \
    --body '{"JWb4JOgO": {}, "n2Vt2ylm": {}, "M6xmPQuV": {}}' \
    > test.out 2>&1
