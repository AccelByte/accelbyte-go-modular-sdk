...
func init() {
	PublicCheckUserSubscriptionSubscribableByItemIdCmd.Flags().String("namespace", "", "Namespace")
	_ = PublicCheckUserSubscriptionSubscribableByItemIdCmd.MarkFlagRequired("namespace")
	PublicCheckUserSubscriptionSubscribableByItemIdCmd.Flags().String("userId", "", "User id")
	_ = PublicCheckUserSubscriptionSubscribableByItemIdCmd.MarkFlagRequired("userId")
	PublicCheckUserSubscriptionSubscribableByItemIdCmd.Flags().String("itemId", "", "Item id")
