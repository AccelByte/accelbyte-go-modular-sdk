...
// IndexHandlerCmd represents the IndexHandler command
var IndexHandlerCmd = &cobra.Command{
	Use:   "indexHandler",
	Short: "Index handler",
	Long:  `Index handler`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		input := &operations.IndexHandlerParams{}
		errOK := operationsService.IndexHandlerShort(input)
		if errOK != nil {
			logrus.Error(errOK)
