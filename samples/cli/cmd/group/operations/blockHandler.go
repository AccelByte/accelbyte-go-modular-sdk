...
// BlockHandlerCmd represents the BlockHandler command
var BlockHandlerCmd = &cobra.Command{
	Use:   "blockHandler",
	Short: "Block handler",
	Long:  `Block handler`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		input := &operations.BlockHandlerParams{}
		errOK := operationsService.BlockHandlerShort(input)
		if errOK != nil {
			logrus.Error(errOK)
