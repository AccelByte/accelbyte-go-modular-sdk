...
var DeleteUserRankingAdminV1Cmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		errNoContent := leaderboardDataService.DeleteUserRankingAdminV1Short(input)
		if errNoContent != nil {
...
func init() {
	DeleteUserRankingAdminV1Cmd.Flags().String("leaderboardCode", "", "Leaderboard code")
	_ = DeleteUserRankingAdminV1Cmd.MarkFlagRequired("leaderboardCode")
	DeleteUserRankingAdminV1Cmd.Flags().String("namespace", "", "Namespace")
	_ = DeleteUserRankingAdminV1Cmd.MarkFlagRequired("namespace")
	DeleteUserRankingAdminV1Cmd.Flags().String("userId", "", "User id")
