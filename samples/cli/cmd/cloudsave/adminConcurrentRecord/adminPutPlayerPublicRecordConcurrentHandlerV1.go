...
var AdminPutPlayerPublicRecordConcurrentHandlerV1Cmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ok, errOK := adminConcurrentRecordService.AdminPutPlayerPublicRecordConcurrentHandlerV1Short(input)
		if errOK != nil {
			logrus.Error(errOK)
...
func init() {
	...
	AdminPutPlayerPublicRecordConcurrentHandlerV1Cmd.Flags().Bool("responseBody", false, "Response body")
}
