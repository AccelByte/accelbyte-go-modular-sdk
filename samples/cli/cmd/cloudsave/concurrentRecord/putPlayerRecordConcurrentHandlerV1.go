...
var PutPlayerRecordConcurrentHandlerV1Cmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ok, errOK := concurrentRecordService.PutPlayerRecordConcurrentHandlerV1Short(input)
		if errOK != nil {
			logrus.Error(errOK)
...
func init() {
	...
	PutPlayerRecordConcurrentHandlerV1Cmd.Flags().Bool("responseBody", false, "Response body")
}
