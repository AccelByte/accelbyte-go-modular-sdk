...
func init() {
	PostPlayerRecordHandlerV1Cmd.Flags().String("body", "", "Body")
	_ = PostPlayerRecordHandlerV1Cmd.MarkFlagRequired("body")
	PostPlayerRecordHandlerV1Cmd.Flags().String("key", "", "Key")
	_ = PostPlayerRecordHandlerV1Cmd.MarkFlagRequired("key")
	PostPlayerRecordHandlerV1Cmd.Flags().String("namespace", "", "Namespace")
	_ = PostPlayerRecordHandlerV1Cmd.MarkFlagRequired("namespace")
	PostPlayerRecordHandlerV1Cmd.Flags().String("userId", "", "User id")
