...
func init() {
    IamCmd.AddCommand(oAuth20.GetAuthorizationServerMetadataWithNamespaceCmd)
    ...
    IamCmd.AddCommand(clientsConfigV3.AdminUpdateModulePackageCmd)
    ...
    IamCmd.AddCommand(inputValidations.AdminGetNamespaceScopedInputValidationsCmd)
    IamCmd.AddCommand(inputValidations.AdminUpdateNamespaceScopedInputValidationsCmd)
    IamCmd.AddCommand(inputValidations.AdminResetNamespaceScopedInputValidationsCmd)
    ...
    IamCmd.AddCommand(users.AdminCursorGetUserV3Cmd)
    ...
    IamCmd.AddCommand(thirdPartyCredential.GetThirdPartyLoginPlatformDefaultsV3Cmd)
    ...
    IamCmd.AddCommand(config.PublicGetSystemConfigV3Cmd)
    ...
    IamCmd.AddCommand(oAuth20.OAuthDynamicClientRegisterWithNamespaceV3Cmd)
    ...
    IamCmd.AddCommand(inputValidations.PublicGetNamespaceScopedInputValidationsCmd)
    IamCmd.AddCommand(inputValidations.PublicGetNamespaceScopedInputValidationByFieldCmd)
    ...
    IamCmd.AddCommand(users.PublicForgotPasswordWithoutNamespaceV3Cmd)
