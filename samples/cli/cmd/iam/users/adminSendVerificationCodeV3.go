...
var AdminSendVerificationCodeV3Cmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		errNoContent := usersService.AdminSendVerificationCodeV3Short(input)
		if errNoContent != nil {
...
func init() {
	AdminSendVerificationCodeV3Cmd.Flags().String("body", "", "Body")
	_ = AdminSendVerificationCodeV3Cmd.MarkFlagRequired("body")
	AdminSendVerificationCodeV3Cmd.Flags().String("namespace", "", "Namespace")
	_ = AdminSendVerificationCodeV3Cmd.MarkFlagRequired("namespace")
	AdminSendVerificationCodeV3Cmd.Flags().String("userId", "", "User id")
