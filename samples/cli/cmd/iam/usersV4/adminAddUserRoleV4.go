...
var AdminAddUserRoleV4Cmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		ok, errOK := usersV4Service.AdminAddUserRoleV4Short(input)
		if errOK != nil {
			logrus.Error(errOK)
...
func init() {
	AdminAddUserRoleV4Cmd.Flags().String("body", "", "Body")
	_ = AdminAddUserRoleV4Cmd.MarkFlagRequired("body")
	AdminAddUserRoleV4Cmd.Flags().String("namespace", "", "Namespace")
	_ = AdminAddUserRoleV4Cmd.MarkFlagRequired("namespace")
	AdminAddUserRoleV4Cmd.Flags().String("userId", "", "User id")
