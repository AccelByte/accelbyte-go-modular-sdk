...
import (
	...
	sessionDSMC "github.com/AccelByte/accelbyte-go-modular-sdk/dsmc-sdk/pkg/dsmcclient/session"
	...
	sdkUtils "github.com/AccelByte/accelbyte-go-modular-sdk/services-api/pkg/utils"
...
var (
	...
	dsmcService = &dsmc.SessionService{
		Client:          dsmc.NewDsmcClient(&configImpl),
		TokenRepository: &tokenImpl,
	}
	sessionBrowserService = sessionbrowser.SessionService{
		Client:          sessionbrowser.NewSessionbrowserClient(&configImpl),
		TokenRepository: &tokenImpl,
	}
	settings        interface{}
