...
func getUserStatItem(params *user_statistic.GetUserStatItemsParams, tokenRepositoryImpl *auth.TokenRepositoryImpl) (*socialclientmodels.UserStatItemPagingSlicedResult, error) {
