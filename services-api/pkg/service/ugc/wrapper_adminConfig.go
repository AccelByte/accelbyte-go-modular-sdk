...
// Deprecated: 2023-03-30 - please use AdminConfigService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/ugc-sdk/pkg"
...
func (aaa *AdminConfigService) UpdateFlightId(flightId string) {
	tempFlightIdAdminConfig = &flightId
}
