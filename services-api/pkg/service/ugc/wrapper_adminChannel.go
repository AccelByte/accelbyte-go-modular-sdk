...
func (aaa *AdminChannelService) SingleAdminGetChannel(input *admin_channel.SingleAdminGetChannelParams) (*ugcclientmodels.ModelsPaginatedGetChannelResponse, error) {
	...
	ok, badRequest, unauthorized, internalServerError, err := aaa.Client.AdminChannel.SingleAdminGetChannel(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *AdminChannelService) AdminGetChannel(input *admin_channel.AdminGetChannelParams) (*ugcclientmodels.ModelsPaginatedGetChannelResponse, error) {
	...
	ok, badRequest, unauthorized, internalServerError, err := aaa.Client.AdminChannel.AdminGetChannel(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
