...
// Deprecated: 2023-03-30 - please use AdminContentService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/ugc-sdk/pkg"
...
func (aaa *AdminContentService) AdminUploadContentDirect(input *admin_content.AdminUploadContentDirectParams) (*ugcclientmodels.ModelsCreateContentResponse, error) {
	...
	created, badRequest, unauthorized, forbidden, conflict, internalServerError, err := aaa.Client.AdminContent.AdminUploadContentDirect(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *AdminContentService) AdminUploadContentS3(input *admin_content.AdminUploadContentS3Params) (*ugcclientmodels.ModelsCreateContentResponse, error) {
	...
	created, badRequest, unauthorized, forbidden, conflict, internalServerError, err := aaa.Client.AdminContent.AdminUploadContentS3(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) SingleAdminUpdateContentS3(input *admin_content.SingleAdminUpdateContentS3Params) (*ugcclientmodels.ModelsCreateContentResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, conflict, internalServerError, err := aaa.Client.AdminContent.SingleAdminUpdateContentS3(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminSearchChannelSpecificContent(input *admin_content.AdminSearchChannelSpecificContentParams) (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, error) {
	...
	ok, badRequest, unauthorized, internalServerError, err := aaa.Client.AdminContent.AdminSearchChannelSpecificContent(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) SingleAdminUpdateContentDirect(input *admin_content.SingleAdminUpdateContentDirectParams) (*ugcclientmodels.ModelsCreateContentResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AdminContent.SingleAdminUpdateContentDirect(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) SingleAdminGetContent(input *admin_content.SingleAdminGetContentParams) (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, error) {
	...
	ok, badRequest, unauthorized, internalServerError, err := aaa.Client.AdminContent.SingleAdminGetContent(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminGetContentBulk(input *admin_content.AdminGetContentBulkParams) ([]*ugcclientmodels.ModelsContentDownloadResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.AdminContent.AdminGetContentBulk(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminSearchContent(input *admin_content.AdminSearchContentParams) (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, error) {
	...
	ok, badRequest, unauthorized, internalServerError, err := aaa.Client.AdminContent.AdminSearchContent(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminGetContentBulkByShareCodes(input *admin_content.AdminGetContentBulkByShareCodesParams) ([]*ugcclientmodels.ModelsContentDownloadResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.AdminContent.AdminGetContentBulkByShareCodes(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminUpdateScreenshots(input *admin_content.AdminUpdateScreenshotsParams) (*ugcclientmodels.ModelsUpdateScreenshotResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AdminContent.AdminUpdateScreenshots(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminUploadContentScreenshot(input *admin_content.AdminUploadContentScreenshotParams) (*ugcclientmodels.ModelsCreateScreenshotResponse, error) {
	...
	created, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AdminContent.AdminUploadContentScreenshot(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminDeleteContentScreenshot(input *admin_content.AdminDeleteContentScreenshotParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AdminContent.AdminDeleteContentScreenshot(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminUpdateContentS3ByShareCode(input *admin_content.AdminUpdateContentS3ByShareCodeParams) (*ugcclientmodels.ModelsCreateContentResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, conflict, internalServerError, err := aaa.Client.AdminContent.AdminUpdateContentS3ByShareCode(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminUpdateContentS3(input *admin_content.AdminUpdateContentS3Params) (*ugcclientmodels.ModelsCreateContentResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, conflict, internalServerError, err := aaa.Client.AdminContent.AdminUpdateContentS3(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminUpdateContentDirect(input *admin_content.AdminUpdateContentDirectParams) (*ugcclientmodels.ModelsCreateContentResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AdminContent.AdminUpdateContentDirect(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminGetContent(input *admin_content.AdminGetContentParams) (*ugcclientmodels.ModelsPaginatedContentDownloadResponse, error) {
	...
	ok, badRequest, unauthorized, internalServerError, err := aaa.Client.AdminContent.AdminGetContent(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *AdminContentService) AdminHideUserContent(input *admin_content.AdminHideUserContentParams) (*ugcclientmodels.ModelsCreateContentResponse, error) {
	...
	ok, badRequest, unauthorized, notFound, internalServerError, err := aaa.Client.AdminContent.AdminHideUserContent(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
