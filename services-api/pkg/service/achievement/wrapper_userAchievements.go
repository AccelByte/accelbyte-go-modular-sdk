...
// UserAchievementsService this is use for compatibility with latest modular sdk only
// Deprecated: 2023-03-30 - please use UserAchievementsService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/achievement-sdk/pkg"
...
func (aaa *UserAchievementsService) AdminBatchQueryUserAchievementsShort(input *user_achievements.AdminBatchQueryUserAchievementsParams) (*user_achievements.AdminBatchQueryUserAchievementsResponse, error) {
	authInfoWriter := input.AuthInfoWriter
	if authInfoWriter == nil {
		security := [][]string{
			{"bearer"},
...
func (aaa *UserAchievementsService) AdminBulkUnlockAchievementShort(input *user_achievements.AdminBulkUnlockAchievementParams) (*user_achievements.AdminBulkUnlockAchievementResponse, error) {
	authInfoWriter := input.AuthInfoWriter
	if authInfoWriter == nil {
		security := [][]string{
			{"bearer"},
...
func (aaa *UserAchievementsService) PublicBulkUnlockAchievementShort(input *user_achievements.PublicBulkUnlockAchievementParams) (*user_achievements.PublicBulkUnlockAchievementResponse, error) {
	authInfoWriter := input.AuthInfoWriter
	if authInfoWriter == nil {
		security := [][]string{
			{"bearer"},
