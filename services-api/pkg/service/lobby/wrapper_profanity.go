...
// Deprecated: please use ProfanityService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/lobby-sdk/pkg"
...
func (aaa *ProfanityService) AdminDebugProfanityFilters(input *profanity.AdminDebugProfanityFiltersParams) ([]*lobbyclientmodels.ModelsProfanityFilter, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminDebugProfanityFilters(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *ProfanityService) AdminGetProfanityListFiltersV1(input *profanity.AdminGetProfanityListFiltersV1Params) (*lobbyclientmodels.ModelsAdminGetProfanityListFiltersV1Response, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminGetProfanityListFiltersV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminAddProfanityFilterIntoList(input *profanity.AdminAddProfanityFilterIntoListParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminAddProfanityFilterIntoList(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminAddProfanityFilters(input *profanity.AdminAddProfanityFiltersParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminAddProfanityFilters(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminImportProfanityFiltersFromFile(input *profanity.AdminImportProfanityFiltersFromFileParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminImportProfanityFiltersFromFile(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminDeleteProfanityFilter(input *profanity.AdminDeleteProfanityFilterParams) ([]*lobbyclientmodels.ModelsProfanityFilter, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminDeleteProfanityFilter(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminGetProfanityLists(input *profanity.AdminGetProfanityListsParams) ([]*lobbyclientmodels.ModelsAdminGetProfanityListsListResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminGetProfanityLists(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminCreateProfanityList(input *profanity.AdminCreateProfanityListParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminCreateProfanityList(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminUpdateProfanityList(input *profanity.AdminUpdateProfanityListParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminUpdateProfanityList(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminDeleteProfanityList(input *profanity.AdminDeleteProfanityListParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminDeleteProfanityList(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminGetProfanityRule(input *profanity.AdminGetProfanityRuleParams) (*lobbyclientmodels.ModelsProfanityRule, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminGetProfanityRule(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminSetProfanityRuleForNamespace(input *profanity.AdminSetProfanityRuleForNamespaceParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminSetProfanityRuleForNamespace(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *ProfanityService) AdminVerifyMessageProfanityResponse(input *profanity.AdminVerifyMessageProfanityResponseParams) (*lobbyclientmodels.ModelsAdminVerifyMessageProfanityResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Profanity.AdminVerifyMessageProfanityResponse(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
