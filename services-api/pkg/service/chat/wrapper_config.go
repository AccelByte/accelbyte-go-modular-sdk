...
// Deprecated: 2023-03-30 - please use ConfigService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/chat-sdk/pkg"
...
func (aaa *ConfigService) ExportConfig(input *config.ExportConfigParams) ([]*chatclientmodels.ModelsConfigExport, error) {
	...
	ok, unauthorized, forbidden, internalServerError, err := aaa.Client.Config.ExportConfig(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *ConfigService) ImportConfig(input *config.ImportConfigParams) (*chatclientmodels.ModelsImportConfigResponse, error) {
	...
	ok, unauthorized, forbidden, internalServerError, err := aaa.Client.Config.ImportConfig(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *ConfigService) PublicGetConfigV1(input *config.PublicGetConfigV1Params) (*chatclientmodels.ModelsPublicConfigResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Config.PublicGetConfigV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *ConfigService) ExportConfigShort(input *config.ExportConfigParams) ([]*chatclientmodels.ModelsConfigExport, error) {
	...
	ok, err := aaa.Client.Config.ExportConfigShort(input, authInfoWriter)
	if err != nil {
		return nil, err
	}
...
func (aaa *ConfigService) ImportConfigShort(input *config.ImportConfigParams) (*chatclientmodels.ModelsImportConfigResponse, error) {
	...
	ok, err := aaa.Client.Config.ImportConfigShort(input, authInfoWriter)
	if err != nil {
		return nil, err
	}
...
func (aaa *ConfigService) PublicGetConfigV1Short(input *config.PublicGetConfigV1Params) (*chatclientmodels.ModelsPublicConfigResponse, error) {
	...
	ok, err := aaa.Client.Config.PublicGetConfigV1Short(input, authInfoWriter)
	if err != nil {
		return nil, err
	}
