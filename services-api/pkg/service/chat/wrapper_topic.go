...
// TopicService this is use for compatibility with latest modular sdk only
// Deprecated: 2023-03-30 - please use TopicService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/chat-sdk/pkg"
...
func (aaa *TopicService) AdminChatHistory(input *topic.AdminChatHistoryParams) (*chatclientmodels.ModelsChatMessageWithPaginationResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminChatHistory(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminCreateNamespaceTopic(input *topic.AdminCreateNamespaceTopicParams) (*chatclientmodels.APICreateTopicResponse, error) {
	...
	ok, err := aaa.Client.Topic.AdminCreateNamespaceTopic(input, client.BearerToken(*token.AccessToken))
	if err != nil {
		return nil, err
	}
...
func (aaa *TopicService) AdminCreateTopic(input *topic.AdminCreateTopicParams) (*chatclientmodels.APICreateTopicResponse, error) {
	...
	ok, err := aaa.Client.Topic.AdminCreateTopic(input, client.BearerToken(*token.AccessToken))
	if err != nil {
		return nil, err
	}
...
func (aaa *TopicService) AdminChannelTopicList(input *topic.AdminChannelTopicListParams) (*chatclientmodels.ModelsChannelTopicWithPaginationResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminChannelTopicList(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminChannelTopicSummary(input *topic.AdminChannelTopicSummaryParams) (*chatclientmodels.ModelsChannelTopicSummaryResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminChannelTopicSummary(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminQueryTopicLog(input *topic.AdminQueryTopicLogParams) (*chatclientmodels.ModelsTopicLogWithPaginationResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminQueryTopicLog(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminChannelTopicInfo(input *topic.AdminChannelTopicInfoParams) (*chatclientmodels.ModelsChannelTopicResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Topic.AdminChannelTopicInfo(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminTopicChatHistory(input *topic.AdminTopicChatHistoryParams) (*chatclientmodels.ModelsChatMessageWithPaginationResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminTopicChatHistory(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminTopicMembers(input *topic.AdminTopicMembersParams) (*chatclientmodels.ModelsTopicMemberWithPaginationResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminTopicMembers(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminTopicShards(input *topic.AdminTopicShardsParams) ([]string, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminTopicShards(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminQueryTopic(input *topic.AdminQueryTopicParams) ([]*chatclientmodels.ModelsTopicInfo, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminQueryTopic(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) AdminQueryUsersTopic(input *topic.AdminQueryUsersTopicParams) (*chatclientmodels.ModelsTopicLogWithPaginationResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.AdminQueryUsersTopic(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) PublicGetMutedTopics(input *topic.PublicGetMutedTopicsParams) ([]*chatclientmodels.APIMutedTopicResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.PublicGetMutedTopics(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) PublicTopicList(input *topic.PublicTopicListParams) ([]*chatclientmodels.ModelsChatMessageResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.PublicTopicList(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) PublicChatHistory(input *topic.PublicChatHistoryParams) ([]*chatclientmodels.ModelsChatMessageResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.PublicChatHistory(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *TopicService) PublicDeleteChat(input *topic.PublicDeleteChatParams) error {
	...
	_, badRequest, unauthorized, forbidden, internalServerError, err := aaa.Client.Topic.PublicDeleteChat(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
