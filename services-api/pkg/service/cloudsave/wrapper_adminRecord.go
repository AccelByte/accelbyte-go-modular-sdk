...
// AdminRecordService this is use for compatibility with latest modular sdk only
// Deprecated: 2023-03-30 - please use AdminRecordService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/cloudsave-sdk/pkg"
...
func (aaa *AdminRecordService) AdminListAdminGameRecordV1(input *admin_record.AdminListAdminGameRecordV1Params) (*cloudsaveclientmodels.ModelsListAdminGameRecordKeysResponse, error) {
	...
	ok, unauthorized, internalServerError, err := aaa.Client.AdminRecord.AdminListAdminGameRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
...
func (aaa *AdminRecordService) AdminBulkGetAdminGameRecordV1(input *admin_record.AdminBulkGetAdminGameRecordV1Params) (*cloudsaveclientmodels.ModelsBulkGetAdminGameRecordResponse, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AdminRecord.AdminBulkGetAdminGameRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *AdminRecordService) AdminGetAdminGameRecordV1(input *admin_record.AdminGetAdminGameRecordV1Params) (*cloudsaveclientmodels.ModelsAdminGameRecordResponse, error) {
	...
	ok, unauthorized, notFound, internalServerError, err := aaa.Client.AdminRecord.AdminGetAdminGameRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if notFound != nil {
...
func (aaa *AdminRecordService) AdminPutAdminGameRecordV1(input *admin_record.AdminPutAdminGameRecordV1Params) (*cloudsaveclientmodels.ModelsAdminGameRecordResponse, error) {
	...
	ok, unauthorized, internalServerError, err := aaa.Client.AdminRecord.AdminPutAdminGameRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *AdminRecordService) AdminPostAdminGameRecordV1(input *admin_record.AdminPostAdminGameRecordV1Params) (*cloudsaveclientmodels.ModelsAdminGameRecordResponse, error) {
	...
	created, unauthorized, internalServerError, err := aaa.Client.AdminRecord.AdminPostAdminGameRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *AdminRecordService) AdminDeleteAdminGameRecordV1(input *admin_record.AdminDeleteAdminGameRecordV1Params) error {
	...
	_, unauthorized, notFound, internalServerError, err := aaa.Client.AdminRecord.AdminDeleteAdminGameRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if notFound != nil {
...
func (aaa *AdminRecordService) BulkGetAdminPlayerRecordByUserIdsV1(input *admin_record.BulkGetAdminPlayerRecordByUserIdsV1Params) (*cloudsaveclientmodels.ModelsBulkGetAdminPlayerRecordResponse, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AdminRecord.BulkGetAdminPlayerRecordByUserIdsV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *AdminRecordService) AdminListAdminUserRecordsV1(input *admin_record.AdminListAdminUserRecordsV1Params) (*cloudsaveclientmodels.ModelsListAdminPlayerRecordKeysResponse, error) {
	...
	ok, badRequest, unauthorized, internalServerError, err := aaa.Client.AdminRecord.AdminListAdminUserRecordsV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *AdminRecordService) AdminBulkGetAdminPlayerRecordV1(input *admin_record.AdminBulkGetAdminPlayerRecordV1Params) (*cloudsaveclientmodels.ModelsBulkGetAdminPlayerRecordResponse, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.AdminRecord.AdminBulkGetAdminPlayerRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *AdminRecordService) AdminGetAdminPlayerRecordV1(input *admin_record.AdminGetAdminPlayerRecordV1Params) (*cloudsaveclientmodels.ModelsAdminPlayerRecordResponse, error) {
	...
	ok, unauthorized, notFound, internalServerError, err := aaa.Client.AdminRecord.AdminGetAdminPlayerRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if notFound != nil {
...
func (aaa *AdminRecordService) AdminPutAdminPlayerRecordV1(input *admin_record.AdminPutAdminPlayerRecordV1Params) (*cloudsaveclientmodels.ModelsAdminPlayerRecordResponse, error) {
	...
	ok, unauthorized, internalServerError, err := aaa.Client.AdminRecord.AdminPutAdminPlayerRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *AdminRecordService) AdminPostPlayerAdminRecordV1(input *admin_record.AdminPostPlayerAdminRecordV1Params) (*cloudsaveclientmodels.ModelsAdminPlayerRecordResponse, error) {
	...
	created, unauthorized, internalServerError, err := aaa.Client.AdminRecord.AdminPostPlayerAdminRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *AdminRecordService) AdminDeleteAdminPlayerRecordV1(input *admin_record.AdminDeleteAdminPlayerRecordV1Params) error {
	...
	_, unauthorized, notFound, internalServerError, err := aaa.Client.AdminRecord.AdminDeleteAdminPlayerRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if notFound != nil {
