...
// PublicPlayerBinaryRecordService this is use for compatibility with latest modular sdk only
// Deprecated: 2023-03-30 - please use PublicPlayerBinaryRecordService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/cloudsave-sdk/pkg"
...
func (aaa *PublicPlayerBinaryRecordService) ListMyBinaryRecordsV1(input *public_player_binary_record.ListMyBinaryRecordsV1Params) (*cloudsaveclientmodels.ModelsListPlayerBinaryRecordsResponse, error) {
	...
	ok, unauthorized, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.ListMyBinaryRecordsV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *PublicPlayerBinaryRecordService) PostPlayerBinaryRecordV1(input *public_player_binary_record.PostPlayerBinaryRecordV1Params) (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, error) {
	...
	created, unauthorized, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.PostPlayerBinaryRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *PublicPlayerBinaryRecordService) ListOtherPlayerPublicBinaryRecordsV1(input *public_player_binary_record.ListOtherPlayerPublicBinaryRecordsV1Params) (*cloudsaveclientmodels.ModelsListPlayerBinaryRecordsResponse, error) {
	...
	ok, badRequest, unauthorized, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.ListOtherPlayerPublicBinaryRecordsV1(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *PublicPlayerBinaryRecordService) GetPlayerBinaryRecordV1(input *public_player_binary_record.GetPlayerBinaryRecordV1Params) (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, error) {
	...
	ok, unauthorized, notFound, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.GetPlayerBinaryRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if notFound != nil {
...
func (aaa *PublicPlayerBinaryRecordService) PutPlayerBinaryRecordV1(input *public_player_binary_record.PutPlayerBinaryRecordV1Params) (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, error) {
	...
	ok, unauthorized, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.PutPlayerBinaryRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *PublicPlayerBinaryRecordService) DeletePlayerBinaryRecordV1(input *public_player_binary_record.DeletePlayerBinaryRecordV1Params) error {
	...
	_, unauthorized, notFound, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.DeletePlayerBinaryRecordV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if notFound != nil {
...
func (aaa *PublicPlayerBinaryRecordService) PutPlayerBinaryRecorMetadataV1(input *public_player_binary_record.PutPlayerBinaryRecorMetadataV1Params) (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, error) {
	...
	ok, unauthorized, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.PutPlayerBinaryRecorMetadataV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *PublicPlayerBinaryRecordService) PostPlayerBinaryPresignedURLV1(input *public_player_binary_record.PostPlayerBinaryPresignedURLV1Params) (*cloudsaveclientmodels.ModelsUploadBinaryRecordResponse, error) {
	...
	created, unauthorized, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.PostPlayerBinaryPresignedURLV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if internalServerError != nil {
...
func (aaa *PublicPlayerBinaryRecordService) GetPlayerPublicBinaryRecordsV1(input *public_player_binary_record.GetPlayerPublicBinaryRecordsV1Params) (*cloudsaveclientmodels.ModelsPlayerBinaryRecordResponse, error) {
	...
	ok, unauthorized, notFound, internalServerError, err := aaa.Client.PublicPlayerBinaryRecord.GetPlayerPublicBinaryRecordsV1(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if notFound != nil {
