...
// Deprecated: 2023-03-30 - please use PublicTagsService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/inventory-sdk/pkg"
...
func (aaa *PublicTagsService) PublicListTags(input *public_tags.PublicListTagsParams) (*inventoryclientmodels.ApimodelsListTagsResp, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
	ok, badRequest, internalServerError, err := aaa.Client.PublicTags.PublicListTags(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
