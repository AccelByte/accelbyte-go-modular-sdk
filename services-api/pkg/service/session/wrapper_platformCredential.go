...
func (aaa *PlatformCredentialService) AdminGetPlatformCredentials(input *platform_credential.AdminGetPlatformCredentialsParams) (*sessionclientmodels.ModelsPlatformCredentials, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.PlatformCredential.AdminGetPlatformCredentials(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *PlatformCredentialService) AdminDeletePlatformCredentials(input *platform_credential.AdminDeletePlatformCredentialsParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.PlatformCredential.AdminDeletePlatformCredentials(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
