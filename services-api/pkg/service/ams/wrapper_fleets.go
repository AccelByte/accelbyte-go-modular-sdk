...
func (aaa *FleetsService) FleetGet(input *fleets.FleetGetParams) (*amsclientmodels.APIFleetGetResponse, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Fleets.FleetGet(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *FleetsService) FleetDelete(input *fleets.FleetDeleteParams) error {
	...
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Fleets.FleetDelete(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
...
func (aaa *FleetsService) FleetServers(input *fleets.FleetServersParams) (*amsclientmodels.APIFleetServersResponse, error) {
	...
	ok, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Fleets.FleetServers(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
