...
func (aaa *FleetsService) FleetList(input *fleets.FleetListParams) (*amsclientmodels.APIFleetListResponse, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
	ok, internalServerError, err := aaa.Client.Fleets.FleetList(input, client.BearerToken(*token.AccessToken))
...
func (aaa *FleetsService) FleetCreate(input *fleets.FleetCreateParams) (*amsclientmodels.APIFleetCreateResponse, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
...
func (aaa *FleetsService) FleetGet(input *fleets.FleetGetParams) (*amsclientmodels.APIFleetGetResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Fleets.FleetGet(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *FleetsService) FleetDelete(input *fleets.FleetDeleteParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Fleets.FleetDelete(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *FleetsService) FleetServers(input *fleets.FleetServersParams) (*amsclientmodels.APIFleetServersResponse, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Fleets.FleetServers(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *FleetsService) FleetClaimByID(input *fleets.FleetClaimByIDParams) (*amsclientmodels.APIFleetClaimResponse, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Fleets.FleetClaimByID(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *FleetsService) FleetClaimByKeys(input *fleets.FleetClaimByKeysParams) (*amsclientmodels.APIFleetClaimResponse, error) {
	token, err := aaa.TokenRepository.GetToken()
	if err != nil {
		return nil, err
	}
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Fleets.FleetClaimByKeys(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
