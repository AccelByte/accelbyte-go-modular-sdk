...
module github.com/AccelByte/accelbyte-go-modular-sdk/services-api/pkg/service/eventlog

go 1.18

// for development only (not propagated)
replace github.com/AccelByte/accelbyte-go-modular-sdk/eventlog-sdk => ../../../../eventlog-sdk

require (
	github.com/AccelByte/accelbyte-go-modular-sdk/eventlog-sdk v0.0.0
