...
// Deprecated: please use BackfillService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/match2-sdk/pkg"
...
func (aaa *BackfillService) GetBackfillProposal(input *backfill.GetBackfillProposalParams) (*match2clientmodels.APIBackfillProposalResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Backfill.GetBackfillProposal(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *BackfillService) GetBackfill(input *backfill.GetBackfillParams) (*match2clientmodels.APIBackfillGetResponse, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Backfill.GetBackfill(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return nil, badRequest
	}
	if unauthorized != nil {
...
func (aaa *BackfillService) DeleteBackfill(input *backfill.DeleteBackfillParams) error {
	...
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Backfill.DeleteBackfill(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
...
func (aaa *BackfillService) RejectBackfill(input *backfill.RejectBackfillParams) error {
	...
	_, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.Backfill.RejectBackfill(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
