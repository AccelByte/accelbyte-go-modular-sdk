module github.com/AccelByte/accelbyte-go-modular-sdk/services-api/pkg/service/match2

go 1.18

// for development only (not propagated)
replace github.com/AccelByte/accelbyte-go-modular-sdk/match2-sdk => ../../../../match2-sdk
