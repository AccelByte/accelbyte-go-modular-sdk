...
// Deprecated: please use RuleSetsService imported from "github.com/AccelByte/accelbyte-go-sdk/match2-sdk/pkg"
...
func (aaa *RuleSetsService) RuleSetList(input *rule_sets.RuleSetListParams) (*match2clientmodels.APIListRuleSetsResponse, error) {
	...
	ok, unauthorized, forbidden, internalServerError, err := aaa.Client.RuleSets.RuleSetList(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
...
func (aaa *RuleSetsService) CreateRuleSet(input *rule_sets.CreateRuleSetParams) error {
	...
	_, badRequest, unauthorized, forbidden, conflict, internalServerError, err := aaa.Client.RuleSets.CreateRuleSet(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
		return badRequest
	}
	if unauthorized != nil {
...
func (aaa *RuleSetsService) RuleSetDetails(input *rule_sets.RuleSetDetailsParams) (*match2clientmodels.APIRuleSetPayload, error) {
	...
	ok, unauthorized, forbidden, internalServerError, err := aaa.Client.RuleSets.RuleSetDetails(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return nil, unauthorized
	}
	if forbidden != nil {
...
func (aaa *RuleSetsService) UpdateRuleSet(input *rule_sets.UpdateRuleSetParams) (*match2clientmodels.APIRuleSetPayload, error) {
	...
	ok, badRequest, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.RuleSets.UpdateRuleSet(input, client.BearerToken(*token.AccessToken))
	if badRequest != nil {
...
func (aaa *RuleSetsService) DeleteRuleSet(input *rule_sets.DeleteRuleSetParams) error {
	...
	_, unauthorized, forbidden, notFound, internalServerError, err := aaa.Client.RuleSets.DeleteRuleSet(input, client.BearerToken(*token.AccessToken))
	if unauthorized != nil {
		return unauthorized
	}
	if forbidden != nil {
