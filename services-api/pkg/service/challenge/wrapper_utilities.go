...
// UtilitiesService this is use for compatibility with latest modular sdk only
// Deprecated: 2023-03-30 - please use UtilitiesService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/challenge-sdk/pkg"
...
func (aaa *UtilitiesService) AdminGetItemReferencesShort(input *utilities.AdminGetItemReferencesParams) (*utilities.AdminGetItemReferencesResponse, error) {
