...
// AppService this is use for compatibility with latest modular sdk only
// Deprecated: 2023-03-30 - please use AppService imported from "github.com/AccelByte/accelbyte-go-modular-sdk/csm-sdk/pkg"
...
var tempFlightIdApp *string

func (aaa *AppService) UpdateFlightId(flightId string) {
	tempFlightIdApp = &flightId
}
...
func (aaa *AppService) GetAppListV1Short(input *app.GetAppListV1Params) (*app.GetAppListV1Response, error) {
	...
	if tempFlightIdApp != nil {
		input.XFlightId = tempFlightIdApp
	} else if aaa.FlightIdRepository != nil {
		utils.GetDefaultFlightID().SetFlightID(aaa.FlightIdRepository.Value)
	}

	ok, err := aaa.Client.App.GetAppListV1Short(input, authInfoWriter)
	if err != nil {
		return nil, err
	}
...
func (aaa *AppService) GetAppV1Short(input *app.GetAppV1Params) (*app.GetAppV1Response, error) {
	...
	ok, err := aaa.Client.App.GetAppV1Short(input, authInfoWriter)
	if err != nil {
		return nil, err
	}
...
func (aaa *AppService) DeleteAppV1Short(input *app.DeleteAppV1Params) error {
	...
	_, err := aaa.Client.App.DeleteAppV1Short(input, authInfoWriter)
	if err != nil {
		return err
	}
...
func (aaa *AppService) UpdateAppV1Short(input *app.UpdateAppV1Params) (*app.UpdateAppV1Response, error) {
	...
	ok, err := aaa.Client.App.UpdateAppV1Short(input, authInfoWriter)
	if err != nil {
		return nil, err
	}
...
func (aaa *AppService) StartAppV1Short(input *app.StartAppV1Params) (*app.StartAppV1Response, error) {
	...
	ok, err := aaa.Client.App.StartAppV1Short(input, authInfoWriter)
	if err != nil {
		return nil, err
	}
