...
// ConfigurationV2Service this is use for compatibility with latest modular sdk only
// Deprecated: 2023-03-30 - please use ConfigurationV2Service imported from "github.com/AccelByte/accelbyte-go-modular-sdk/csm-sdk/pkg"
